 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(F,X){var $=F.length;F.push(X);e:for(;0<$;){var ne=$-1>>>1,fe=F[ne];if(0<r(fe,X))F[ne]=X,F[$]=fe,$=ne;else break e}}function n(F){return F.length===0?null:F[0]}function i(F){if(F.length===0)return null;var X=F[0],$=F.pop();if($!==X){F[0]=$;e:for(var ne=0,fe=F.length,Ve=fe>>>1;ne<Ve;){var We=2*(ne+1)-1,Le=F[We],K=We+1,de=F[K];if(0>r(Le,$))K<fe&&0>r(de,Le)?(F[ne]=de,F[K]=$,ne=K):(F[ne]=Le,F[We]=$,ne=We);else if(K<fe&&0>r(de,$))F[ne]=de,F[K]=$,ne=K;else break e}}return X}function r(F,X){var $=F.sortIndex-X.sortIndex;return $!==0?$:F.id-X.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],d=1,h=null,f=3,p=!1,_=!1,v=!1,m=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function x(F){for(var X=n(u);X!==null;){if(X.callback===null)i(u);else if(X.startTime<=F)i(u),X.sortIndex=X.expirationTime,e(l,X);else break;X=n(u)}}function y(F){if(v=!1,x(F),!_)if(n(l)!==null)_=!0,B(R);else{var X=n(u);X!==null&&O(y,X.startTime-F)}}function R(F,X){_=!1,v&&(v=!1,c(S),S=-1),p=!0;var $=f;try{for(x(X),h=n(l);h!==null&&(!(h.expirationTime>X)||F&&!w());){var ne=h.callback;if(typeof ne=="function"){h.callback=null,f=h.priorityLevel;var fe=ne(h.expirationTime<=X);X=t.unstable_now(),typeof fe=="function"?h.callback=fe:h===n(l)&&i(l),x(X)}else i(l);h=n(l)}if(h!==null)var Ve=!0;else{var We=n(u);We!==null&&O(y,We.startTime-X),Ve=!1}return Ve}finally{h=null,f=$,p=!1}}var T=!1,b=null,S=-1,A=5,P=-1;function w(){return!(t.unstable_now()-P<A)}function L(){if(b!==null){var F=t.unstable_now();P=F;var X=!0;try{X=b(!0,F)}finally{X?k():(T=!1,b=null)}}else T=!1}var k;if(typeof g=="function")k=function(){g(L)};else if(typeof MessageChannel<"u"){var j=new MessageChannel,D=j.port2;j.port1.onmessage=L,k=function(){D.postMessage(null)}}else k=function(){m(L,0)};function B(F){b=F,T||(T=!0,k())}function O(F,X){S=m(function(){F(t.unstable_now())},X)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(F){F.callback=null},t.unstable_continueExecution=function(){_||p||(_=!0,B(R))},t.unstable_forceFrameRate=function(F){0>F||125<F?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<F?Math.floor(1e3/F):5},t.unstable_getCurrentPriorityLevel=function(){return f},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(F){switch(f){case 1:case 2:case 3:var X=3;break;default:X=f}var $=f;f=X;try{return F()}finally{f=$}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(F,X){switch(F){case 1:case 2:case 3:case 4:case 5:break;default:F=3}var $=f;f=F;try{return X()}finally{f=$}},t.unstable_scheduleCallback=function(F,X,$){var ne=t.unstable_now();switch(typeof $=="object"&&$!==null?($=$.delay,$=typeof $=="number"&&0<$?ne+$:ne):$=ne,F){case 1:var fe=-1;break;case 2:fe=250;break;case 5:fe=1073741823;break;case 4:fe=1e4;break;default:fe=5e3}return fe=$+fe,F={id:d++,callback:X,priorityLevel:F,startTime:$,expirationTime:fe,sortIndex:-1},$>ne?(F.sortIndex=$,e(u,F),n(l)===null&&F===n(u)&&(v?(c(S),S=-1):v=!0,O(y,$-ne))):(F.sortIndex=fe,e(l,F),_||p||(_=!0,B(R))),F},t.unstable_shouldYield=w,t.unstable_wrapCallback=function(F){var X=f;return function(){var $=f;f=X;try{return F.apply(this,arguments)}finally{f=$}}}})(ug);lg.exports=ug;var Pv=lg.exports;/**
 * @license React
...
`)+`
`+c);const x=g+m+o,y=g+c+a,R=Lm(r,r.VERTEX_SHADER,x),T=Lm(r,r.FRAGMENT_SHADER,y);r.attachShader(v,R),r.attachShader(v,T),n.index0AttributeName!==void 0?r.bindAttribLocation(v,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function b(w){if(t.debug.checkShaderErrors){const L=r.getProgramInfoLog(v)||"",k=r.getShaderInfoLog(R)||"",j=r.getShaderInfoLog(T)||"",D=L.trim(),B=k.trim(),O=j.trim();let F=!0,X=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(F=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,v,R,T);else{const $=Dm(r,R,"vertex"),ne=Dm(r,T,"fragment");Ke("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
...
}`,jw=[new G(1,0,0),new G(-1,0,0),new G(0,1,0),new G(0,-1,0),new G(0,0,1),new G(0,0,-1)],Yw=[new G(0,-1,0),new G(0,-1,0),new G(0,0,1),new G(0,0,-1),new G(0,-1,0),new G(0,-1,0)],Vm=new Ft,uo=new G,yc=new G;function $w(t,e,n){let i=new N_;const r=new st,s=new st,o=new Rt,a=new iM,l=new rM,u={},d=n.maxTextureSize,h={[mr]:gn,[gn]:mr,[Ei]:Ei},f=new Zn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new st},radius:{value:4}},vertexShader:Ww,fragmentShader:Xw}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const _=new Bi;_.setAttribute("position",new di(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new pi(_,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ll;let c=this.type;this.render=function(T,b,S){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||T.length===0)return;this.type===XS&&(Pe("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=ll);const A=t.getRenderTarget(),P=t.getActiveCubeFace(),w=t.getActiveMipmapLevel(),L=t.state;L.setBlending(Ci),L.buffers.depth.getReversed()===!0?L.buffers.color.setClear(0,0,0,0):L.buffers.color.setClear(1,1,1,1),L.buffers.depth.setTest(!0),L.setScissorTest(!1);const k=c!==this.type;k&&b.traverse(function(j){j.material&&(Array.isArray(j.material)?j.material.forEach(D=>D.needsUpdate=!0):j.material.needsUpdate=!0)});for(let j=0,D=T.length;j<D;j++){const B=T[j],O=B.shadow;if(O===void 0){Pe("WebGLShadowMap:",B,"has no shadow.");continue}if(O.autoUpdate===!1&&O.needsUpdate===!1)continue;r.copy(O.mapSize);const F=O.getFrameExtents();r.multiply(F),s.copy(O.mapSize),(r.x>d||r.y>d)&&(r.x>d&&(s.x=Math.floor(d/F.x),r.x=s.x*F.x,O.mapSize.x=s.x),r.y>d&&(s.y=Math.floor(d/F.y),r.y=s.y*F.y,O.mapSize.y=s.y));const X=t.state.buffers.depth.getReversed();if(O.camera._reversedDepth=X,O.map===null||k===!0){if(O.map!==null&&(O.map.depthTexture!==null&&(O.map.depthTexture.dispose(),O.map.depthTexture=null),O.map.dispose()),this.type===go){if(B.isPointLight){Pe("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}O.map=new fi(r.x,r.y,{format:Hr,type:Fi,minFilter:Vt,magFilter:Vt,generateMipmaps:!1}),O.map.texture.name=B.name+".shadowMap",O.map.depthTexture=new Vs(r.x,r.y,oi),O.map.depthTexture.name=B.name+".shadowMapDepth",O.map.depthTexture.format=Oi,O.map.depthTexture.compareFunction=null,O.map.depthTexture.minFilter=Wt,O.map.depthTexture.magFilter=Wt}else B.isPointLight?(O.map=new B_(r.x),O.map.depthTexture=new Zy(r.x,hi)):(O.map=new fi(r.x,r.y),O.map.depthTexture=new Vs(r.x,r.y,hi)),O.map.depthTexture.name=B.name+".shadowMap",O.map.depthTexture.format=Oi,this.type===ll?(O.map.depthTexture.compareFunction=X?ph:hh,O.map.depthTexture.minFilter=Vt,O.map.depthTexture.magFilter=Vt):(O.map.depthTexture.compareFunction=null,O.map.depthTexture.minFilter=Wt,O.map.depthTexture.magFilter=Wt);O.camera.updateProjectionMatrix()}const $=O.map.isWebGLCubeRenderTarget?6:1;for(let ne=0;ne<$;ne++){if(O.map.isWebGLCubeRenderTarget)t.setRenderTarget(O.map,ne),t.clear();else{ne===0&&(t.setRenderTarget(O.map),t.clear());const fe=O.getViewport(ne);o.set(s.x*fe.x,s.y*fe.y,s.x*fe.z,s.y*fe.w),L.viewport(o)}if(B.isPointLight){const fe=O.camera,Ve=O.matrix,We=B.distance||fe.far;We!==fe.far&&(fe.far=We,fe.updateProjectionMatrix()),uo.setFromMatrixPosition(B.matrixWorld),fe.position.copy(uo),yc.copy(fe.position),yc.add(jw[ne]),fe.up.copy(Yw[ne]),fe.lookAt(yc),fe.updateMatrixWorld(),Ve.makeTranslation(-uo.x,-uo.y,-uo.z),Vm.multiplyMatrices(fe.projectionMatrix,fe.matrixWorldInverse),O._frustum.setFromProjectionMatrix(Vm,fe.coordinateSystem,fe.reversedDepth)}else O.updateMatrices(B);i=O.getFrustum(),y(b,S,O.camera,B,this.type)}O.isPointLightShadow!==!0&&this.type===go&&g(O,S),O.needsUpdate=!1}c=this.type,m.needsUpdate=!1,t.setRenderTarget(A,P,w)};function g(T,b){const S=e.update(v);f.defines.VSM_SAMPLES!==T.blurSamples&&(f.defines.VSM_SAMPLES=T.blurSamples,p.defines.VSM_SAMPLES=T.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new fi(r.x,r.y,{format:Hr,type:Fi})),f.uniforms.shadow_pass.value=T.map.depthTexture,f.uniforms.resolution.value=T.mapSize,f.uniforms.radius.value=T.radius,t.setRenderTarget(T.mapPass),t.clear(),t.renderBufferDirect(b,null,S,f,v,null),p.uniforms.shadow_pass.value=T.mapPass.texture,p.uniforms.resolution.value=T.mapSize,p.uniforms.radius.value=T.radius,t.setRenderTarget(T.map),t.clear(),t.renderBufferDirect(b,null,S,p,v,null)}function x(T,b,S,A){let P=null;const w=S.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(w!==void 0)P=w;else if(P=S.isPointLight===!0?l:a,t.localClippingEnabled&&b.clipShadows===!0&&Array.isArray(b.clippingPlanes)&&b.clippingPlanes.length!==0||b.displacementMap&&b.displacementScale!==0||b.alphaMap&&b.alphaTest>0||b.map&&b.alphaTest>0||b.alphaToCoverage===!0){const L=P.uuid,k=b.uuid;let j=u[L];j===void 0&&(j={},u[L]=j);let D=j[k];D===void 0&&(D=P.clone(),j[k]=D,b.addEventListener("dispose",R)),P=D}if(P.visible=b.visible,P.wireframe=b.wireframe,A===go?P.side=b.shadowSide!==null?b.shadowSide:b.side:P.side=b.shadowSide!==null?b.shadowSide:h[b.side],P.alphaMap=b.alphaMap,P.alphaTest=b.alphaToCoverage===!0?.5:b.alphaTest,P.map=b.map,P.clipShadows=b.clipShadows,P.clippingPlanes=b.clippingPlanes,P.clipIntersection=b.clipIntersection,P.displacementMap=b.displacementMap,P.displacementScale=b.displacementScale,P.displacementBias=b.displacementBias,P.wireframeLinewidth=b.wireframeLinewidth,P.linewidth=b.linewidth,S.isPointLight===!0&&P.isMeshDistanceMaterial===!0){const L=t.properties.get(P);L.light=S}return P}function y(T,b,S,A,P){if(T.visible===!1)return;if(T.layers.test(b.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&P===go)&&(!T.frustumCulled||i.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(S.matrixWorldInverse,T.matrixWorld);const k=e.update(T),j=T.material;if(Array.isArray(j)){const D=k.groups;for(let B=0,O=D.length;B<O;B++){const F=D[B],X=j[F.materialIndex];if(X&&X.visible){const $=x(T,X,A,P);T.onBeforeShadow(t,T,b,S,k,$,F),t.renderBufferDirect(S,null,k,$,T,F),T.onAfterShadow(t,T,b,S,k,$,F)}}}else if(j.visible){const D=x(T,j,A,P);T.onBeforeShadow(t,T,b,S,k,D,null),t.renderBufferDirect(S,null,k,D,T,null),T.onAfterShadow(t,T,b,S,k,D,null)}}const L=T.children;for(let k=0,j=L.length;k<j;k++)y(L[k],b,S,A,P)}function R(T){T.target.removeEventListener("dispose",R);for(const S in u){const A=u[S],P=T.target.uuid;P in A&&(A[P].dispose(),delete A[P])}}}function qw(t,e){function n(){let N=!1;const oe=new Rt;let q=null;const ve=new Rt(0,0,0,0);return{setMask:function(ue){q!==ue&&!N&&(t.colorMask(ue,ue,ue,ue),q=ue)},setLocked:function(ue){N=ue},setClear:function(ue,ee,we,Fe,Et){Et===!0&&(ue*=Fe,ee*=Fe,we*=Fe),oe.set(ue,ee,we,Fe),ve.equals(oe)===!1&&(t.clearColor(ue,ee,we,Fe),ve.copy(oe))},reset:function(){N=!1,q=null,ve.set(-1,0,0,0)}}}function i(){let N=!1,oe=!1,q=null,ve=null,ue=null;return{setReversed:function(ee){if(oe!==ee){const we=e.get("EXT_clip_control");ee?we.clipControlEXT(we.LOWER_LEFT_EXT,we.ZERO_TO_ONE_EXT):we.clipControlEXT(we.LOWER_LEFT_EXT,we.NEGATIVE_ONE_TO_ONE_EXT),oe=ee;const Fe=ue;ue=null,this.setClear(Fe)}},getReversed:function(){return oe},setTest:function(ee){ee?ae(t.DEPTH_TEST):Ce(t.DEPTH_TEST)},setMask:function(ee){q!==ee&&!N&&(t.depthMask(ee),q=ee)},setFunc:function(ee){if(oe&&(ee=Ty[ee]),ve!==ee){switch(ee){case xf:t.depthFunc(t.NEVER);break;case Sf:t.depthFunc(t.ALWAYS);break;case yf:t.depthFunc(t.LESS);break;case Bs:t.depthFunc(t.LEQUAL);break;case Mf:t.depthFunc(t.EQUAL);break;case Ef:t.depthFunc(t.GEQUAL);break;case Tf:t.depthFunc(t.GREATER);break;case wf:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}ve=ee}},setLocked:function(ee){N=ee},setClear:function(ee){ue!==ee&&(ue=ee,oe&&(ee=1-ee),t.clearDepth(ee))},reset:function(){N=!1,q=null,ve=null,ue=null,oe=!1}}}function r(){let N=!1,oe=null,q=null,ve=null,ue=null,ee=null,we=null,Fe=null,Et=null;return{setTest:function(nt){N||(nt?ae(t.STENCIL_TEST):Ce(t.STENCIL_TEST))},setMask:function(nt){oe!==nt&&!N&&(t.stencilMask(nt),oe=nt)},setFunc:function(nt,mi,Qn){(q!==nt||ve!==mi||ue!==Qn)&&(t.stencilFunc(nt,mi,Qn),q=nt,ve=mi,ue=Qn)},setOp:function(nt,mi,Qn){(ee!==nt||we!==mi||Fe!==Qn)&&(t.stencilOp(nt,mi,Qn),ee=nt,we=mi,Fe=Qn)},setLocked:function(nt){N=nt},setClear:function(nt){Et!==nt&&(t.clearStencil(nt),Et=nt)},reset:function(){N=!1,oe=null,q=null,ve=null,ue=null,ee=null,we=null,Fe=null,Et=null}}}const s=new n,o=new i,a=new r,l=new WeakMap,u=new WeakMap;let d={},h={},f={},p=new WeakMap,_=[],v=null,m=!1,c=null,g=null,x=null,y=null,R=null,T=null,b=null,S=new rt(0,0,0),A=0,P=!1,w=null,L=null,k=null,j=null,D=null;const B=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let O=!1,F=0;const X=t.getParameter(t.VERSION);X.indexOf("WebGL")!==-1?(F=parseFloat(/^WebGL (\d)/.exec(X)[1]),O=F>=1):X.indexOf("OpenGL ES")!==-1&&(F=parseFloat(/^OpenGL ES (\d)/.exec(X)[1]),O=F>=2);let $=null,ne={};const fe=t.getParameter(t.SCISSOR_BOX),Ve=t.getParameter(t.VIEWPORT),We=new Rt().fromArray(fe),Le=new Rt().fromArray(Ve);function K(N,oe,q,ve){const ue=new Uint8Array(4),ee=t.createTexture();t.bindTexture(N,ee),t.texParameteri(N,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(N,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let we=0;we<q;we++)N===t.TEXTURE_3D||N===t.TEXTURE_2D_ARRAY?t.texImage3D(oe,0,t.RGBA,1,1,ve,0,t.RGBA,t.UNSIGNED_BYTE,ue):t.texImage2D(oe+we,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,ue);return ee}const de={};de[t.TEXTURE_2D]=K(t.TEXTURE_2D,t.TEXTURE_2D,1),de[t.TEXTURE_CUBE_MAP]=K(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),de[t.TEXTURE_2D_ARRAY]=K(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),de[t.TEXTURE_3D]=K(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),ae(t.DEPTH_TEST),o.setFunc(Bs),Lt(!1),gt(Gp),ae(t.CULL_FACE),ft(Ci);function ae(N){d[N]!==!0&&(t.enable(N),d[N]=!0)}function Ce(N){d[N]!==!1&&(t.disable(N),d[N]=!1)}function Ie(N,oe){return f[N]!==oe?(t.bindFramebuffer(N,oe),f[N]=oe,N===t.DRAW_FRAMEBUFFER&&(f[t.FRAMEBUFFER]=oe),N===t.FRAMEBUFFER&&(f[t.DRAW_FRAMEBUFFER]=oe),!0):!1}function be(N,oe){let q=_,ve=!1;if(N){q=p.get(oe),q===void 0&&(q=[],p.set(oe,q));const ue=N.textures;if(q.length!==ue.length||q[0]!==t.COLOR_ATTACHMENT0){for(let ee=0,we=ue.length;ee<we;ee++)q[ee]=t.COLOR_ATTACHMENT0+ee;q.length=ue.length,ve=!0}}else q[0]!==t.BACK&&(q[0]=t.BACK,ve=!0);ve&&t.drawBuffers(q)}function mt(N){return v!==N?(t.useProgram(N),v=N,!0):!1}const Xe={[Rr]:t.FUNC_ADD,[YS]:t.FUNC_SUBTRACT,[$S]:t.FUNC_REVERSE_SUBTRACT};Xe[qS]=t.MIN,Xe[KS]=t.MAX;const tt={[ZS]:t.ZERO,[QS]:t.ONE,[JS]:t.SRC_COLOR,[_f]:t.SRC_ALPHA,[sy]:t.SRC_ALPHA_SATURATE,[iy]:t.DST_COLOR,[ty]:t.DST_ALPHA,[ey]:t.ONE_MINUS_SRC_COLOR,[vf]:t.ONE_MINUS_SRC_ALPHA,[ry]:t.ONE_MINUS_DST_COLOR,[ny]:t.ONE_MINUS_DST_ALPHA,[oy]:t.CONSTANT_COLOR,[ay]:t.ONE_MINUS_CONSTANT_COLOR,[ly]:t.CONSTANT_ALPHA,[uy]:t.ONE_MINUS_CONSTANT_ALPHA};function ft(N,oe,q,ve,ue,ee,we,Fe,Et,nt){if(N===Ci){m===!0&&(Ce(t.BLEND),m=!1);return}if(m===!1&&(ae(t.BLEND),m=!0),N!==jS){if(N!==c||nt!==P){if((g!==Rr||R!==Rr)&&(t.blendEquation(t.FUNC_ADD),g=Rr,R=Rr),nt)switch(N){case Ps:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Wp:t.blendFunc(t.ONE,t.ONE);break;case Xp:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case jp:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:Ke("WebGLState: Invalid blending: ",N);break}else switch(N){case Ps:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Wp:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case Xp:Ke("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case jp:Ke("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ke("WebGLState: Invalid blending: ",N);break}x=null,y=null,T=null,b=null,S.set(0,0,0),A=0,c=N,P=nt}return}ue=ue||oe,ee=ee||q,we=we||ve,(oe!==g||ue!==R)&&(t.blendEquationSeparate(Xe[oe],Xe[ue]),g=oe,R=ue),(q!==x||ve!==y||ee!==T||we!==b)&&(t.blendFuncSeparate(tt[q],tt[ve],tt[ee],tt[we]),x=q,y=ve,T=ee,b=we),(Fe.equals(S)===!1||Et!==A)&&(t.blendColor(Fe.r,Fe.g,Fe.b,Et),S.copy(Fe),A=Et),c=N,P=!1}function He(N,oe){N.side===Ei?Ce(t.CULL_FACE):ae(t.CULL_FACE);let q=N.side===gn;oe&&(q=!q),Lt(q),N.blending===Ps&&N.transparent===!1?ft(Ci):ft(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),o.setFunc(N.depthFunc),o.setTest(N.depthTest),o.setMask(N.depthWrite),s.setMask(N.colorWrite);const ve=N.stencilWrite;a.setTest(ve),ve&&(a.setMask(N.stencilWriteMask),a.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),a.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),I(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?ae(t.SAMPLE_ALPHA_TO_COVERAGE):Ce(t.SAMPLE_ALPHA_TO_COVERAGE)}function Lt(N){w!==N&&(N?t.frontFace(t.CW):t.frontFace(t.CCW),w=N)}function gt(N){N!==GS?(ae(t.CULL_FACE),N!==L&&(N===Gp?t.cullFace(t.BACK):N===WS?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):Ce(t.CULL_FACE),L=N}function _n(N){N!==k&&(O&&t.lineWidth(N),k=N)}function I(N,oe,q){N?(ae(t.POLYGON_OFFSET_FILL),(j!==oe||D!==q)&&(j=oe,D=q,o.getReversed()&&(oe=-oe),t.polygonOffset(oe,q))):Ce(t.POLYGON_OFFSET_FILL)}function Nt(N){N?ae(t.SCISSOR_TEST):Ce(t.SCISSOR_TEST)}function je(N){N===void 0&&(N=t.TEXTURE0+B-1),$!==N&&(t.activeTexture(N),$=N)}function lt(N,oe,q){q===void 0&&($===null?q=t.TEXTURE0+B-1:q=$);let ve=ne[q];ve===void 0&&(ve={type:void 0,texture:void 0},ne[q]=ve),(ve.type!==N||ve.texture!==oe)&&($!==q&&(t.activeTexture(q),$=q),t.bindTexture(N,oe||de[N]),ve.type=N,ve.texture=oe)}function he(){const N=ne[$];N!==void 0&&N.type!==void 0&&(t.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function St(){try{t.compressedTexImage2D(...arguments)}catch(N){Ke("WebGLState:",N)}}function C(){try{t.compressedTexImage3D(...arguments)}catch(N){Ke("WebGLState:",N)}}function M(){try{t.texSubImage2D(...arguments)}catch(N){Ke("WebGLState:",N)}}function z(){try{t.texSubImage3D(...arguments)}catch(N){Ke("WebGLState:",N)}}function Z(){try{t.compressedTexSubImage2D(...arguments)}catch(N){Ke("WebGLState:",N)}}function te(){try{t.compressedTexSubImage3D(...arguments)}catch(N){Ke("WebGLState:",N)}}function re(){try{t.texStorage2D(...arguments)}catch(N){Ke("WebGLState:",N)}}function ce(){try{t.texStorage3D(...arguments)}catch(N){Ke("WebGLState:",N)}}function Y(){try{t.texImage2D(...arguments)}catch(N){Ke("WebGLState:",N)}}function Q(){try{t.texImage3D(...arguments)}catch(N){Ke("WebGLState:",N)}}function _e(N){return h[N]!==void 0?h[N]:t.getParameter(N)}function Se(N,oe){h[N]!==oe&&(t.pixelStorei(N,oe),h[N]=oe)}function le(N){We.equals(N)===!1&&(t.scissor(N.x,N.y,N.z,N.w),We.copy(N))}function se(N){Le.equals(N)===!1&&(t.viewport(N.x,N.y,N.z,N.w),Le.copy(N))}function De(N,oe){let q=u.get(oe);q===void 0&&(q=new WeakMap,u.set(oe,q));let ve=q.get(N);ve===void 0&&(ve=t.getUniformBlockIndex(oe,N.name),q.set(N,ve))}function ke(N,oe){const ve=u.get(oe).get(N);l.get(oe)!==ve&&(t.uniformBlockBinding(oe,ve,N.__bindingPointIndex),l.set(oe,ve))}function Qe(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),o.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),t.pixelStorei(t.PACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,!1),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.BROWSER_DEFAULT_WEBGL),t.pixelStorei(t.PACK_ROW_LENGTH,0),t.pixelStorei(t.PACK_SKIP_PIXELS,0),t.pixelStorei(t.PACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_ROW_LENGTH,0),t.pixelStorei(t.UNPACK_IMAGE_HEIGHT,0),t.pixelStorei(t.UNPACK_SKIP_PIXELS,0),t.pixelStorei(t.UNPACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_SKIP_IMAGES,0),d={},h={},$=null,ne={},f={},p=new WeakMap,_=[],v=null,m=!1,c=null,g=null,x=null,y=null,R=null,T=null,b=null,S=new rt(0,0,0),A=0,P=!1,w=null,L=null,k=null,j=null,D=null,We.set(0,0,t.canvas.width,t.canvas.height),Le.set(0,0,t.canvas.width,t.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:ae,disable:Ce,bindFramebuffer:Ie,drawBuffers:be,useProgram:mt,setBlending:ft,setMaterial:He,setFlipSided:Lt,setCullFace:gt,setLineWidth:_n,setPolygonOffset:I,setScissorTest:Nt,activeTexture:je,bindTexture:lt,unbindTexture:he,compressedTexImage2D:St,compressedTexImage3D:C,texImage2D:Y,texImage3D:Q,pixelStorei:Se,getParameter:_e,updateUBOMapping:De,uniformBlockBinding:ke,texStorage2D:re,texStorage3D:ce,texSubImage2D:M,texSubImage3D:z,compressedTexSubImage2D:Z,compressedTexSubImage3D:te,scissor:le,viewport:se,reset:Qe}}function Kw(t,e,n,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new st,d=new WeakMap,h=new Set;let f;const p=new WeakMap;let _=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(C,M){return _?new OffscreenCanvas(C,M):Ko("canvas")}function m(C,M,z){let Z=1;const te=St(C);if((te.width>z||te.height>z)&&(Z=z/Math.max(te.width,te.height)),Z<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const re=Math.floor(Z*te.width),ce=Math.floor(Z*te.height);f===void 0&&(f=v(re,ce));const Y=M?v(re,ce):f;return Y.width=re,Y.height=ce,Y.getContext("2d").drawImage(C,0,0,re,ce),Pe("WebGLRenderer: Texture has been resized from ("+te.width+"x"+te.height+") to ("+re+"x"+ce+")."),Y}else return"data"in C&&Pe("WebGLRenderer: Image in DataTexture is too big ("+te.width+"x"+te.height+")."),C;return C}function c(C){return C.generateMipmaps}function g(C){t.generateMipmap(C)}function x(C){return C.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:C.isWebGL3DRenderTarget?t.TEXTURE_3D:C.isWebGLArrayRenderTarget||C.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function y(C,M,z,Z,te,re=!1){if(C!==null){if(t[C]!==void 0)return t[C];Pe("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let ce;Z&&(ce=e.get("EXT_texture_norm16"),ce||Pe("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Y=M;if(M===t.RED&&(z===t.FLOAT&&(Y=t.R32F),z===t.HALF_FLOAT&&(Y=t.R16F),z===t.UNSIGNED_BYTE&&(Y=t.R8),z===t.UNSIGNED_SHORT&&ce&&(Y=ce.R16_EXT),z===t.SHORT&&ce&&(Y=ce.R16_SNORM_EXT)),M===t.RED_INTEGER&&(z===t.UNSIGNED_BYTE&&(Y=t.R8UI),z===t.UNSIGNED_SHORT&&(Y=t.R16UI),z===t.UNSIGNED_INT&&(Y=t.R32UI),z===t.BYTE&&(Y=t.R8I),z===t.SHORT&&(Y=t.R16I),z===t.INT&&(Y=t.R32I)),M===t.RG&&(z===t.FLOAT&&(Y=t.RG32F),z===t.HALF_FLOAT&&(Y=t.RG16F),z===t.UNSIGNED_BYTE&&(Y=t.RG8),z===t.UNSIGNED_SHORT&&ce&&(Y=ce.RG16_EXT),z===t.SHORT&&ce&&(Y=ce.RG16_SNORM_EXT)),M===t.RG_INTEGER&&(z===t.UNSIGNED_BYTE&&(Y=t.RG8UI),z===t.UNSIGNED_SHORT&&(Y=t.RG16UI),z===t.UNSIGNED_INT&&(Y=t.RG32UI),z===t.BYTE&&(Y=t.RG8I),z===t.SHORT&&(Y=t.RG16I),z===t.INT&&(Y=t.RG32I)),M===t.RGB_INTEGER&&(z===t.UNSIGNED_BYTE&&(Y=t.RGB8UI),z===t.UNSIGNED_SHORT&&(Y=t.RGB16UI),z===t.UNSIGNED_INT&&(Y=t.RGB32UI),z===t.BYTE&&(Y=t.RGB8I),z===t.SHORT&&(Y=t.RGB16I),z===t.INT&&(Y=t.RGB32I)),M===t.RGBA_INTEGER&&(z===t.UNSIGNED_BYTE&&(Y=t.RGBA8UI),z===t.UNSIGNED_SHORT&&(Y=t.RGBA16UI),z===t.UNSIGNED_INT&&(Y=t.RGBA32UI),z===t.BYTE&&(Y=t.RGBA8I),z===t.SHORT&&(Y=t.RGBA16I),z===t.INT&&(Y=t.RGBA32I)),M===t.RGB&&(z===t.UNSIGNED_SHORT&&ce&&(Y=ce.RGB16_EXT),z===t.SHORT&&ce&&(Y=ce.RGB16_SNORM_EXT),z===t.UNSIGNED_INT_5_9_9_9_REV&&(Y=t.RGB9_E5),z===t.UNSIGNED_INT_10F_11F_11F_REV&&(Y=t.R11F_G11F_B10F)),M===t.RGBA){const Q=re?Hl:Ye.getTransfer(te);z===t.FLOAT&&(Y=t.RGBA32F),z===t.HALF_FLOAT&&(Y=t.RGBA16F),z===t.UNSIGNED_BYTE&&(Y=Q===Je?t.SRGB8_ALPHA8:t.RGBA8),z===t.UNSIGNED_SHORT&&ce&&(Y=ce.RGBA16_EXT),z===t.SHORT&&ce&&(Y=ce.RGBA16_SNORM_EXT),z===t.UNSIGNED_SHORT_4_4_4_4&&(Y=t.RGBA4),z===t.UNSIGNED_SHORT_5_5_5_1&&(Y=t.RGB5_A1)}return(Y===t.R16F||Y===t.R32F||Y===t.RG16F||Y===t.RG32F||Y===t.RGBA16F||Y===t.RGBA32F)&&e.get("EXT_color_buffer_float"),Y}function R(C,M){let z;return C?M===null||M===hi||M===qo?z=t.DEPTH24_STENCIL8:M===oi?z=t.DEPTH32F_STENCIL8:M===$o&&(z=t.DEPTH24_STENCIL8,Pe("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===hi||M===qo?z=t.DEPTH_COMPONENT24:M===oi?z=t.DEPTH_COMPONENT32F:M===$o&&(z=t.DEPTH_COMPONENT16),z}function T(C,M){return c(C)===!0||C.isFramebufferTexture&&C.minFilter!==Wt&&C.minFilter!==Vt?Math.log2(Math.max(M.width,M.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?M.mipmaps.length:1}function b(C){const M=C.target;M.removeEventListener("dispose",b),A(M),M.isVideoTexture&&d.delete(M),M.isHTMLTexture&&h.delete(M)}function S(C){const M=C.target;M.removeEventListener("dispose",S),w(M)}function A(C){const M=i.get(C);if(M.__webglInit===void 0)return;const z=C.source,Z=p.get(z);if(Z){const te=Z[M.__cacheKey];te.usedTimes--,te.usedTimes===0&&P(C),Object.keys(Z).length===0&&p.delete(z)}i.remove(C)}function P(C){const M=i.get(C);t.deleteTexture(M.__webglTexture);const z=C.source,Z=p.get(z);delete Z[M.__cacheKey],o.memory.textures--}function w(C){const M=i.get(C);if(C.depthTexture&&(C.depthTexture.dispose(),i.remove(C.depthTexture)),C.isWebGLCubeRenderTarget)for(let Z=0;Z<6;Z++){if(Array.isArray(M.__webglFramebuffer[Z]))for(let te=0;te<M.__webglFramebuffer[Z].length;te++)t.deleteFramebuffer(M.__webglFramebuffer[Z][te]);else t.deleteFramebuffer(M.__webglFramebuffer[Z]);M.__webglDepthbuffer&&t.deleteRenderbuffer(M.__webglDepthbuffer[Z])}else{if(Array.isArray(M.__webglFramebuffer))for(let Z=0;Z<M.__webglFramebuffer.length;Z++)t.deleteFramebuffer(M.__webglFramebuffer[Z]);else t.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&t.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&t.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let Z=0;Z<M.__webglColorRenderbuffer.length;Z++)M.__webglColorRenderbuffer[Z]&&t.deleteRenderbuffer(M.__webglColorRenderbuffer[Z]);M.__webglDepthRenderbuffer&&t.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const z=C.textures;for(let Z=0,te=z.length;Z<te;Z++){const re=i.get(z[Z]);re.__webglTexture&&(t.deleteTexture(re.__webglTexture),o.memory.textures--),i.remove(z[Z])}i.remove(C)}let L=0;function k(){L=0}function j(){return L}function D(C){L=C}function B(){const C=L;return C>=r.maxTextures&&Pe("WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+r.maxTextures),L+=1,C}function O(C){const M=[];return M.push(C.wrapS),M.push(C.wrapT),M.push(C.wrapR||0),M.push(C.magFilter),M.push(C.minFilter),M.push(C.anisotropy),M.push(C.internalFormat),M.push(C.format),M.push(C.type),M.push(C.generateMipmaps),M.push(C.premultiplyAlpha),M.push(C.flipY),M.push(C.unpackAlignment),M.push(C.colorSpace),M.join()}function F(C,M){const z=i.get(C);if(C.isVideoTexture&&lt(C),C.isRenderTargetTexture===!1&&C.isExternalTexture!==!0&&C.version>0&&z.__version!==C.version){const Z=C.image;if(Z===null)Pe("WebGLRenderer: Texture marked for update but no image data found.");else if(Z.complete===!1)Pe("WebGLRenderer: Texture marked for update but image is incomplete");else{Ce(z,C,M);return}}else C.isExternalTexture&&(z.__webglTexture=C.sourceTexture?C.sourceTexture:null);n.bindTexture(t.TEXTURE_2D,z.__webglTexture,t.TEXTURE0+M)}function X(C,M){const z=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&z.__version!==C.version){Ce(z,C,M);return}else C.isExternalTexture&&(z.__webglTexture=C.sourceTexture?C.sourceTexture:null);n.bindTexture(t.TEXTURE_2D_ARRAY,z.__webglTexture,t.TEXTURE0+M)}function $(C,M){const z=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&z.__version!==C.version){Ce(z,C,M);return}n.bindTexture(t.TEXTURE_3D,z.__webglTexture,t.TEXTURE0+M)}function ne(C,M){const z=i.get(C);if(C.isCubeDepthTexture!==!0&&C.version>0&&z.__version!==C.version){Ie(z,C,M);return}n.bindTexture(t.TEXTURE_CUBE_MAP,z.__webglTexture,t.TEXTURE0+M)}const fe={[Af]:t.REPEAT,[Ai]:t.CLAMP_TO_EDGE,[Rf]:t.MIRRORED_REPEAT},Ve={[Wt]:t.NEAREST,[dy]:t.NEAREST_MIPMAP_NEAREST,[Aa]:t.NEAREST_MIPMAP_LINEAR,[Vt]:t.LINEAR,[Wu]:t.LINEAR_MIPMAP_NEAREST,[Nr]:t.LINEAR_MIPMAP_LINEAR},We={[my]:t.NEVER,[Sy]:t.ALWAYS,[gy]:t.LESS,[hh]:t.LEQUAL,[_y]:t.EQUAL,[ph]:t.GEQUAL,[vy]:t.GREATER,[xy]:t.NOTEQUAL};function Le(C,M){if(M.type===oi&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===Vt||M.magFilter===Wu||M.magFilter===Aa||M.magFilter===Nr||M.minFilter===Vt||M.minFilter===Wu||M.minFilter===Aa||M.minFilter===Nr)&&Pe("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(C,t.TEXTURE_WRAP_S,fe[M.wrapS]),t.texParameteri(C,t.TEXTURE_WRAP_T,fe[M.wrapT]),(C===t.TEXTURE_3D||C===t.TEXTURE_2D_ARRAY)&&t.texParameteri(C,t.TEXTURE_WRAP_R,fe[M.wrapR]),t.texParameteri(C,t.TEXTURE_MAG_FILTER,Ve[M.magFilter]),t.texParameteri(C,t.TEXTURE_MIN_FILTER,Ve[M.minFilter]),M.compareFunction&&(t.texParameteri(C,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(C,t.TEXTURE_COMPARE_FUNC,We[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===Wt||M.minFilter!==Aa&&M.minFilter!==Nr||M.type===oi&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||i.get(M).__currentAnisotropy){const z=e.get("EXT_texture_filter_anisotropic");t.texParameterf(C,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,r.getMaxAnisotropy())),i.get(M).__currentAnisotropy=M.anisotropy}}}function K(C,M){let z=!1;C.__webglInit===void 0&&(C.__webglInit=!0,M.addEventListener("dispose",b));const Z=M.source;let te=p.get(Z);te===void 0&&(te={},p.set(Z,te));const re=O(M);if(re!==C.__cacheKey){te[re]===void 0&&(te[re]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,z=!0),te[re].usedTimes++;const ce=te[C.__cacheKey];ce!==void 0&&(te[C.__cacheKey].usedTimes--,ce.usedTimes===0&&P(M)),C.__cacheKey=re,C.__webglTexture=te[re].texture}return z}function de(C,M,z){return Math.floor(Math.floor(C/z)/M)}function ae(C,M,z,Z){const re=C.updateRanges;if(re.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,M.width,M.height,z,Z,M.data);else{re.sort((Se,le)=>Se.start-le.start);let ce=0;for(let Se=1;Se<re.length;Se++){const le=re[ce],se=re[Se],De=le.start+le.count,ke=de(se.start,M.width,4),Qe=de(le.start,M.width,4);se.start<=De+1&&ke===Qe&&de(se.start+se.count-1,M.width,4)===ke?le.count=Math.max(le.count,se.start+se.count-le.start):(++ce,re[ce]=se)}re.length=ce+1;const Y=n.getParameter(t.UNPACK_ROW_LENGTH),Q=n.getParameter(t.UNPACK_SKIP_PIXELS),_e=n.getParameter(t.UNPACK_SKIP_ROWS);n.pixelStorei(t.UNPACK_ROW_LENGTH,M.width);for(let Se=0,le=re.length;Se<le;Se++){const se=re[Se],De=Math.floor(se.start/4),ke=Math.ceil(se.count/4),Qe=De%M.width,N=Math.floor(De/M.width),oe=ke,q=1;n.pixelStorei(t.UNPACK_SKIP_PIXELS,Qe),n.pixelStorei(t.UNPACK_SKIP_ROWS,N),n.texSubImage2D(t.TEXTURE_2D,0,Qe,N,oe,q,z,Z,M.data)}C.clearUpdateRanges(),n.pixelStorei(t.UNPACK_ROW_LENGTH,Y),n.pixelStorei(t.UNPACK_SKIP_PIXELS,Q),n.pixelStorei(t.UNPACK_SKIP_ROWS,_e)}}function Ce(C,M,z){let Z=t.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(Z=t.TEXTURE_2D_ARRAY),M.isData3DTexture&&(Z=t.TEXTURE_3D);const te=K(C,M),re=M.source;n.bindTexture(Z,C.__webglTexture,t.TEXTURE0+z);const ce=i.get(re);if(re.version!==ce.__version||te===!0){if(n.activeTexture(t.TEXTURE0+z),(typeof ImageBitmap<"u"&&M.image instanceof ImageBitmap)===!1){const q=Ye.getPrimaries(Ye.workingColorSpace),ve=M.colorSpace===er?null:Ye.getPrimaries(M.colorSpace),ue=M.colorSpace===er||q===ve?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,M.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,ue)}n.pixelStorei(t.UNPACK_ALIGNMENT,M.unpackAlignment);let Q=m(M.image,!1,r.maxTextureSize);Q=he(M,Q);const _e=s.convert(M.format,M.colorSpace),Se=s.convert(M.type);let le=y(M.internalFormat,_e,Se,M.normalized,M.colorSpace,M.isVideoTexture);Le(Z,M);let se;const De=M.mipmaps,ke=M.isVideoTexture!==!0,Qe=ce.__version===void 0||te===!0,N=re.dataReady,oe=T(M,Q);if(M.isDepthTexture)le=R(M.format===Dr,M.type),Qe&&(ke?n.texStorage2D(t.TEXTURE_2D,1,le,Q.width,Q.height):n.texImage2D(t.TEXTURE_2D,0,le,Q.width,Q.height,0,_e,Se,null));else if(M.isDataTexture)if(De.length>0){ke&&Qe&&n.texStorage2D(t.TEXTURE_2D,oe,le,De[0].width,De[0].height);for(let q=0,ve=De.length;q<ve;q++)se=De[q],ke?N&&n.texSubImage2D(t.TEXTURE_2D,q,0,0,se.width,se.height,_e,Se,se.data):n.texImage2D(t.TEXTURE_2D,q,le,se.width,se.height,0,_e,Se,se.data);M.generateMipmaps=!1}else ke?(Qe&&n.texStorage2D(t.TEXTURE_2D,oe,le,Q.width,Q.height),N&&ae(M,Q,_e,Se)):n.texImage2D(t.TEXTURE_2D,0,le,Q.width,Q.height,0,_e,Se,Q.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){ke&&Qe&&n.texStorage3D(t.TEXTURE_2D_ARRAY,oe,le,De[0].width,De[0].height,Q.depth);for(let q=0,ve=De.length;q<ve;q++)if(se=De[q],M.format!==Yn)if(_e!==null)if(ke){if(N)if(M.layerUpdates.size>0){const ue=vm(se.width,se.height,M.format,M.type);for(const ee of M.layerUpdates){const we=se.data.subarray(ee*ue/se.data.BYTES_PER_ELEMENT,(ee+1)*ue/se.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,q,0,0,ee,se.width,se.height,1,_e,we)}M.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,q,0,0,0,se.width,se.height,Q.depth,_e,se.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,q,le,se.width,se.height,Q.depth,0,se.data,0,0);else Pe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else ke?N&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,q,0,0,0,se.width,se.height,Q.depth,_e,Se,se.data):n.texImage3D(t.TEXTURE_2D_ARRAY,q,le,se.width,se.height,Q.depth,0,_e,Se,se.data)}else{ke&&Qe&&n.texStorage2D(t.TEXTURE_2D,oe,le,De[0].width,De[0].height);for(let q=0,ve=De.length;q<ve;q++)se=De[q],M.format!==Yn?_e!==null?ke?N&&n.compressedTexSubImage2D(t.TEXTURE_2D,q,0,0,se.width,se.height,_e,se.data):n.compressedTexImage2D(t.TEXTURE_2D,q,le,se.width,se.height,0,se.data):Pe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):ke?N&&n.texSubImage2D(t.TEXTURE_2D,q,0,0,se.width,se.height,_e,Se,se.data):n.texImage2D(t.TEXTURE_2D,q,le,se.width,se.height,0,_e,Se,se.data)}else if(M.isDataArrayTexture)if(ke){if(Qe&&n.texStorage3D(t.TEXTURE_2D_ARRAY,oe,le,Q.width,Q.height,Q.depth),N)if(M.layerUpdates.size>0){const q=vm(Q.width,Q.height,M.format,M.type);for(const ve of M.layerUpdates){const ue=Q.data.subarray(ve*q/Q.data.BYTES_PER_ELEMENT,(ve+1)*q/Q.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,ve,Q.width,Q.height,1,_e,Se,ue)}M.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,_e,Se,Q.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,le,Q.width,Q.height,Q.depth,0,_e,Se,Q.data);else if(M.isData3DTexture)ke?(Qe&&n.texStorage3D(t.TEXTURE_3D,oe,le,Q.width,Q.height,Q.depth),N&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,_e,Se,Q.data)):n.texImage3D(t.TEXTURE_3D,0,le,Q.width,Q.height,Q.depth,0,_e,Se,Q.data);else if(M.isFramebufferTexture){if(Qe)if(ke)n.texStorage2D(t.TEXTURE_2D,oe,le,Q.width,Q.height);else{let q=Q.width,ve=Q.height;for(let ue=0;ue<oe;ue++)n.texImage2D(t.TEXTURE_2D,ue,le,q,ve,0,_e,Se,null),q>>=1,ve>>=1}}else if(M.isHTMLTexture){if("texElementImage2D"in t){const q=t.canvas;if(q.hasAttribute("layoutsubtree")||q.setAttribute("layoutsubtree","true"),Q.parentNode!==q){q.appendChild(Q),h.add(M),q.onpaint=Fe=>{const Et=Fe.changedElements;for(const nt of h)Et.includes(nt.image)&&(nt.needsUpdate=!0)},q.requestPaint();return}const ve=0,ue=t.RGBA,ee=t.RGBA,we=t.UNSIGNED_BYTE;t.texElementImage2D(t.TEXTURE_2D,ve,ue,ee,we,Q),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE)}}else if(De.length>0){if(ke&&Qe){const q=St(De[0]);n.texStorage2D(t.TEXTURE_2D,oe,le,q.width,q.height)}for(let q=0,ve=De.length;q<ve;q++)se=De[q],ke?N&&n.texSubImage2D(t.TEXTURE_2D,q,0,0,_e,Se,se):n.texImage2D(t.TEXTURE_2D,q,le,_e,Se,se);M.generateMipmaps=!1}else if(ke){if(Qe){const q=St(Q);n.texStorage2D(t.TEXTURE_2D,oe,le,q.width,q.height)}N&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,_e,Se,Q)}else n.texImage2D(t.TEXTURE_2D,0,le,_e,Se,Q);c(M)&&g(Z),ce.__version=re.version,M.onUpdate&&M.onUpdate(M)}C.__version=M.version}function Ie(C,M,z){if(M.image.length!==6)return;const Z=K(C,M),te=M.source;n.bindTexture(t.TEXTURE_CUBE_MAP,C.__webglTexture,t.TEXTURE0+z);const re=i.get(te);if(te.version!==re.__version||Z===!0){n.activeTexture(t.TEXTURE0+z);const ce=Ye.getPrimaries(Ye.workingColorSpace),Y=M.colorSpace===er?null:Ye.getPrimaries(M.colorSpace),Q=M.colorSpace===er||ce===Y?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,M.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),n.pixelStorei(t.UNPACK_ALIGNMENT,M.unpackAlignment),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Q);const _e=M.isCompressedTexture||M.image[0].isCompressedTexture,Se=M.image[0]&&M.image[0].isDataTexture,le=[];for(let ee=0;ee<6;ee++)!_e&&!Se?le[ee]=m(M.image[ee],!0,r.maxCubemapSize):le[ee]=Se?M.image[ee].image:M.image[ee],le[ee]=he(M,le[ee]);const se=le[0],De=s.convert(M.format,M.colorSpace),ke=s.convert(M.type),Qe=y(M.internalFormat,De,ke,M.normalized,M.colorSpace),N=M.isVideoTexture!==!0,oe=re.__version===void 0||Z===!0,q=te.dataReady;let ve=T(M,se);Le(t.TEXTURE_CUBE_MAP,M);let ue;if(_e){N&&oe&&n.texStorage2D(t.TEXTURE_CUBE_MAP,ve,Qe,se.width,se.height);for(let ee=0;ee<6;ee++){ue=le[ee].mipmaps;for(let we=0;we<ue.length;we++){const Fe=ue[we];M.format!==Yn?De!==null?N?q&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,we,0,0,Fe.width,Fe.height,De,Fe.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,we,Qe,Fe.width,Fe.height,0,Fe.data):Pe("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?q&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,we,0,0,Fe.width,Fe.height,De,ke,Fe.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,we,Qe,Fe.width,Fe.height,0,De,ke,Fe.data)}}}else{if(ue=M.mipmaps,N&&oe){ue.length>0&&ve++;const ee=St(le[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,ve,Qe,ee.width,ee.height)}for(let ee=0;ee<6;ee++)if(Se){N?q&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,le[ee].width,le[ee].height,De,ke,le[ee].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Qe,le[ee].width,le[ee].height,0,De,ke,le[ee].data);for(let we=0;we<ue.length;we++){const Et=ue[we].image[ee].image;N?q&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,we+1,0,0,Et.width,Et.height,De,ke,Et.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,we+1,Qe,Et.width,Et.height,0,De,ke,Et.data)}}else{N?q&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,De,ke,le[ee]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Qe,De,ke,le[ee]);for(let we=0;we<ue.length;we++){const Fe=ue[we];N?q&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,we+1,0,0,De,ke,Fe.image[ee]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,we+1,Qe,De,ke,Fe.image[ee])}}}c(M)&&g(t.TEXTURE_CUBE_MAP),re.__version=te.version,M.onUpdate&&M.onUpdate(M)}C.__version=M.version}function be(C,M,z,Z,te,re){const ce=s.convert(z.format,z.colorSpace),Y=s.convert(z.type),Q=y(z.internalFormat,ce,Y,z.normalized,z.colorSpace),_e=i.get(M),Se=i.get(z);if(Se.__renderTarget=M,!_e.__hasExternalTextures){const le=Math.max(1,M.width>>re),se=Math.max(1,M.height>>re);te===t.TEXTURE_3D||te===t.TEXTURE_2D_ARRAY?n.texImage3D(te,re,Q,le,se,M.depth,0,ce,Y,null):n.texImage2D(te,re,Q,le,se,0,ce,Y,null)}n.bindFramebuffer(t.FRAMEBUFFER,C),je(M)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,Z,te,Se.__webglTexture,0,Nt(M)):(te===t.TEXTURE_2D||te>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&te<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,Z,te,Se.__webglTexture,re),n.bindFramebuffer(t.FRAMEBUFFER,null)}function mt(C,M,z){if(t.bindRenderbuffer(t.RENDERBUFFER,C),M.depthBuffer){const Z=M.depthTexture,te=Z&&Z.isDepthTexture?Z.type:null,re=R(M.stencilBuffer,te),ce=M.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;je(M)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Nt(M),re,M.width,M.height):z?t.renderbufferStorageMultisample(t.RENDERBUFFER,Nt(M),re,M.width,M.height):t.renderbufferStorage(t.RENDERBUFFER,re,M.width,M.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,ce,t.RENDERBUFFER,C)}else{const Z=M.textures;for(let te=0;te<Z.length;te++){const re=Z[te],ce=s.convert(re.format,re.colorSpace),Y=s.convert(re.type),Q=y(re.internalFormat,ce,Y,re.normalized,re.colorSpace);je(M)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Nt(M),Q,M.width,M.height):z?t.renderbufferStorageMultisample(t.RENDERBUFFER,Nt(M),Q,M.width,M.height):t.renderbufferStorage(t.RENDERBUFFER,Q,M.width,M.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Xe(C,M,z){const Z=M.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(t.FRAMEBUFFER,C),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const te=i.get(M.depthTexture);if(te.__renderTarget=M,(!te.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),Z){if(te.__webglInit===void 0&&(te.__webglInit=!0,M.depthTexture.addEventListener("dispose",b)),te.__webglTexture===void 0){te.__webglTexture=t.createTexture(),n.bindTexture(t.TEXTURE_CUBE_MAP,te.__webglTexture),Le(t.TEXTURE_CUBE_MAP,M.depthTexture);const _e=s.convert(M.depthTexture.format),Se=s.convert(M.depthTexture.type);let le;M.depthTexture.format===Oi?le=t.DEPTH_COMPONENT24:M.depthTexture.format===Dr&&(le=t.DEPTH24_STENCIL8);for(let se=0;se<6;se++)t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,le,M.width,M.height,0,_e,Se,null)}}else F(M.depthTexture,0);const re=te.__webglTexture,ce=Nt(M),Y=Z?t.TEXTURE_CUBE_MAP_POSITIVE_X+z:t.TEXTURE_2D,Q=M.depthTexture.format===Dr?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;if(M.depthTexture.format===Oi)je(M)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,Q,Y,re,0,ce):t.framebufferTexture2D(t.FRAMEBUFFER,Q,Y,re,0);else if(M.depthTexture.format===Dr)je(M)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,Q,Y,re,0,ce):t.framebufferTexture2D(t.FRAMEBUFFER,Q,Y,re,0);else throw new Error("Unknown depthTexture format")}function tt(C){const M=i.get(C),z=C.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==C.depthTexture){const Z=C.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),Z){const te=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,Z.removeEventListener("dispose",te)};Z.addEventListener("dispose",te),M.__depthDisposeCallback=te}M.__boundDepthTexture=Z}if(C.depthTexture&&!M.__autoAllocateDepthBuffer)if(z)for(let Z=0;Z<6;Z++)Xe(M.__webglFramebuffer[Z],C,Z);else{const Z=C.texture.mipmaps;Z&&Z.length>0?Xe(M.__webglFramebuffer[0],C,0):Xe(M.__webglFramebuffer,C,0)}else if(z){M.__webglDepthbuffer=[];for(let Z=0;Z<6;Z++)if(n.bindFramebuffer(t.FRAMEBUFFER,M.__webglFramebuffer[Z]),M.__webglDepthbuffer[Z]===void 0)M.__webglDepthbuffer[Z]=t.createRenderbuffer(),mt(M.__webglDepthbuffer[Z],C,!1);else{const te=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,re=M.__webglDepthbuffer[Z];t.bindRenderbuffer(t.RENDERBUFFER,re),t.framebufferRenderbuffer(t.FRAMEBUFFER,te,t.RENDERBUFFER,re)}}else{const Z=C.texture.mipmaps;if(Z&&Z.length>0?n.bindFramebuffer(t.FRAMEBUFFER,M.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=t.createRenderbuffer(),mt(M.__webglDepthbuffer,C,!1);else{const te=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,re=M.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,re),t.framebufferRenderbuffer(t.FRAMEBUFFER,te,t.RENDERBUFFER,re)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function ft(C,M,z){const Z=i.get(C);M!==void 0&&be(Z.__webglFramebuffer,C,C.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),z!==void 0&&tt(C)}function He(C){const M=C.texture,z=i.get(C),Z=i.get(M);C.addEventListener("dispose",S);const te=C.textures,re=C.isWebGLCubeRenderTarget===!0,ce=te.length>1;if(ce||(Z.__webglTexture===void 0&&(Z.__webglTexture=t.createTexture()),Z.__version=M.version,o.memory.textures++),re){z.__webglFramebuffer=[];for(let Y=0;Y<6;Y++)if(M.mipmaps&&M.mipmaps.length>0){z.__webglFramebuffer[Y]=[];for(let Q=0;Q<M.mipmaps.length;Q++)z.__webglFramebuffer[Y][Q]=t.createFramebuffer()}else z.__webglFramebuffer[Y]=t.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){z.__webglFramebuffer=[];for(let Y=0;Y<M.mipmaps.length;Y++)z.__webglFramebuffer[Y]=t.createFramebuffer()}else z.__webglFramebuffer=t.createFramebuffer();if(ce)for(let Y=0,Q=te.length;Y<Q;Y++){const _e=i.get(te[Y]);_e.__webglTexture===void 0&&(_e.__webglTexture=t.createTexture(),o.memory.textures++)}if(C.samples>0&&je(C)===!1){z.__webglMultisampledFramebuffer=t.createFramebuffer(),z.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let Y=0;Y<te.length;Y++){const Q=te[Y];z.__webglColorRenderbuffer[Y]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,z.__webglColorRenderbuffer[Y]);const _e=s.convert(Q.format,Q.colorSpace),Se=s.convert(Q.type),le=y(Q.internalFormat,_e,Se,Q.normalized,Q.colorSpace,C.isXRRenderTarget===!0),se=Nt(C);t.renderbufferStorageMultisample(t.RENDERBUFFER,se,le,C.width,C.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Y,t.RENDERBUFFER,z.__webglColorRenderbuffer[Y])}t.bindRenderbuffer(t.RENDERBUFFER,null),C.depthBuffer&&(z.__webglDepthRenderbuffer=t.createRenderbuffer(),mt(z.__webglDepthRenderbuffer,C,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(re){n.bindTexture(t.TEXTURE_CUBE_MAP,Z.__webglTexture),Le(t.TEXTURE_CUBE_MAP,M);for(let Y=0;Y<6;Y++)if(M.mipmaps&&M.mipmaps.length>0)for(let Q=0;Q<M.mipmaps.length;Q++)be(z.__webglFramebuffer[Y][Q],C,M,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Y,Q);else be(z.__webglFramebuffer[Y],C,M,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0);c(M)&&g(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(ce){for(let Y=0,Q=te.length;Y<Q;Y++){const _e=te[Y],Se=i.get(_e);let le=t.TEXTURE_2D;(C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(le=C.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(le,Se.__webglTexture),Le(le,_e),be(z.__webglFramebuffer,C,_e,t.COLOR_ATTACHMENT0+Y,le,0),c(_e)&&g(le)}n.unbindTexture()}else{let Y=t.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(Y=C.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(Y,Z.__webglTexture),Le(Y,M),M.mipmaps&&M.mipmaps.length>0)for(let Q=0;Q<M.mipmaps.length;Q++)be(z.__webglFramebuffer[Q],C,M,t.COLOR_ATTACHMENT0,Y,Q);else be(z.__webglFramebuffer,C,M,t.COLOR_ATTACHMENT0,Y,0);c(M)&&g(Y),n.unbindTexture()}C.depthBuffer&&tt(C)}function Lt(C){const M=C.textures;for(let z=0,Z=M.length;z<Z;z++){const te=M[z];if(c(te)){const re=x(C),ce=i.get(te).__webglTexture;n.bindTexture(re,ce),g(re),n.unbindTexture()}}}const gt=[],_n=[];function I(C){if(C.samples>0){if(je(C)===!1){const M=C.textures,z=C.width,Z=C.height;let te=t.COLOR_BUFFER_BIT;const re=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ce=i.get(C),Y=M.length>1;if(Y)for(let _e=0;_e<M.length;_e++)n.bindFramebuffer(t.FRAMEBUFFER,ce.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+_e,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,ce.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+_e,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,ce.__webglMultisampledFramebuffer);const Q=C.texture.mipmaps;Q&&Q.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,ce.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,ce.__webglFramebuffer);for(let _e=0;_e<M.length;_e++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(te|=t.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(te|=t.STENCIL_BUFFER_BIT)),Y){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,ce.__webglColorRenderbuffer[_e]);const Se=i.get(M[_e]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,Se,0)}t.blitFramebuffer(0,0,z,Z,0,0,z,Z,te,t.NEAREST),l===!0&&(gt.length=0,_n.length=0,gt.push(t.COLOR_ATTACHMENT0+_e),C.depthBuffer&&C.resolveDepthBuffer===!1&&(gt.push(re),_n.push(re),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,_n)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,gt))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),Y)for(let _e=0;_e<M.length;_e++){n.bindFramebuffer(t.FRAMEBUFFER,ce.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+_e,t.RENDERBUFFER,ce.__webglColorRenderbuffer[_e]);const Se=i.get(M[_e]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,ce.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+_e,t.TEXTURE_2D,Se,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,ce.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){const M=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[M])}}}function Nt(C){return Math.min(r.maxSamples,C.samples)}function je(C){const M=i.get(C);return C.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function lt(C){const M=o.render.frame;d.get(C)!==M&&(d.set(C,M),C.update())}function he(C,M){const z=C.colorSpace,Z=C.format,te=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||z!==Vl&&z!==er&&(Ye.getTransfer(z)===Je?(Z!==Yn||te!==Dn)&&Pe("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ke("WebGLTextures: Unsupported texture color space:",z)),M}function St(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(u.width=C.naturalWidth||C.width,u.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(u.width=C.displayWidth,u.height=C.displayHeight):(u.width=C.width,u.height=C.height),u}this.allocateTextureUnit=B,this.resetTextureUnits=k,this.getTextureUnits=j,this.setTextureUnits=D,this.setTexture2D=F,this.setTexture2DArray=X,this.setTexture3D=$,this.setTextureCube=ne,this.rebindTextures=ft,this.setupRenderTarget=He,this.updateRenderTargetMipmap=Lt,this.updateMultisampleRenderTarget=I,this.setupDepthRenderbuffer=tt,this.setupFrameBufferTexture=be,this.useMultisampledRTT=je,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function Zw(t,e){function n(i,r=er){let s;const o=Ye.getTransfer(r);if(i===Dn)return t.UNSIGNED_BYTE;if(i===lh)return t.UNSIGNED_SHORT_4_4_4_4;if(i===uh)return t.UNSIGNED_SHORT_5_5_5_1;if(i===S_)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===y_)return t.UNSIGNED_INT_10F_11F_11F_REV;if(i===v_)return t.BYTE;if(i===x_)return t.SHORT;if(i===$o)return t.UNSIGNED_SHORT;if(i===ah)return t.INT;if(i===hi)return t.UNSIGNED_INT;if(i===oi)return t.FLOAT;if(i===Fi)return t.HALF_FLOAT;if(i===M_)return t.ALPHA;if(i===E_)return t.RGB;if(i===Yn)return t.RGBA;if(i===Oi)return t.DEPTH_COMPONENT;if(i===Dr)return t.DEPTH_STENCIL;if(i===T_)return t.RED;if(i===ch)return t.RED_INTEGER;if(i===Hr)return t.RG;if(i===fh)return t.RG_INTEGER;if(i===dh)return t.RGBA_INTEGER;if(i===ul||i===cl||i===fl||i===dl)if(o===Je)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===ul)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===cl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===fl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===dl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===ul)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===cl)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===fl)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===dl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Cf||i===bf||i===Pf||i===Lf)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Cf)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===bf)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Pf)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Lf)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Nf||i===Df||i===If||i===Uf||i===Ff||i===Bl||i===Of)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Nf||i===Df)return o===Je?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===If)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===Uf)return s.COMPRESSED_R11_EAC;if(i===Ff)return s.COMPRESSED_SIGNED_R11_EAC;if(i===Bl)return s.COMPRESSED_RG11_EAC;if(i===Of)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===kf||i===Bf||i===zf||i===Vf||i===Hf||i===Gf||i===Wf||i===Xf||i===jf||i===Yf||i===$f||i===qf||i===Kf||i===Zf)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===kf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Bf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===zf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Vf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Hf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Gf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Wf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Xf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===jf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Yf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===$f)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===qf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Kf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Zf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Qf||i===Jf||i===ed)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Qf)return o===Je?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Jf)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===ed)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===td||i===nd||i===zl||i===id)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===td)return s.COMPRESSED_RED_RGTC1_EXT;if(i===nd)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===zl)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===id)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===qo?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const Qw=`
void main() {
...
`;function X_({media:t,startIndex:e=0,width:n,height:i,onIndex:r}){const s=Ne.useRef(null),o=Ne.useRef(e),a=Ne.useRef(!1);Ne.useEffect(()=>{var d;(d=s.current)!=null&&d.__goto&&s.current.__goto(e)},[e]);const[l,u]=Ne.useState(!1);if(Ne.useEffect(()=>{const d=s.current;if(!d||a.current)return;let h;try{h=new aA({antialias:!0,alpha:!0})}catch{a.current=!0,u(!0);return}h.setPixelRatio(Math.min(2,window.devicePixelRatio)),h.setSize(n,i),d.appendChild(h.domElement);const f=new By,p=new vh(-n/2,n/2,i/2,-i/2,-1500,1500),_=i*.6,v=_*.78,m=v+110,c=new lM,g=[],x=t.map((B,O)=>{let F;if(B.type==="video"){const ne=document.createElement("video");ne.src=B.src,ne.muted=!0,ne.loop=!0,ne.playsInline=!0,ne.play().catch(()=>{}),g.push(ne),F=new Ky(ne)}else F=c.load(B.src);F.colorSpace=Mn;const X=new Zn({vertexShader:lA,fragmentShader:uA,uniforms:{uMap:{value:F},uVel:{value:0},uTime:{value:0},uEffect:{value:Hm[Ee.FX]??0}}}),$=new pi(new oa(v,_,48,48),X);return $.position.x=O*m,f.add($),$});let y=e*m,R=y,T=R,b=null;const S=(t.length-1)*m;d.__goto=B=>{y=Math.max(0,Math.min(S,B*m))};const A=B=>{var O;b={x:B.clientX,t:y},(O=d.setPointerCapture)==null||O.call(d,B.pointerId)},P=B=>{b&&(y=Math.max(-m*.4,Math.min(S+m*.4,b.t-(B.clientX-b.x)*1.6)))},w=()=>{b=null,y=Math.max(0,Math.min(S,y))},L=B=>{y=Math.max(0,Math.min(S,y+(B.deltaY+B.deltaX)*1.1))};d.addEventListener("pointerdown",A),d.addEventListener("pointermove",P),d.addEventListener("pointerup",w),d.addEventListener("pointercancel",w),d.addEventListener("wheel",L,{passive:!0});let k;const j=new fM,D=()=>{R+=(y-R)*.085;const B=(R-T)/m;T=R;const O=j.getElapsedTime(),F=Hm[Ee.FX]??0;x.forEach(($,ne)=>{$.position.x=ne*m-R,$.material.uniforms.uVel.value=B*6,$.material.uniforms.uTime.value=O,$.material.uniforms.uEffect.value=F});const X=Math.round(Math.max(0,Math.min(S,R))/m);X!==o.current&&(o.current=X,r==null||r(X)),h.render(f,p),k=requestAnimationFrame(D)};return k=requestAnimationFrame(D),()=>{cancelAnimationFrame(k),d.removeEventListener("pointerdown",A),d.removeEventListener("pointermove",P),d.removeEventListener("pointerup",w),d.removeEventListener("pointercancel",w),d.removeEventListener("wheel",L),g.forEach(B=>B.pause()),x.forEach(B=>{B.geometry.dispose(),B.material.uniforms.uMap.value.dispose(),B.material.dispose()}),h.dispose(),d.removeChild(h.domElement)}},[t,n,i]),l){const d=t[Math.min(e,t.length-1)];return J.jsx("div",{className:"fullBleed",children:d.type==="video"?J.jsx("video",{src:d.src,autoPlay:!0,muted:!0,loop:!0,playsInline:!0}):J.jsx("img",{src:d.src,alt:""})})}return J.jsx("div",{className:"glStage",ref:s})}const cA=-200,Gm=220,Mc=265,fA=150;function dA(t,e,n,i,r=1){if(e||n==="arc"){const o=(e?fA:Mc)*r;return Array.from({length:t},(a,l)=>{const u=(cA+(t>1?l*Gm/(t-1):Gm/2))*Math.PI/180;return{ox:Math.cos(u)*o*1.25,oy:Math.sin(u)*o*.9,z:-150}})}if(n==="fan")return Array.from({length:t},(o,a)=>({ox:(240+a*130)*r,oy:(-36-a*38)*r,z:-110-a*175}));if(n==="tide"){const o=1280*r;return Array.from({length:t},(a,l)=>({ox:(i*42+l*(o/t))%o-o/2,oy:((l%2?-1:1)*(105+l%3*38)+Math.sin(i*.7+l)*14)*r,z:-120-l%3*150}))}const s=i*9*Math.PI/180;return Array.from({length:t},(o,a)=>{const l=a/t*Math.PI*2-Math.PI/2+s;return{ox:Math.cos(l)*Mc*1.3*r,oy:Math.sin(l)*Mc*.85*r,z:-150}})}const hA=110;function pA({sim:t,activeId:e,width:n,height:i,onNavigate:r}){const{visibleNodes:s,roles:o,byId:a}=t,l=Ne.useRef(null),[u,d]=Ne.useState(null),[h,f]=Ne.useState(null);Ne.useEffect(()=>f(null),[e]),Ne.useEffect(()=>{const A=P=>{if(P.key!=="Escape")return;const w=a.get(e);w!=null&&w.parentId&&r(a.get(w.parentId))};return window.addEventListener("keydown",A),()=>window.removeEventListener("keydown",A)},[e,a,r]);const[,p]=Ne.useState(0);Ne.useEffect(()=>{let A;const P=()=>{(Ee.EMIT==="orbit"||Ee.EMIT==="tide")&&p(w=>w+1),A=requestAnimationFrame(P)};return A=requestAnimationFrame(P),()=>cancelAnimationFrame(A)},[]),Ne.useEffect(()=>{const A=P=>{const w=P.clientX/window.innerWidth-.5,L=P.clientY/window.innerHeight-.5;l.current&&(l.current.style.perspectiveOrigin=`${50+w*16}% ${46+L*11}%`)};return window.addEventListener("mousemove",A),()=>window.removeEventListener("mousemove",A)},[]);const _=a.get(e),v=_.childIds.length===0,m=v&&_.media?_.media:null,c=!m&&(_!=null&&_.img)&&v?_:null,g=Ee.VIEWPORT_SCALE;m&&dA(m.length,h!=null,Ee.EMIT,performance.now()/1e3,g);const x=m&&h!=null?m[h]:null,y=A=>A==="active"?Ut("active",_.label,n):A==="parent"?38:A==="child"?Ut("child"):A==="sibling"?15:13,R=A=>{if(A.id===e&&x){f(null);return}r(A)},T=A=>{if(!A.target.closest(".flabel, .eFrame, .froomImg")){if(x){f(null);return}_.parentId&&r(a.get(_.parentId))}},b=!!m,S=Ui(e,a).reverse().map(A=>a.get(A));return J.jsxs(J.Fragment,{children:[b&&J.jsx(X_,{media:m,startIndex:h??0,width:n,height:i??window.innerHeight,onIndex:A=>f(A)},`gl-${e}`),J.jsxs("div",{className:"focusSpace",ref:l,onClick:T,style:{pointerEvents:b?"none":"auto"},children:[b&&J.jsxs("div",{className:"workHeader",children:[J.jsx("nav",{className:"crumbs",children:S.map(A=>J.jsxs("span",{className:"crumbItem",children:[J.jsx("button",{onClick:()=>r(A),children:A.label}),J.jsx("i",{children:"/"})]},A.id))}),J.jsx("h2",{className:"workTitle",children:_.label}),_.copy&&J.jsx("p",{className:"workBlurb",children:_.copy}),J.jsx("button",{className:"workBack",onClick:()=>_.parentId&&r(a.get(_.parentId)),children:"↑ Back"})]},`wh-${e}`),!b&&c&&J.jsx("img",{className:"froomImg",src:c.img,alt:""},`room-${c.id}`),!b&&s.map(A=>{if(A.x==null)return null;const P=o.get(A.id);if(P==="sibling"||P==="distant")return null;const w=P==="parent"&&A.id===_.parentId;if(P==="parent"&&!w)return null;let L,k,j;return w?(L=-410*1.05,k=u===A.id?0:1.5,j=u===A.id?.85:.34):P==="active"?(L=0,k=0,j=1):(L=hA,k=0,j=u===A.id?1:.9),J.jsx("div",{className:"fnode",style:{transform:`translate3d(${A.x}px, ${A.y}px, 0)`},children:J.jsx("div",{className:"fnodeInner",style:{transform:`translateZ(${L}px)`,filter:k?`blur(${k}px)`:"none",opacity:j},children:J.jsxs("span",{"data-node":A.id,className:`flabel ${P==="active"?"activeL":""} ${w?"wayback":""} ${u===A.id?"hot":""}`,style:{fontSize:y(P)},onMouseEnter:()=>d(A.id),onMouseLeave:()=>d(null),onClick:()=>R(A),children:[w&&J.jsx("span",{className:"backArrow",children:"↑ "}),A.label]})})},A.id)}),!b&&(_==null?void 0:_.copy)&&_.x!=null&&J.jsx("div",{className:"fcopy",style:{transform:`translate3d(${_.x}px, ${_.y+y("active")*.62+16}px, 0) translateX(-50%)`},children:_.copy},e)]})]})}const mA=165;function gA({sim:t,activeId:e,width:n,height:i,onNavigate:r}){const{visibleNodes:s,roles:o,byId:a}=t,[l,u]=Ne.useState(null),d=mA*Ee.VIEWPORT_SCALE,h=n/2,f=i/2-20,p=a.get(e),_=p!=null&&p.img&&p.childIds.length===0?p:null,v=(c,g)=>{let x=c.x-h,y=c.y-f;const R=Math.hypot(x,y)||1;return{x:h+x/R*g,y:f+y/R*g*.82}},m=(c,g)=>c==="active"?Ut("active",p.label,n):c==="child"?Ut("child"):c==="parent"?Math.max(13,24-g*5):c==="sibling"?14:11.5;return J.jsxs("div",{className:"ringsSpace",children:[_&&J.jsx("img",{className:"ringsRoom",src:_.img,alt:""},`rroom-${_.id}`),J.jsx("div",{className:"pulse",style:{left:h,top:f}},`pulse-${e}`),s.map(c=>{if(c.x==null)return null;const g=o.get(c.id),x=Math.max(0,p.depth-c.depth);let y=c.x,R=c.y,T=1;return g==="active"?(y=h,R=f):g==="child"?({x:y,y:R}=v(c,d*1.32),T=.9):g==="sibling"?({x:y,y:R}=v(c,d*2.15),T=.42):g==="parent"?({x:y,y:R}=v(c,d*(1+x)*1.45),T=Math.max(.22,.55-x*.15)):({x:y,y:R}=v(c,d*2.9),T=.2),J.jsx("span",{"data-node":c.id,className:`rlabel ${g==="active"?"activeL":""} ${l===c.id?"hot":""}`,style:{transform:`translate3d(${y}px, ${R}px, 0) translate(-50%, -50%)`,fontSize:m(g,x),fontWeight:g==="active"?700:400,opacity:T},onMouseEnter:()=>u(c.id),onMouseLeave:()=>u(null),onClick:()=>r(c),children:c.label},c.id)}),(p==null?void 0:p.copy)&&J.jsx("div",{className:"fcopy",style:{transform:`translate3d(${h}px, ${f+m("active",0)*.62+16}px, 0) translateX(-50%)`},children:p.copy},`rc-${e}`)]})}const _A={active:{w:700,op:1},child:{w:500,op:.95},parent:{w:200,op:.8},sibling:{w:200,op:.55},distant:{w:100,op:.4}};function vA({sim:t,activeId:e,width:n,onNavigate:i}){const{visibleNodes:r,roles:s,byId:o}=t,[a,l]=Ne.useState(null),u=o.get(e),d=u!=null&&u.img&&u.childIds.length===0?u:null,h=(f,p)=>f==="active"?Ut("active",u.label,n)*1.15:f==="child"?Ut("child")*1.15:f==="parent"?Math.max(14,26-p*5):f==="sibling"?15:12;return J.jsxs("div",{className:"weightSpace",children:[d&&J.jsx("img",{className:"ringsRoom",src:d.img,alt:""},`wroom-${d.id}`),r.map(f=>{if(f.x==null)return null;const p=s.get(f.id),_=Math.max(0,u.depth-f.depth),v=_A[p],m=a===f.id;return J.jsx("span",{"data-node":f.id,className:`wlabel ${p==="active"?"activeL":""}`,style:{transform:`translate3d(${f.x}px, ${f.y}px, 0) translate(-50%, -50%)`,fontSize:h(p,_),fontWeight:m&&p!=="active"?Math.min(700,v.w+200):v.w,opacity:m?Math.min(1,v.op+.3):v.op},onMouseEnter:()=>l(f.id),onMouseLeave:()=>l(null),onClick:()=>i(f),children:f.label},f.id)}),(u==null?void 0:u.copy)&&u.x!=null&&J.jsx("div",{className:"fcopy",style:{transform:`translate3d(${u.x}px, ${u.y+h("active",0)*.62+16}px, 0) translateX(-50%)`},children:u.copy},`wc-${e}`)]})}function xA({byId:t,activeId:e,width:n,height:i,onNavigate:r}){const[s,o]=Ne.useState(null),[a,l]=Ne.useState({phase:"in",chosen:null,dir:"down"});Ne.useEffect(()=>{o(null),l({phase:"in",chosen:null,dir:"down"})},[e]),Ne.useEffect(()=>{const c=g=>g.key==="Escape"&&(s!=null?o(null):m());return window.addEventListener("keydown",c),()=>window.removeEventListener("keydown",c)});const u=t.get(e),d=Ui(e,t).reverse().map(c=>t.get(c)),h=u.childIds.map(c=>t.get(c)),f=h.length===0,p=f&&u.media?u.media:null,_=u.parentId,v=(c,g,x=null)=>{c&&(l({phase:"out",chosen:x,dir:g}),setTimeout(()=>r(c),430))},m=()=>v(_&&t.get(_),"up");return J.jsxs("div",{className:"reveal",children:[p&&J.jsx(X_,{media:p,startIndex:s??0,width:n,height:i??window.innerHeight,onIndex:o},`gl-${e}`),J.jsxs("div",{className:`revealCol ${p?"overMedia":""} fold-${a.phase} fold-${a.dir}`,children:[J.jsx("nav",{className:"crumbs",children:d.map((c,g)=>J.jsxs("span",{className:"crumbItem",style:{animationDelay:`${g*50}ms`},children:[J.jsx("button",{onClick:()=>v(c,"up"),children:c.label}),J.jsx("i",{children:"/"})]},c.id))},`cr-${e}`),J.jsx("button",{className:"revealTitle",onClick:m,disabled:!_,style:{cursor:_?"pointer":"default"},children:u.label}),u.copy&&J.jsx("p",{className:"revealCopy",children:u.copy},`copy-${e}`),!f&&J.jsx("ul",{className:"revealList",children:h.map((c,g)=>J.jsx("li",{className:a.chosen===c.id?"chosen":"",style:{"--i":g},children:J.jsxs("button",{onClick:()=>v(c,"down",c.id),children:[J.jsx("span",{className:"idx",children:String(g+1).padStart(2,"0")}),J.jsx("span",{className:"lbl",children:c.label}),c.media&&J.jsx("span",{className:"tag",children:"work"}),J.jsx("span",{className:"arrow",children:"→"})]})},c.id))},`list-${e}`),f&&!p&&u.copy==null&&J.jsx("p",{className:"revealCopy",children:"—"})]})]})}const ld=[{obj:Ee,key:"TYPE_SCALE",label:"Type scale",min:.7,max:2.4,step:.05},{obj:Ee,key:"CHARGE",label:"Repulsion",min:-1200,max:-50,step:10},{obj:bt,key:"STRENGTH",label:"Spring",min:.05,max:1.2,step:.05},{obj:Ee,key:"DAMPING",label:"Damping",min:.1,max:.7,step:.02},{obj:Ee,key:"ALPHA_KICK",label:"Energy",min:.2,max:1,step:.05},{obj:Ee,key:"DRIFT",label:"Idle drift",min:0,max:.8,step:.02},{obj:bt,key:"LOOSE",label:"Looseness",min:0,max:48,step:2},{obj:bt,key:"GAP",label:"Rhythm",min:26,max:72,step:2},{obj:Ee,key:"SPACING",label:"Spacing",min:0,max:48,step:2},{obj:Ee,key:"CURSOR",label:"Cursor pull",min:-.8,max:.8,step:.05},{obj:Ee,key:"SHOCK",label:"Shockwave",min:0,max:20,step:1}],SA=ld.map(t=>t.obj[t.key]);function yA({onTune:t}){const[e,n]=Ne.useState(typeof window>"u"?!0:window.innerWidth>680),[,i]=Ne.useState(0),r=(o,a)=>{o.obj[o.key]=a,i(l=>l+1),t()},s=()=>{ld.forEach((o,a)=>o.obj[o.key]=SA[a]),i(o=>o+1),t()};return J.jsxs("aside",{className:`tune ${e?"open":""}`,children:[J.jsxs("button",{className:"tuneHead",onClick:()=>n(o=>!o),children:["Physics ",e?"▾":"▸"]}),e&&J.jsxs("div",{className:"tuneBody",children:[J.jsxs("div",{className:"tuneRow tuneVariants",children:[J.jsx("span",{className:"tuneLabel",children:"Threads"}),[!0,!1].map(o=>J.jsx("button",{className:Ee.THREADS===o?"on":"",onClick:()=>{Ee.THREADS=o,i(a=>a+1),t()},children:o?"on":"off"},String(o)))]}),J.jsxs("div",{className:"tuneRow tuneVariants",children:[J.jsx("span",{className:"tuneLabel",children:"Effect"}),["lens","wave","rgb"].map(o=>J.jsx("button",{className:Ee.FX===o?"on":"",onClick:()=>{Ee.FX=o,i(a=>a+1),t()},children:o},o))]}),J.jsxs("div",{className:"tuneRow tuneVariants",children:[J.jsx("span",{className:"tuneLabel",children:"Emission"}),["arc","orbit","fan","tide"].map(o=>J.jsx("button",{className:Ee.EMIT===o?"on":"",onClick:()=>{Ee.EMIT=o,i(a=>a+1),t()},children:o},o))]}),ld.map(o=>J.jsxs("label",{className:"tuneRow",children:[J.jsx("span",{className:"tuneLabel",children:o.label}),J.jsx("input",{type:"range",min:o.min,max:o.max,step:o.step,value:o.obj[o.key],onChange:a=>r(o,+a.target.value)}),J.jsx("span",{className:"tuneVal",children:Number(o.obj[o.key]).toFixed(o.step<1?2:0)})]},o.key)),J.jsx("button",{className:"tuneReset",onClick:s,children:"Reset"})]})]})}function MA(t){const e=+this._x.call(null,t),n=+this._y.call(null,t);return j_(this.cover(e,n),e,n,t)}function j_(t,e,n,i){if(isNaN(e)||isNaN(n))return t;var r,s=t._root,o={data:i},a=t._x0,l=t._y0,u=t._x1,d=t._y1,h,f,p,_,v,m,c,g;if(!s)return t._root=o,t;for(;s.length;)if((v=e>=(h=(a+u)/2))?a=h:u=h,(m=n>=(f=(l+d)/2))?l=f:d=f,r=s,!(s=s[c=m<<1|v]))return r[c]=o,t;if(p=+t._x.call(null,s.data),_=+t._y.call(null,s.data),e===p&&n===_)return o.next=s,r?r[c]=o:t._root=o,t;do r=r?r[c]=new Array(4):t._root=new Array(4),(v=e>=(h=(a+u)/2))?a=h:u=h,(m=n>=(f=(l+d)/2))?l=f:d=f;while((c=m<<1|v)===(g=(_>=f)<<1|p>=h));return r[g]=s,r[c]=o,t}function EA(t){var e,n,i=t.length,r,s,o=new Array(i),a=new Array(i),l=1/0,u=1/0,d=-1/0,h=-1/0;for(n=0;n<i;++n)isNaN(r=+this._x.call(null,e=t[n]))||isNaN(s=+this._y.call(null,e))||(o[n]=r,a[n]=s,r<l&&(l=r),r>d&&(d=r),s<u&&(u=s),s>h&&(h=s));if(l>d||u>h)return this;for(this.cover(l,u).cover(d,h),n=0;n<i;++n)j_(this,o[n],a[n],t[n]);return this}function TA(t,e){if(isNaN(t=+t)||isNaN(e=+e))return this;var n=this._x0,i=this._y0,r=this._x1,s=this._y1;if(isNaN(n))r=(n=Math.floor(t))+1,s=(i=Math.floor(e))+1;else{for(var o=r-n||1,a=this._root,l,u;n>t||t>=r||i>e||e>=s;)switch(u=(e<i)<<1|t<n,l=new Array(4),l[u]=a,a=l,o*=2,u){case 0:r=n+o,s=i+o;break;case 1:n=r-o,s=i+o;break;case 2:r=n+o,i=s-o;break;case 3:n=r-o,i=s-o;break}this._root&&this._root.length&&(this._root=a)}return this._x0=n,this._y0=i,this._x1=r,this._y1=s,this}function wA(){var t=[];return this.visit(function(e){if(!e.length)do t.push(e.data);while(e=e.next)}),t}function AA(t){return arguments.length?this.cover(+t[0][0],+t[0][1]).cover(+t[1][0],+t[1][1]):isNaN(this._x0)?void 0:[[this._x0,this._y0],[this._x1,this._y1]]}function rn(t,e,n,i,r){this.node=t,this.x0=e,this.y0=n,this.x1=i,this.y1=r}function RA(t,e,n){var i,r=this._x0,s=this._y0,o,a,l,u,d=this._x1,h=this._y1,f=[],p=this._root,_,v;for(p&&f.push(new rn(p,r,s,d,h)),n==null?n=1/0:(r=t-n,s=e-n,d=t+n,h=e+n,n*=n);_=f.pop();)if(!(!(p=_.node)||(o=_.x0)>d||(a=_.y0)>h||(l=_.x1)<r||(u=_.y1)<s))if(p.length){var m=(o+l)/2,c=(a+u)/2;f.push(new rn(p[3],m,c,l,u),new rn(p[2],o,c,m,u),new rn(p[1],m,a,l,c),new rn(p[0],o,a,m,c)),(v=(e>=c)<<1|t>=m)&&(_=f[f.length-1],f[f.length-1]=f[f.length-1-v],f[f.length-1-v]=_)}else{var g=t-+this._x.call(null,p.data),x=e-+this._y.call(null,p.data),y=g*g+x*x;if(y<n){var R=Math.sqrt(n=y);r=t-R,s=e-R,d=t+R,h=e+R,i=p.data}}return i}function CA(t){if(isNaN(d=+this._x.call(null,t))||isNaN(h=+this._y.call(null,t)))return this;var e,n=this._root,i,r,s,o=this._x0,a=this._y0,l=this._x1,u=this._y1,d,h,f,p,_,v,m,c;if(!n)return this;if(n.length)for(;;){if((_=d>=(f=(o+l)/2))?o=f:l=f,(v=h>=(p=(a+u)/2))?a=p:u=p,e=n,!(n=n[m=v<<1|_]))return this;if(!n.length)break;(e[m+1&3]||e[m+2&3]||e[m+3&3])&&(i=e,c=m)}for(;n.data!==t;)if(r=n,!(n=n.next))return this;return(s=n.next)&&delete n.next,r?(s?r.next=s:delete r.next,this):e?(s?e[m]=s:delete e[m],(n=e[0]||e[1]||e[2]||e[3])&&n===(e[3]||e[2]||e[1]||e[0])&&!n.length&&(i?i[c]=n:this._root=n),this):(this._root=s,this)}function bA(t){for(var e=0,n=t.length;e<n;++e)this.remove(t[e]);return this}function PA(){return this._root}function LA(){var t=0;return this.visit(function(e){if(!e.length)do++t;while(e=e.next)}),t}function NA(t){var e=[],n,i=this._root,r,s,o,a,l;for(i&&e.push(new rn(i,this._x0,this._y0,this._x1,this._y1));n=e.pop();)if(!t(i=n.node,s=n.x0,o=n.y0,a=n.x1,l=n.y1)&&i.length){var u=(s+a)/2,d=(o+l)/2;(r=i[3])&&e.push(new rn(r,u,d,a,l)),(r=i[2])&&e.push(new rn(r,s,d,u,l)),(r=i[1])&&e.push(new rn(r,u,o,a,d)),(r=i[0])&&e.push(new rn(r,s,o,u,d))}return this}function DA(t){var e=[],n=[],i;for(this._root&&e.push(new rn(this._root,this._x0,this._y0,this._x1,this._y1));i=e.pop();){var r=i.node;if(r.length){var s,o=i.x0,a=i.y0,l=i.x1,u=i.y1,d=(o+l)/2,h=(a+u)/2;(s=r[0])&&e.push(new rn(s,o,a,d,h)),(s=r[1])&&e.push(new rn(s,d,a,l,h)),(s=r[2])&&e.push(new rn(s,o,h,d,u)),(s=r[3])&&e.push(new rn(s,d,h,l,u))}n.push(i)}for(;i=n.pop();)t(i.node,i.x0,i.y0,i.x1,i.y1);return this}function IA(t){return t[0]}function UA(t){return arguments.length?(this._x=t,this):this._x}function FA(t){return t[1]}function OA(t){return arguments.length?(this._y=t,this):this._y}function xh(t,e,n){var i=new Sh(e??IA,n??FA,NaN,NaN,NaN,NaN);return t==null?i:i.addAll(t)}function Sh(t,e,n,i,r,s){this._x=t,this._y=e,this._x0=n,this._y0=i,this._x1=r,this._y1=s,this._root=void 0}function Wm(t){for(var e={data:t.data},n=e;t=t.next;)n=n.next={data:t.data};return e}var un=xh.prototype=Sh.prototype;un.copy=function(){var t=new Sh(this._x,this._y,this._x0,this._y0,this._x1,this._y1),e=this._root,n,i;if(!e)return t;if(!e.length)return t._root=Wm(e),t;for(n=[{source:e,target:t._root=new Array(4)}];e=n.pop();)for(var r=0;r<4;++r)(i=e.source[r])&&(i.length?n.push({source:i,target:e.target[r]=new Array(4)}):e.target[r]=Wm(i));return t};un.add=MA;un.addAll=EA;un.cover=TA;un.data=wA;un.extent=AA;un.find=RA;un.remove=CA;un.removeAll=bA;un.root=PA;un.size=LA;un.visit=NA;un.visitAfter=DA;un.x=UA;un.y=OA;function sn(t){return function(){return t}}function rr(t){return(t()-.5)*1e-6}function kA(t){return t.x+t.vx}function BA(t){return t.y+t.vy}function zA(t){var e,n,i,r=1,s=1;typeof t!="function"&&(t=sn(t==null?1:+t));function o(){for(var u,d=e.length,h,f,p,_,v,m,c=0;c<s;++c)for(h=xh(e,kA,BA).visitAfter(a),u=0;u<d;++u)f=e[u],v=n[f.index],m=v*v,p=f.x+f.vx,_=f.y+f.vy,h.visit(g);function g(x,y,R,T,b){var S=x.data,A=x.r,P=v+A;if(S){if(S.index>f.index){var w=p-S.x-S.vx,L=_-S.y-S.vy,k=w*w+L*L;k<P*P&&(w===0&&(w=rr(i),k+=w*w),L===0&&(L=rr(i),k+=L*L),k=(P-(k=Math.sqrt(k)))/k*r,f.vx+=(w*=k)*(P=(A*=A)/(m+A)),f.vy+=(L*=k)*P,S.vx-=w*(P=1-P),S.vy-=L*P)}return}return y>p+P||T<p-P||R>_+P||b<_-P}}function a(u){if(u.data)return u.r=n[u.data.index];for(var d=u.r=0;d<4;++d)u[d]&&u[d].r>u.r&&(u.r=u[d].r)}function l(){if(e){var u,d=e.length,h;for(n=new Array(d),u=0;u<d;++u)h=e[u],n[h.index]=+t(h,u,e)}}return o.initialize=function(u,d){e=u,i=d,l()},o.iterations=function(u){return arguments.length?(s=+u,o):s},o.strength=function(u){return arguments.length?(r=+u,o):r},o.radius=function(u){return arguments.length?(t=typeof u=="function"?u:sn(+u),l(),o):t},o}function VA(t){return t.index}function Xm(t,e){var n=t.get(e);if(!n)throw new Error("node not found: "+e);return n}function HA(t){var e=VA,n=h,i,r=sn(30),s,o,a,l,u,d=1;t==null&&(t=[]);function h(m){return 1/Math.min(a[m.source.index],a[m.target.index])}function f(m){for(var c=0,g=t.length;c<d;++c)for(var x=0,y,R,T,b,S,A,P;x<g;++x)y=t[x],R=y.source,T=y.target,b=T.x+T.vx-R.x-R.vx||rr(u),S=T.y+T.vy-R.y-R.vy||rr(u),A=Math.sqrt(b*b+S*S),A=(A-s[x])/A*m*i[x],b*=A,S*=A,T.vx-=b*(P=l[x]),T.vy-=S*P,R.vx+=b*(P=1-P),R.vy+=S*P}function p(){if(o){var m,c=o.length,g=t.length,x=new Map(o.map((R,T)=>[e(R,T,o),R])),y;for(m=0,a=new Array(c);m<g;++m)y=t[m],y.index=m,typeof y.source!="object"&&(y.source=Xm(x,y.source)),typeof y.target!="object"&&(y.target=Xm(x,y.target)),a[y.source.index]=(a[y.source.index]||0)+1,a[y.target.index]=(a[y.target.index]||0)+1;for(m=0,l=new Array(g);m<g;++m)y=t[m],l[m]=a[y.source.index]/(a[y.source.index]+a[y.target.index]);i=new Array(g),_(),s=new Array(g),v()}}function _(){if(o)for(var m=0,c=t.length;m<c;++m)i[m]=+n(t[m],m,t)}function v(){if(o)for(var m=0,c=t.length;m<c;++m)s[m]=+r(t[m],m,t)}return f.initialize=function(m,c){o=m,u=c,p()},f.links=function(m){return arguments.length?(t=m,p(),f):t},f.id=function(m){return arguments.length?(e=m,f):e},f.iterations=function(m){return arguments.length?(d=+m,f):d},f.strength=function(m){return arguments.length?(n=typeof m=="function"?m:sn(+m),_(),f):n},f.distance=function(m){return arguments.length?(r=typeof m=="function"?m:sn(+m),v(),f):r},f}var GA={value:()=>{}};function Y_(){for(var t=0,e=arguments.length,n={},i;t<e;++t){if(!(i=arguments[t]+"")||i in n||/[\s.]/.test(i))throw new Error("illegal type: "+i);n[i]=[]}return new pl(n)}function pl(t){this._=t}function WA(t,e){return t.trim().split(/^|\s+/).map(function(n){var i="",r=n.indexOf(".");if(r>=0&&(i=n.slice(r+1),n=n.slice(0,r)),n&&!e.hasOwnProperty(n))throw new Error("unknown type: "+n);return{type:n,name:i}})}pl.prototype=Y_.prototype={constructor:pl,on:function(t,e){var n=this._,i=WA(t+"",n),r,s=-1,o=i.length;if(arguments.length<2){for(;++s<o;)if((r=(t=i[s]).type)&&(r=XA(n[r],t.name)))return r;return}if(e!=null&&typeof e!="function")throw new Error("invalid callback: "+e);for(;++s<o;)if(r=(t=i[s]).type)n[r]=jm(n[r],t.name,e);else if(e==null)for(r in n)n[r]=jm(n[r],t.name,null);return this},copy:function(){var t={},e=this._;for(var n in e)t[n]=e[n].slice();return new pl(t)},call:function(t,e){if((r=arguments.length-2)>0)for(var n=new Array(r),i=0,r,s;i<r;++i)n[i]=arguments[i+2];if(!this._.hasOwnProperty(t))throw new Error("unknown type: "+t);for(s=this._[t],i=0,r=s.length;i<r;++i)s[i].value.apply(e,n)},apply:function(t,e,n){if(!this._.hasOwnProperty(t))throw new Error("unknown type: "+t);for(var i=this._[t],r=0,s=i.length;r<s;++r)i[r].value.apply(e,n)}};function XA(t,e){for(var n=0,i=t.length,r;n<i;++n)if((r=t[n]).name===e)return r.value}function jm(t,e,n){for(var i=0,r=t.length;i<r;++i)if(t[i].name===e){t[i]=GA,t=t.slice(0,i).concat(t.slice(i+1));break}return n!=null&&t.push({name:e,value:n}),t}var Gs=0,vo=0,co=0,$_=1e3,Wl,xo,Xl=0,Wr=0,hu=0,Zo=typeof performance=="object"&&performance.now?performance:Date,q_=typeof window=="object"&&window.requestAnimationFrame?window.requestAnimationFrame.bind(window):function(t){setTimeout(t,17)};function K_(){return Wr||(q_(jA),Wr=Zo.now()+hu)}function jA(){Wr=0}function ud(){this._call=this._time=this._next=null}ud.prototype=Z_.prototype={constructor:ud,restart:function(t,e,n){if(typeof t!="function")throw new TypeError("callback is not a function");n=(n==null?K_():+n)+(e==null?0:+e),!this._next&&xo!==this&&(xo?xo._next=this:Wl=this,xo=this),this._call=t,this._time=n,cd()},stop:function(){this._call&&(this._call=null,this._time=1/0,cd())}};function Z_(t,e,n){var i=new ud;return i.restart(t,e,n),i}function YA(){K_(),++Gs;for(var t=Wl,e;t;)(e=Wr-t._time)>=0&&t._call.call(void 0,e),t=t._next;--Gs}function Ym(){Wr=(Xl=Zo.now())+hu,Gs=vo=0;try{YA()}finally{Gs=0,qA(),Wr=0}}function $A(){var t=Zo.now(),e=t-Xl;e>$_&&(hu-=e,Xl=t)}function qA(){for(var t,e=Wl,n,i=1/0;e;)e._call?(i>e._time&&(i=e._time),t=e,e=e._next):(n=e._next,e._next=null,e=t?t._next=n:Wl=n);xo=t,cd(i)}function cd(t){if(!Gs){vo&&(vo=clearTimeout(vo));var e=t-Wr;e>24?(t<1/0&&(vo=setTimeout(Ym,t-Zo.now()-hu)),co&&(co=clearInterval(co))):(co||(Xl=Zo.now(),co=setInterval($A,$_)),Gs=1,q_(Ym))}}const KA=1664525,ZA=1013904223,$m=4294967296;function QA(){let t=1;return()=>(t=(KA*t+ZA)%$m)/$m}function JA(t){return t.x}function eR(t){return t.y}var tR=10,nR=Math.PI*(3-Math.sqrt(5));function iR(t){var e,n=1,i=.001,r=1-Math.pow(i,1/300),s=0,o=.6,a=new Map,l=Z_(h),u=Y_("tick","end"),d=QA();t==null&&(t=[]);function h(){f(),u.call("tick",e),n<i&&(l.stop(),u.call("end",e))}function f(v){var m,c=t.length,g;v===void 0&&(v=1);for(var x=0;x<v;++x)for(n+=(s-n)*r,a.forEach(function(y){y(n)}),m=0;m<c;++m)g=t[m],g.fx==null?g.x+=g.vx*=o:(g.x=g.fx,g.vx=0),g.fy==null?g.y+=g.vy*=o:(g.y=g.fy,g.vy=0);return e}function p(){for(var v=0,m=t.length,c;v<m;++v){if(c=t[v],c.index=v,c.fx!=null&&(c.x=c.fx),c.fy!=null&&(c.y=c.fy),isNaN(c.x)||isNaN(c.y)){var g=tR*Math.sqrt(.5+v),x=v*nR;c.x=g*Math.cos(x),c.y=g*Math.sin(x)}(isNaN(c.vx)||isNaN(c.vy))&&(c.vx=c.vy=0)}}function _(v){return v.initialize&&v.initialize(t,d),v}return p(),e={tick:f,restart:function(){return l.restart(h),e},stop:function(){return l.stop(),e},nodes:function(v){return arguments.length?(t=v,p(),a.forEach(_),e):t},alpha:function(v){return arguments.length?(n=+v,e):n},alphaMin:function(v){return arguments.length?(i=+v,e):i},alphaDecay:function(v){return arguments.length?(r=+v,e):+r},alphaTarget:function(v){return arguments.length?(s=+v,e):s},velocityDecay:function(v){return arguments.length?(o=1-v,e):1-o},randomSource:function(v){return arguments.length?(d=v,a.forEach(_),e):d},force:function(v,m){return arguments.length>1?(m==null?a.delete(v):a.set(v,_(m)),e):a.get(v)},find:function(v,m,c){var g=0,x=t.length,y,R,T,b,S;for(c==null?c=1/0:c*=c,g=0;g<x;++g)b=t[g],y=v-b.x,R=m-b.y,T=y*y+R*R,T<c&&(S=b,c=T);return S},on:function(v,m){return arguments.length>1?(u.on(v,m),e):u.on(v)}}}function rR(){var t,e,n,i,r=sn(-30),s,o=1,a=1/0,l=.81;function u(p){var _,v=t.length,m=xh(t,JA,eR).visitAfter(h);for(i=p,_=0;_<v;++_)e=t[_],m.visit(f)}function d(){if(t){var p,_=t.length,v;for(s=new Array(_),p=0;p<_;++p)v=t[p],s[v.index]=+r(v,p,t)}}function h(p){var _=0,v,m,c=0,g,x,y;if(p.length){for(g=x=y=0;y<4;++y)(v=p[y])&&(m=Math.abs(v.value))&&(_+=v.value,c+=m,g+=m*v.x,x+=m*v.y);p.x=g/c,p.y=x/c}else{v=p,v.x=v.data.x,v.y=v.data.y;do _+=s[v.data.index];while(v=v.next)}p.value=_}function f(p,_,v,m){if(!p.value)return!0;var c=p.x-e.x,g=p.y-e.y,x=m-_,y=c*c+g*g;if(x*x/l<y)return y<a&&(c===0&&(c=rr(n),y+=c*c),g===0&&(g=rr(n),y+=g*g),y<o&&(y=Math.sqrt(o*y)),e.vx+=c*p.value*i/y,e.vy+=g*p.value*i/y),!0;if(p.length||y>=a)return;(p.data!==e||p.next)&&(c===0&&(c=rr(n),y+=c*c),g===0&&(g=rr(n),y+=g*g),y<o&&(y=Math.sqrt(o*y)));do p.data!==e&&(x=s[p.data.index]*i/y,e.vx+=c*x,e.vy+=g*x);while(p=p.next)}return u.initialize=function(p,_){t=p,n=_,d()},u.strength=function(p){return arguments.length?(r=typeof p=="function"?p:sn(+p),d(),u):r},u.distanceMin=function(p){return arguments.length?(o=p*p,u):Math.sqrt(o)},u.distanceMax=function(p){return arguments.length?(a=p*p,u):Math.sqrt(a)},u.theta=function(p){return arguments.length?(l=p*p,u):Math.sqrt(l)},u}function sR(t){var e=sn(.1),n,i,r;typeof t!="function"&&(t=sn(t==null?0:+t));function s(a){for(var l=0,u=n.length,d;l<u;++l)d=n[l],d.vx+=(r[l]-d.x)*i[l]*a}function o(){if(n){var a,l=n.length;for(i=new Array(l),r=new Array(l),a=0;a<l;++a)i[a]=isNaN(r[a]=+t(n[a],a,n))?0:+e(n[a],a,n)}}return s.initialize=function(a){n=a,o()},s.strength=function(a){return arguments.length?(e=typeof a=="function"?a:sn(+a),o(),s):e},s.x=function(a){return arguments.length?(t=typeof a=="function"?a:sn(+a),o(),s):t},s}function oR(t){var e=sn(.1),n,i,r;typeof t!="function"&&(t=sn(t==null?0:+t));function s(a){for(var l=0,u=n.length,d;l<u;++l)d=n[l],d.vy+=(r[l]-d.y)*i[l]*a}function o(){if(n){var a,l=n.length;for(i=new Array(l),r=new Array(l),a=0;a<l;++a)i[a]=isNaN(r[a]=+t(n[a],a,n))?0:+e(n[a],a,n)}}return s.initialize=function(a){n=a,o()},s.strength=function(a){return arguments.length?(e=typeof a=="function"?a:sn(+a),o(),s):e},s.y=function(a){return arguments.length?(t=typeof a=="function"?a:sn(+a),o(),s):t},s}const Q_={id:"nevverland",label:"Nevverland",copy:"An experimental practice. Navigation as material, type as structure, imagery as weather. Built fast, kept forever — every study frozen the moment it works.",img:"img/03.jpg",children:[{id:"work",label:"Work",copy:"Studies in interfaces that behave like places — each one rebuilds a piece of the 2007 spatial web with today’s physics.",img:"img/07.jpg",children:[{id:"nike",label:"Nike",img:"img/00.jpg",copy:"Motion identity sprints. Twelve directions in ten days.",media:[{type:"video",src:"img/nike.mp4"},{type:"img",src:"img/00.jpg"},{type:"img",src:"img/03.jpg"},{type:"img",src:"img/05.jpg"}]},{id:"hbo",label:"HBO",img:"img/14.jpg",copy:"Title sequences as navigation. The menu is the trailer.",media:[{type:"img",src:"img/14.jpg"},{type:"video",src:"img/hbo.mp4"},{type:"img",src:"img/11.jpg"}]},{id:"sony",label:"Sony",img:"img/17.jpg",copy:"Product stories told through a bent lens.",media:[{type:"img",src:"img/17.jpg"},{type:"img",src:"img/09.jpg"},{type:"video",src:"img/sony.mp4"},{type:"img",src:"img/07.jpg"}]},{id:"pepsi",label:"Pepsi",img:"img/21.jpg",copy:"Liquid type systems for a liquid product.",media:[{type:"img",src:"img/21.jpg"},{type:"img",src:"img/34.jpg"},{type:"img",src:"img/38.jpg"}]},{id:"experimental",label:"Experimental",img:"img/28.jpg",copy:"The unbriefed work. Where the other four came from.",media:[{type:"video",src:"img/experimental.mp4"},{type:"img",src:"img/28.jpg"},{type:"img",src:"img/11.jpg"},{type:"img",src:"img/09.jpg"}]}]},{id:"about",label:"About",copy:"Nevverland is the studio of Nessim Higson — I AM ALWAYS HUNGRY. Twenty years of brand and interactive work, currently obsessed with making the web feel hand-made again. Small team, long leash, no templates.",img:"img/05.jpg",children:[{id:"studio",label:"Studio",img:"img/09.jpg",copy:"A room with good light, too many books, and a server that never sleeps."},{id:"people",label:"People",img:"img/11.jpg",copy:"One founder, many collaborators, several machines that think."},{id:"process",label:"Process",img:"img/34.jpg",copy:"Prototype first. Theory later, if ever. Ship the sketch."}]},{id:"info",label:"Info",copy:"Field notes and colophon. Set in Helvetica because the grid deserves respect; broken on purpose where it doesn’t. All imagery from the Uniqlock sessions.",img:"img/38.jpg",children:[{id:"notes",label:"Notes",img:"img/03.jpg",copy:"Working notes from each experiment, unedited."},{id:"colophon",label:"Colophon",img:"img/05.jpg",copy:"React + d3-force for the organic modes; just slots and springs for the structural ones."},{id:"archive",label:"Archive",img:"img/07.jpg",copy:"Frozen versions of everything, kept forever."}]},{id:"contact",label:"Contact",copy:"Always hungry. Say hello.",img:"img/09.jpg",children:[{id:"newyork",label:"New York",img:"img/11.jpg",copy:"EST, for now."},{id:"losangeles",label:"Los Angeles",img:"img/14.jpg",copy:"Golden hour, permanently."},{id:"email",label:"Email",img:"img/21.jpg",copy:"ness@iamalwayshungry.com"}]}]};function aR(t,e,n){const i=e.get(t.id);return n==="type"?Ut(i)*.8+2:sh[i].radius+Ee.COLLIDE_PADDING}function lR(t,e,n=1){function i(r){const s=t();if(!s)return;const o=Ee.CHILD_RING*n*Ee.VIEWPORT_SCALE;for(const a of e()){let l=a.x-s.x,u=a.y-s.y,d=Math.sqrt(l*l+u*u);d<1&&(l=Math.cos(a.phase),u=Math.sin(a.phase),d=1);const h=(o-d)/d*Ee.CHILD_RING_STRENGTH*r;a.vx+=l*h,a.vy+=u*h}}return i.initialize=()=>{},i}function uR(){let t=[],e=0;function n(){e+=.006;for(const i of t)i.vx+=Math.cos(e*i.driftSpeed+i.phase)*Ee.DRIFT*.1,i.vy+=Math.sin(e*i.driftSpeed*1.37+i.phase)*Ee.DRIFT*.1}return n.initialize=i=>t=i,n}function cR(t){let e=0;for(const n of t)e=(e*31+n.charCodeAt(0))%997;return e}function fR(t,e=bt.STRENGTH){function n(i){for(const r of t){const s=r.anchor.x+r.dx,o=r.anchor.y+r.dy;r.node.vx+=(s-r.node.x)*e*i,r.node.vy+=(o-r.node.y)*e*i}}return n.initialize=()=>{},n}function dR(t,e,n,i,r=0){const s=i.get(t),o=Ui(t,i),a=[],l=Ee.VIEWPORT_SCALE,u=Math.max(bt.COL_W*l*.78,bo(s.label,Ut("active"))+30*l),d=bt.BREAD_STEP*l,h=Math.max(bt.GAP*l,Ut("child")*1.7+6),f=Math.max(bt.GAP_DISTANT*l,Ut("distant")*2+8);for(const p of e){const _=n.get(p.id);if(_==="child"){const v=s.childIds.indexOf(p.id);a.push({node:p,anchor:s,dx:u,dy:bt.CHILD_DROP+r+v*h})}else if(_==="sibling"){const v=i.get(s.parentId).childIds,m=v.indexOf(p.id)-v.indexOf(t);a.push({node:p,anchor:s,dx:0,dy:m*h+(m>0?bt.ACTIVE_CLEAR+r:0)})}else if(_==="parent"){const v=o.indexOf(p.id)+1;a.push({node:p,anchor:s,dx:-d*v,dy:-bt.ROW_LIFT*l*v})}else if(_==="distant"){const v=i.get(p.parentId).childIds,m=e.find(g=>g.parentId===p.parentId&&(n.get(g.id)==="parent"||g.id===t));if(!m)continue;const c=v.indexOf(p.id)-v.indexOf(m.id);a.push({node:p,anchor:m,dx:0,dy:c*f+(c>0?10:-6)})}}return a}function hR(t,e,n,i,r,s,o){const a=i.get(t),l=Ui(t,i),u=[],d=Ut("active",a.label,s),h=Math.max(bt.GAP,Ut("child")*2.15),f=Math.max(30,Ut("sibling")*2.6),p=c=>o?(cR(c)%100/50-1)*o:0;l.forEach((c,g)=>{u.push({node:i.get(c),anchor:a,dx:p(c)*.6,dy:-(d*.55+34+g*34)})});const _=a.childIds.filter(c=>n.has(c)),v=d*.55+26+r;_.forEach((c,g)=>{u.push({node:i.get(c),anchor:a,dx:p(c),dy:v+g*h})});let m=v+_.length*h+30;if(a.parentId)for(const c of i.get(a.parentId).childIds)c===t||!n.has(c)||(u.push({node:i.get(c),anchor:a,dx:p(c),dy:m}),m+=f);m+=18;for(const c of e)n.get(c.id)==="distant"&&(u.push({node:c,anchor:a,dx:p(c.id),dy:m}),m+=27);return u}function pR(t,e){let n=[];function i(r){const s=Ee.CONTAIN_MARGIN*Ee.VIEWPORT_SCALE;for(const o of n)o.x<s&&(o.vx+=(s-o.x)*Ee.CONTAIN_STRENGTH*r),o.x>t-s&&(o.vx-=(o.x-(t-s))*Ee.CONTAIN_STRENGTH*r),o.y<s&&(o.vy+=(s-o.y)*Ee.CONTAIN_STRENGTH*r),o.y>e-s&&(o.vy-=(o.y-(e-s))*Ee.CONTAIN_STRENGTH*r)}return i.initialize=r=>n=r,i}function mR(t){let e=[];function i(){if(!(!Ee.CURSOR||t.x==null))for(const r of e){const s=t.x-r.x,o=t.y-r.y,a=Math.hypot(s,o);if(a>300||a<2)continue;const l=Ee.CURSOR*(1-a/300)*.18;r.vx+=s/a*l,r.vy+=o/a*l}}return i.initialize=r=>e=r,i}function gR(t,e,n,i="type",r=0){const[,s]=Ne.useState(0),o=Ne.useRef(null);if(!o.current){const{nodes:d,byId:h}=US(Q_);for(const f of d)f.phase=Math.random()*Math.PI*2,f.driftSpeed=.5+Math.random(),f.everShown=!1;o.current={sim:iR([]).stop(),nodes:d,byId:h,roles:new Map,seeded:!1,pointer:{x:null,y:null},prevFocus:null}}const{sim:a,nodes:l,byId:u}=o.current;return Ne.useEffect(()=>{if(!e||!n)return;const d=i==="focus"||i==="rings"||i==="weight",h=i==="orbs"||d?"orbs":"type",f=e/2,p=n/2;if(!o.current.seeded){for(const w of l)w.x=e/2+(Math.random()-.5)*60,w.y=n/2+(Math.random()-.5)*60;o.current.seeded=!0}const _=FS(t,u);o.current.roles=_;const v=w=>_.get(w.id),m=l.filter(w=>_.has(w.id));for(const w of m)if(!w.everShown){const L=w.parentId?u.get(w.parentId):null;L&&L.everShown&&(w.x=L.x+(Math.random()-.5)*40,w.y=L.y+(Math.random()-.5)*40),w.everShown=!0}const c=[];for(const w of m){if(!w.parentId||!_.has(w.parentId))continue;const L=v(w),k=L==="child"?"activeChild":L==="active"||L==="parent"?"breadcrumb":L==="sibling"?"sibling":"distant";c.push({source:w.parentId,target:w.id,kind:k})}o.current.links=c;for(const w of["charge","link","collide","x","y","ring","drift","contain","pointer"])a.force(w,null);a.nodes(m),a.velocityDecay(Ee.DAMPING);const g=h==="type"?bt.CHARGE_SCALE:1;a.force("charge",rR().strength(w=>Ee.CHARGE*sh[v(w)].scale*g*Ee.VIEWPORT_SCALE).distanceMax(Ee.CHARGE_MAX_DISTANCE*Ee.VIEWPORT_SCALE)),a.force("link",HA(c).id(w=>w.id).distance(w=>Ee.LINK_DISTANCE[w.kind]*Ee.VIEWPORT_SCALE).strength(h==="type"?bt.LINK_STRENGTH:.6)),a.force("collide",zA(w=>d?bo(w.label,Ut(v(w)))*.42+6+Ee.SPACING*.5:aR(w,_,h)+(h==="type"?Ee.SPACING*.25:0)).strength(Ee.COLLIDE_STRENGTH).iterations(2));const x=i==="structure"||i==="imagery",y=Ui(t,u).length,R=u.get(t),T=R.childIds.filter(w=>_.has(w)),b=R.parentId?u.get(R.parentId).childIds.filter(w=>_.has(w)&&w!==t).length:0;let S,A;if(h==="type"){const w=Ee.VIEWPORT_SCALE,L=Ut("active",R.label,e),k=Math.max(bt.GAP*w,Ut("child")*1.7+6),j=(x||i==="depth")&&R.copy?Math.min(150,Math.ceil(R.copy.length/48)*21+26):0,D=y*(x?34:bt.ROW_LIFT*w*.7)+L*.5+30,B=L*.5+j+T.length*k+(b?30+b*(x?30:0):0);A=n*.46-(B-D)/2;const O=Math.max(28,e*.06),F=x?0:Math.max(bt.COL_W*w*.78,bo(R.label,L)+30*w);let X=0;for(const fe of T)X=Math.max(X,bo(u.get(fe).label,Ut("child")));const $=x?O:O+y*bt.BREAD_STEP*w,ne=e-24-F-X;S=Math.max(O,Math.min($,Math.max(O,ne)))}else S=f,A=p;if(a.force("x",sR(S).strength(w=>v(w)==="active"?Ee.CENTER_PULL_ACTIVE:Ee.CENTER_PULL_OTHERS)),a.force("y",oR(w=>v(w)==="parent"&&h!=="type"?p-Ee.BREADCRUMB_LIFT:A).strength(w=>{const L=v(w);return L==="active"?Ee.CENTER_PULL_ACTIVE:L==="parent"?Ee.BREADCRUMB_PULL:Ee.CENTER_PULL_OTHERS})),h==="type"){const w=u.get(t),L=(x||i==="depth")&&w.copy?Math.min(150,Math.ceil(w.copy.length/48)*21+26):0,k=x?hR(t,m,_,u,L,e,i==="structure"?0:bt.LOOSE):dR(t,m,_,u,L);a.force("ring",fR(k,x?.9:bt.STRENGTH))}else a.force("ring",lR(()=>u.get(t),()=>m.filter(w=>v(w)==="child"),d?1.5:1));a.force("drift",uR()),a.force("contain",pR(e,n)),a.force("pointer",mR(o.current.pointer));const P=u.get(t);if(Ee.SHOCK>0&&o.current.prevFocus&&o.current.prevFocus!==t&&P.x!=null)for(const w of m){if(w===P||w.x==null)continue;const L=w.x-P.x,k=w.y-P.y,j=Math.hypot(L,k)||1,D=Ee.SHOCK*Math.min(1,220/j);w.vx+=L/j*D,w.vy+=k/j*D}return o.current.prevFocus=t,a.on("tick",()=>s(w=>w+1)),a.alpha(Ee.ALPHA_KICK).alphaTarget(Ee.DRIFT>.015?Ee.IDLE_ALPHA:0).restart(),s(w=>w+1),()=>a.on("tick",null)},[t,e,n,i,r]),Ne.useEffect(()=>()=>a.stop(),[]),{visibleNodes:l.filter(d=>o.current.roles.has(d.id)),links:o.current.links||[],roles:o.current.roles,byId:u,pointer:o.current.pointer}}function qm(t){return Math.max(.5,Math.min(1,(t-80)/1e3))}const _R=Q_.id,vR=[{key:"focus",label:"01 FOCAL"},{key:"type",label:"02 ORGANIC"},{key:"orbs",label:"03 ORBS"},{key:"structure",label:"04 STRUCTURE"},{key:"imagery",label:"05 IMAGERY"},{key:"depth",label:"06 DEPTH"},{key:"rings",label:"07 RINGS"},{key:"weight",label:"08 WEIGHT"},{key:"reveal",label:"09 REVEAL"}];function xR(){const[t,e]=Ne.useState(_R),[n,i]=Ne.useState("focus"),[r,s]=Ne.useState(0),[o,a]=Ne.useState(!1),l=Ne.useRef(null),[u,d]=Ne.useState({width:0,height:0});Ne.useEffect(()=>{const _=v=>{(v.key==="h"||v.key==="H")&&a(m=>!m)};return window.addEventListener("keydown",_),()=>window.removeEventListener("keydown",_)},[]),Ne.useEffect(()=>{const _=l.current,v=_.getBoundingClientRect();Ee.VIEWPORT_SCALE=qm(v.width),d({width:v.width,height:v.height});const m=new ResizeObserver(([c])=>{const{width:g,height:x}=c.contentRect;Ee.VIEWPORT_SCALE=qm(g),d({width:g,height:x})});return m.observe(_),()=>m.disconnect()},[]);const h=gR(t,u.width,u.height,n,r);Ne.useEffect(()=>{const _=v=>{v.key==="fb-nav"&&v.newValue&&h.byId.has(v.newValue)&&e(v.newValue)};return window.addEventListener("storage",_),()=>window.removeEventListener("storage",_)},[h.byId]);const f=_=>{const v=_.id===t?_.parentId:_.id;if(v){e(v);try{localStorage.setItem("fb-nav",v)}catch{}}},p=[t,...Ui(t,h.byId)].reverse().map(_=>h.byId.get(_).label);return J.jsxs("div",{className:`stage ${o?"bare":""}`,ref:l,onMouseMove:_=>{h.pointer.x=_.clientX,h.pointer.y=_.clientY},onMouseLeave:()=>{h.pointer.x=null,h.pointer.y=null},children:[u.width>0&&(n==="reveal"?J.jsx(xA,{byId:h.byId,activeId:t,width:u.width,height:u.height,onNavigate:f}):n==="focus"?J.jsx(pA,{sim:h,activeId:t,width:u.width,height:u.height,onNavigate:f}):n==="rings"?J.jsx(gA,{sim:h,activeId:t,width:u.width,height:u.height,onNavigate:f}):n==="weight"?J.jsx(vA,{sim:h,activeId:t,width:u.width,onNavigate:f}):J.jsx(HS,{width:u.width,height:u.height,sim:h,activeId:t,mode:n,onNavigate:f})),J.jsx(yA,{onTune:()=>s(_=>_+1)}),J.jsxs("header",{className:"chrome top",children:[J.jsx("span",{className:"wordmark",children:"NEVVERLAND"}),J.jsx("span",{className:"trail",children:p.join("  /  ")})]}),J.jsxs("footer",{className:"chrome bottom",children:[J.jsx("span",{className:"hint",children:"CLICK TO GO DEEPER — CLICK THE SPACE TO GO BACK — H FOR CLEAN VIEW"}),J.jsx("span",{className:"switch",children:vR.map(_=>J.jsx("button",{className:n===_.key?"on":"",onClick:()=>i(_.key),children:_.label},_.key))})]})]})}Ec.createRoot(document.getElementById("root")).render(J.jsx(Ev.StrictMode,{children:J.jsx(xR,{})}));
