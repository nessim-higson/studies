 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(F,X){var $=F.length;F.push(X);e:for(;0<$;){var te=$-1>>>1,fe=F[te];if(0<r(fe,X))F[te]=X,F[$]=fe,$=te;else break e}}function n(F){return F.length===0?null:F[0]}function i(F){if(F.length===0)return null;var X=F[0],$=F.pop();if($!==X){F[0]=$;e:for(var te=0,fe=F.length,Ve=fe>>>1;te<Ve;){var We=2*(te+1)-1,Le=F[We],K=We+1,de=F[K];if(0>r(Le,$))K<fe&&0>r(de,Le)?(F[te]=de,F[K]=$,te=K):(F[te]=Le,F[We]=$,te=We);else if(K<fe&&0>r(de,$))F[te]=de,F[K]=$,te=K;else break e}}return X}function r(F,X){var $=F.sortIndex-X.sortIndex;return $!==0?$:F.id-X.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],d=1,h=null,f=3,p=!1,_=!1,v=!1,m=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function x(F){for(var X=n(u);X!==null;){if(X.callback===null)i(u);else if(X.startTime<=F)i(u),X.sortIndex=X.expirationTime,e(l,X);else break;X=n(u)}}function y(F){if(v=!1,x(F),!_)if(n(l)!==null)_=!0,k(R);else{var X=n(u);X!==null&&O(y,X.startTime-F)}}function R(F,X){_=!1,v&&(v=!1,c(S),S=-1),p=!0;var $=f;try{for(x(X),h=n(l);h!==null&&(!(h.expirationTime>X)||F&&!w());){var te=h.callback;if(typeof te=="function"){h.callback=null,f=h.priorityLevel;var fe=te(h.expirationTime<=X);X=t.unstable_now(),typeof fe=="function"?h.callback=fe:h===n(l)&&i(l),x(X)}else i(l);h=n(l)}if(h!==null)var Ve=!0;else{var We=n(u);We!==null&&O(y,We.startTime-X),Ve=!1}return Ve}finally{h=null,f=$,p=!1}}var T=!1,A=null,S=-1,b=5,P=-1;function w(){return!(t.unstable_now()-P<b)}function L(){if(A!==null){var F=t.unstable_now();P=F;var X=!0;try{X=A(!0,F)}finally{X?z():(T=!1,A=null)}}else T=!1}var z;if(typeof g=="function")z=function(){g(L)};else if(typeof MessageChannel<"u"){var Y=new MessageChannel,D=Y.port2;Y.port1.onmessage=L,z=function(){D.postMessage(null)}}else z=function(){m(L,0)};function k(F){A=F,T||(T=!0,z())}function O(F,X){S=m(function(){F(t.unstable_now())},X)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(F){F.callback=null},t.unstable_continueExecution=function(){_||p||(_=!0,k(R))},t.unstable_forceFrameRate=function(F){0>F||125<F?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):b=0<F?Math.floor(1e3/F):5},t.unstable_getCurrentPriorityLevel=function(){return f},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(F){switch(f){case 1:case 2:case 3:var X=3;break;default:X=f}var $=f;f=X;try{return F()}finally{f=$}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(F,X){switch(F){case 1:case 2:case 3:case 4:case 5:break;default:F=3}var $=f;f=F;try{return X()}finally{f=$}},t.unstable_scheduleCallback=function(F,X,$){var te=t.unstable_now();switch(typeof $=="object"&&$!==null?($=$.delay,$=typeof $=="number"&&0<$?te+$:te):$=te,F){case 1:var fe=-1;break;case 2:fe=250;break;case 5:fe=1073741823;break;case 4:fe=1e4;break;default:fe=5e3}return fe=$+fe,F={id:d++,callback:X,priorityLevel:F,startTime:$,expirationTime:fe,sortIndex:-1},$>te?(F.sortIndex=$,e(u,F),n(l)===null&&F===n(u)&&(v?(c(S),S=-1):v=!0,O(y,$-te))):(F.sortIndex=fe,e(l,F),_||p||(_=!0,k(R))),F},t.unstable_shouldYield=w,t.unstable_wrapCallback=function(F){var X=f;return function(){var $=f;f=X;try{return F.apply(this,arguments)}finally{f=$}}}})(ug);lg.exports=ug;var bv=lg.exports;/**
 * @license React
...
void main() {
	...
	`}class B_ extends fi{constructor(e=1,n={}){super(e,e,n),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},r=[i,i,i,i,i,i];this.texture=new D_(r),this._setTextureOptions(n),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,n){this.texture.type=n.type,this.texture.colorSpace=n.colorSpace,this.texture.generateMipmaps=n.generateMipmaps,this.texture.minFilter=n.minFilter,this.texture.magFilter=n.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),u=new pi(a,l),d=new vh(-1,1,1,-1,0,1);let h=null,f=null,p=!1,_,v=null,m=[],c=!1;this.setSize=function(g,x){s.setSize(g,x),o.setSize(g,x);for(let y=0;y<m.length;y++){const R=m[y];R.setSize&&R.setSize(g,x)}},this.setEffects=function(g){m=g,c=m.length>0&&m[0].isRenderPass===!0;const x=s.width,y=s.height;for(let R=0;R<m.length;R++){const T=m[R];T.setSize&&T.setSize(x,y)}},this.begin=function(g,x){if(p||g.toneMapping===ci&&m.length===0)return!1;if(v=x,x!==null){const y=x.width,R=x.height;(s.width!==y||s.height!==R)&&this.setSize(y,R)}return c===!1&&g.setRenderTarget(s),_=g.toneMapping,g.toneMapping=ci,!0},this.hasRenderPass=function(){return c},this.end=function(g,x){g.toneMapping=_,p=!0;let y=s,R=o;for(let T=0;T<m.length;T++){const A=m[T];if(A.enabled!==!1&&(A.render(g,R,y,x),A.needsSwap!==!1)){const S=y;y=R,R=S}}if(h!==g.outputColorSpace||f!==g.toneMapping){h=g.outputColorSpace,f=g.toneMapping,l.defines={},Ye.getTransfer(h)===Je&&(l.defines.SRGB_TRANSFER="");const T=f1[f];T&&(l.defines[T]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=y.texture,g.setRenderTarget(v),g.render(u,d),v=null,p=!1},this.isCompositing=function(){return p},this.dispose=function(){s.depthTexture&&s.depthTexture.dispose(),s.dispose(),o.dispose(),a.dispose(),l.dispose()}}const z_=new jt,od=new Vs(1,1),V_=new A_,H_=new Py,G_=new D_,wm=[],Am=[],Rm=new Float32Array(16),Cm=new Float32Array(9),bm=new Float32Array(4);function $s(t,e,n){const i=t[0];if(i<=0||i>0)return t;const r=e*n;let s=wm[r];if(s===void 0&&(s=new Float32Array(r),wm[r]=s),e!==0){i.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=n,t[o].toArray(s,a)}return s}function Ot(t,e){if(t.length!==e.length)return!1;for(let n=0,i=t.length;n<i;n++)if(t[n]!==e[n])return!1;return!0}function kt(t,e){for(let n=0,i=e.length;n<i;n++)t[n]=e[n]}function du(t,e){let n=Am[e];n===void 0&&(n=new Int32Array(e),Am[e]=n);for(let i=0;i!==e;++i)n[i]=t.allocateTextureUnit();return n}function h1(t,e){const n=this.cache;n[0]!==e&&(t.uniform1f(this.addr,e),n[0]=e)}function p1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2f(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Ot(n,e))return;t.uniform2fv(this.addr,e),kt(n,e)}}function m1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3f(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else if(e.r!==void 0)(n[0]!==e.r||n[1]!==e.g||n[2]!==e.b)&&(t.uniform3f(this.addr,e.r,e.g,e.b),n[0]=e.r,n[1]=e.g,n[2]=e.b);else{if(Ot(n,e))return;t.uniform3fv(this.addr,e),kt(n,e)}}function g1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4f(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Ot(n,e))return;t.uniform4fv(this.addr,e),kt(n,e)}}function _1(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(Ot(n,e))return;t.uniformMatrix2fv(this.addr,!1,e),kt(n,e)}else{if(Ot(n,i))return;bm.set(i),t.uniformMatrix2fv(this.addr,!1,bm),kt(n,i)}}function v1(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(Ot(n,e))return;t.uniformMatrix3fv(this.addr,!1,e),kt(n,e)}else{if(Ot(n,i))return;Cm.set(i),t.uniformMatrix3fv(this.addr,!1,Cm),kt(n,i)}}function x1(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(Ot(n,e))return;t.uniformMatrix4fv(this.addr,!1,e),kt(n,e)}else{if(Ot(n,i))return;Rm.set(i),t.uniformMatrix4fv(this.addr,!1,Rm),kt(n,i)}}function S1(t,e){const n=this.cache;n[0]!==e&&(t.uniform1i(this.addr,e),n[0]=e)}function y1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2i(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Ot(n,e))return;t.uniform2iv(this.addr,e),kt(n,e)}}function M1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3i(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else{if(Ot(n,e))return;t.uniform3iv(this.addr,e),kt(n,e)}}function E1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4i(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Ot(n,e))return;t.uniform4iv(this.addr,e),kt(n,e)}}function T1(t,e){const n=this.cache;n[0]!==e&&(t.uniform1ui(this.addr,e),n[0]=e)}function w1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2ui(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Ot(n,e))return;t.uniform2uiv(this.addr,e),kt(n,e)}}function A1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3ui(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else{if(Ot(n,e))return;t.uniform3uiv(this.addr,e),kt(n,e)}}function R1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4ui(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Ot(n,e))return;t.uniform4uiv(this.addr,e),kt(n,e)}}function C1(t,e,n){const i=this.cache,r=n.allocateTextureUnit();i[0]!==r&&(t.uniform1i(this.addr,r),i[0]=r);let s;this.type===t.SAMPLER_2D_SHADOW?(od.compareFunction=n.isReversedDepthBuffer()?ph:hh,s=od):s=z_,n.setTexture2D(e||s,r)}function b1(t,e,n){const i=this.cache,r=n.allocateTextureUnit();i[0]!==r&&(t.uniform1i(this.addr,r),i[0]=r),n.setTexture3D(e||H_,r)}function P1(t,e,n){const i=this.cache,r=n.allocateTextureUnit();i[0]!==r&&(t.uniform1i(this.addr,r),i[0]=r),n.setTextureCube(e||G_,r)}function L1(t,e,n){const i=this.cache,r=n.allocateTextureUnit();i[0]!==r&&(t.uniform1i(this.addr,r),i[0]=r),n.setTexture2DArray(e||V_,r)}function N1(t){switch(t){case 5126:return h1;case 35664:return p1;case 35665:return m1;case 35666:return g1;case 35674:return _1;case 35675:return v1;case 35676:return x1;case 5124:case 35670:return S1;case 35667:case 35671:return y1;case 35668:case 35672:return M1;case 35669:case 35673:return E1;case 5125:return T1;case 36294:return w1;case 36295:return A1;case 36296:return R1;case 35678:case 36198:case 36298:case 36306:case 35682:return C1;case 35679:case 36299:case 36307:return b1;case 35680:case 36300:case 36308:case 36293:return P1;case 36289:case 36303:case 36311:case 36292:return L1}}function D1(t,e){t.uniform1fv(this.addr,e)}function I1(t,e){const n=$s(e,this.size,2);t.uniform2fv(this.addr,n)}function U1(t,e){const n=$s(e,this.size,3);t.uniform3fv(this.addr,n)}function F1(t,e){const n=$s(e,this.size,4);t.uniform4fv(this.addr,n)}function O1(t,e){const n=$s(e,this.size,4);t.uniformMatrix2fv(this.addr,!1,n)}function k1(t,e){const n=$s(e,this.size,9);t.uniformMatrix3fv(this.addr,!1,n)}function B1(t,e){const n=$s(e,this.size,16);t.uniformMatrix4fv(this.addr,!1,n)}function z1(t,e){t.uniform1iv(this.addr,e)}function V1(t,e){t.uniform2iv(this.addr,e)}function H1(t,e){t.uniform3iv(this.addr,e)}function G1(t,e){t.uniform4iv(this.addr,e)}function W1(t,e){t.uniform1uiv(this.addr,e)}function X1(t,e){t.uniform2uiv(this.addr,e)}function j1(t,e){t.uniform3uiv(this.addr,e)}function Y1(t,e){t.uniform4uiv(this.addr,e)}function $1(t,e,n){const i=this.cache,r=e.length,s=du(n,r);Ot(i,s)||(t.uniform1iv(this.addr,s),kt(i,s));let o;this.type===t.SAMPLER_2D_SHADOW?o=od:o=z_;for(let a=0;a!==r;++a)n.setTexture2D(e[a]||o,s[a])}function q1(t,e,n){const i=this.cache,r=e.length,s=du(n,r);Ot(i,s)||(t.uniform1iv(this.addr,s),kt(i,s));for(let o=0;o!==r;++o)n.setTexture3D(e[o]||H_,s[o])}function K1(t,e,n){const i=this.cache,r=e.length,s=du(n,r);Ot(i,s)||(t.uniform1iv(this.addr,s),kt(i,s));for(let o=0;o!==r;++o)n.setTextureCube(e[o]||G_,s[o])}function Z1(t,e,n){const i=this.cache,r=e.length,s=du(n,r);Ot(i,s)||(t.uniform1iv(this.addr,s),kt(i,s));for(let o=0;o!==r;++o)n.setTexture2DArray(e[o]||V_,s[o])}function Q1(t){switch(t){case 5126:return D1;case 35664:return I1;case 35665:return U1;case 35666:return F1;case 35674:return O1;case 35675:return k1;case 35676:return B1;case 5124:case 35670:return z1;case 35667:case 35671:return V1;case 35668:case 35672:return H1;case 35669:case 35673:return G1;case 5125:return W1;case 36294:return X1;case 36295:return j1;case 36296:return Y1;case 35678:case 36198:case 36298:case 36306:case 35682:return $1;case 35679:case 36299:case 36307:return q1;case 35680:case 36300:case 36308:case 36293:return K1;case 36289:case 36303:case 36311:case 36292:return Z1}}class J1{constructor(e,n,i){this.id=e,this.addr=i,this.cache=[],this.type=n.type,this.setValue=N1(n.type)}}class ew{constructor(e,n,i){this.id=e,this.addr=i,this.cache=[],this.type=n.type,this.size=n.size,this.setValue=Q1(n.type)}}class tw{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,n,i){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,n[a.id],i)}}}const Sc=/(\w+)(\])?(\[|\.)?/g;function Pm(t,e){t.seq.push(e),t.map[e.id]=e}function nw(t,e,n){const i=t.name,r=i.length;for(Sc.lastIndex=0;;){const s=Sc.exec(i),o=Sc.lastIndex;let a=s[1];const l=s[2]==="]",u=s[3];if(l&&(a=a|0),u===void 0||u==="["&&o+2===r){Pm(n,u===void 0?new J1(a,t,e):new ew(a,t,e));break}else{let h=n.map[a];h===void 0&&(h=new tw(a),Pm(n,h)),n=h}}}class hl{constructor(e,n){this.seq=[],this.map={};const i=e.getProgramParameter(n,e.ACTIVE_UNIFORMS);for(let o=0;o<i;++o){const a=e.getActiveUniform(n,o),l=e.getUniformLocation(n,a.name);nw(a,l,this)}const r=[],s=[];for(const o of this.seq)o.type===e.SAMPLER_2D_SHADOW||o.type===e.SAMPLER_CUBE_SHADOW||o.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(o):s.push(o);r.length>0&&(this.seq=r.concat(s))}setValue(e,n,i,r){const s=this.map[n];s!==void 0&&s.setValue(e,i,r)}setOptional(e,n,i){const r=n[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,n,i,r){for(let s=0,o=n.length;s!==o;++s){const a=n[s],l=i[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,r)}}static seqWithValue(e,n){const i=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in n&&i.push(o)}return i}}function Lm(t,e,n){const i=t.createShader(e);return t.shaderSource(i,n),t.compileShader(i),i}const iw=37297;let rw=0;function sw(t,e){const n=t.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,n.length);for(let o=r;o<s;o++){const a=o+1;i.push(`${a===e?">":" "} ${a}: ${n[o]}`)}return i.join(`
`)}const Nm=new Ie;function ow(t){Ye._getMatrix(Nm,Ye.workingColorSpace,t);const e=`mat3( ${Nm.elements.map(n=>n.toFixed(4))} )`;switch(Ye.getTransfer(t)){case Hl:return[e,"LinearTransferOETF"];case Je:return[e,"sRGBTransferOETF"];default:return Pe("WebGLProgram: Unsupported color space: ",t),[e,"LinearTransferOETF"]}}function Dm(t,e,n){const i=t.getShaderParameter(e,t.COMPILE_STATUS),s=(t.getShaderInfoLog(e)||"").trim();if(i&&s==="")return"";const o=/ERROR: 0:(\d+)/.exec(s);if(o){const a=parseInt(o[1]);return n.toUpperCase()+`
...
`)+`
`+c);const x=g+m+o,y=g+c+a,R=Lm(r,r.VERTEX_SHADER,x),T=Lm(r,r.FRAGMENT_SHADER,y);r.attachShader(v,R),r.attachShader(v,T),n.index0AttributeName!==void 0?r.bindAttribLocation(v,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function A(w){if(t.debug.checkShaderErrors){const L=r.getProgramInfoLog(v)||"",z=r.getShaderInfoLog(R)||"",Y=r.getShaderInfoLog(T)||"",D=L.trim(),k=z.trim(),O=Y.trim();let F=!0,X=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(F=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,v,R,T);else{const $=Dm(r,R,"vertex"),te=Dm(r,T,"fragment");Ke("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
...
}`,Xw=[new G(1,0,0),new G(-1,0,0),new G(0,1,0),new G(0,-1,0),new G(0,0,1),new G(0,0,-1)],jw=[new G(0,-1,0),new G(0,-1,0),new G(0,0,1),new G(0,0,-1),new G(0,-1,0),new G(0,-1,0)],Vm=new Ft,uo=new G,yc=new G;function Yw(t,e,n){let i=new N_;const r=new st,s=new st,o=new Rt,a=new nM,l=new iM,u={},d=n.maxTextureSize,h={[pr]:gn,[gn]:pr,[Ei]:Ei},f=new Zn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new st},radius:{value:4}},vertexShader:Gw,fragmentShader:Ww}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const _=new ki;_.setAttribute("position",new di(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new pi(_,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ll;let c=this.type;this.render=function(T,A,S){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||T.length===0)return;this.type===WS&&(Pe("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=ll);const b=t.getRenderTarget(),P=t.getActiveCubeFace(),w=t.getActiveMipmapLevel(),L=t.state;L.setBlending(Ci),L.buffers.depth.getReversed()===!0?L.buffers.color.setClear(0,0,0,0):L.buffers.color.setClear(1,1,1,1),L.buffers.depth.setTest(!0),L.setScissorTest(!1);const z=c!==this.type;z&&A.traverse(function(Y){Y.material&&(Array.isArray(Y.material)?Y.material.forEach(D=>D.needsUpdate=!0):Y.material.needsUpdate=!0)});for(let Y=0,D=T.length;Y<D;Y++){const k=T[Y],O=k.shadow;if(O===void 0){Pe("WebGLShadowMap:",k,"has no shadow.");continue}if(O.autoUpdate===!1&&O.needsUpdate===!1)continue;r.copy(O.mapSize);const F=O.getFrameExtents();r.multiply(F),s.copy(O.mapSize),(r.x>d||r.y>d)&&(r.x>d&&(s.x=Math.floor(d/F.x),r.x=s.x*F.x,O.mapSize.x=s.x),r.y>d&&(s.y=Math.floor(d/F.y),r.y=s.y*F.y,O.mapSize.y=s.y));const X=t.state.buffers.depth.getReversed();if(O.camera._reversedDepth=X,O.map===null||z===!0){if(O.map!==null&&(O.map.depthTexture!==null&&(O.map.depthTexture.dispose(),O.map.depthTexture=null),O.map.dispose()),this.type===go){if(k.isPointLight){Pe("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}O.map=new fi(r.x,r.y,{format:Hr,type:Ui,minFilter:Vt,magFilter:Vt,generateMipmaps:!1}),O.map.texture.name=k.name+".shadowMap",O.map.depthTexture=new Vs(r.x,r.y,oi),O.map.depthTexture.name=k.name+".shadowMapDepth",O.map.depthTexture.format=Fi,O.map.depthTexture.compareFunction=null,O.map.depthTexture.minFilter=Wt,O.map.depthTexture.magFilter=Wt}else k.isPointLight?(O.map=new B_(r.x),O.map.depthTexture=new Ky(r.x,hi)):(O.map=new fi(r.x,r.y),O.map.depthTexture=new Vs(r.x,r.y,hi)),O.map.depthTexture.name=k.name+".shadowMap",O.map.depthTexture.format=Fi,this.type===ll?(O.map.depthTexture.compareFunction=X?ph:hh,O.map.depthTexture.minFilter=Vt,O.map.depthTexture.magFilter=Vt):(O.map.depthTexture.compareFunction=null,O.map.depthTexture.minFilter=Wt,O.map.depthTexture.magFilter=Wt);O.camera.updateProjectionMatrix()}const $=O.map.isWebGLCubeRenderTarget?6:1;for(let te=0;te<$;te++){if(O.map.isWebGLCubeRenderTarget)t.setRenderTarget(O.map,te),t.clear();else{te===0&&(t.setRenderTarget(O.map),t.clear());const fe=O.getViewport(te);o.set(s.x*fe.x,s.y*fe.y,s.x*fe.z,s.y*fe.w),L.viewport(o)}if(k.isPointLight){const fe=O.camera,Ve=O.matrix,We=k.distance||fe.far;We!==fe.far&&(fe.far=We,fe.updateProjectionMatrix()),uo.setFromMatrixPosition(k.matrixWorld),fe.position.copy(uo),yc.copy(fe.position),yc.add(Xw[te]),fe.up.copy(jw[te]),fe.lookAt(yc),fe.updateMatrixWorld(),Ve.makeTranslation(-uo.x,-uo.y,-uo.z),Vm.multiplyMatrices(fe.projectionMatrix,fe.matrixWorldInverse),O._frustum.setFromProjectionMatrix(Vm,fe.coordinateSystem,fe.reversedDepth)}else O.updateMatrices(k);i=O.getFrustum(),y(A,S,O.camera,k,this.type)}O.isPointLightShadow!==!0&&this.type===go&&g(O,S),O.needsUpdate=!1}c=this.type,m.needsUpdate=!1,t.setRenderTarget(b,P,w)};function g(T,A){const S=e.update(v);f.defines.VSM_SAMPLES!==T.blurSamples&&(f.defines.VSM_SAMPLES=T.blurSamples,p.defines.VSM_SAMPLES=T.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new fi(r.x,r.y,{format:Hr,type:Ui})),f.uniforms.shadow_pass.value=T.map.depthTexture,f.uniforms.resolution.value=T.mapSize,f.uniforms.radius.value=T.radius,t.setRenderTarget(T.mapPass),t.clear(),t.renderBufferDirect(A,null,S,f,v,null),p.uniforms.shadow_pass.value=T.mapPass.texture,p.uniforms.resolution.value=T.mapSize,p.uniforms.radius.value=T.radius,t.setRenderTarget(T.map),t.clear(),t.renderBufferDirect(A,null,S,p,v,null)}function x(T,A,S,b){let P=null;const w=S.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(w!==void 0)P=w;else if(P=S.isPointLight===!0?l:a,t.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0||A.alphaToCoverage===!0){const L=P.uuid,z=A.uuid;let Y=u[L];Y===void 0&&(Y={},u[L]=Y);let D=Y[z];D===void 0&&(D=P.clone(),Y[z]=D,A.addEventListener("dispose",R)),P=D}if(P.visible=A.visible,P.wireframe=A.wireframe,b===go?P.side=A.shadowSide!==null?A.shadowSide:A.side:P.side=A.shadowSide!==null?A.shadowSide:h[A.side],P.alphaMap=A.alphaMap,P.alphaTest=A.alphaToCoverage===!0?.5:A.alphaTest,P.map=A.map,P.clipShadows=A.clipShadows,P.clippingPlanes=A.clippingPlanes,P.clipIntersection=A.clipIntersection,P.displacementMap=A.displacementMap,P.displacementScale=A.displacementScale,P.displacementBias=A.displacementBias,P.wireframeLinewidth=A.wireframeLinewidth,P.linewidth=A.linewidth,S.isPointLight===!0&&P.isMeshDistanceMaterial===!0){const L=t.properties.get(P);L.light=S}return P}function y(T,A,S,b,P){if(T.visible===!1)return;if(T.layers.test(A.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&P===go)&&(!T.frustumCulled||i.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(S.matrixWorldInverse,T.matrixWorld);const z=e.update(T),Y=T.material;if(Array.isArray(Y)){const D=z.groups;for(let k=0,O=D.length;k<O;k++){const F=D[k],X=Y[F.materialIndex];if(X&&X.visible){const $=x(T,X,b,P);T.onBeforeShadow(t,T,A,S,z,$,F),t.renderBufferDirect(S,null,z,$,T,F),T.onAfterShadow(t,T,A,S,z,$,F)}}}else if(Y.visible){const D=x(T,Y,b,P);T.onBeforeShadow(t,T,A,S,z,D,null),t.renderBufferDirect(S,null,z,D,T,null),T.onAfterShadow(t,T,A,S,z,D,null)}}const L=T.children;for(let z=0,Y=L.length;z<Y;z++)y(L[z],A,S,b,P)}function R(T){T.target.removeEventListener("dispose",R);for(const S in u){const b=u[S],P=T.target.uuid;P in b&&(b[P].dispose(),delete b[P])}}}function $w(t,e){function n(){let N=!1;const se=new Rt;let q=null;const ve=new Rt(0,0,0,0);return{setMask:function(le){q!==le&&!N&&(t.colorMask(le,le,le,le),q=le)},setLocked:function(le){N=le},setClear:function(le,J,we,Ue,Et){Et===!0&&(le*=Ue,J*=Ue,we*=Ue),se.set(le,J,we,Ue),ve.equals(se)===!1&&(t.clearColor(le,J,we,Ue),ve.copy(se))},reset:function(){N=!1,q=null,ve.set(-1,0,0,0)}}}function i(){let N=!1,se=!1,q=null,ve=null,le=null;return{setReversed:function(J){if(se!==J){const we=e.get("EXT_clip_control");J?we.clipControlEXT(we.LOWER_LEFT_EXT,we.ZERO_TO_ONE_EXT):we.clipControlEXT(we.LOWER_LEFT_EXT,we.NEGATIVE_ONE_TO_ONE_EXT),se=J;const Ue=le;le=null,this.setClear(Ue)}},getReversed:function(){return se},setTest:function(J){J?oe(t.DEPTH_TEST):Ce(t.DEPTH_TEST)},setMask:function(J){q!==J&&!N&&(t.depthMask(J),q=J)},setFunc:function(J){if(se&&(J=Ey[J]),ve!==J){switch(J){case xf:t.depthFunc(t.NEVER);break;case Sf:t.depthFunc(t.ALWAYS);break;case yf:t.depthFunc(t.LESS);break;case Bs:t.depthFunc(t.LEQUAL);break;case Mf:t.depthFunc(t.EQUAL);break;case Ef:t.depthFunc(t.GEQUAL);break;case Tf:t.depthFunc(t.GREATER);break;case wf:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}ve=J}},setLocked:function(J){N=J},setClear:function(J){le!==J&&(le=J,se&&(J=1-J),t.clearDepth(J))},reset:function(){N=!1,q=null,ve=null,le=null,se=!1}}}function r(){let N=!1,se=null,q=null,ve=null,le=null,J=null,we=null,Ue=null,Et=null;return{setTest:function(nt){N||(nt?oe(t.STENCIL_TEST):Ce(t.STENCIL_TEST))},setMask:function(nt){se!==nt&&!N&&(t.stencilMask(nt),se=nt)},setFunc:function(nt,mi,Qn){(q!==nt||ve!==mi||le!==Qn)&&(t.stencilFunc(nt,mi,Qn),q=nt,ve=mi,le=Qn)},setOp:function(nt,mi,Qn){(J!==nt||we!==mi||Ue!==Qn)&&(t.stencilOp(nt,mi,Qn),J=nt,we=mi,Ue=Qn)},setLocked:function(nt){N=nt},setClear:function(nt){Et!==nt&&(t.clearStencil(nt),Et=nt)},reset:function(){N=!1,se=null,q=null,ve=null,le=null,J=null,we=null,Ue=null,Et=null}}}const s=new n,o=new i,a=new r,l=new WeakMap,u=new WeakMap;let d={},h={},f={},p=new WeakMap,_=[],v=null,m=!1,c=null,g=null,x=null,y=null,R=null,T=null,A=null,S=new rt(0,0,0),b=0,P=!1,w=null,L=null,z=null,Y=null,D=null;const k=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let O=!1,F=0;const X=t.getParameter(t.VERSION);X.indexOf("WebGL")!==-1?(F=parseFloat(/^WebGL (\d)/.exec(X)[1]),O=F>=1):X.indexOf("OpenGL ES")!==-1&&(F=parseFloat(/^OpenGL ES (\d)/.exec(X)[1]),O=F>=2);let $=null,te={};const fe=t.getParameter(t.SCISSOR_BOX),Ve=t.getParameter(t.VIEWPORT),We=new Rt().fromArray(fe),Le=new Rt().fromArray(Ve);function K(N,se,q,ve){const le=new Uint8Array(4),J=t.createTexture();t.bindTexture(N,J),t.texParameteri(N,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(N,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let we=0;we<q;we++)N===t.TEXTURE_3D||N===t.TEXTURE_2D_ARRAY?t.texImage3D(se,0,t.RGBA,1,1,ve,0,t.RGBA,t.UNSIGNED_BYTE,le):t.texImage2D(se+we,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,le);return J}const de={};de[t.TEXTURE_2D]=K(t.TEXTURE_2D,t.TEXTURE_2D,1),de[t.TEXTURE_CUBE_MAP]=K(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),de[t.TEXTURE_2D_ARRAY]=K(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),de[t.TEXTURE_3D]=K(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),oe(t.DEPTH_TEST),o.setFunc(Bs),Lt(!1),gt(Gp),oe(t.CULL_FACE),ft(Ci);function oe(N){d[N]!==!0&&(t.enable(N),d[N]=!0)}function Ce(N){d[N]!==!1&&(t.disable(N),d[N]=!1)}function De(N,se){return f[N]!==se?(t.bindFramebuffer(N,se),f[N]=se,N===t.DRAW_FRAMEBUFFER&&(f[t.FRAMEBUFFER]=se),N===t.FRAMEBUFFER&&(f[t.DRAW_FRAMEBUFFER]=se),!0):!1}function be(N,se){let q=_,ve=!1;if(N){q=p.get(se),q===void 0&&(q=[],p.set(se,q));const le=N.textures;if(q.length!==le.length||q[0]!==t.COLOR_ATTACHMENT0){for(let J=0,we=le.length;J<we;J++)q[J]=t.COLOR_ATTACHMENT0+J;q.length=le.length,ve=!0}}else q[0]!==t.BACK&&(q[0]=t.BACK,ve=!0);ve&&t.drawBuffers(q)}function mt(N){return v!==N?(t.useProgram(N),v=N,!0):!1}const Xe={[Ar]:t.FUNC_ADD,[jS]:t.FUNC_SUBTRACT,[YS]:t.FUNC_REVERSE_SUBTRACT};Xe[$S]=t.MIN,Xe[qS]=t.MAX;const tt={[KS]:t.ZERO,[ZS]:t.ONE,[QS]:t.SRC_COLOR,[_f]:t.SRC_ALPHA,[ry]:t.SRC_ALPHA_SATURATE,[ny]:t.DST_COLOR,[ey]:t.DST_ALPHA,[JS]:t.ONE_MINUS_SRC_COLOR,[vf]:t.ONE_MINUS_SRC_ALPHA,[iy]:t.ONE_MINUS_DST_COLOR,[ty]:t.ONE_MINUS_DST_ALPHA,[sy]:t.CONSTANT_COLOR,[oy]:t.ONE_MINUS_CONSTANT_COLOR,[ay]:t.CONSTANT_ALPHA,[ly]:t.ONE_MINUS_CONSTANT_ALPHA};function ft(N,se,q,ve,le,J,we,Ue,Et,nt){if(N===Ci){m===!0&&(Ce(t.BLEND),m=!1);return}if(m===!1&&(oe(t.BLEND),m=!0),N!==XS){if(N!==c||nt!==P){if((g!==Ar||R!==Ar)&&(t.blendEquation(t.FUNC_ADD),g=Ar,R=Ar),nt)switch(N){case Ps:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Wp:t.blendFunc(t.ONE,t.ONE);break;case Xp:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case jp:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:Ke("WebGLState: Invalid blending: ",N);break}else switch(N){case Ps:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Wp:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case Xp:Ke("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case jp:Ke("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ke("WebGLState: Invalid blending: ",N);break}x=null,y=null,T=null,A=null,S.set(0,0,0),b=0,c=N,P=nt}return}le=le||se,J=J||q,we=we||ve,(se!==g||le!==R)&&(t.blendEquationSeparate(Xe[se],Xe[le]),g=se,R=le),(q!==x||ve!==y||J!==T||we!==A)&&(t.blendFuncSeparate(tt[q],tt[ve],tt[J],tt[we]),x=q,y=ve,T=J,A=we),(Ue.equals(S)===!1||Et!==b)&&(t.blendColor(Ue.r,Ue.g,Ue.b,Et),S.copy(Ue),b=Et),c=N,P=!1}function He(N,se){N.side===Ei?Ce(t.CULL_FACE):oe(t.CULL_FACE);let q=N.side===gn;se&&(q=!q),Lt(q),N.blending===Ps&&N.transparent===!1?ft(Ci):ft(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),o.setFunc(N.depthFunc),o.setTest(N.depthTest),o.setMask(N.depthWrite),s.setMask(N.colorWrite);const ve=N.stencilWrite;a.setTest(ve),ve&&(a.setMask(N.stencilWriteMask),a.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),a.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),I(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?oe(t.SAMPLE_ALPHA_TO_COVERAGE):Ce(t.SAMPLE_ALPHA_TO_COVERAGE)}function Lt(N){w!==N&&(N?t.frontFace(t.CW):t.frontFace(t.CCW),w=N)}function gt(N){N!==HS?(oe(t.CULL_FACE),N!==L&&(N===Gp?t.cullFace(t.BACK):N===GS?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):Ce(t.CULL_FACE),L=N}function _n(N){N!==z&&(O&&t.lineWidth(N),z=N)}function I(N,se,q){N?(oe(t.POLYGON_OFFSET_FILL),(Y!==se||D!==q)&&(Y=se,D=q,o.getReversed()&&(se=-se),t.polygonOffset(se,q))):Ce(t.POLYGON_OFFSET_FILL)}function Nt(N){N?oe(t.SCISSOR_TEST):Ce(t.SCISSOR_TEST)}function je(N){N===void 0&&(N=t.TEXTURE0+k-1),$!==N&&(t.activeTexture(N),$=N)}function lt(N,se,q){q===void 0&&($===null?q=t.TEXTURE0+k-1:q=$);let ve=te[q];ve===void 0&&(ve={type:void 0,texture:void 0},te[q]=ve),(ve.type!==N||ve.texture!==se)&&($!==q&&(t.activeTexture(q),$=q),t.bindTexture(N,se||de[N]),ve.type=N,ve.texture=se)}function he(){const N=te[$];N!==void 0&&N.type!==void 0&&(t.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function St(){try{t.compressedTexImage2D(...arguments)}catch(N){Ke("WebGLState:",N)}}function C(){try{t.compressedTexImage3D(...arguments)}catch(N){Ke("WebGLState:",N)}}function M(){try{t.texSubImage2D(...arguments)}catch(N){Ke("WebGLState:",N)}}function B(){try{t.texSubImage3D(...arguments)}catch(N){Ke("WebGLState:",N)}}function Z(){try{t.compressedTexSubImage2D(...arguments)}catch(N){Ke("WebGLState:",N)}}function ee(){try{t.compressedTexSubImage3D(...arguments)}catch(N){Ke("WebGLState:",N)}}function ie(){try{t.texStorage2D(...arguments)}catch(N){Ke("WebGLState:",N)}}function ce(){try{t.texStorage3D(...arguments)}catch(N){Ke("WebGLState:",N)}}function j(){try{t.texImage2D(...arguments)}catch(N){Ke("WebGLState:",N)}}function Q(){try{t.texImage3D(...arguments)}catch(N){Ke("WebGLState:",N)}}function _e(N){return h[N]!==void 0?h[N]:t.getParameter(N)}function Se(N,se){h[N]!==se&&(t.pixelStorei(N,se),h[N]=se)}function ae(N){We.equals(N)===!1&&(t.scissor(N.x,N.y,N.z,N.w),We.copy(N))}function re(N){Le.equals(N)===!1&&(t.viewport(N.x,N.y,N.z,N.w),Le.copy(N))}function Ne(N,se){let q=u.get(se);q===void 0&&(q=new WeakMap,u.set(se,q));let ve=q.get(N);ve===void 0&&(ve=t.getUniformBlockIndex(se,N.name),q.set(N,ve))}function Oe(N,se){const ve=u.get(se).get(N);l.get(se)!==ve&&(t.uniformBlockBinding(se,ve,N.__bindingPointIndex),l.set(se,ve))}function Qe(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),o.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),t.pixelStorei(t.PACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,!1),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.BROWSER_DEFAULT_WEBGL),t.pixelStorei(t.PACK_ROW_LENGTH,0),t.pixelStorei(t.PACK_SKIP_PIXELS,0),t.pixelStorei(t.PACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_ROW_LENGTH,0),t.pixelStorei(t.UNPACK_IMAGE_HEIGHT,0),t.pixelStorei(t.UNPACK_SKIP_PIXELS,0),t.pixelStorei(t.UNPACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_SKIP_IMAGES,0),d={},h={},$=null,te={},f={},p=new WeakMap,_=[],v=null,m=!1,c=null,g=null,x=null,y=null,R=null,T=null,A=null,S=new rt(0,0,0),b=0,P=!1,w=null,L=null,z=null,Y=null,D=null,We.set(0,0,t.canvas.width,t.canvas.height),Le.set(0,0,t.canvas.width,t.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:oe,disable:Ce,bindFramebuffer:De,drawBuffers:be,useProgram:mt,setBlending:ft,setMaterial:He,setFlipSided:Lt,setCullFace:gt,setLineWidth:_n,setPolygonOffset:I,setScissorTest:Nt,activeTexture:je,bindTexture:lt,unbindTexture:he,compressedTexImage2D:St,compressedTexImage3D:C,texImage2D:j,texImage3D:Q,pixelStorei:Se,getParameter:_e,updateUBOMapping:Ne,uniformBlockBinding:Oe,texStorage2D:ie,texStorage3D:ce,texSubImage2D:M,texSubImage3D:B,compressedTexSubImage2D:Z,compressedTexSubImage3D:ee,scissor:ae,viewport:re,reset:Qe}}function qw(t,e,n,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new st,d=new WeakMap,h=new Set;let f;const p=new WeakMap;let _=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(C,M){return _?new OffscreenCanvas(C,M):Ko("canvas")}function m(C,M,B){let Z=1;const ee=St(C);if((ee.width>B||ee.height>B)&&(Z=B/Math.max(ee.width,ee.height)),Z<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const ie=Math.floor(Z*ee.width),ce=Math.floor(Z*ee.height);f===void 0&&(f=v(ie,ce));const j=M?v(ie,ce):f;return j.width=ie,j.height=ce,j.getContext("2d").drawImage(C,0,0,ie,ce),Pe("WebGLRenderer: Texture has been resized from ("+ee.width+"x"+ee.height+") to ("+ie+"x"+ce+")."),j}else return"data"in C&&Pe("WebGLRenderer: Image in DataTexture is too big ("+ee.width+"x"+ee.height+")."),C;return C}function c(C){return C.generateMipmaps}function g(C){t.generateMipmap(C)}function x(C){return C.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:C.isWebGL3DRenderTarget?t.TEXTURE_3D:C.isWebGLArrayRenderTarget||C.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function y(C,M,B,Z,ee,ie=!1){if(C!==null){if(t[C]!==void 0)return t[C];Pe("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let ce;Z&&(ce=e.get("EXT_texture_norm16"),ce||Pe("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let j=M;if(M===t.RED&&(B===t.FLOAT&&(j=t.R32F),B===t.HALF_FLOAT&&(j=t.R16F),B===t.UNSIGNED_BYTE&&(j=t.R8),B===t.UNSIGNED_SHORT&&ce&&(j=ce.R16_EXT),B===t.SHORT&&ce&&(j=ce.R16_SNORM_EXT)),M===t.RED_INTEGER&&(B===t.UNSIGNED_BYTE&&(j=t.R8UI),B===t.UNSIGNED_SHORT&&(j=t.R16UI),B===t.UNSIGNED_INT&&(j=t.R32UI),B===t.BYTE&&(j=t.R8I),B===t.SHORT&&(j=t.R16I),B===t.INT&&(j=t.R32I)),M===t.RG&&(B===t.FLOAT&&(j=t.RG32F),B===t.HALF_FLOAT&&(j=t.RG16F),B===t.UNSIGNED_BYTE&&(j=t.RG8),B===t.UNSIGNED_SHORT&&ce&&(j=ce.RG16_EXT),B===t.SHORT&&ce&&(j=ce.RG16_SNORM_EXT)),M===t.RG_INTEGER&&(B===t.UNSIGNED_BYTE&&(j=t.RG8UI),B===t.UNSIGNED_SHORT&&(j=t.RG16UI),B===t.UNSIGNED_INT&&(j=t.RG32UI),B===t.BYTE&&(j=t.RG8I),B===t.SHORT&&(j=t.RG16I),B===t.INT&&(j=t.RG32I)),M===t.RGB_INTEGER&&(B===t.UNSIGNED_BYTE&&(j=t.RGB8UI),B===t.UNSIGNED_SHORT&&(j=t.RGB16UI),B===t.UNSIGNED_INT&&(j=t.RGB32UI),B===t.BYTE&&(j=t.RGB8I),B===t.SHORT&&(j=t.RGB16I),B===t.INT&&(j=t.RGB32I)),M===t.RGBA_INTEGER&&(B===t.UNSIGNED_BYTE&&(j=t.RGBA8UI),B===t.UNSIGNED_SHORT&&(j=t.RGBA16UI),B===t.UNSIGNED_INT&&(j=t.RGBA32UI),B===t.BYTE&&(j=t.RGBA8I),B===t.SHORT&&(j=t.RGBA16I),B===t.INT&&(j=t.RGBA32I)),M===t.RGB&&(B===t.UNSIGNED_SHORT&&ce&&(j=ce.RGB16_EXT),B===t.SHORT&&ce&&(j=ce.RGB16_SNORM_EXT),B===t.UNSIGNED_INT_5_9_9_9_REV&&(j=t.RGB9_E5),B===t.UNSIGNED_INT_10F_11F_11F_REV&&(j=t.R11F_G11F_B10F)),M===t.RGBA){const Q=ie?Hl:Ye.getTransfer(ee);B===t.FLOAT&&(j=t.RGBA32F),B===t.HALF_FLOAT&&(j=t.RGBA16F),B===t.UNSIGNED_BYTE&&(j=Q===Je?t.SRGB8_ALPHA8:t.RGBA8),B===t.UNSIGNED_SHORT&&ce&&(j=ce.RGBA16_EXT),B===t.SHORT&&ce&&(j=ce.RGBA16_SNORM_EXT),B===t.UNSIGNED_SHORT_4_4_4_4&&(j=t.RGBA4),B===t.UNSIGNED_SHORT_5_5_5_1&&(j=t.RGB5_A1)}return(j===t.R16F||j===t.R32F||j===t.RG16F||j===t.RG32F||j===t.RGBA16F||j===t.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function R(C,M){let B;return C?M===null||M===hi||M===qo?B=t.DEPTH24_STENCIL8:M===oi?B=t.DEPTH32F_STENCIL8:M===$o&&(B=t.DEPTH24_STENCIL8,Pe("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===hi||M===qo?B=t.DEPTH_COMPONENT24:M===oi?B=t.DEPTH_COMPONENT32F:M===$o&&(B=t.DEPTH_COMPONENT16),B}function T(C,M){return c(C)===!0||C.isFramebufferTexture&&C.minFilter!==Wt&&C.minFilter!==Vt?Math.log2(Math.max(M.width,M.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?M.mipmaps.length:1}function A(C){const M=C.target;M.removeEventListener("dispose",A),b(M),M.isVideoTexture&&d.delete(M),M.isHTMLTexture&&h.delete(M)}function S(C){const M=C.target;M.removeEventListener("dispose",S),w(M)}function b(C){const M=i.get(C);if(M.__webglInit===void 0)return;const B=C.source,Z=p.get(B);if(Z){const ee=Z[M.__cacheKey];ee.usedTimes--,ee.usedTimes===0&&P(C),Object.keys(Z).length===0&&p.delete(B)}i.remove(C)}function P(C){const M=i.get(C);t.deleteTexture(M.__webglTexture);const B=C.source,Z=p.get(B);delete Z[M.__cacheKey],o.memory.textures--}function w(C){const M=i.get(C);if(C.depthTexture&&(C.depthTexture.dispose(),i.remove(C.depthTexture)),C.isWebGLCubeRenderTarget)for(let Z=0;Z<6;Z++){if(Array.isArray(M.__webglFramebuffer[Z]))for(let ee=0;ee<M.__webglFramebuffer[Z].length;ee++)t.deleteFramebuffer(M.__webglFramebuffer[Z][ee]);else t.deleteFramebuffer(M.__webglFramebuffer[Z]);M.__webglDepthbuffer&&t.deleteRenderbuffer(M.__webglDepthbuffer[Z])}else{if(Array.isArray(M.__webglFramebuffer))for(let Z=0;Z<M.__webglFramebuffer.length;Z++)t.deleteFramebuffer(M.__webglFramebuffer[Z]);else t.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&t.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&t.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let Z=0;Z<M.__webglColorRenderbuffer.length;Z++)M.__webglColorRenderbuffer[Z]&&t.deleteRenderbuffer(M.__webglColorRenderbuffer[Z]);M.__webglDepthRenderbuffer&&t.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const B=C.textures;for(let Z=0,ee=B.length;Z<ee;Z++){const ie=i.get(B[Z]);ie.__webglTexture&&(t.deleteTexture(ie.__webglTexture),o.memory.textures--),i.remove(B[Z])}i.remove(C)}let L=0;function z(){L=0}function Y(){return L}function D(C){L=C}function k(){const C=L;return C>=r.maxTextures&&Pe("WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+r.maxTextures),L+=1,C}function O(C){const M=[];return M.push(C.wrapS),M.push(C.wrapT),M.push(C.wrapR||0),M.push(C.magFilter),M.push(C.minFilter),M.push(C.anisotropy),M.push(C.internalFormat),M.push(C.format),M.push(C.type),M.push(C.generateMipmaps),M.push(C.premultiplyAlpha),M.push(C.flipY),M.push(C.unpackAlignment),M.push(C.colorSpace),M.join()}function F(C,M){const B=i.get(C);if(C.isVideoTexture&&lt(C),C.isRenderTargetTexture===!1&&C.isExternalTexture!==!0&&C.version>0&&B.__version!==C.version){const Z=C.image;if(Z===null)Pe("WebGLRenderer: Texture marked for update but no image data found.");else if(Z.complete===!1)Pe("WebGLRenderer: Texture marked for update but image is incomplete");else{Ce(B,C,M);return}}else C.isExternalTexture&&(B.__webglTexture=C.sourceTexture?C.sourceTexture:null);n.bindTexture(t.TEXTURE_2D,B.__webglTexture,t.TEXTURE0+M)}function X(C,M){const B=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&B.__version!==C.version){Ce(B,C,M);return}else C.isExternalTexture&&(B.__webglTexture=C.sourceTexture?C.sourceTexture:null);n.bindTexture(t.TEXTURE_2D_ARRAY,B.__webglTexture,t.TEXTURE0+M)}function $(C,M){const B=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&B.__version!==C.version){Ce(B,C,M);return}n.bindTexture(t.TEXTURE_3D,B.__webglTexture,t.TEXTURE0+M)}function te(C,M){const B=i.get(C);if(C.isCubeDepthTexture!==!0&&C.version>0&&B.__version!==C.version){De(B,C,M);return}n.bindTexture(t.TEXTURE_CUBE_MAP,B.__webglTexture,t.TEXTURE0+M)}const fe={[Af]:t.REPEAT,[Ai]:t.CLAMP_TO_EDGE,[Rf]:t.MIRRORED_REPEAT},Ve={[Wt]:t.NEAREST,[fy]:t.NEAREST_MIPMAP_NEAREST,[Aa]:t.NEAREST_MIPMAP_LINEAR,[Vt]:t.LINEAR,[Wu]:t.LINEAR_MIPMAP_NEAREST,[Lr]:t.LINEAR_MIPMAP_LINEAR},We={[py]:t.NEVER,[xy]:t.ALWAYS,[my]:t.LESS,[hh]:t.LEQUAL,[gy]:t.EQUAL,[ph]:t.GEQUAL,[_y]:t.GREATER,[vy]:t.NOTEQUAL};function Le(C,M){if(M.type===oi&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===Vt||M.magFilter===Wu||M.magFilter===Aa||M.magFilter===Lr||M.minFilter===Vt||M.minFilter===Wu||M.minFilter===Aa||M.minFilter===Lr)&&Pe("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(C,t.TEXTURE_WRAP_S,fe[M.wrapS]),t.texParameteri(C,t.TEXTURE_WRAP_T,fe[M.wrapT]),(C===t.TEXTURE_3D||C===t.TEXTURE_2D_ARRAY)&&t.texParameteri(C,t.TEXTURE_WRAP_R,fe[M.wrapR]),t.texParameteri(C,t.TEXTURE_MAG_FILTER,Ve[M.magFilter]),t.texParameteri(C,t.TEXTURE_MIN_FILTER,Ve[M.minFilter]),M.compareFunction&&(t.texParameteri(C,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(C,t.TEXTURE_COMPARE_FUNC,We[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===Wt||M.minFilter!==Aa&&M.minFilter!==Lr||M.type===oi&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||i.get(M).__currentAnisotropy){const B=e.get("EXT_texture_filter_anisotropic");t.texParameterf(C,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,r.getMaxAnisotropy())),i.get(M).__currentAnisotropy=M.anisotropy}}}function K(C,M){let B=!1;C.__webglInit===void 0&&(C.__webglInit=!0,M.addEventListener("dispose",A));const Z=M.source;let ee=p.get(Z);ee===void 0&&(ee={},p.set(Z,ee));const ie=O(M);if(ie!==C.__cacheKey){ee[ie]===void 0&&(ee[ie]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,B=!0),ee[ie].usedTimes++;const ce=ee[C.__cacheKey];ce!==void 0&&(ee[C.__cacheKey].usedTimes--,ce.usedTimes===0&&P(M)),C.__cacheKey=ie,C.__webglTexture=ee[ie].texture}return B}function de(C,M,B){return Math.floor(Math.floor(C/B)/M)}function oe(C,M,B,Z){const ie=C.updateRanges;if(ie.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,M.width,M.height,B,Z,M.data);else{ie.sort((Se,ae)=>Se.start-ae.start);let ce=0;for(let Se=1;Se<ie.length;Se++){const ae=ie[ce],re=ie[Se],Ne=ae.start+ae.count,Oe=de(re.start,M.width,4),Qe=de(ae.start,M.width,4);re.start<=Ne+1&&Oe===Qe&&de(re.start+re.count-1,M.width,4)===Oe?ae.count=Math.max(ae.count,re.start+re.count-ae.start):(++ce,ie[ce]=re)}ie.length=ce+1;const j=n.getParameter(t.UNPACK_ROW_LENGTH),Q=n.getParameter(t.UNPACK_SKIP_PIXELS),_e=n.getParameter(t.UNPACK_SKIP_ROWS);n.pixelStorei(t.UNPACK_ROW_LENGTH,M.width);for(let Se=0,ae=ie.length;Se<ae;Se++){const re=ie[Se],Ne=Math.floor(re.start/4),Oe=Math.ceil(re.count/4),Qe=Ne%M.width,N=Math.floor(Ne/M.width),se=Oe,q=1;n.pixelStorei(t.UNPACK_SKIP_PIXELS,Qe),n.pixelStorei(t.UNPACK_SKIP_ROWS,N),n.texSubImage2D(t.TEXTURE_2D,0,Qe,N,se,q,B,Z,M.data)}C.clearUpdateRanges(),n.pixelStorei(t.UNPACK_ROW_LENGTH,j),n.pixelStorei(t.UNPACK_SKIP_PIXELS,Q),n.pixelStorei(t.UNPACK_SKIP_ROWS,_e)}}function Ce(C,M,B){let Z=t.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(Z=t.TEXTURE_2D_ARRAY),M.isData3DTexture&&(Z=t.TEXTURE_3D);const ee=K(C,M),ie=M.source;n.bindTexture(Z,C.__webglTexture,t.TEXTURE0+B);const ce=i.get(ie);if(ie.version!==ce.__version||ee===!0){if(n.activeTexture(t.TEXTURE0+B),(typeof ImageBitmap<"u"&&M.image instanceof ImageBitmap)===!1){const q=Ye.getPrimaries(Ye.workingColorSpace),ve=M.colorSpace===Ji?null:Ye.getPrimaries(M.colorSpace),le=M.colorSpace===Ji||q===ve?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,M.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,le)}n.pixelStorei(t.UNPACK_ALIGNMENT,M.unpackAlignment);let Q=m(M.image,!1,r.maxTextureSize);Q=he(M,Q);const _e=s.convert(M.format,M.colorSpace),Se=s.convert(M.type);let ae=y(M.internalFormat,_e,Se,M.normalized,M.colorSpace,M.isVideoTexture);Le(Z,M);let re;const Ne=M.mipmaps,Oe=M.isVideoTexture!==!0,Qe=ce.__version===void 0||ee===!0,N=ie.dataReady,se=T(M,Q);if(M.isDepthTexture)ae=R(M.format===Nr,M.type),Qe&&(Oe?n.texStorage2D(t.TEXTURE_2D,1,ae,Q.width,Q.height):n.texImage2D(t.TEXTURE_2D,0,ae,Q.width,Q.height,0,_e,Se,null));else if(M.isDataTexture)if(Ne.length>0){Oe&&Qe&&n.texStorage2D(t.TEXTURE_2D,se,ae,Ne[0].width,Ne[0].height);for(let q=0,ve=Ne.length;q<ve;q++)re=Ne[q],Oe?N&&n.texSubImage2D(t.TEXTURE_2D,q,0,0,re.width,re.height,_e,Se,re.data):n.texImage2D(t.TEXTURE_2D,q,ae,re.width,re.height,0,_e,Se,re.data);M.generateMipmaps=!1}else Oe?(Qe&&n.texStorage2D(t.TEXTURE_2D,se,ae,Q.width,Q.height),N&&oe(M,Q,_e,Se)):n.texImage2D(t.TEXTURE_2D,0,ae,Q.width,Q.height,0,_e,Se,Q.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){Oe&&Qe&&n.texStorage3D(t.TEXTURE_2D_ARRAY,se,ae,Ne[0].width,Ne[0].height,Q.depth);for(let q=0,ve=Ne.length;q<ve;q++)if(re=Ne[q],M.format!==Yn)if(_e!==null)if(Oe){if(N)if(M.layerUpdates.size>0){const le=vm(re.width,re.height,M.format,M.type);for(const J of M.layerUpdates){const we=re.data.subarray(J*le/re.data.BYTES_PER_ELEMENT,(J+1)*le/re.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,q,0,0,J,re.width,re.height,1,_e,we)}M.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,q,0,0,0,re.width,re.height,Q.depth,_e,re.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,q,ae,re.width,re.height,Q.depth,0,re.data,0,0);else Pe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Oe?N&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,q,0,0,0,re.width,re.height,Q.depth,_e,Se,re.data):n.texImage3D(t.TEXTURE_2D_ARRAY,q,ae,re.width,re.height,Q.depth,0,_e,Se,re.data)}else{Oe&&Qe&&n.texStorage2D(t.TEXTURE_2D,se,ae,Ne[0].width,Ne[0].height);for(let q=0,ve=Ne.length;q<ve;q++)re=Ne[q],M.format!==Yn?_e!==null?Oe?N&&n.compressedTexSubImage2D(t.TEXTURE_2D,q,0,0,re.width,re.height,_e,re.data):n.compressedTexImage2D(t.TEXTURE_2D,q,ae,re.width,re.height,0,re.data):Pe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Oe?N&&n.texSubImage2D(t.TEXTURE_2D,q,0,0,re.width,re.height,_e,Se,re.data):n.texImage2D(t.TEXTURE_2D,q,ae,re.width,re.height,0,_e,Se,re.data)}else if(M.isDataArrayTexture)if(Oe){if(Qe&&n.texStorage3D(t.TEXTURE_2D_ARRAY,se,ae,Q.width,Q.height,Q.depth),N)if(M.layerUpdates.size>0){const q=vm(Q.width,Q.height,M.format,M.type);for(const ve of M.layerUpdates){const le=Q.data.subarray(ve*q/Q.data.BYTES_PER_ELEMENT,(ve+1)*q/Q.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,ve,Q.width,Q.height,1,_e,Se,le)}M.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,_e,Se,Q.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,ae,Q.width,Q.height,Q.depth,0,_e,Se,Q.data);else if(M.isData3DTexture)Oe?(Qe&&n.texStorage3D(t.TEXTURE_3D,se,ae,Q.width,Q.height,Q.depth),N&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,_e,Se,Q.data)):n.texImage3D(t.TEXTURE_3D,0,ae,Q.width,Q.height,Q.depth,0,_e,Se,Q.data);else if(M.isFramebufferTexture){if(Qe)if(Oe)n.texStorage2D(t.TEXTURE_2D,se,ae,Q.width,Q.height);else{let q=Q.width,ve=Q.height;for(let le=0;le<se;le++)n.texImage2D(t.TEXTURE_2D,le,ae,q,ve,0,_e,Se,null),q>>=1,ve>>=1}}else if(M.isHTMLTexture){if("texElementImage2D"in t){const q=t.canvas;if(q.hasAttribute("layoutsubtree")||q.setAttribute("layoutsubtree","true"),Q.parentNode!==q){q.appendChild(Q),h.add(M),q.onpaint=Ue=>{const Et=Ue.changedElements;for(const nt of h)Et.includes(nt.image)&&(nt.needsUpdate=!0)},q.requestPaint();return}const ve=0,le=t.RGBA,J=t.RGBA,we=t.UNSIGNED_BYTE;t.texElementImage2D(t.TEXTURE_2D,ve,le,J,we,Q),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE)}}else if(Ne.length>0){if(Oe&&Qe){const q=St(Ne[0]);n.texStorage2D(t.TEXTURE_2D,se,ae,q.width,q.height)}for(let q=0,ve=Ne.length;q<ve;q++)re=Ne[q],Oe?N&&n.texSubImage2D(t.TEXTURE_2D,q,0,0,_e,Se,re):n.texImage2D(t.TEXTURE_2D,q,ae,_e,Se,re);M.generateMipmaps=!1}else if(Oe){if(Qe){const q=St(Q);n.texStorage2D(t.TEXTURE_2D,se,ae,q.width,q.height)}N&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,_e,Se,Q)}else n.texImage2D(t.TEXTURE_2D,0,ae,_e,Se,Q);c(M)&&g(Z),ce.__version=ie.version,M.onUpdate&&M.onUpdate(M)}C.__version=M.version}function De(C,M,B){if(M.image.length!==6)return;const Z=K(C,M),ee=M.source;n.bindTexture(t.TEXTURE_CUBE_MAP,C.__webglTexture,t.TEXTURE0+B);const ie=i.get(ee);if(ee.version!==ie.__version||Z===!0){n.activeTexture(t.TEXTURE0+B);const ce=Ye.getPrimaries(Ye.workingColorSpace),j=M.colorSpace===Ji?null:Ye.getPrimaries(M.colorSpace),Q=M.colorSpace===Ji||ce===j?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,M.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),n.pixelStorei(t.UNPACK_ALIGNMENT,M.unpackAlignment),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Q);const _e=M.isCompressedTexture||M.image[0].isCompressedTexture,Se=M.image[0]&&M.image[0].isDataTexture,ae=[];for(let J=0;J<6;J++)!_e&&!Se?ae[J]=m(M.image[J],!0,r.maxCubemapSize):ae[J]=Se?M.image[J].image:M.image[J],ae[J]=he(M,ae[J]);const re=ae[0],Ne=s.convert(M.format,M.colorSpace),Oe=s.convert(M.type),Qe=y(M.internalFormat,Ne,Oe,M.normalized,M.colorSpace),N=M.isVideoTexture!==!0,se=ie.__version===void 0||Z===!0,q=ee.dataReady;let ve=T(M,re);Le(t.TEXTURE_CUBE_MAP,M);let le;if(_e){N&&se&&n.texStorage2D(t.TEXTURE_CUBE_MAP,ve,Qe,re.width,re.height);for(let J=0;J<6;J++){le=ae[J].mipmaps;for(let we=0;we<le.length;we++){const Ue=le[we];M.format!==Yn?Ne!==null?N?q&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,we,0,0,Ue.width,Ue.height,Ne,Ue.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,we,Qe,Ue.width,Ue.height,0,Ue.data):Pe("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?q&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,we,0,0,Ue.width,Ue.height,Ne,Oe,Ue.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,we,Qe,Ue.width,Ue.height,0,Ne,Oe,Ue.data)}}}else{if(le=M.mipmaps,N&&se){le.length>0&&ve++;const J=St(ae[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,ve,Qe,J.width,J.height)}for(let J=0;J<6;J++)if(Se){N?q&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,ae[J].width,ae[J].height,Ne,Oe,ae[J].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,Qe,ae[J].width,ae[J].height,0,Ne,Oe,ae[J].data);for(let we=0;we<le.length;we++){const Et=le[we].image[J].image;N?q&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,we+1,0,0,Et.width,Et.height,Ne,Oe,Et.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,we+1,Qe,Et.width,Et.height,0,Ne,Oe,Et.data)}}else{N?q&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,Ne,Oe,ae[J]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,Qe,Ne,Oe,ae[J]);for(let we=0;we<le.length;we++){const Ue=le[we];N?q&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,we+1,0,0,Ne,Oe,Ue.image[J]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,we+1,Qe,Ne,Oe,Ue.image[J])}}}c(M)&&g(t.TEXTURE_CUBE_MAP),ie.__version=ee.version,M.onUpdate&&M.onUpdate(M)}C.__version=M.version}function be(C,M,B,Z,ee,ie){const ce=s.convert(B.format,B.colorSpace),j=s.convert(B.type),Q=y(B.internalFormat,ce,j,B.normalized,B.colorSpace),_e=i.get(M),Se=i.get(B);if(Se.__renderTarget=M,!_e.__hasExternalTextures){const ae=Math.max(1,M.width>>ie),re=Math.max(1,M.height>>ie);ee===t.TEXTURE_3D||ee===t.TEXTURE_2D_ARRAY?n.texImage3D(ee,ie,Q,ae,re,M.depth,0,ce,j,null):n.texImage2D(ee,ie,Q,ae,re,0,ce,j,null)}n.bindFramebuffer(t.FRAMEBUFFER,C),je(M)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,Z,ee,Se.__webglTexture,0,Nt(M)):(ee===t.TEXTURE_2D||ee>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&ee<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,Z,ee,Se.__webglTexture,ie),n.bindFramebuffer(t.FRAMEBUFFER,null)}function mt(C,M,B){if(t.bindRenderbuffer(t.RENDERBUFFER,C),M.depthBuffer){const Z=M.depthTexture,ee=Z&&Z.isDepthTexture?Z.type:null,ie=R(M.stencilBuffer,ee),ce=M.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;je(M)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Nt(M),ie,M.width,M.height):B?t.renderbufferStorageMultisample(t.RENDERBUFFER,Nt(M),ie,M.width,M.height):t.renderbufferStorage(t.RENDERBUFFER,ie,M.width,M.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,ce,t.RENDERBUFFER,C)}else{const Z=M.textures;for(let ee=0;ee<Z.length;ee++){const ie=Z[ee],ce=s.convert(ie.format,ie.colorSpace),j=s.convert(ie.type),Q=y(ie.internalFormat,ce,j,ie.normalized,ie.colorSpace);je(M)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Nt(M),Q,M.width,M.height):B?t.renderbufferStorageMultisample(t.RENDERBUFFER,Nt(M),Q,M.width,M.height):t.renderbufferStorage(t.RENDERBUFFER,Q,M.width,M.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Xe(C,M,B){const Z=M.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(t.FRAMEBUFFER,C),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const ee=i.get(M.depthTexture);if(ee.__renderTarget=M,(!ee.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),Z){if(ee.__webglInit===void 0&&(ee.__webglInit=!0,M.depthTexture.addEventListener("dispose",A)),ee.__webglTexture===void 0){ee.__webglTexture=t.createTexture(),n.bindTexture(t.TEXTURE_CUBE_MAP,ee.__webglTexture),Le(t.TEXTURE_CUBE_MAP,M.depthTexture);const _e=s.convert(M.depthTexture.format),Se=s.convert(M.depthTexture.type);let ae;M.depthTexture.format===Fi?ae=t.DEPTH_COMPONENT24:M.depthTexture.format===Nr&&(ae=t.DEPTH24_STENCIL8);for(let re=0;re<6;re++)t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,ae,M.width,M.height,0,_e,Se,null)}}else F(M.depthTexture,0);const ie=ee.__webglTexture,ce=Nt(M),j=Z?t.TEXTURE_CUBE_MAP_POSITIVE_X+B:t.TEXTURE_2D,Q=M.depthTexture.format===Nr?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;if(M.depthTexture.format===Fi)je(M)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,Q,j,ie,0,ce):t.framebufferTexture2D(t.FRAMEBUFFER,Q,j,ie,0);else if(M.depthTexture.format===Nr)je(M)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,Q,j,ie,0,ce):t.framebufferTexture2D(t.FRAMEBUFFER,Q,j,ie,0);else throw new Error("Unknown depthTexture format")}function tt(C){const M=i.get(C),B=C.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==C.depthTexture){const Z=C.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),Z){const ee=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,Z.removeEventListener("dispose",ee)};Z.addEventListener("dispose",ee),M.__depthDisposeCallback=ee}M.__boundDepthTexture=Z}if(C.depthTexture&&!M.__autoAllocateDepthBuffer)if(B)for(let Z=0;Z<6;Z++)Xe(M.__webglFramebuffer[Z],C,Z);else{const Z=C.texture.mipmaps;Z&&Z.length>0?Xe(M.__webglFramebuffer[0],C,0):Xe(M.__webglFramebuffer,C,0)}else if(B){M.__webglDepthbuffer=[];for(let Z=0;Z<6;Z++)if(n.bindFramebuffer(t.FRAMEBUFFER,M.__webglFramebuffer[Z]),M.__webglDepthbuffer[Z]===void 0)M.__webglDepthbuffer[Z]=t.createRenderbuffer(),mt(M.__webglDepthbuffer[Z],C,!1);else{const ee=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ie=M.__webglDepthbuffer[Z];t.bindRenderbuffer(t.RENDERBUFFER,ie),t.framebufferRenderbuffer(t.FRAMEBUFFER,ee,t.RENDERBUFFER,ie)}}else{const Z=C.texture.mipmaps;if(Z&&Z.length>0?n.bindFramebuffer(t.FRAMEBUFFER,M.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=t.createRenderbuffer(),mt(M.__webglDepthbuffer,C,!1);else{const ee=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ie=M.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,ie),t.framebufferRenderbuffer(t.FRAMEBUFFER,ee,t.RENDERBUFFER,ie)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function ft(C,M,B){const Z=i.get(C);M!==void 0&&be(Z.__webglFramebuffer,C,C.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),B!==void 0&&tt(C)}function He(C){const M=C.texture,B=i.get(C),Z=i.get(M);C.addEventListener("dispose",S);const ee=C.textures,ie=C.isWebGLCubeRenderTarget===!0,ce=ee.length>1;if(ce||(Z.__webglTexture===void 0&&(Z.__webglTexture=t.createTexture()),Z.__version=M.version,o.memory.textures++),ie){B.__webglFramebuffer=[];for(let j=0;j<6;j++)if(M.mipmaps&&M.mipmaps.length>0){B.__webglFramebuffer[j]=[];for(let Q=0;Q<M.mipmaps.length;Q++)B.__webglFramebuffer[j][Q]=t.createFramebuffer()}else B.__webglFramebuffer[j]=t.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){B.__webglFramebuffer=[];for(let j=0;j<M.mipmaps.length;j++)B.__webglFramebuffer[j]=t.createFramebuffer()}else B.__webglFramebuffer=t.createFramebuffer();if(ce)for(let j=0,Q=ee.length;j<Q;j++){const _e=i.get(ee[j]);_e.__webglTexture===void 0&&(_e.__webglTexture=t.createTexture(),o.memory.textures++)}if(C.samples>0&&je(C)===!1){B.__webglMultisampledFramebuffer=t.createFramebuffer(),B.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let j=0;j<ee.length;j++){const Q=ee[j];B.__webglColorRenderbuffer[j]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,B.__webglColorRenderbuffer[j]);const _e=s.convert(Q.format,Q.colorSpace),Se=s.convert(Q.type),ae=y(Q.internalFormat,_e,Se,Q.normalized,Q.colorSpace,C.isXRRenderTarget===!0),re=Nt(C);t.renderbufferStorageMultisample(t.RENDERBUFFER,re,ae,C.width,C.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+j,t.RENDERBUFFER,B.__webglColorRenderbuffer[j])}t.bindRenderbuffer(t.RENDERBUFFER,null),C.depthBuffer&&(B.__webglDepthRenderbuffer=t.createRenderbuffer(),mt(B.__webglDepthRenderbuffer,C,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(ie){n.bindTexture(t.TEXTURE_CUBE_MAP,Z.__webglTexture),Le(t.TEXTURE_CUBE_MAP,M);for(let j=0;j<6;j++)if(M.mipmaps&&M.mipmaps.length>0)for(let Q=0;Q<M.mipmaps.length;Q++)be(B.__webglFramebuffer[j][Q],C,M,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+j,Q);else be(B.__webglFramebuffer[j],C,M,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+j,0);c(M)&&g(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(ce){for(let j=0,Q=ee.length;j<Q;j++){const _e=ee[j],Se=i.get(_e);let ae=t.TEXTURE_2D;(C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(ae=C.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(ae,Se.__webglTexture),Le(ae,_e),be(B.__webglFramebuffer,C,_e,t.COLOR_ATTACHMENT0+j,ae,0),c(_e)&&g(ae)}n.unbindTexture()}else{let j=t.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(j=C.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(j,Z.__webglTexture),Le(j,M),M.mipmaps&&M.mipmaps.length>0)for(let Q=0;Q<M.mipmaps.length;Q++)be(B.__webglFramebuffer[Q],C,M,t.COLOR_ATTACHMENT0,j,Q);else be(B.__webglFramebuffer,C,M,t.COLOR_ATTACHMENT0,j,0);c(M)&&g(j),n.unbindTexture()}C.depthBuffer&&tt(C)}function Lt(C){const M=C.textures;for(let B=0,Z=M.length;B<Z;B++){const ee=M[B];if(c(ee)){const ie=x(C),ce=i.get(ee).__webglTexture;n.bindTexture(ie,ce),g(ie),n.unbindTexture()}}}const gt=[],_n=[];function I(C){if(C.samples>0){if(je(C)===!1){const M=C.textures,B=C.width,Z=C.height;let ee=t.COLOR_BUFFER_BIT;const ie=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ce=i.get(C),j=M.length>1;if(j)for(let _e=0;_e<M.length;_e++)n.bindFramebuffer(t.FRAMEBUFFER,ce.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+_e,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,ce.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+_e,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,ce.__webglMultisampledFramebuffer);const Q=C.texture.mipmaps;Q&&Q.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,ce.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,ce.__webglFramebuffer);for(let _e=0;_e<M.length;_e++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(ee|=t.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(ee|=t.STENCIL_BUFFER_BIT)),j){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,ce.__webglColorRenderbuffer[_e]);const Se=i.get(M[_e]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,Se,0)}t.blitFramebuffer(0,0,B,Z,0,0,B,Z,ee,t.NEAREST),l===!0&&(gt.length=0,_n.length=0,gt.push(t.COLOR_ATTACHMENT0+_e),C.depthBuffer&&C.resolveDepthBuffer===!1&&(gt.push(ie),_n.push(ie),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,_n)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,gt))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),j)for(let _e=0;_e<M.length;_e++){n.bindFramebuffer(t.FRAMEBUFFER,ce.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+_e,t.RENDERBUFFER,ce.__webglColorRenderbuffer[_e]);const Se=i.get(M[_e]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,ce.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+_e,t.TEXTURE_2D,Se,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,ce.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){const M=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[M])}}}function Nt(C){return Math.min(r.maxSamples,C.samples)}function je(C){const M=i.get(C);return C.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function lt(C){const M=o.render.frame;d.get(C)!==M&&(d.set(C,M),C.update())}function he(C,M){const B=C.colorSpace,Z=C.format,ee=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||B!==Vl&&B!==Ji&&(Ye.getTransfer(B)===Je?(Z!==Yn||ee!==Dn)&&Pe("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ke("WebGLTextures: Unsupported texture color space:",B)),M}function St(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(u.width=C.naturalWidth||C.width,u.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(u.width=C.displayWidth,u.height=C.displayHeight):(u.width=C.width,u.height=C.height),u}this.allocateTextureUnit=k,this.resetTextureUnits=z,this.getTextureUnits=Y,this.setTextureUnits=D,this.setTexture2D=F,this.setTexture2DArray=X,this.setTexture3D=$,this.setTextureCube=te,this.rebindTextures=ft,this.setupRenderTarget=He,this.updateRenderTargetMipmap=Lt,this.updateMultisampleRenderTarget=I,this.setupDepthRenderbuffer=tt,this.setupFrameBufferTexture=be,this.useMultisampledRTT=je,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function Kw(t,e){function n(i,r=Ji){let s;const o=Ye.getTransfer(r);if(i===Dn)return t.UNSIGNED_BYTE;if(i===lh)return t.UNSIGNED_SHORT_4_4_4_4;if(i===uh)return t.UNSIGNED_SHORT_5_5_5_1;if(i===S_)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===y_)return t.UNSIGNED_INT_10F_11F_11F_REV;if(i===v_)return t.BYTE;if(i===x_)return t.SHORT;if(i===$o)return t.UNSIGNED_SHORT;if(i===ah)return t.INT;if(i===hi)return t.UNSIGNED_INT;if(i===oi)return t.FLOAT;if(i===Ui)return t.HALF_FLOAT;if(i===M_)return t.ALPHA;if(i===E_)return t.RGB;if(i===Yn)return t.RGBA;if(i===Fi)return t.DEPTH_COMPONENT;if(i===Nr)return t.DEPTH_STENCIL;if(i===T_)return t.RED;if(i===ch)return t.RED_INTEGER;if(i===Hr)return t.RG;if(i===fh)return t.RG_INTEGER;if(i===dh)return t.RGBA_INTEGER;if(i===ul||i===cl||i===fl||i===dl)if(o===Je)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===ul)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===cl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===fl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===dl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===ul)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===cl)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===fl)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===dl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Cf||i===bf||i===Pf||i===Lf)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Cf)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===bf)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Pf)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Lf)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Nf||i===Df||i===If||i===Uf||i===Ff||i===Bl||i===Of)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Nf||i===Df)return o===Je?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===If)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===Uf)return s.COMPRESSED_R11_EAC;if(i===Ff)return s.COMPRESSED_SIGNED_R11_EAC;if(i===Bl)return s.COMPRESSED_RG11_EAC;if(i===Of)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===kf||i===Bf||i===zf||i===Vf||i===Hf||i===Gf||i===Wf||i===Xf||i===jf||i===Yf||i===$f||i===qf||i===Kf||i===Zf)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===kf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Bf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===zf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Vf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Hf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Gf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Wf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Xf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===jf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Yf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===$f)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===qf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Kf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Zf)return o===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Qf||i===Jf||i===ed)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Qf)return o===Je?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Jf)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===ed)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===td||i===nd||i===zl||i===id)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===td)return s.COMPRESSED_RED_RGTC1_EXT;if(i===nd)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===zl)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===id)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===qo?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const Zw=`
void main() {
...
`;function uA({media:t,startIndex:e=0,width:n,height:i,onIndex:r}){const s=ke.useRef(null),o=ke.useRef(e),a=ke.useRef(!1);ke.useEffect(()=>{var d;(d=s.current)!=null&&d.__goto&&s.current.__goto(e)},[e]);const[l,u]=ke.useState(!1);if(ke.useEffect(()=>{const d=s.current;if(!d||a.current)return;let h;try{h=new oA({antialias:!0,alpha:!0})}catch{a.current=!0,u(!0);return}h.setPixelRatio(Math.min(2,window.devicePixelRatio)),h.setSize(n,i),d.appendChild(h.domElement);const f=new ky,p=new vh(-n/2,n/2,i/2,-i/2,-1500,1500),_=i*.6,v=_*.78,m=v+110,c=new aM,g=[],x=t.map((k,O)=>{let F;if(k.type==="video"){const te=document.createElement("video");te.src=k.src,te.muted=!0,te.loop=!0,te.playsInline=!0,te.play().catch(()=>{}),g.push(te),F=new qy(te)}else F=c.load(k.src);F.colorSpace=Mn;const X=new Zn({vertexShader:aA,fragmentShader:lA,uniforms:{uMap:{value:F},uVel:{value:0},uTime:{value:0},uEffect:{value:Hm[Ee.FX]??0}}}),$=new pi(new oa(v,_,48,48),X);return $.position.x=O*m,f.add($),$});let y=e*m,R=y,T=R,A=null;const S=(t.length-1)*m;d.__goto=k=>{y=Math.max(0,Math.min(S,k*m))};const b=k=>{var O;A={x:k.clientX,t:y},(O=d.setPointerCapture)==null||O.call(d,k.pointerId)},P=k=>{A&&(y=Math.max(-m*.4,Math.min(S+m*.4,A.t-(k.clientX-A.x)*1.6)))},w=()=>{A=null,y=Math.max(0,Math.min(S,y))},L=k=>{y=Math.max(0,Math.min(S,y+(k.deltaY+k.deltaX)*1.1))};d.addEventListener("pointerdown",b),d.addEventListener("pointermove",P),d.addEventListener("pointerup",w),d.addEventListener("pointercancel",w),d.addEventListener("wheel",L,{passive:!0});let z;const Y=new cM,D=()=>{R+=(y-R)*.085;const k=(R-T)/m;T=R;const O=Y.getElapsedTime(),F=Hm[Ee.FX]??0;x.forEach(($,te)=>{$.position.x=te*m-R,$.material.uniforms.uVel.value=k*6,$.material.uniforms.uTime.value=O,$.material.uniforms.uEffect.value=F});const X=Math.round(Math.max(0,Math.min(S,R))/m);X!==o.current&&(o.current=X,r==null||r(X)),h.render(f,p),z=requestAnimationFrame(D)};return z=requestAnimationFrame(D),()=>{cancelAnimationFrame(z),d.removeEventListener("pointerdown",b),d.removeEventListener("pointermove",P),d.removeEventListener("pointerup",w),d.removeEventListener("pointercancel",w),d.removeEventListener("wheel",L),g.forEach(k=>k.pause()),x.forEach(k=>{k.geometry.dispose(),k.material.uniforms.uMap.value.dispose(),k.material.dispose()}),h.dispose(),d.removeChild(h.domElement)}},[t,n,i]),l){const d=t[Math.min(e,t.length-1)];return ue.jsx("div",{className:"fullBleed",children:d.type==="video"?ue.jsx("video",{src:d.src,autoPlay:!0,muted:!0,loop:!0,playsInline:!0}):ue.jsx("img",{src:d.src,alt:""})})}return ue.jsx("div",{className:"glStage",ref:s})}const cA=-200,Gm=220,Mc=265,fA=150;function dA(t,e,n,i,r=1){if(e||n==="arc"){const o=(e?fA:Mc)*r;return Array.from({length:t},(a,l)=>{const u=(cA+(t>1?l*Gm/(t-1):Gm/2))*Math.PI/180;return{ox:Math.cos(u)*o*1.25,oy:Math.sin(u)*o*.9,z:-150}})}if(n==="fan")return Array.from({length:t},(o,a)=>({ox:(240+a*130)*r,oy:(-36-a*38)*r,z:-110-a*175}));if(n==="tide"){const o=1280*r;return Array.from({length:t},(a,l)=>({ox:(i*42+l*(o/t))%o-o/2,oy:((l%2?-1:1)*(105+l%3*38)+Math.sin(i*.7+l)*14)*r,z:-120-l%3*150}))}const s=i*9*Math.PI/180;return Array.from({length:t},(o,a)=>{const l=a/t*Math.PI*2-Math.PI/2+s;return{ox:Math.cos(l)*Mc*1.3*r,oy:Math.sin(l)*Mc*.85*r,z:-150}})}const hA=410,pA=110;function mA({sim:t,activeId:e,width:n,height:i,onNavigate:r}){const{visibleNodes:s,roles:o,byId:a}=t,l=ke.useRef(null),[u,d]=ke.useState(null),[h,f]=ke.useState(null);ke.useEffect(()=>f(null),[e]),ke.useEffect(()=>{const A=S=>S.key==="Escape"&&f(null);return window.addEventListener("keydown",A),()=>window.removeEventListener("keydown",A)},[]);const[,p]=ke.useState(0);ke.useEffect(()=>{let A;const S=()=>{(Ee.EMIT==="orbit"||Ee.EMIT==="tide")&&p(b=>b+1),A=requestAnimationFrame(S)};return A=requestAnimationFrame(S),()=>cancelAnimationFrame(A)},[]),ke.useEffect(()=>{const A=S=>{const b=S.clientX/window.innerWidth-.5,P=S.clientY/window.innerHeight-.5;l.current&&(l.current.style.perspectiveOrigin=`${50+b*16}% ${46+P*11}%`)};return window.addEventListener("mousemove",A),()=>window.removeEventListener("mousemove",A)},[]);const _=a.get(e),v=_.childIds.length===0,m=v&&_.media?_.media:null,c=!m&&(_!=null&&_.img)&&v?_:null,g=Ee.VIEWPORT_SCALE,x=m?dA(m.length,h!=null,Ee.EMIT,performance.now()/1e3,g):[],y=m&&h!=null?m[h]:null,R=A=>A==="active"?Ut("active",_.label,n):A==="parent"?38:A==="child"?Ut("child"):A==="sibling"?15:13,T=A=>{if(A.id===e&&y){f(null);return}r(A)};return ue.jsxs(ue.Fragment,{children:[y&&ue.jsx(uA,{media:m,startIndex:h,width:n,height:i??window.innerHeight,onIndex:A=>f(A)},`gl-${e}`),ue.jsxs("div",{className:"focusSpace",ref:l,children:[c&&ue.jsx("img",{className:"froomImg",src:c.img,alt:""},`room-${c.id}`),m&&_.x!=null&&ue.jsx("div",{className:"emitWrap",style:{transform:`translate3d(${_.x}px, ${_.y}px, 0)`},children:m.map((A,S)=>{const b=x[S],P=S%2===0,w=(y?64:P?200:160)*g,L=(y?64:(P?200:160)*(P?1.24:.78))*g;return ue.jsx("div",{className:`eFrame ${h===S?"current":""} ${Ee.EMIT==="tide"&&h==null?"flow":""}`,style:{width:w,height:L,zIndex:20+S,transform:`translate(calc(-50% + ${b.ox}px), calc(-50% + ${b.oy}px)) translateZ(${b.z}px)`,animationDelay:`${.25+S*.14}s`},onClick:()=>f(S),children:A.type==="video"?ue.jsx("video",{src:A.src,autoPlay:!0,muted:!0,loop:!0,playsInline:!0}):ue.jsx("img",{src:A.src,alt:"",draggable:!1})},`${e}-em-${S}`)})}),s.map(A=>{if(A.x==null)return null;const S=o.get(A.id),b=Math.max(-3,Math.min(1,A.depth-_.depth)),P=b>=0?b*pA:b*hA,w=b<0?-b*1.7:0,L=b<0?Math.max(.3,1+b*.26):S==="active"?1:.92;return ue.jsx("div",{className:"fnode",style:{transform:`translate3d(${A.x}px, ${A.y}px, 0)`},children:ue.jsx("div",{className:"fnodeInner",style:{transform:`translateZ(${P}px)`,filter:w?`blur(${w}px)`:"none",opacity:L},children:ue.jsx("span",{"data-node":A.id,className:`flabel ${S==="active"?"activeL":""} ${u===A.id?"hot":""}`,style:{fontSize:R(S)},onMouseEnter:()=>d(A.id),onMouseLeave:()=>d(null),onClick:()=>T(A),children:A.label})})},A.id)}),(_==null?void 0:_.copy)&&_.x!=null&&!y&&ue.jsx("div",{className:"fcopy",style:{transform:`translate3d(${_.x}px, ${_.y+R("active")*.62+16}px, 0) translateX(-50%)`},children:_.copy},e)]})]})}const gA=165;function _A({sim:t,activeId:e,width:n,height:i,onNavigate:r}){const{visibleNodes:s,roles:o,byId:a}=t,[l,u]=ke.useState(null),d=gA*Ee.VIEWPORT_SCALE,h=n/2,f=i/2-20,p=a.get(e),_=p!=null&&p.img&&p.childIds.length===0?p:null,v=(c,g)=>{let x=c.x-h,y=c.y-f;const R=Math.hypot(x,y)||1;return{x:h+x/R*g,y:f+y/R*g*.82}},m=(c,g)=>c==="active"?Ut("active",p.label,n):c==="child"?Ut("child"):c==="parent"?Math.max(13,24-g*5):c==="sibling"?14:11.5;return ue.jsxs("div",{className:"ringsSpace",children:[_&&ue.jsx("img",{className:"ringsRoom",src:_.img,alt:""},`rroom-${_.id}`),ue.jsx("div",{className:"pulse",style:{left:h,top:f}},`pulse-${e}`),s.map(c=>{if(c.x==null)return null;const g=o.get(c.id),x=Math.max(0,p.depth-c.depth);let y=c.x,R=c.y,T=1;return g==="active"?(y=h,R=f):g==="child"?({x:y,y:R}=v(c,d*1.32),T=.9):g==="sibling"?({x:y,y:R}=v(c,d*2.15),T=.42):g==="parent"?({x:y,y:R}=v(c,d*(1+x)*1.45),T=Math.max(.22,.55-x*.15)):({x:y,y:R}=v(c,d*2.9),T=.2),ue.jsx("span",{"data-node":c.id,className:`rlabel ${g==="active"?"activeL":""} ${l===c.id?"hot":""}`,style:{transform:`translate3d(${y}px, ${R}px, 0) translate(-50%, -50%)`,fontSize:m(g,x),fontWeight:g==="active"?700:400,opacity:T},onMouseEnter:()=>u(c.id),onMouseLeave:()=>u(null),onClick:()=>r(c),children:c.label},c.id)}),(p==null?void 0:p.copy)&&ue.jsx("div",{className:"fcopy",style:{transform:`translate3d(${h}px, ${f+m("active",0)*.62+16}px, 0) translateX(-50%)`},children:p.copy},`rc-${e}`)]})}const vA={active:{w:700,op:1},child:{w:500,op:.95},parent:{w:200,op:.8},sibling:{w:200,op:.55},distant:{w:100,op:.4}};function xA({sim:t,activeId:e,width:n,onNavigate:i}){const{visibleNodes:r,roles:s,byId:o}=t,[a,l]=ke.useState(null),u=o.get(e),d=u!=null&&u.img&&u.childIds.length===0?u:null,h=(f,p)=>f==="active"?Ut("active",u.label,n)*1.15:f==="child"?Ut("child")*1.15:f==="parent"?Math.max(14,26-p*5):f==="sibling"?15:12;return ue.jsxs("div",{className:"weightSpace",children:[d&&ue.jsx("img",{className:"ringsRoom",src:d.img,alt:""},`wroom-${d.id}`),r.map(f=>{if(f.x==null)return null;const p=s.get(f.id),_=Math.max(0,u.depth-f.depth),v=vA[p],m=a===f.id;return ue.jsx("span",{"data-node":f.id,className:`wlabel ${p==="active"?"activeL":""}`,style:{transform:`translate3d(${f.x}px, ${f.y}px, 0) translate(-50%, -50%)`,fontSize:h(p,_),fontWeight:m&&p!=="active"?Math.min(700,v.w+200):v.w,opacity:m?Math.min(1,v.op+.3):v.op},onMouseEnter:()=>l(f.id),onMouseLeave:()=>l(null),onClick:()=>i(f),children:f.label},f.id)}),(u==null?void 0:u.copy)&&u.x!=null&&ue.jsx("div",{className:"fcopy",style:{transform:`translate3d(${u.x}px, ${u.y+h("active",0)*.62+16}px, 0) translateX(-50%)`},children:u.copy},`wc-${e}`)]})}const ld=[{obj:Ee,key:"TYPE_SCALE",label:"Type scale",min:.7,max:2.4,step:.05},{obj:Ee,key:"CHARGE",label:"Repulsion",min:-1200,max:-50,step:10},{obj:bt,key:"STRENGTH",label:"Spring",min:.05,max:1.2,step:.05},{obj:Ee,key:"DAMPING",label:"Damping",min:.1,max:.7,step:.02},{obj:Ee,key:"ALPHA_KICK",label:"Energy",min:.2,max:1,step:.05},{obj:Ee,key:"DRIFT",label:"Idle drift",min:0,max:.8,step:.02},{obj:bt,key:"LOOSE",label:"Looseness",min:0,max:48,step:2},{obj:bt,key:"GAP",label:"Rhythm",min:26,max:72,step:2},{obj:Ee,key:"SPACING",label:"Spacing",min:0,max:48,step:2},{obj:Ee,key:"CURSOR",label:"Cursor pull",min:-.8,max:.8,step:.05},{obj:Ee,key:"SHOCK",label:"Shockwave",min:0,max:20,step:1}],SA=ld.map(t=>t.obj[t.key]);function yA({onTune:t}){const[e,n]=ke.useState(typeof window>"u"?!0:window.innerWidth>680),[,i]=ke.useState(0),r=(o,a)=>{o.obj[o.key]=a,i(l=>l+1),t()},s=()=>{ld.forEach((o,a)=>o.obj[o.key]=SA[a]),i(o=>o+1),t()};return ue.jsxs("aside",{className:`tune ${e?"open":""}`,children:[ue.jsxs("button",{className:"tuneHead",onClick:()=>n(o=>!o),children:["Physics ",e?"▾":"▸"]}),e&&ue.jsxs("div",{className:"tuneBody",children:[ue.jsxs("div",{className:"tuneRow tuneVariants",children:[ue.jsx("span",{className:"tuneLabel",children:"Threads"}),[!0,!1].map(o=>ue.jsx("button",{className:Ee.THREADS===o?"on":"",onClick:()=>{Ee.THREADS=o,i(a=>a+1),t()},children:o?"on":"off"},String(o)))]}),ue.jsxs("div",{className:"tuneRow tuneVariants",children:[ue.jsx("span",{className:"tuneLabel",children:"Effect"}),["lens","wave","rgb"].map(o=>ue.jsx("button",{className:Ee.FX===o?"on":"",onClick:()=>{Ee.FX=o,i(a=>a+1),t()},children:o},o))]}),ue.jsxs("div",{className:"tuneRow tuneVariants",children:[ue.jsx("span",{className:"tuneLabel",children:"Emission"}),["arc","orbit","fan","tide"].map(o=>ue.jsx("button",{className:Ee.EMIT===o?"on":"",onClick:()=>{Ee.EMIT=o,i(a=>a+1),t()},children:o},o))]}),ld.map(o=>ue.jsxs("label",{className:"tuneRow",children:[ue.jsx("span",{className:"tuneLabel",children:o.label}),ue.jsx("input",{type:"range",min:o.min,max:o.max,step:o.step,value:o.obj[o.key],onChange:a=>r(o,+a.target.value)}),ue.jsx("span",{className:"tuneVal",children:Number(o.obj[o.key]).toFixed(o.step<1?2:0)})]},o.key)),ue.jsx("button",{className:"tuneReset",onClick:s,children:"Reset"})]})]})}function MA(t){const e=+this._x.call(null,t),n=+this._y.call(null,t);return X_(this.cover(e,n),e,n,t)}function X_(t,e,n,i){if(isNaN(e)||isNaN(n))return t;var r,s=t._root,o={data:i},a=t._x0,l=t._y0,u=t._x1,d=t._y1,h,f,p,_,v,m,c,g;if(!s)return t._root=o,t;for(;s.length;)if((v=e>=(h=(a+u)/2))?a=h:u=h,(m=n>=(f=(l+d)/2))?l=f:d=f,r=s,!(s=s[c=m<<1|v]))return r[c]=o,t;if(p=+t._x.call(null,s.data),_=+t._y.call(null,s.data),e===p&&n===_)return o.next=s,r?r[c]=o:t._root=o,t;do r=r?r[c]=new Array(4):t._root=new Array(4),(v=e>=(h=(a+u)/2))?a=h:u=h,(m=n>=(f=(l+d)/2))?l=f:d=f;while((c=m<<1|v)===(g=(_>=f)<<1|p>=h));return r[g]=s,r[c]=o,t}function EA(t){var e,n,i=t.length,r,s,o=new Array(i),a=new Array(i),l=1/0,u=1/0,d=-1/0,h=-1/0;for(n=0;n<i;++n)isNaN(r=+this._x.call(null,e=t[n]))||isNaN(s=+this._y.call(null,e))||(o[n]=r,a[n]=s,r<l&&(l=r),r>d&&(d=r),s<u&&(u=s),s>h&&(h=s));if(l>d||u>h)return this;for(this.cover(l,u).cover(d,h),n=0;n<i;++n)X_(this,o[n],a[n],t[n]);return this}function TA(t,e){if(isNaN(t=+t)||isNaN(e=+e))return this;var n=this._x0,i=this._y0,r=this._x1,s=this._y1;if(isNaN(n))r=(n=Math.floor(t))+1,s=(i=Math.floor(e))+1;else{for(var o=r-n||1,a=this._root,l,u;n>t||t>=r||i>e||e>=s;)switch(u=(e<i)<<1|t<n,l=new Array(4),l[u]=a,a=l,o*=2,u){case 0:r=n+o,s=i+o;break;case 1:n=r-o,s=i+o;break;case 2:r=n+o,i=s-o;break;case 3:n=r-o,i=s-o;break}this._root&&this._root.length&&(this._root=a)}return this._x0=n,this._y0=i,this._x1=r,this._y1=s,this}function wA(){var t=[];return this.visit(function(e){if(!e.length)do t.push(e.data);while(e=e.next)}),t}function AA(t){return arguments.length?this.cover(+t[0][0],+t[0][1]).cover(+t[1][0],+t[1][1]):isNaN(this._x0)?void 0:[[this._x0,this._y0],[this._x1,this._y1]]}function rn(t,e,n,i,r){this.node=t,this.x0=e,this.y0=n,this.x1=i,this.y1=r}function RA(t,e,n){var i,r=this._x0,s=this._y0,o,a,l,u,d=this._x1,h=this._y1,f=[],p=this._root,_,v;for(p&&f.push(new rn(p,r,s,d,h)),n==null?n=1/0:(r=t-n,s=e-n,d=t+n,h=e+n,n*=n);_=f.pop();)if(!(!(p=_.node)||(o=_.x0)>d||(a=_.y0)>h||(l=_.x1)<r||(u=_.y1)<s))if(p.length){var m=(o+l)/2,c=(a+u)/2;f.push(new rn(p[3],m,c,l,u),new rn(p[2],o,c,m,u),new rn(p[1],m,a,l,c),new rn(p[0],o,a,m,c)),(v=(e>=c)<<1|t>=m)&&(_=f[f.length-1],f[f.length-1]=f[f.length-1-v],f[f.length-1-v]=_)}else{var g=t-+this._x.call(null,p.data),x=e-+this._y.call(null,p.data),y=g*g+x*x;if(y<n){var R=Math.sqrt(n=y);r=t-R,s=e-R,d=t+R,h=e+R,i=p.data}}return i}function CA(t){if(isNaN(d=+this._x.call(null,t))||isNaN(h=+this._y.call(null,t)))return this;var e,n=this._root,i,r,s,o=this._x0,a=this._y0,l=this._x1,u=this._y1,d,h,f,p,_,v,m,c;if(!n)return this;if(n.length)for(;;){if((_=d>=(f=(o+l)/2))?o=f:l=f,(v=h>=(p=(a+u)/2))?a=p:u=p,e=n,!(n=n[m=v<<1|_]))return this;if(!n.length)break;(e[m+1&3]||e[m+2&3]||e[m+3&3])&&(i=e,c=m)}for(;n.data!==t;)if(r=n,!(n=n.next))return this;return(s=n.next)&&delete n.next,r?(s?r.next=s:delete r.next,this):e?(s?e[m]=s:delete e[m],(n=e[0]||e[1]||e[2]||e[3])&&n===(e[3]||e[2]||e[1]||e[0])&&!n.length&&(i?i[c]=n:this._root=n),this):(this._root=s,this)}function bA(t){for(var e=0,n=t.length;e<n;++e)this.remove(t[e]);return this}function PA(){return this._root}function LA(){var t=0;return this.visit(function(e){if(!e.length)do++t;while(e=e.next)}),t}function NA(t){var e=[],n,i=this._root,r,s,o,a,l;for(i&&e.push(new rn(i,this._x0,this._y0,this._x1,this._y1));n=e.pop();)if(!t(i=n.node,s=n.x0,o=n.y0,a=n.x1,l=n.y1)&&i.length){var u=(s+a)/2,d=(o+l)/2;(r=i[3])&&e.push(new rn(r,u,d,a,l)),(r=i[2])&&e.push(new rn(r,s,d,u,l)),(r=i[1])&&e.push(new rn(r,u,o,a,d)),(r=i[0])&&e.push(new rn(r,s,o,u,d))}return this}function DA(t){var e=[],n=[],i;for(this._root&&e.push(new rn(this._root,this._x0,this._y0,this._x1,this._y1));i=e.pop();){var r=i.node;if(r.length){var s,o=i.x0,a=i.y0,l=i.x1,u=i.y1,d=(o+l)/2,h=(a+u)/2;(s=r[0])&&e.push(new rn(s,o,a,d,h)),(s=r[1])&&e.push(new rn(s,d,a,l,h)),(s=r[2])&&e.push(new rn(s,o,h,d,u)),(s=r[3])&&e.push(new rn(s,d,h,l,u))}n.push(i)}for(;i=n.pop();)t(i.node,i.x0,i.y0,i.x1,i.y1);return this}function IA(t){return t[0]}function UA(t){return arguments.length?(this._x=t,this):this._x}function FA(t){return t[1]}function OA(t){return arguments.length?(this._y=t,this):this._y}function xh(t,e,n){var i=new Sh(e??IA,n??FA,NaN,NaN,NaN,NaN);return t==null?i:i.addAll(t)}function Sh(t,e,n,i,r,s){this._x=t,this._y=e,this._x0=n,this._y0=i,this._x1=r,this._y1=s,this._root=void 0}function Wm(t){for(var e={data:t.data},n=e;t=t.next;)n=n.next={data:t.data};return e}var un=xh.prototype=Sh.prototype;un.copy=function(){var t=new Sh(this._x,this._y,this._x0,this._y0,this._x1,this._y1),e=this._root,n,i;if(!e)return t;if(!e.length)return t._root=Wm(e),t;for(n=[{source:e,target:t._root=new Array(4)}];e=n.pop();)for(var r=0;r<4;++r)(i=e.source[r])&&(i.length?n.push({source:i,target:e.target[r]=new Array(4)}):e.target[r]=Wm(i));return t};un.add=MA;un.addAll=EA;un.cover=TA;un.data=wA;un.extent=AA;un.find=RA;un.remove=CA;un.removeAll=bA;un.root=PA;un.size=LA;un.visit=NA;un.visitAfter=DA;un.x=UA;un.y=OA;function sn(t){return function(){return t}}function ir(t){return(t()-.5)*1e-6}function kA(t){return t.x+t.vx}function BA(t){return t.y+t.vy}function zA(t){var e,n,i,r=1,s=1;typeof t!="function"&&(t=sn(t==null?1:+t));function o(){for(var u,d=e.length,h,f,p,_,v,m,c=0;c<s;++c)for(h=xh(e,kA,BA).visitAfter(a),u=0;u<d;++u)f=e[u],v=n[f.index],m=v*v,p=f.x+f.vx,_=f.y+f.vy,h.visit(g);function g(x,y,R,T,A){var S=x.data,b=x.r,P=v+b;if(S){if(S.index>f.index){var w=p-S.x-S.vx,L=_-S.y-S.vy,z=w*w+L*L;z<P*P&&(w===0&&(w=ir(i),z+=w*w),L===0&&(L=ir(i),z+=L*L),z=(P-(z=Math.sqrt(z)))/z*r,f.vx+=(w*=z)*(P=(b*=b)/(m+b)),f.vy+=(L*=z)*P,S.vx-=w*(P=1-P),S.vy-=L*P)}return}return y>p+P||T<p-P||R>_+P||A<_-P}}function a(u){if(u.data)return u.r=n[u.data.index];for(var d=u.r=0;d<4;++d)u[d]&&u[d].r>u.r&&(u.r=u[d].r)}function l(){if(e){var u,d=e.length,h;for(n=new Array(d),u=0;u<d;++u)h=e[u],n[h.index]=+t(h,u,e)}}return o.initialize=function(u,d){e=u,i=d,l()},o.iterations=function(u){return arguments.length?(s=+u,o):s},o.strength=function(u){return arguments.length?(r=+u,o):r},o.radius=function(u){return arguments.length?(t=typeof u=="function"?u:sn(+u),l(),o):t},o}function VA(t){return t.index}function Xm(t,e){var n=t.get(e);if(!n)throw new Error("node not found: "+e);return n}function HA(t){var e=VA,n=h,i,r=sn(30),s,o,a,l,u,d=1;t==null&&(t=[]);function h(m){return 1/Math.min(a[m.source.index],a[m.target.index])}function f(m){for(var c=0,g=t.length;c<d;++c)for(var x=0,y,R,T,A,S,b,P;x<g;++x)y=t[x],R=y.source,T=y.target,A=T.x+T.vx-R.x-R.vx||ir(u),S=T.y+T.vy-R.y-R.vy||ir(u),b=Math.sqrt(A*A+S*S),b=(b-s[x])/b*m*i[x],A*=b,S*=b,T.vx-=A*(P=l[x]),T.vy-=S*P,R.vx+=A*(P=1-P),R.vy+=S*P}function p(){if(o){var m,c=o.length,g=t.length,x=new Map(o.map((R,T)=>[e(R,T,o),R])),y;for(m=0,a=new Array(c);m<g;++m)y=t[m],y.index=m,typeof y.source!="object"&&(y.source=Xm(x,y.source)),typeof y.target!="object"&&(y.target=Xm(x,y.target)),a[y.source.index]=(a[y.source.index]||0)+1,a[y.target.index]=(a[y.target.index]||0)+1;for(m=0,l=new Array(g);m<g;++m)y=t[m],l[m]=a[y.source.index]/(a[y.source.index]+a[y.target.index]);i=new Array(g),_(),s=new Array(g),v()}}function _(){if(o)for(var m=0,c=t.length;m<c;++m)i[m]=+n(t[m],m,t)}function v(){if(o)for(var m=0,c=t.length;m<c;++m)s[m]=+r(t[m],m,t)}return f.initialize=function(m,c){o=m,u=c,p()},f.links=function(m){return arguments.length?(t=m,p(),f):t},f.id=function(m){return arguments.length?(e=m,f):e},f.iterations=function(m){return arguments.length?(d=+m,f):d},f.strength=function(m){return arguments.length?(n=typeof m=="function"?m:sn(+m),_(),f):n},f.distance=function(m){return arguments.length?(r=typeof m=="function"?m:sn(+m),v(),f):r},f}var GA={value:()=>{}};function j_(){for(var t=0,e=arguments.length,n={},i;t<e;++t){if(!(i=arguments[t]+"")||i in n||/[\s.]/.test(i))throw new Error("illegal type: "+i);n[i]=[]}return new pl(n)}function pl(t){this._=t}function WA(t,e){return t.trim().split(/^|\s+/).map(function(n){var i="",r=n.indexOf(".");if(r>=0&&(i=n.slice(r+1),n=n.slice(0,r)),n&&!e.hasOwnProperty(n))throw new Error("unknown type: "+n);return{type:n,name:i}})}pl.prototype=j_.prototype={constructor:pl,on:function(t,e){var n=this._,i=WA(t+"",n),r,s=-1,o=i.length;if(arguments.length<2){for(;++s<o;)if((r=(t=i[s]).type)&&(r=XA(n[r],t.name)))return r;return}if(e!=null&&typeof e!="function")throw new Error("invalid callback: "+e);for(;++s<o;)if(r=(t=i[s]).type)n[r]=jm(n[r],t.name,e);else if(e==null)for(r in n)n[r]=jm(n[r],t.name,null);return this},copy:function(){var t={},e=this._;for(var n in e)t[n]=e[n].slice();return new pl(t)},call:function(t,e){if((r=arguments.length-2)>0)for(var n=new Array(r),i=0,r,s;i<r;++i)n[i]=arguments[i+2];if(!this._.hasOwnProperty(t))throw new Error("unknown type: "+t);for(s=this._[t],i=0,r=s.length;i<r;++i)s[i].value.apply(e,n)},apply:function(t,e,n){if(!this._.hasOwnProperty(t))throw new Error("unknown type: "+t);for(var i=this._[t],r=0,s=i.length;r<s;++r)i[r].value.apply(e,n)}};function XA(t,e){for(var n=0,i=t.length,r;n<i;++n)if((r=t[n]).name===e)return r.value}function jm(t,e,n){for(var i=0,r=t.length;i<r;++i)if(t[i].name===e){t[i]=GA,t=t.slice(0,i).concat(t.slice(i+1));break}return n!=null&&t.push({name:e,value:n}),t}var Gs=0,vo=0,co=0,Y_=1e3,Wl,xo,Xl=0,Wr=0,hu=0,Zo=typeof performance=="object"&&performance.now?performance:Date,$_=typeof window=="object"&&window.requestAnimationFrame?window.requestAnimationFrame.bind(window):function(t){setTimeout(t,17)};function q_(){return Wr||($_(jA),Wr=Zo.now()+hu)}function jA(){Wr=0}function ud(){this._call=this._time=this._next=null}ud.prototype=K_.prototype={constructor:ud,restart:function(t,e,n){if(typeof t!="function")throw new TypeError("callback is not a function");n=(n==null?q_():+n)+(e==null?0:+e),!this._next&&xo!==this&&(xo?xo._next=this:Wl=this,xo=this),this._call=t,this._time=n,cd()},stop:function(){this._call&&(this._call=null,this._time=1/0,cd())}};function K_(t,e,n){var i=new ud;return i.restart(t,e,n),i}function YA(){q_(),++Gs;for(var t=Wl,e;t;)(e=Wr-t._time)>=0&&t._call.call(void 0,e),t=t._next;--Gs}function Ym(){Wr=(Xl=Zo.now())+hu,Gs=vo=0;try{YA()}finally{Gs=0,qA(),Wr=0}}function $A(){var t=Zo.now(),e=t-Xl;e>Y_&&(hu-=e,Xl=t)}function qA(){for(var t,e=Wl,n,i=1/0;e;)e._call?(i>e._time&&(i=e._time),t=e,e=e._next):(n=e._next,e._next=null,e=t?t._next=n:Wl=n);xo=t,cd(i)}function cd(t){if(!Gs){vo&&(vo=clearTimeout(vo));var e=t-Wr;e>24?(t<1/0&&(vo=setTimeout(Ym,t-Zo.now()-hu)),co&&(co=clearInterval(co))):(co||(Xl=Zo.now(),co=setInterval($A,Y_)),Gs=1,$_(Ym))}}const KA=1664525,ZA=1013904223,$m=4294967296;function QA(){let t=1;return()=>(t=(KA*t+ZA)%$m)/$m}function JA(t){return t.x}function eR(t){return t.y}var tR=10,nR=Math.PI*(3-Math.sqrt(5));function iR(t){var e,n=1,i=.001,r=1-Math.pow(i,1/300),s=0,o=.6,a=new Map,l=K_(h),u=j_("tick","end"),d=QA();t==null&&(t=[]);function h(){f(),u.call("tick",e),n<i&&(l.stop(),u.call("end",e))}function f(v){var m,c=t.length,g;v===void 0&&(v=1);for(var x=0;x<v;++x)for(n+=(s-n)*r,a.forEach(function(y){y(n)}),m=0;m<c;++m)g=t[m],g.fx==null?g.x+=g.vx*=o:(g.x=g.fx,g.vx=0),g.fy==null?g.y+=g.vy*=o:(g.y=g.fy,g.vy=0);return e}function p(){for(var v=0,m=t.length,c;v<m;++v){if(c=t[v],c.index=v,c.fx!=null&&(c.x=c.fx),c.fy!=null&&(c.y=c.fy),isNaN(c.x)||isNaN(c.y)){var g=tR*Math.sqrt(.5+v),x=v*nR;c.x=g*Math.cos(x),c.y=g*Math.sin(x)}(isNaN(c.vx)||isNaN(c.vy))&&(c.vx=c.vy=0)}}function _(v){return v.initialize&&v.initialize(t,d),v}return p(),e={tick:f,restart:function(){return l.restart(h),e},stop:function(){return l.stop(),e},nodes:function(v){return arguments.length?(t=v,p(),a.forEach(_),e):t},alpha:function(v){return arguments.length?(n=+v,e):n},alphaMin:function(v){return arguments.length?(i=+v,e):i},alphaDecay:function(v){return arguments.length?(r=+v,e):+r},alphaTarget:function(v){return arguments.length?(s=+v,e):s},velocityDecay:function(v){return arguments.length?(o=1-v,e):1-o},randomSource:function(v){return arguments.length?(d=v,a.forEach(_),e):d},force:function(v,m){return arguments.length>1?(m==null?a.delete(v):a.set(v,_(m)),e):a.get(v)},find:function(v,m,c){var g=0,x=t.length,y,R,T,A,S;for(c==null?c=1/0:c*=c,g=0;g<x;++g)A=t[g],y=v-A.x,R=m-A.y,T=y*y+R*R,T<c&&(S=A,c=T);return S},on:function(v,m){return arguments.length>1?(u.on(v,m),e):u.on(v)}}}function rR(){var t,e,n,i,r=sn(-30),s,o=1,a=1/0,l=.81;function u(p){var _,v=t.length,m=xh(t,JA,eR).visitAfter(h);for(i=p,_=0;_<v;++_)e=t[_],m.visit(f)}function d(){if(t){var p,_=t.length,v;for(s=new Array(_),p=0;p<_;++p)v=t[p],s[v.index]=+r(v,p,t)}}function h(p){var _=0,v,m,c=0,g,x,y;if(p.length){for(g=x=y=0;y<4;++y)(v=p[y])&&(m=Math.abs(v.value))&&(_+=v.value,c+=m,g+=m*v.x,x+=m*v.y);p.x=g/c,p.y=x/c}else{v=p,v.x=v.data.x,v.y=v.data.y;do _+=s[v.data.index];while(v=v.next)}p.value=_}function f(p,_,v,m){if(!p.value)return!0;var c=p.x-e.x,g=p.y-e.y,x=m-_,y=c*c+g*g;if(x*x/l<y)return y<a&&(c===0&&(c=ir(n),y+=c*c),g===0&&(g=ir(n),y+=g*g),y<o&&(y=Math.sqrt(o*y)),e.vx+=c*p.value*i/y,e.vy+=g*p.value*i/y),!0;if(p.length||y>=a)return;(p.data!==e||p.next)&&(c===0&&(c=ir(n),y+=c*c),g===0&&(g=ir(n),y+=g*g),y<o&&(y=Math.sqrt(o*y)));do p.data!==e&&(x=s[p.data.index]*i/y,e.vx+=c*x,e.vy+=g*x);while(p=p.next)}return u.initialize=function(p,_){t=p,n=_,d()},u.strength=function(p){return arguments.length?(r=typeof p=="function"?p:sn(+p),d(),u):r},u.distanceMin=function(p){return arguments.length?(o=p*p,u):Math.sqrt(o)},u.distanceMax=function(p){return arguments.length?(a=p*p,u):Math.sqrt(a)},u.theta=function(p){return arguments.length?(l=p*p,u):Math.sqrt(l)},u}function sR(t){var e=sn(.1),n,i,r;typeof t!="function"&&(t=sn(t==null?0:+t));function s(a){for(var l=0,u=n.length,d;l<u;++l)d=n[l],d.vx+=(r[l]-d.x)*i[l]*a}function o(){if(n){var a,l=n.length;for(i=new Array(l),r=new Array(l),a=0;a<l;++a)i[a]=isNaN(r[a]=+t(n[a],a,n))?0:+e(n[a],a,n)}}return s.initialize=function(a){n=a,o()},s.strength=function(a){return arguments.length?(e=typeof a=="function"?a:sn(+a),o(),s):e},s.x=function(a){return arguments.length?(t=typeof a=="function"?a:sn(+a),o(),s):t},s}function oR(t){var e=sn(.1),n,i,r;typeof t!="function"&&(t=sn(t==null?0:+t));function s(a){for(var l=0,u=n.length,d;l<u;++l)d=n[l],d.vy+=(r[l]-d.y)*i[l]*a}function o(){if(n){var a,l=n.length;for(i=new Array(l),r=new Array(l),a=0;a<l;++a)i[a]=isNaN(r[a]=+t(n[a],a,n))?0:+e(n[a],a,n)}}return s.initialize=function(a){n=a,o()},s.strength=function(a){return arguments.length?(e=typeof a=="function"?a:sn(+a),o(),s):e},s.y=function(a){return arguments.length?(t=typeof a=="function"?a:sn(+a),o(),s):t},s}const Z_={id:"nevverland",label:"Nevverland",copy:"An experimental practice. Navigation as material, type as structure, imagery as weather. Built fast, kept forever — every study frozen the moment it works.",img:"img/03.jpg",children:[{id:"work",label:"Work",copy:"Studies in interfaces that behave like places — each one rebuilds a piece of the 2007 spatial web with today’s physics.",img:"img/07.jpg",children:[{id:"nike",label:"Nike",img:"img/00.jpg",copy:"Motion identity sprints. Twelve directions in ten days.",media:[{type:"video",src:"img/nike.mp4"},{type:"img",src:"img/00.jpg"},{type:"img",src:"img/03.jpg"},{type:"img",src:"img/05.jpg"}]},{id:"hbo",label:"HBO",img:"img/14.jpg",copy:"Title sequences as navigation. The menu is the trailer.",media:[{type:"img",src:"img/14.jpg"},{type:"video",src:"img/hbo.mp4"},{type:"img",src:"img/11.jpg"}]},{id:"sony",label:"Sony",img:"img/17.jpg",copy:"Product stories told through a bent lens.",media:[{type:"img",src:"img/17.jpg"},{type:"img",src:"img/09.jpg"},{type:"video",src:"img/sony.mp4"},{type:"img",src:"img/07.jpg"}]},{id:"pepsi",label:"Pepsi",img:"img/21.jpg",copy:"Liquid type systems for a liquid product.",media:[{type:"img",src:"img/21.jpg"},{type:"img",src:"img/34.jpg"},{type:"img",src:"img/38.jpg"}]},{id:"experimental",label:"Experimental",img:"img/28.jpg",copy:"The unbriefed work. Where the other four came from.",media:[{type:"video",src:"img/experimental.mp4"},{type:"img",src:"img/28.jpg"},{type:"img",src:"img/11.jpg"},{type:"img",src:"img/09.jpg"}]}]},{id:"about",label:"About",copy:"Nevverland is the studio of Nessim Higson — I AM ALWAYS HUNGRY. Twenty years of brand and interactive work, currently obsessed with making the web feel hand-made again. Small team, long leash, no templates.",img:"img/05.jpg",children:[{id:"studio",label:"Studio",img:"img/09.jpg",copy:"A room with good light, too many books, and a server that never sleeps."},{id:"people",label:"People",img:"img/11.jpg",copy:"One founder, many collaborators, several machines that think."},{id:"process",label:"Process",img:"img/34.jpg",copy:"Prototype first. Theory later, if ever. Ship the sketch."}]},{id:"info",label:"Info",copy:"Field notes and colophon. Set in Helvetica because the grid deserves respect; broken on purpose where it doesn’t. All imagery from the Uniqlock sessions.",img:"img/38.jpg",children:[{id:"notes",label:"Notes",img:"img/03.jpg",copy:"Working notes from each experiment, unedited."},{id:"colophon",label:"Colophon",img:"img/05.jpg",copy:"React + d3-force for the organic modes; just slots and springs for the structural ones."},{id:"archive",label:"Archive",img:"img/07.jpg",copy:"Frozen versions of everything, kept forever."}]},{id:"contact",label:"Contact",copy:"Always hungry. Say hello.",img:"img/09.jpg",children:[{id:"newyork",label:"New York",img:"img/11.jpg",copy:"EST, for now."},{id:"losangeles",label:"Los Angeles",img:"img/14.jpg",copy:"Golden hour, permanently."},{id:"email",label:"Email",img:"img/21.jpg",copy:"ness@iamalwayshungry.com"}]}]};function aR(t,e,n){const i=e.get(t.id);return n==="type"?Ut(i)*.8+2:sh[i].radius+Ee.COLLIDE_PADDING}function lR(t,e,n=1){function i(r){const s=t();if(!s)return;const o=Ee.CHILD_RING*n*Ee.VIEWPORT_SCALE;for(const a of e()){let l=a.x-s.x,u=a.y-s.y,d=Math.sqrt(l*l+u*u);d<1&&(l=Math.cos(a.phase),u=Math.sin(a.phase),d=1);const h=(o-d)/d*Ee.CHILD_RING_STRENGTH*r;a.vx+=l*h,a.vy+=u*h}}return i.initialize=()=>{},i}function uR(){let t=[],e=0;function n(){e+=.006;for(const i of t)i.vx+=Math.cos(e*i.driftSpeed+i.phase)*Ee.DRIFT*.1,i.vy+=Math.sin(e*i.driftSpeed*1.37+i.phase)*Ee.DRIFT*.1}return n.initialize=i=>t=i,n}function cR(t){let e=0;for(const n of t)e=(e*31+n.charCodeAt(0))%997;return e}function fR(t,e=bt.STRENGTH){function n(i){for(const r of t){const s=r.anchor.x+r.dx,o=r.anchor.y+r.dy;r.node.vx+=(s-r.node.x)*e*i,r.node.vy+=(o-r.node.y)*e*i}}return n.initialize=()=>{},n}function dR(t,e,n,i,r=0){const s=i.get(t),o=zr(t,i),a=[],l=Ee.VIEWPORT_SCALE,u=Math.max(bt.COL_W*l*.78,bo(s.label,Ut("active"))+30*l),d=bt.BREAD_STEP*l,h=Math.max(bt.GAP*l,Ut("child")*1.7+6),f=Math.max(bt.GAP_DISTANT*l,Ut("distant")*2+8);for(const p of e){const _=n.get(p.id);if(_==="child"){const v=s.childIds.indexOf(p.id);a.push({node:p,anchor:s,dx:u,dy:bt.CHILD_DROP+r+v*h})}else if(_==="sibling"){const v=i.get(s.parentId).childIds,m=v.indexOf(p.id)-v.indexOf(t);a.push({node:p,anchor:s,dx:0,dy:m*h+(m>0?bt.ACTIVE_CLEAR+r:0)})}else if(_==="parent"){const v=o.indexOf(p.id)+1;a.push({node:p,anchor:s,dx:-d*v,dy:-bt.ROW_LIFT*l*v})}else if(_==="distant"){const v=i.get(p.parentId).childIds,m=e.find(g=>g.parentId===p.parentId&&(n.get(g.id)==="parent"||g.id===t));if(!m)continue;const c=v.indexOf(p.id)-v.indexOf(m.id);a.push({node:p,anchor:m,dx:0,dy:c*f+(c>0?10:-6)})}}return a}function hR(t,e,n,i,r,s,o){const a=i.get(t),l=zr(t,i),u=[],d=Ut("active",a.label,s),h=Math.max(bt.GAP,Ut("child")*2.15),f=Math.max(30,Ut("sibling")*2.6),p=c=>o?(cR(c)%100/50-1)*o:0;l.forEach((c,g)=>{u.push({node:i.get(c),anchor:a,dx:p(c)*.6,dy:-(d*.55+34+g*34)})});const _=a.childIds.filter(c=>n.has(c)),v=d*.55+26+r;_.forEach((c,g)=>{u.push({node:i.get(c),anchor:a,dx:p(c),dy:v+g*h})});let m=v+_.length*h+30;if(a.parentId)for(const c of i.get(a.parentId).childIds)c===t||!n.has(c)||(u.push({node:i.get(c),anchor:a,dx:p(c),dy:m}),m+=f);m+=18;for(const c of e)n.get(c.id)==="distant"&&(u.push({node:c,anchor:a,dx:p(c.id),dy:m}),m+=27);return u}function pR(t,e){let n=[];function i(r){const s=Ee.CONTAIN_MARGIN*Ee.VIEWPORT_SCALE;for(const o of n)o.x<s&&(o.vx+=(s-o.x)*Ee.CONTAIN_STRENGTH*r),o.x>t-s&&(o.vx-=(o.x-(t-s))*Ee.CONTAIN_STRENGTH*r),o.y<s&&(o.vy+=(s-o.y)*Ee.CONTAIN_STRENGTH*r),o.y>e-s&&(o.vy-=(o.y-(e-s))*Ee.CONTAIN_STRENGTH*r)}return i.initialize=r=>n=r,i}function mR(t){let e=[];function i(){if(!(!Ee.CURSOR||t.x==null))for(const r of e){const s=t.x-r.x,o=t.y-r.y,a=Math.hypot(s,o);if(a>300||a<2)continue;const l=Ee.CURSOR*(1-a/300)*.18;r.vx+=s/a*l,r.vy+=o/a*l}}return i.initialize=r=>e=r,i}function gR(t,e,n,i="type",r=0){const[,s]=ke.useState(0),o=ke.useRef(null);if(!o.current){const{nodes:d,byId:h}=IS(Z_);for(const f of d)f.phase=Math.random()*Math.PI*2,f.driftSpeed=.5+Math.random(),f.everShown=!1;o.current={sim:iR([]).stop(),nodes:d,byId:h,roles:new Map,seeded:!1,pointer:{x:null,y:null},prevFocus:null}}const{sim:a,nodes:l,byId:u}=o.current;return ke.useEffect(()=>{if(!e||!n)return;const d=i==="focus"||i==="rings"||i==="weight",h=i==="orbs"||d?"orbs":"type",f=e/2,p=n/2;if(!o.current.seeded){for(const w of l)w.x=e/2+(Math.random()-.5)*60,w.y=n/2+(Math.random()-.5)*60;o.current.seeded=!0}const _=US(t,u);o.current.roles=_;const v=w=>_.get(w.id),m=l.filter(w=>_.has(w.id));for(const w of m)if(!w.everShown){const L=w.parentId?u.get(w.parentId):null;L&&L.everShown&&(w.x=L.x+(Math.random()-.5)*40,w.y=L.y+(Math.random()-.5)*40),w.everShown=!0}const c=[];for(const w of m){if(!w.parentId||!_.has(w.parentId))continue;const L=v(w),z=L==="child"?"activeChild":L==="active"||L==="parent"?"breadcrumb":L==="sibling"?"sibling":"distant";c.push({source:w.parentId,target:w.id,kind:z})}o.current.links=c;for(const w of["charge","link","collide","x","y","ring","drift","contain","pointer"])a.force(w,null);a.nodes(m),a.velocityDecay(Ee.DAMPING);const g=h==="type"?bt.CHARGE_SCALE:1;a.force("charge",rR().strength(w=>Ee.CHARGE*sh[v(w)].scale*g*Ee.VIEWPORT_SCALE).distanceMax(Ee.CHARGE_MAX_DISTANCE*Ee.VIEWPORT_SCALE)),a.force("link",HA(c).id(w=>w.id).distance(w=>Ee.LINK_DISTANCE[w.kind]*Ee.VIEWPORT_SCALE).strength(h==="type"?bt.LINK_STRENGTH:.6)),a.force("collide",zA(w=>d?bo(w.label,Ut(v(w)))*.42+6+Ee.SPACING*.5:aR(w,_,h)+(h==="type"?Ee.SPACING*.25:0)).strength(Ee.COLLIDE_STRENGTH).iterations(2));const x=i==="structure"||i==="imagery",y=zr(t,u).length,R=u.get(t),T=R.childIds.filter(w=>_.has(w)),A=R.parentId?u.get(R.parentId).childIds.filter(w=>_.has(w)&&w!==t).length:0;let S,b;if(h==="type"){const w=Ee.VIEWPORT_SCALE,L=Ut("active",R.label,e),z=Math.max(bt.GAP*w,Ut("child")*1.7+6),Y=(x||i==="depth")&&R.copy?Math.min(150,Math.ceil(R.copy.length/48)*21+26):0,D=y*(x?34:bt.ROW_LIFT*w*.7)+L*.5+30,k=L*.5+Y+T.length*z+(A?30+A*(x?30:0):0);b=n*.46-(k-D)/2;const O=Math.max(28,e*.06),F=x?0:Math.max(bt.COL_W*w*.78,bo(R.label,L)+30*w);let X=0;for(const fe of T)X=Math.max(X,bo(u.get(fe).label,Ut("child")));const $=x?O:O+y*bt.BREAD_STEP*w,te=e-24-F-X;S=Math.max(O,Math.min($,Math.max(O,te)))}else S=f,b=p;if(a.force("x",sR(S).strength(w=>v(w)==="active"?Ee.CENTER_PULL_ACTIVE:Ee.CENTER_PULL_OTHERS)),a.force("y",oR(w=>v(w)==="parent"&&h!=="type"?p-Ee.BREADCRUMB_LIFT:b).strength(w=>{const L=v(w);return L==="active"?Ee.CENTER_PULL_ACTIVE:L==="parent"?Ee.BREADCRUMB_PULL:Ee.CENTER_PULL_OTHERS})),h==="type"){const w=u.get(t),L=(x||i==="depth")&&w.copy?Math.min(150,Math.ceil(w.copy.length/48)*21+26):0,z=x?hR(t,m,_,u,L,e,i==="structure"?0:bt.LOOSE):dR(t,m,_,u,L);a.force("ring",fR(z,x?.9:bt.STRENGTH))}else a.force("ring",lR(()=>u.get(t),()=>m.filter(w=>v(w)==="child"),d?1.5:1));a.force("drift",uR()),a.force("contain",pR(e,n)),a.force("pointer",mR(o.current.pointer));const P=u.get(t);if(Ee.SHOCK>0&&o.current.prevFocus&&o.current.prevFocus!==t&&P.x!=null)for(const w of m){if(w===P||w.x==null)continue;const L=w.x-P.x,z=w.y-P.y,Y=Math.hypot(L,z)||1,D=Ee.SHOCK*Math.min(1,220/Y);w.vx+=L/Y*D,w.vy+=z/Y*D}return o.current.prevFocus=t,a.on("tick",()=>s(w=>w+1)),a.alpha(Ee.ALPHA_KICK).alphaTarget(Ee.DRIFT>.015?Ee.IDLE_ALPHA:0).restart(),s(w=>w+1),()=>a.on("tick",null)},[t,e,n,i,r]),ke.useEffect(()=>()=>a.stop(),[]),{visibleNodes:l.filter(d=>o.current.roles.has(d.id)),links:o.current.links||[],roles:o.current.roles,byId:u,pointer:o.current.pointer}}function qm(t){return Math.max(.5,Math.min(1,(t-80)/1e3))}const _R=Z_.id,vR=[{key:"type",label:"01 ORGANIC"},{key:"orbs",label:"02 ORBS"},{key:"structure",label:"03 STRUCTURE"},{key:"imagery",label:"04 IMAGERY"},{key:"depth",label:"05 DEPTH"},{key:"focus",label:"06 FOCAL"},{key:"rings",label:"07 RINGS"},{key:"weight",label:"08 WEIGHT"}];function xR(){const[t,e]=ke.useState(_R),[n,i]=ke.useState("focus"),[r,s]=ke.useState(0),[o,a]=ke.useState(!1),l=ke.useRef(null),[u,d]=ke.useState({width:0,height:0});ke.useEffect(()=>{const _=v=>{(v.key==="h"||v.key==="H")&&a(m=>!m)};return window.addEventListener("keydown",_),()=>window.removeEventListener("keydown",_)},[]),ke.useEffect(()=>{const _=l.current,v=_.getBoundingClientRect();Ee.VIEWPORT_SCALE=qm(v.width),d({width:v.width,height:v.height});const m=new ResizeObserver(([c])=>{const{width:g,height:x}=c.contentRect;Ee.VIEWPORT_SCALE=qm(g),d({width:g,height:x})});return m.observe(_),()=>m.disconnect()},[]);const h=gR(t,u.width,u.height,n,r);ke.useEffect(()=>{const _=v=>{v.key==="fb-nav"&&v.newValue&&h.byId.has(v.newValue)&&e(v.newValue)};return window.addEventListener("storage",_),()=>window.removeEventListener("storage",_)},[h.byId]);const f=_=>{const v=_.id===t?_.parentId:_.id;if(v){e(v);try{localStorage.setItem("fb-nav",v)}catch{}}},p=[t,...zr(t,h.byId)].reverse().map(_=>h.byId.get(_).label);return ue.jsxs("div",{className:`stage ${o?"bare":""}`,ref:l,onMouseMove:_=>{h.pointer.x=_.clientX,h.pointer.y=_.clientY},onMouseLeave:()=>{h.pointer.x=null,h.pointer.y=null},children:[u.width>0&&(n==="focus"?ue.jsx(mA,{sim:h,activeId:t,width:u.width,height:u.height,onNavigate:f}):n==="rings"?ue.jsx(_A,{sim:h,activeId:t,width:u.width,height:u.height,onNavigate:f}):n==="weight"?ue.jsx(xA,{sim:h,activeId:t,width:u.width,onNavigate:f}):ue.jsx(VS,{width:u.width,height:u.height,sim:h,activeId:t,mode:n,onNavigate:f})),ue.jsx(yA,{onTune:()=>s(_=>_+1)}),ue.jsxs("header",{className:"chrome top",children:[ue.jsx("span",{className:"wordmark",children:"NEVVERLAND"}),ue.jsx("span",{className:"trail",children:p.join("  /  ")})]}),ue.jsxs("footer",{className:"chrome bottom",children:[ue.jsx("span",{className:"hint",children:"CLICK A NODE TO NAVIGATE — CLICK THE FOCUS TO STEP BACK — H FOR CLEAN VIEW"}),ue.jsx("span",{className:"switch",children:vR.map(_=>ue.jsx("button",{className:n===_.key?"on":"",onClick:()=>i(_.key),children:_.label},_.key))})]})]})}Ec.createRoot(document.getElementById("root")).render(ue.jsx(Mv.StrictMode,{children:ue.jsx(xR,{})}));
