...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ci,depthTest:!1,depthWrite:!1})}function d1(t,e,n){const i=new Float32Array(Cr),r=new W(0,1,0);return new Zn({name:"SphericalGaussianBlur",defines:{n:Cr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${t}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:fu(),fragmentShader:`
	...
	`}class B_ extends fi{constructor(e=1,n={}){super(e,e,n),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},r=[i,i,i,i,i,i];this.texture=new D_(r),this._setTextureOptions(n),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,n){this.texture.type=n.type,this.texture.colorSpace=n.colorSpace,this.texture.generateMipmaps=n.generateMipmaps,this.texture.minFilter=n.minFilter,this.texture.magFilter=n.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new sa(5,5,5),s=new Zn({name:"CubemapFromEquirect",uniforms:Hs(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:gn,blending:Ci});s.uniforms.tEquirect.value=n;const o=new pi(r,s),a=n.minFilter;return n.minFilter===Nr&&(n.minFilter=Vt),new _M(1,10,this).update(e,o),n.minFilter=a,o.geometry.dispose(),o.material.dispose(),this}clear(e,n=!0,i=!0,r=!0){const s=e.getRenderTarget();for(let o=0;o<6;o++)e.setRenderTarget(this,o),e.clear(n,i,r);e.setRenderTarget(s)}}function h1(t){let e=new WeakMap,n=new WeakMap,i=null;function r(f,p=!1){return f==null?null:p?o(f):s(f)}function s(f){if(f&&f.isTexture){const p=f.mapping;if(p===Gu||p===Wu)if(e.has(f)){const _=e.get(f).texture;return a(_,f.mapping)}else{const _=f.image;if(_&&_.height>0){const v=new B_(_.height);return v.fromEquirectangularTexture(t,f),e.set(f,v),f.addEventListener("dispose",u),a(v.texture,f.mapping)}else return null}}return f}function o(f){if(f&&f.isTexture){const p=f.mapping,_=p===Gu||p===Wu,v=p===Vr||p===zs;if(_||v){let m=n.get(f);const c=m!==void 0?m.texture.pmremVersion:0;if(f.isRenderTargetTexture&&f.pmremVersion!==c)return i===null&&(i=new Mm(t)),m=_?i.fromEquirectangular(f,m):i.fromCubemap(f,m),m.texture.pmremVersion=f.pmremVersion,n.set(f,m),m.texture;if(m!==void 0)return m.texture;{const g=f.image;return _&&g&&g.height>0||v&&g&&l(g)?(i===null&&(i=new Mm(t)),m=_?i.fromEquirectangular(f):i.fromCubemap(f),m.texture.pmremVersion=f.pmremVersion,n.set(f,m),f.addEventListener("dispose",d),m.texture):null}}}return f}function a(f,p){return p===Gu?f.mapping=Vr:p===Wu&&(f.mapping=zs),f}function l(f){let p=0;const _=6;for(let v=0;v<_;v++)f[v]!==void 0&&p++;return p===_}function u(f){const p=f.target;p.removeEventListener("dispose",u);const _=e.get(p);_!==void 0&&(e.delete(p),_.dispose())}function d(f){const p=f.target;p.removeEventListener("dispose",d);const _=n.get(p);_!==void 0&&(n.delete(p),_.dispose())}function h(){e=new WeakMap,n=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:h}}function p1(t){const e={};function n(i){if(e[i]!==void 0)return e[i];const r=t.getExtension(i);return e[i]=r,r}return{has:function(i){return n(i)!==null},init:function(){n("EXT_color_buffer_float"),n("WEBGL_clip_cull_distance"),n("OES_texture_float_linear"),n("EXT_color_buffer_half_float"),n("WEBGL_multisampled_render_to_texture"),n("WEBGL_render_shared_exponent")},get:function(i){const r=n(i);return r===null&&rd("WebGLRenderer: "+i+" extension not supported."),r}}}function m1(t,e,n,i){const r={},s=new WeakMap;function o(h){const f=h.target;f.index!==null&&e.remove(f.index);for(const _ in f.attributes)e.remove(f.attributes[_]);f.removeEventListener("dispose",o),delete r[f.id];const p=s.get(f);p&&(e.remove(p),s.delete(f)),i.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,n.memory.geometries--}function a(h,f){return r[f.id]===!0||(f.addEventListener("dispose",o),r[f.id]=!0,n.memory.geometries++),f}function l(h){const f=h.attributes;for(const p in f)e.update(f[p],t.ARRAY_BUFFER)}function u(h){const f=[],p=h.index,_=h.attributes.position;let v=0;if(_===void 0)return;if(p!==null){const g=p.array;v=p.version;for(let x=0,y=g.length;x<y;x+=3){const A=g[x+0],T=g[x+1],C=g[x+2];f.push(A,T,T,C,C,A)}}else{const g=_.array;v=_.version;for(let x=0,y=g.length/3-1;x<y;x+=3){const A=x+0,T=x+1,C=x+2;f.push(A,T,T,C,C,A)}}const m=new(_.count>=65535?P_:b_)(f,1);m.version=v;const c=s.get(h);c&&e.remove(c),s.set(h,m)}function d(h){const f=s.get(h);if(f){const p=h.index;p!==null&&f.version<p.version&&u(h)}else u(h);return s.get(h)}return{get:a,update:l,getWireframeAttribute:d}}function g1(t,e,n){let i;function r(h){i=h}let s,o;function a(h){s=h.type,o=h.bytesPerElement}function l(h,f){t.drawElements(i,f,s,h*o),n.update(f,i,1)}function u(h,f,p){p!==0&&(t.drawElementsInstanced(i,f,s,h*o,p),n.update(f,i,p))}function d(h,f,p){if(p===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,f,0,s,h,0,p);let v=0;for(let m=0;m<p;m++)v+=f[m];n.update(v,i,1)}this.setMode=r,this.setIndex=a,this.render=l,this.renderInstances=u,this.renderMultiDraw=d}function _1(t){const e={geometries:0,textures:0},n={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(n.calls++,o){case t.TRIANGLES:n.triangles+=a*(s/3);break;case t.LINES:n.lines+=a*(s/2);break;case t.LINE_STRIP:n.lines+=a*(s-1);break;case t.LINE_LOOP:n.lines+=a*s;break;case t.POINTS:n.points+=a*s;break;default:Ke("WebGLInfo: Unknown draw mode:",o);break}}function r(){n.calls=0,n.triangles=0,n.points=0,n.lines=0}return{memory:e,render:n,programs:null,autoReset:!0,reset:r,update:i}}function v1(t,e,n){const i=new WeakMap,r=new Rt;function s(o,a,l){const u=o.morphTargetInfluences,d=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=d!==void 0?d.length:0;let f=i.get(a);if(f===void 0||f.count!==h){let P=function(){S.dispose(),i.delete(a),a.removeEventListener("dispose",P)};var p=P;f!==void 0&&f.texture.dispose();const _=a.morphAttributes.position!==void 0,v=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,c=a.morphAttributes.position||[],g=a.morphAttributes.normal||[],x=a.morphAttributes.color||[];let y=0;_===!0&&(y=1),v===!0&&(y=2),m===!0&&(y=3);let A=a.attributes.position.count*y,T=1;A>e.maxTextureSize&&(T=Math.ceil(A/e.maxTextureSize),A=e.maxTextureSize);const C=new Float32Array(A*T*4*h),S=new A_(C,A,T,h);S.type=oi,S.needsUpdate=!0;const b=y*4;for(let w=0;w<h;w++){const N=c[w],D=g[w],G=x[w],L=A*T*4*w;for(let F=0;F<N.count;F++){const k=F*b;_===!0&&(r.fromBufferAttribute(N,F),C[L+k+0]=r.x,C[L+k+1]=r.y,C[L+k+2]=r.z,C[L+k+3]=0),v===!0&&(r.fromBufferAttribute(D,F),C[L+k+4]=r.x,C[L+k+5]=r.y,C[L+k+6]=r.z,C[L+k+7]=0),m===!0&&(r.fromBufferAttribute(G,F),C[L+k+8]=r.x,C[L+k+9]=r.y,C[L+k+10]=r.z,C[L+k+11]=G.itemSize===4?r.w:1)}}f={count:h,texture:S,size:new st(A,T)},i.set(a,f),a.addEventListener("dispose",P)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(t,"morphTexture",o.morphTexture,n);else{let _=0;for(let m=0;m<u.length;m++)_+=u[m];const v=a.morphTargetsRelative?1:1-_;l.getUniforms().setValue(t,"morphTargetBaseInfluence",v),l.getUniforms().setValue(t,"morphTargetInfluences",u)}l.getUniforms().setValue(t,"morphTargetsTexture",f.texture,n),l.getUniforms().setValue(t,"morphTargetsTextureSize",f.size)}return{update:s}}function x1(t,e,n,i,r){let s=new WeakMap;function o(u){const d=r.render.frame,h=u.geometry,f=e.get(u,h);if(s.get(f)!==d&&(e.update(f),s.set(f,d)),u.isInstancedMesh&&(u.hasEventListener("dispose",l)===!1&&u.addEventListener("dispose",l),s.get(u)!==d&&(n.update(u.instanceMatrix,t.ARRAY_BUFFER),u.instanceColor!==null&&n.update(u.instanceColor,t.ARRAY_BUFFER),s.set(u,d))),u.isSkinnedMesh){const p=u.skeleton;s.get(p)!==d&&(p.update(),s.set(p,d))}return f}function a(){s=new WeakMap}function l(u){const d=u.target;d.removeEventListener("dispose",l),i.releaseStatesOfObject(d),n.remove(d.instanceMatrix),d.instanceColor!==null&&n.remove(d.instanceColor)}return{update:o,dispose:a}}const S1={[c_]:"LINEAR_TONE_MAPPING",[f_]:"REINHARD_TONE_MAPPING",[d_]:"CINEON_TONE_MAPPING",[h_]:"ACES_FILMIC_TONE_MAPPING",[m_]:"AGX_TONE_MAPPING",[g_]:"NEUTRAL_TONE_MAPPING",[p_]:"CUSTOM_TONE_MAPPING"};function y1(t,e,n,i,r){const s=new fi(e,n,{type:t,depthBuffer:i,stencilBuffer:r,depthTexture:i?new Vs(e,n):void 0}),o=new fi(e,n,{type:Fi,depthBuffer:!1,stencilBuffer:!1}),a=new Bi;a.setAttribute("position",new Pi([-1,3,0,-1,-1,0,3,-1,0],3)),a.setAttribute("uv",new Pi([0,2,0,0,2,0],2));const l=new cM({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),u=new pi(a,l),d=new vh(-1,1,1,-1,0,1);let h=null,f=null,p=!1,_,v=null,m=[],c=!1;this.setSize=function(g,x){s.setSize(g,x),o.setSize(g,x);for(let y=0;y<m.length;y++){const A=m[y];A.setSize&&A.setSize(g,x)}},this.setEffects=function(g){m=g,c=m.length>0&&m[0].isRenderPass===!0;const x=s.width,y=s.height;for(let A=0;A<m.length;A++){const T=m[A];T.setSize&&T.setSize(x,y)}},this.begin=function(g,x){if(p||g.toneMapping===ci&&m.length===0)return!1;if(v=x,x!==null){const y=x.width,A=x.height;(s.width!==y||s.height!==A)&&this.setSize(y,A)}return c===!1&&g.setRenderTarget(s),_=g.toneMapping,g.toneMapping=ci,!0},this.hasRenderPass=function(){return c},this.end=function(g,x){g.toneMapping=_,p=!0;let y=s,A=o;for(let T=0;T<m.length;T++){const C=m[T];if(C.enabled!==!1&&(C.render(g,A,y,x),C.needsSwap!==!1)){const S=y;y=A,A=S}}if(h!==g.outputColorSpace||f!==g.toneMapping){h=g.outputColorSpace,f=g.toneMapping,l.defines={},$e.getTransfer(h)===Je&&(l.defines.SRGB_TRANSFER="");const T=S1[f];T&&(l.defines[T]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=y.texture,g.setRenderTarget(v),g.render(u,d),v=null,p=!1},this.isCompositing=function(){return p},this.dispose=function(){s.depthTexture&&s.depthTexture.dispose(),s.dispose(),o.dispose(),a.dispose(),l.dispose()}}const z_=new jt,od=new Vs(1,1),V_=new A_,H_=new By,G_=new D_,Am=[],Rm=[],Cm=new Float32Array(16),bm=new Float32Array(9),Pm=new Float32Array(4);function Ys(t,e,n){const i=t[0];if(i<=0||i>0)return t;const r=e*n;let s=Am[r];if(s===void 0&&(s=new Float32Array(r),Am[r]=s),e!==0){i.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=n,t[o].toArray(s,a)}return s}function Ot(t,e){if(t.length!==e.length)return!1;for(let n=0,i=t.length;n<i;n++)if(t[n]!==e[n])return!1;return!0}function kt(t,e){for(let n=0,i=e.length;n<i;n++)t[n]=e[n]}function du(t,e){let n=Rm[e];n===void 0&&(n=new Int32Array(e),Rm[e]=n);for(let i=0;i!==e;++i)n[i]=t.allocateTextureUnit();return n}function M1(t,e){const n=this.cache;n[0]!==e&&(t.uniform1f(this.addr,e),n[0]=e)}function E1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2f(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Ot(n,e))return;t.uniform2fv(this.addr,e),kt(n,e)}}function T1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3f(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else if(e.r!==void 0)(n[0]!==e.r||n[1]!==e.g||n[2]!==e.b)&&(t.uniform3f(this.addr,e.r,e.g,e.b),n[0]=e.r,n[1]=e.g,n[2]=e.b);else{if(Ot(n,e))return;t.uniform3fv(this.addr,e),kt(n,e)}}function w1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4f(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Ot(n,e))return;t.uniform4fv(this.addr,e),kt(n,e)}}function A1(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(Ot(n,e))return;t.uniformMatrix2fv(this.addr,!1,e),kt(n,e)}else{if(Ot(n,i))return;Pm.set(i),t.uniformMatrix2fv(this.addr,!1,Pm),kt(n,i)}}function R1(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(Ot(n,e))return;t.uniformMatrix3fv(this.addr,!1,e),kt(n,e)}else{if(Ot(n,i))return;bm.set(i),t.uniformMatrix3fv(this.addr,!1,bm),kt(n,i)}}function C1(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(Ot(n,e))return;t.uniformMatrix4fv(this.addr,!1,e),kt(n,e)}else{if(Ot(n,i))return;Cm.set(i),t.uniformMatrix4fv(this.addr,!1,Cm),kt(n,i)}}function b1(t,e){const n=this.cache;n[0]!==e&&(t.uniform1i(this.addr,e),n[0]=e)}function P1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2i(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Ot(n,e))return;t.uniform2iv(this.addr,e),kt(n,e)}}function L1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3i(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else{if(Ot(n,e))return;t.uniform3iv(this.addr,e),kt(n,e)}}function N1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4i(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Ot(n,e))return;t.uniform4iv(this.addr,e),kt(n,e)}}function D1(t,e){const n=this.cache;n[0]!==e&&(t.uniform1ui(this.addr,e),n[0]=e)}function I1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2ui(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Ot(n,e))return;t.uniform2uiv(this.addr,e),kt(n,e)}}function U1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3ui(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else{if(Ot(n,e))return;t.uniform3uiv(this.addr,e),kt(n,e)}}function F1(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4ui(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Ot(n,e))return;t.uniform4uiv(this.addr,e),kt(n,e)}}function O1(t,e,n){const i=this.cache,r=n.allocateTextureUnit();i[0]!==r&&(t.uniform1i(this.addr,r),i[0]=r);let s;this.type===t.SAMPLER_2D_SHADOW?(od.compareFunction=n.isReversedDepthBuffer()?ph:hh,s=od):s=z_,n.setTexture2D(e||s,r)}function k1(t,e,n){const i=this.cache,r=n.allocateTextureUnit();i[0]!==r&&(t.uniform1i(this.addr,r),i[0]=r),n.setTexture3D(e||H_,r)}function B1(t,e,n){const i=this.cache,r=n.allocateTextureUnit();i[0]!==r&&(t.uniform1i(this.addr,r),i[0]=r),n.setTextureCube(e||G_,r)}function z1(t,e,n){const i=this.cache,r=n.allocateTextureUnit();i[0]!==r&&(t.uniform1i(this.addr,r),i[0]=r),n.setTexture2DArray(e||V_,r)}function V1(t){switch(t){case 5126:return M1;case 35664:return E1;case 35665:return T1;case 35666:return w1;case 35674:return A1;case 35675:return R1;case 35676:return C1;case 5124:case 35670:return b1;case 35667:case 35671:return P1;case 35668:case 35672:return L1;case 35669:case 35673:return N1;case 5125:return D1;case 36294:return I1;case 36295:return U1;case 36296:return F1;case 35678:case 36198:case 36298:case 36306:case 35682:return O1;case 35679:case 36299:case 36307:return k1;case 35680:case 36300:case 36308:case 36293:return B1;case 36289:case 36303:case 36311:case 36292:return z1}}function H1(t,e){t.uniform1fv(this.addr,e)}function G1(t,e){const n=Ys(e,this.size,2);t.uniform2fv(this.addr,n)}function W1(t,e){const n=Ys(e,this.size,3);t.uniform3fv(this.addr,n)}function X1(t,e){const n=Ys(e,this.size,4);t.uniform4fv(this.addr,n)}function j1(t,e){const n=Ys(e,this.size,4);t.uniformMatrix2fv(this.addr,!1,n)}function $1(t,e){const n=Ys(e,this.size,9);t.uniformMatrix3fv(this.addr,!1,n)}function Y1(t,e){const n=Ys(e,this.size,16);t.uniformMatrix4fv(this.addr,!1,n)}function q1(t,e){t.uniform1iv(this.addr,e)}function K1(t,e){t.uniform2iv(this.addr,e)}function Z1(t,e){t.uniform3iv(this.addr,e)}function Q1(t,e){t.uniform4iv(this.addr,e)}function J1(t,e){t.uniform1uiv(this.addr,e)}function ew(t,e){t.uniform2uiv(this.addr,e)}function tw(t,e){t.uniform3uiv(this.addr,e)}function nw(t,e){t.uniform4uiv(this.addr,e)}function iw(t,e,n){const i=this.cache,r=e.length,s=du(n,r);Ot(i,s)||(t.uniform1iv(this.addr,s),kt(i,s));let o;this.type===t.SAMPLER_2D_SHADOW?o=od:o=z_;for(let a=0;a!==r;++a)n.setTexture2D(e[a]||o,s[a])}function rw(t,e,n){const i=this.cache,r=e.length,s=du(n,r);Ot(i,s)||(t.uniform1iv(this.addr,s),kt(i,s));for(let o=0;o!==r;++o)n.setTexture3D(e[o]||H_,s[o])}function sw(t,e,n){const i=this.cache,r=e.length,s=du(n,r);Ot(i,s)||(t.uniform1iv(this.addr,s),kt(i,s));for(let o=0;o!==r;++o)n.setTextureCube(e[o]||G_,s[o])}function ow(t,e,n){const i=this.cache,r=e.length,s=du(n,r);Ot(i,s)||(t.uniform1iv(this.addr,s),kt(i,s));for(let o=0;o!==r;++o)n.setTexture2DArray(e[o]||V_,s[o])}function aw(t){switch(t){case 5126:return H1;case 35664:return G1;case 35665:return W1;case 35666:return X1;case 35674:return j1;case 35675:return $1;case 35676:return Y1;case 5124:case 35670:return q1;case 35667:case 35671:return K1;case 35668:case 35672:return Z1;case 35669:case 35673:return Q1;case 5125:return J1;case 36294:return ew;case 36295:return tw;case 36296:return nw;case 35678:case 36198:case 36298:case 36306:case 35682:return iw;case 35679:case 36299:case 36307:return rw;case 35680:case 36300:case 36308:case 36293:return sw;case 36289:case 36303:case 36311:case 36292:return ow}}class lw{constructor(e,n,i){this.id=e,this.addr=i,this.cache=[],this.type=n.type,this.setValue=V1(n.type)}}class uw{constructor(e,n,i){this.id=e,this.addr=i,this.cache=[],this.type=n.type,this.size=n.size,this.setValue=aw(n.type)}}class cw{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,n,i){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,n[a.id],i)}}}const yc=/(\w+)(\])?(\[|\.)?/g;function Lm(t,e){t.seq.push(e),t.map[e.id]=e}function fw(t,e,n){const i=t.name,r=i.length;for(yc.lastIndex=0;;){const s=yc.exec(i),o=yc.lastIndex;let a=s[1];const l=s[2]==="]",u=s[3];if(l&&(a=a|0),u===void 0||u==="["&&o+2===r){Lm(n,u===void 0?new lw(a,t,e):new uw(a,t,e));break}else{let h=n.map[a];h===void 0&&(h=new cw(a),Lm(n,h)),n=h}}}class hl{constructor(e,n){this.seq=[],this.map={};const i=e.getProgramParameter(n,e.ACTIVE_UNIFORMS);for(let o=0;o<i;++o){const a=e.getActiveUniform(n,o),l=e.getUniformLocation(n,a.name);fw(a,l,this)}const r=[],s=[];for(const o of this.seq)o.type===e.SAMPLER_2D_SHADOW||o.type===e.SAMPLER_CUBE_SHADOW||o.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(o):s.push(o);r.length>0&&(this.seq=r.concat(s))}setValue(e,n,i,r){const s=this.map[n];s!==void 0&&s.setValue(e,i,r)}setOptional(e,n,i){const r=n[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,n,i,r){for(let s=0,o=n.length;s!==o;++s){const a=n[s],l=i[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,r)}}static seqWithValue(e,n){const i=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in n&&i.push(o)}return i}}function Nm(t,e,n){const i=t.createShader(e);return t.shaderSource(i,n),t.compileShader(i),i}const dw=37297;let hw=0;function pw(t,e){const n=t.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,n.length);for(let o=r;o<s;o++){const a=o+1;i.push(`${a===e?">":" "} ${a}: ${n[o]}`)}return i.join(`
`)}const Dm=new Ue;function mw(t){$e._getMatrix(Dm,$e.workingColorSpace,t);const e=`mat3( ${Dm.elements.map(n=>n.toFixed(4))} )`;switch($e.getTransfer(t)){case Hl:return[e,"LinearTransferOETF"];case Je:return[e,"sRGBTransferOETF"];default:return Le("WebGLProgram: Unsupported color space: ",t),[e,"LinearTransferOETF"]}}function Im(t,e,n){const i=t.getShaderParameter(e,t.COMPILE_STATUS),s=(t.getShaderInfoLog(e)||"").trim();if(i&&s==="")return"";const o=/ERROR: 0:(\d+)/.exec(s);if(o){const a=parseInt(o[1]);return n.toUpperCase()+`
...
`)}const _w={[c_]:"Linear",[f_]:"Reinhard",[d_]:"Cineon",[h_]:"ACESFilmic",[m_]:"AgX",[g_]:"Neutral",[p_]:"Custom"};function vw(t,e){const n=_w[e];return n===void 0?(Le("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+t+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const Ya=new W;function xw(){$e.getLuminanceCoefficients(Ya);const t=Ya.x.toFixed(4),e=Ya.y.toFixed(4),n=Ya.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${t}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+c);const x=g+m+o,y=g+c+a,A=Nm(r,r.VERTEX_SHADER,x),T=Nm(r,r.FRAGMENT_SHADER,y);r.attachShader(v,A),r.attachShader(v,T),n.index0AttributeName!==void 0?r.bindAttribLocation(v,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function C(w){if(t.debug.checkShaderErrors){const N=r.getProgramInfoLog(v)||"",D=r.getShaderInfoLog(A)||"",G=r.getShaderInfoLog(T)||"",L=N.trim(),F=D.trim(),k=G.trim();let B=!0,j=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(B=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,v,A,T);else{const Y=Im(r,A,"vertex"),ne=Im(r,T,"fragment");Ke("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
...
Program Info Log: `+L+`
`+Y+`
`+ne)}else L!==""?Le("WebGLProgram: Program Info Log:",L):(F===""||k==="")&&(j=!1);j&&(w.diagnostics={runnable:B,programLog:L,vertexShader:{log:F,prefix:m},fragmentShader:{log:k,prefix:c}})}r.deleteShader(A),r.deleteShader(T),S=new hl(r,v),b=Mw(r,v)}let S;this.getUniforms=function(){return S===void 0&&C(this),S};let b;this.getAttributes=function(){return b===void 0&&C(this),b};let P=n.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return P===!1&&(P=r.getProgramParameter(v,dw)),P},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(v),this.program=void 0},this.type=n.shaderType,this.name=n.shaderName,this.id=hw++,this.cacheKey=e,this.usedTimes=1,this.program=v,this.vertexShader=A,this.fragmentShader=T,this}let kw=0;class Bw{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const n=e.vertexShader,i=e.fragmentShader,r=this._getShaderStage(n),s=this._getShaderStage(i),o=this._getShaderCacheForMaterial(e);return o.has(r)===!1&&(o.add(r),r.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(e){const n=this.materialCache.get(e);for(const i of n)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const n=this.materialCache;let i=n.get(e);return i===void 0&&(i=new Set,n.set(e,i)),i}_getShaderStage(e){const n=this.shaderCache;let i=n.get(e);return i===void 0&&(i=new zw(e),n.set(e,i)),i}}class zw{constructor(e){this.id=kw++,this.code=e,this.usedTimes=0}}function Vw(t){return t===Hr||t===Bl||t===zl}function Hw(t,e,n,i,r,s){const o=new R_,a=new Bw,l=new Set,u=[],d=new Map,h=i.logarithmicDepthBuffer;let f=i.precision;const p={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(S){return l.add(S),S===0?"uv":`uv${S}`}function v(S,b,P,w,N,D){const G=w.fog,L=N.geometry,F=S.isMeshStandardMaterial||S.isMeshLambertMaterial||S.isMeshPhongMaterial?w.environment:null,k=S.isMeshStandardMaterial||S.isMeshLambertMaterial&&!S.envMap||S.isMeshPhongMaterial&&!S.envMap,B=e.get(S.envMap||F,k),j=B&&B.mapping===uu?B.image.height:null,Y=p[S.type];S.precision!==null&&(f=i.getMaxPrecision(S.precision),f!==S.precision&&Le("WebGLProgram.getParameters:",S.precision,"not supported, using",f,"instead."));const ne=L.morphAttributes.position||L.morphAttributes.normal||L.morphAttributes.color,fe=ne!==void 0?ne.length:0;let Ve=0;L.morphAttributes.position!==void 0&&(Ve=1),L.morphAttributes.normal!==void 0&&(Ve=2),L.morphAttributes.color!==void 0&&(Ve=3);let We,Ne,K,de;if(Y){const Fe=ri[Y];We=Fe.vertexShader,Ne=Fe.fragmentShader}else We=S.vertexShader,Ne=S.fragmentShader,a.update(S),K=a.getVertexShaderID(S),de=a.getFragmentShaderID(S);const ae=t.getRenderTarget(),be=t.state.buffers.depth.getReversed(),Ie=N.isInstancedMesh===!0,Pe=N.isBatchedMesh===!0,mt=!!S.map,Xe=!!S.matcap,tt=!!B,ft=!!S.aoMap,He=!!S.lightMap,Lt=!!S.bumpMap,gt=!!S.normalMap,_n=!!S.displacementMap,U=!!S.emissiveMap,Nt=!!S.metalnessMap,je=!!S.roughnessMap,lt=S.anisotropy>0,he=S.clearcoat>0,St=S.dispersion>0,R=S.iridescence>0,M=S.sheen>0,z=S.transmission>0,Z=lt&&!!S.anisotropyMap,te=he&&!!S.clearcoatMap,re=he&&!!S.clearcoatNormalMap,ce=he&&!!S.clearcoatRoughnessMap,$=R&&!!S.iridescenceMap,Q=R&&!!S.iridescenceThicknessMap,_e=M&&!!S.sheenColorMap,Se=M&&!!S.sheenRoughnessMap,le=!!S.specularMap,se=!!S.specularColorMap,De=!!S.specularIntensityMap,ke=z&&!!S.transmissionMap,Qe=z&&!!S.thicknessMap,I=!!S.gradientMap,oe=!!S.alphaMap,q=S.alphaTest>0,ve=!!S.alphaHash,ue=!!S.extensions;let ee=ci;S.toneMapped&&(ae===null||ae.isXRRenderTarget===!0)&&(ee=t.toneMapping);const we={shaderID:Y,shaderType:S.type,shaderName:S.name,vertexShader:We,fragmentShader:Ne,defines:S.defines,customVertexShaderID:K,customFragmentShaderID:de,isRawShaderMaterial:S.isRawShaderMaterial===!0,glslVersion:S.glslVersion,precision:f,batching:Pe,batchingColor:Pe&&N._colorsTexture!==null,instancing:Ie,instancingColor:Ie&&N.instanceColor!==null,instancingMorph:Ie&&N.morphTexture!==null,outputColorSpace:ae===null?t.outputColorSpace:ae.isXRRenderTarget===!0?ae.texture.colorSpace:$e.workingColorSpace,alphaToCoverage:!!S.alphaToCoverage,map:mt,matcap:Xe,envMap:tt,envMapMode:tt&&B.mapping,envMapCubeUVHeight:j,aoMap:ft,lightMap:He,bumpMap:Lt,normalMap:gt,displacementMap:_n,emissiveMap:U,normalMapObjectSpace:gt&&S.normalMapType===My,normalMapTangentSpace:gt&&S.normalMapType===Yp,packedNormalMap:gt&&S.normalMapType===Yp&&Vw(S.normalMap.format),metalnessMap:Nt,roughnessMap:je,anisotropy:lt,anisotropyMap:Z,clearcoat:he,clearcoatMap:te,clearcoatNormalMap:re,clearcoatRoughnessMap:ce,dispersion:St,iridescence:R,iridescenceMap:$,iridescenceThicknessMap:Q,sheen:M,sheenColorMap:_e,sheenRoughnessMap:Se,specularMap:le,specularColorMap:se,specularIntensityMap:De,transmission:z,transmissionMap:ke,thicknessMap:Qe,gradientMap:I,opaque:S.transparent===!1&&S.blending===Ps&&S.alphaToCoverage===!1,alphaMap:oe,alphaTest:q,alphaHash:ve,combine:S.combine,mapUv:mt&&_(S.map.channel),aoMapUv:ft&&_(S.aoMap.channel),lightMapUv:He&&_(S.lightMap.channel),bumpMapUv:Lt&&_(S.bumpMap.channel),normalMapUv:gt&&_(S.normalMap.channel),displacementMapUv:_n&&_(S.displacementMap.channel),emissiveMapUv:U&&_(S.emissiveMap.channel),metalnessMapUv:Nt&&_(S.metalnessMap.channel),roughnessMapUv:je&&_(S.roughnessMap.channel),anisotropyMapUv:Z&&_(S.anisotropyMap.channel),clearcoatMapUv:te&&_(S.clearcoatMap.channel),clearcoatNormalMapUv:re&&_(S.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ce&&_(S.clearcoatRoughnessMap.channel),iridescenceMapUv:$&&_(S.iridescenceMap.channel),iridescenceThicknessMapUv:Q&&_(S.iridescenceThicknessMap.channel),sheenColorMapUv:_e&&_(S.sheenColorMap.channel),sheenRoughnessMapUv:Se&&_(S.sheenRoughnessMap.channel),specularMapUv:le&&_(S.specularMap.channel),specularColorMapUv:se&&_(S.specularColorMap.channel),specularIntensityMapUv:De&&_(S.specularIntensityMap.channel),transmissionMapUv:ke&&_(S.transmissionMap.channel),thicknessMapUv:Qe&&_(S.thicknessMap.channel),alphaMapUv:oe&&_(S.alphaMap.channel),vertexTangents:!!L.attributes.tangent&&(gt||lt),vertexNormals:!!L.attributes.normal,vertexColors:S.vertexColors,vertexAlphas:S.vertexColors===!0&&!!L.attributes.color&&L.attributes.color.itemSize===4,pointsUvs:N.isPoints===!0&&!!L.attributes.uv&&(mt||oe),fog:!!G,useFog:S.fog===!0,fogExp2:!!G&&G.isFogExp2,flatShading:S.wireframe===!1&&(S.flatShading===!0||L.attributes.normal===void 0&&gt===!1&&(S.isMeshLambertMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isMeshPhysicalMaterial)),sizeAttenuation:S.sizeAttenuation===!0,logarithmicDepthBuffer:h,reversedDepthBuffer:be,skinning:N.isSkinnedMesh===!0,morphTargets:L.morphAttributes.position!==void 0,morphNormals:L.morphAttributes.normal!==void 0,morphColors:L.morphAttributes.color!==void 0,morphTargetsCount:fe,morphTextureStride:Ve,numDirLights:b.directional.length,numPointLights:b.point.length,numSpotLights:b.spot.length,numSpotLightMaps:b.spotLightMap.length,numRectAreaLights:b.rectArea.length,numHemiLights:b.hemi.length,numDirLightShadows:b.directionalShadowMap.length,numPointLightShadows:b.pointShadowMap.length,numSpotLightShadows:b.spotShadowMap.length,numSpotLightShadowsWithMaps:b.numSpotLightShadowsWithMaps,numLightProbes:b.numLightProbes,numLightProbeGrids:D.length,numClippingPlanes:s.numPlanes,numClipIntersection:s.numIntersection,dithering:S.dithering,shadowMapEnabled:t.shadowMap.enabled&&P.length>0,shadowMapType:t.shadowMap.type,toneMapping:ee,decodeVideoTexture:mt&&S.map.isVideoTexture===!0&&$e.getTransfer(S.map.colorSpace)===Je,decodeVideoTextureEmissive:U&&S.emissiveMap.isVideoTexture===!0&&$e.getTransfer(S.emissiveMap.colorSpace)===Je,premultipliedAlpha:S.premultipliedAlpha,doubleSided:S.side===Ei,flipSided:S.side===gn,useDepthPacking:S.depthPacking>=0,depthPacking:S.depthPacking||0,index0AttributeName:S.index0AttributeName,extensionClipCullDistance:ue&&S.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(ue&&S.extensions.multiDraw===!0||Pe)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:S.customProgramCacheKey()};return we.vertexUv1s=l.has(1),we.vertexUv2s=l.has(2),we.vertexUv3s=l.has(3),l.clear(),we}function m(S){const b=[];if(S.shaderID?b.push(S.shaderID):(b.push(S.customVertexShaderID),b.push(S.customFragmentShaderID)),S.defines!==void 0)for(const P in S.defines)b.push(P),b.push(S.defines[P]);return S.isRawShaderMaterial===!1&&(c(b,S),g(b,S),b.push(t.outputColorSpace)),b.push(S.customProgramCacheKey),b.join()}function c(S,b){S.push(b.precision),S.push(b.outputColorSpace),S.push(b.envMapMode),S.push(b.envMapCubeUVHeight),S.push(b.mapUv),S.push(b.alphaMapUv),S.push(b.lightMapUv),S.push(b.aoMapUv),S.push(b.bumpMapUv),S.push(b.normalMapUv),S.push(b.displacementMapUv),S.push(b.emissiveMapUv),S.push(b.metalnessMapUv),S.push(b.roughnessMapUv),S.push(b.anisotropyMapUv),S.push(b.clearcoatMapUv),S.push(b.clearcoatNormalMapUv),S.push(b.clearcoatRoughnessMapUv),S.push(b.iridescenceMapUv),S.push(b.iridescenceThicknessMapUv),S.push(b.sheenColorMapUv),S.push(b.sheenRoughnessMapUv),S.push(b.specularMapUv),S.push(b.specularColorMapUv),S.push(b.specularIntensityMapUv),S.push(b.transmissionMapUv),S.push(b.thicknessMapUv),S.push(b.combine),S.push(b.fogExp2),S.push(b.sizeAttenuation),S.push(b.morphTargetsCount),S.push(b.morphAttributeCount),S.push(b.numDirLights),S.push(b.numPointLights),S.push(b.numSpotLights),S.push(b.numSpotLightMaps),S.push(b.numHemiLights),S.push(b.numRectAreaLights),S.push(b.numDirLightShadows),S.push(b.numPointLightShadows),S.push(b.numSpotLightShadows),S.push(b.numSpotLightShadowsWithMaps),S.push(b.numLightProbes),S.push(b.shadowMapType),S.push(b.toneMapping),S.push(b.numClippingPlanes),S.push(b.numClipIntersection),S.push(b.depthPacking)}function g(S,b){o.disableAll(),b.instancing&&o.enable(0),b.instancingColor&&o.enable(1),b.instancingMorph&&o.enable(2),b.matcap&&o.enable(3),b.envMap&&o.enable(4),b.normalMapObjectSpace&&o.enable(5),b.normalMapTangentSpace&&o.enable(6),b.clearcoat&&o.enable(7),b.iridescence&&o.enable(8),b.alphaTest&&o.enable(9),b.vertexColors&&o.enable(10),b.vertexAlphas&&o.enable(11),b.vertexUv1s&&o.enable(12),b.vertexUv2s&&o.enable(13),b.vertexUv3s&&o.enable(14),b.vertexTangents&&o.enable(15),b.anisotropy&&o.enable(16),b.alphaHash&&o.enable(17),b.batching&&o.enable(18),b.dispersion&&o.enable(19),b.batchingColor&&o.enable(20),b.gradientMap&&o.enable(21),b.packedNormalMap&&o.enable(22),b.vertexNormals&&o.enable(23),S.push(o.mask),o.disableAll(),b.fog&&o.enable(0),b.useFog&&o.enable(1),b.flatShading&&o.enable(2),b.logarithmicDepthBuffer&&o.enable(3),b.reversedDepthBuffer&&o.enable(4),b.skinning&&o.enable(5),b.morphTargets&&o.enable(6),b.morphNormals&&o.enable(7),b.morphColors&&o.enable(8),b.premultipliedAlpha&&o.enable(9),b.shadowMapEnabled&&o.enable(10),b.doubleSided&&o.enable(11),b.flipSided&&o.enable(12),b.useDepthPacking&&o.enable(13),b.dithering&&o.enable(14),b.transmission&&o.enable(15),b.sheen&&o.enable(16),b.opaque&&o.enable(17),b.pointsUvs&&o.enable(18),b.decodeVideoTexture&&o.enable(19),b.decodeVideoTextureEmissive&&o.enable(20),b.alphaToCoverage&&o.enable(21),b.numLightProbeGrids>0&&o.enable(22),S.push(o.mask)}function x(S){const b=p[S.type];let P;if(b){const w=ri[b];P=aM.clone(w.uniforms)}else P=S.uniforms;return P}function y(S,b){let P=d.get(b);return P!==void 0?++P.usedTimes:(P=new Ow(t,b,S,r),u.push(P),d.set(b,P)),P}function A(S){if(--S.usedTimes===0){const b=u.indexOf(S);u[b]=u[u.length-1],u.pop(),d.delete(S.cacheKey),S.destroy()}}function T(S){a.remove(S)}function C(){a.dispose()}return{getParameters:v,getProgramCacheKey:m,getUniforms:x,acquireProgram:y,releaseProgram:A,releaseShaderCache:T,programs:u,dispose:C}}function Gw(){let t=new WeakMap;function e(o){return t.has(o)}function n(o){let a=t.get(o);return a===void 0&&(a={},t.set(o,a)),a}function i(o){t.delete(o)}function r(o,a,l){t.get(o)[a]=l}function s(){t=new WeakMap}return{has:e,get:n,remove:i,update:r,dispose:s}}function Ww(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.material.id!==e.material.id?t.material.id-e.material.id:t.materialVariant!==e.materialVariant?t.materialVariant-e.materialVariant:t.z!==e.z?t.z-e.z:t.id-e.id}function Bm(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.z!==e.z?e.z-t.z:t.id-e.id}function zm(){const t=[];let e=0;const n=[],i=[],r=[];function s(){e=0,n.length=0,i.length=0,r.length=0}function o(f){let p=0;return f.isInstancedMesh&&(p+=2),f.isSkinnedMesh&&(p+=1),p}function a(f,p,_,v,m,c){let g=t[e];return g===void 0?(g={id:f.id,object:f,geometry:p,material:_,materialVariant:o(f),groupOrder:v,renderOrder:f.renderOrder,z:m,group:c},t[e]=g):(g.id=f.id,g.object=f,g.geometry=p,g.material=_,g.materialVariant=o(f),g.groupOrder=v,g.renderOrder=f.renderOrder,g.z=m,g.group=c),e++,g}function l(f,p,_,v,m,c){const g=a(f,p,_,v,m,c);_.transmission>0?i.push(g):_.transparent===!0?r.push(g):n.push(g)}function u(f,p,_,v,m,c){const g=a(f,p,_,v,m,c);_.transmission>0?i.unshift(g):_.transparent===!0?r.unshift(g):n.unshift(g)}function d(f,p){n.length>1&&n.sort(f||Ww),i.length>1&&i.sort(p||Bm),r.length>1&&r.sort(p||Bm)}function h(){for(let f=e,p=t.length;f<p;f++){const _=t[f];if(_.id===null)break;_.id=null,_.object=null,_.geometry=null,_.material=null,_.group=null}}return{opaque:n,transmissive:i,transparent:r,init:s,push:l,unshift:u,finish:h,sort:d}}function Xw(){let t=new WeakMap;function e(i,r){const s=t.get(i);let o;return s===void 0?(o=new zm,t.set(i,[o])):r>=s.length?(o=new zm,s.push(o)):o=s[r],o}function n(){t=new WeakMap}return{get:e,dispose:n}}function jw(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={direction:new W,color:new rt};break;case"SpotLight":n={position:new W,direction:new W,color:new rt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":n={position:new W,color:new rt,distance:0,decay:0};break;case"HemisphereLight":n={direction:new W,skyColor:new rt,groundColor:new rt};break;case"RectAreaLight":n={color:new rt,position:new W,halfWidth:new W,halfHeight:new W};break}return t[e.id]=n,n}}}function $w(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new st};break;case"SpotLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new st};break;case"PointLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new st,shadowCameraNear:1,shadowCameraFar:1e3};break}return t[e.id]=n,n}}}let Yw=0;function qw(t,e){return(e.castShadow?2:0)-(t.castShadow?2:0)+(e.map?1:0)-(t.map?1:0)}function Kw(t){const e=new jw,n=$w(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let u=0;u<9;u++)i.probe.push(new W);const r=new W,s=new Ft,o=new Ft;function a(u){let d=0,h=0,f=0;for(let b=0;b<9;b++)i.probe[b].set(0,0,0);let p=0,_=0,v=0,m=0,c=0,g=0,x=0,y=0,A=0,T=0,C=0;u.sort(qw);for(let b=0,P=u.length;b<P;b++){const w=u[b],N=w.color,D=w.intensity,G=w.distance;let L=null;if(w.shadow&&w.shadow.map&&(w.shadow.map.texture.format===Hr?L=w.shadow.map.texture:L=w.shadow.map.depthTexture||w.shadow.map.texture),w.isAmbientLight)d+=N.r*D,h+=N.g*D,f+=N.b*D;else if(w.isLightProbe){for(let F=0;F<9;F++)i.probe[F].addScaledVector(w.sh.coefficients[F],D);C++}else if(w.isDirectionalLight){const F=e.get(w);if(F.color.copy(w.color).multiplyScalar(w.intensity),w.castShadow){const k=w.shadow,B=n.get(w);B.shadowIntensity=k.intensity,B.shadowBias=k.bias,B.shadowNormalBias=k.normalBias,B.shadowRadius=k.radius,B.shadowMapSize=k.mapSize,i.directionalShadow[p]=B,i.directionalShadowMap[p]=L,i.directionalShadowMatrix[p]=w.shadow.matrix,g++}i.directional[p]=F,p++}else if(w.isSpotLight){const F=e.get(w);F.position.setFromMatrixPosition(w.matrixWorld),F.color.copy(N).multiplyScalar(D),F.distance=G,F.coneCos=Math.cos(w.angle),F.penumbraCos=Math.cos(w.angle*(1-w.penumbra)),F.decay=w.decay,i.spot[v]=F;const k=w.shadow;if(w.map&&(i.spotLightMap[A]=w.map,A++,k.updateMatrices(w),w.castShadow&&T++),i.spotLightMatrix[v]=k.matrix,w.castShadow){const B=n.get(w);B.shadowIntensity=k.intensity,B.shadowBias=k.bias,B.shadowNormalBias=k.normalBias,B.shadowRadius=k.radius,B.shadowMapSize=k.mapSize,i.spotShadow[v]=B,i.spotShadowMap[v]=L,y++}v++}else if(w.isRectAreaLight){const F=e.get(w);F.color.copy(N).multiplyScalar(D),F.halfWidth.set(w.width*.5,0,0),F.halfHeight.set(0,w.height*.5,0),i.rectArea[m]=F,m++}else if(w.isPointLight){const F=e.get(w);if(F.color.copy(w.color).multiplyScalar(w.intensity),F.distance=w.distance,F.decay=w.decay,w.castShadow){const k=w.shadow,B=n.get(w);B.shadowIntensity=k.intensity,B.shadowBias=k.bias,B.shadowNormalBias=k.normalBias,B.shadowRadius=k.radius,B.shadowMapSize=k.mapSize,B.shadowCameraNear=k.camera.near,B.shadowCameraFar=k.camera.far,i.pointShadow[_]=B,i.pointShadowMap[_]=L,i.pointShadowMatrix[_]=w.shadow.matrix,x++}i.point[_]=F,_++}else if(w.isHemisphereLight){const F=e.get(w);F.skyColor.copy(w.color).multiplyScalar(D),F.groundColor.copy(w.groundColor).multiplyScalar(D),i.hemi[c]=F,c++}}m>0&&(t.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=pe.LTC_FLOAT_1,i.rectAreaLTC2=pe.LTC_FLOAT_2):(i.rectAreaLTC1=pe.LTC_HALF_1,i.rectAreaLTC2=pe.LTC_HALF_2)),i.ambient[0]=d,i.ambient[1]=h,i.ambient[2]=f;const S=i.hash;(S.directionalLength!==p||S.pointLength!==_||S.spotLength!==v||S.rectAreaLength!==m||S.hemiLength!==c||S.numDirectionalShadows!==g||S.numPointShadows!==x||S.numSpotShadows!==y||S.numSpotMaps!==A||S.numLightProbes!==C)&&(i.directional.length=p,i.spot.length=v,i.rectArea.length=m,i.point.length=_,i.hemi.length=c,i.directionalShadow.length=g,i.directionalShadowMap.length=g,i.pointShadow.length=x,i.pointShadowMap.length=x,i.spotShadow.length=y,i.spotShadowMap.length=y,i.directionalShadowMatrix.length=g,i.pointShadowMatrix.length=x,i.spotLightMatrix.length=y+A-T,i.spotLightMap.length=A,i.numSpotLightShadowsWithMaps=T,i.numLightProbes=C,S.directionalLength=p,S.pointLength=_,S.spotLength=v,S.rectAreaLength=m,S.hemiLength=c,S.numDirectionalShadows=g,S.numPointShadows=x,S.numSpotShadows=y,S.numSpotMaps=A,S.numLightProbes=C,i.version=Yw++)}function l(u,d){let h=0,f=0,p=0,_=0,v=0;const m=d.matrixWorldInverse;for(let c=0,g=u.length;c<g;c++){const x=u[c];if(x.isDirectionalLight){const y=i.directional[h];y.direction.setFromMatrixPosition(x.matrixWorld),r.setFromMatrixPosition(x.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(m),h++}else if(x.isSpotLight){const y=i.spot[p];y.position.setFromMatrixPosition(x.matrixWorld),y.position.applyMatrix4(m),y.direction.setFromMatrixPosition(x.matrixWorld),r.setFromMatrixPosition(x.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(m),p++}else if(x.isRectAreaLight){const y=i.rectArea[_];y.position.setFromMatrixPosition(x.matrixWorld),y.position.applyMatrix4(m),o.identity(),s.copy(x.matrixWorld),s.premultiply(m),o.extractRotation(s),y.halfWidth.set(x.width*.5,0,0),y.halfHeight.set(0,x.height*.5,0),y.halfWidth.applyMatrix4(o),y.halfHeight.applyMatrix4(o),_++}else if(x.isPointLight){const y=i.point[f];y.position.setFromMatrixPosition(x.matrixWorld),y.position.applyMatrix4(m),f++}else if(x.isHemisphereLight){const y=i.hemi[v];y.direction.setFromMatrixPosition(x.matrixWorld),y.direction.transformDirection(m),v++}}}return{setup:a,setupView:l,state:i}}function Vm(t){const e=new Kw(t),n=[],i=[],r=[];function s(f){h.camera=f,n.length=0,i.length=0,r.length=0}function o(f){n.push(f)}function a(f){i.push(f)}function l(f){r.push(f)}function u(){e.setup(n)}function d(f){e.setupView(n,f)}const h={lightsArray:n,shadowsArray:i,lightProbeGridArray:r,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:s,state:h,setupLights:u,setupLightsView:d,pushLight:o,pushShadow:a,pushLightProbeGrid:l}}function Zw(t){let e=new WeakMap;function n(r,s=0){const o=e.get(r);let a;return o===void 0?(a=new Vm(t),e.set(r,[a])):s>=o.length?(a=new Vm(t),o.push(a)):a=o[s],a}function i(){e=new WeakMap}return{get:n,dispose:i}}const Qw=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;class lA{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n){if(this.texture===null){const i=new I_(e.texture);(e.depthNear!==n.depthNear||e.depthFar!==n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,i=new Zn({vertexShader:oA,fragmentShader:aA,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new pi(new oa(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class uA extends $r{constructor(e,n){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,u=null,d=null,h=null,f=null,p=null,_=null;const v=typeof XRWebGLBinding<"u",m=new lA,c={},g=n.getContextAttributes();let x=null,y=null;const A=[],T=[],C=new st;let S=null;const b=new Xn;b.viewport=new Rt;const P=new Xn;P.viewport=new Rt;const w=[b,P],N=new vM;let D=null,G=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let de=A[K];return de===void 0&&(de=new Ju,A[K]=de),de.getTargetRaySpace()},this.getControllerGrip=function(K){let de=A[K];return de===void 0&&(de=new Ju,A[K]=de),de.getGripSpace()},this.getHand=function(K){let de=A[K];return de===void 0&&(de=new Ju,A[K]=de),de.getHandSpace()};function L(K){const de=T.indexOf(K.inputSource);if(de===-1)return;const ae=A[de];ae!==void 0&&(ae.update(K.inputSource,K.frame,u||o),ae.dispatchEvent({type:K.type,data:K.inputSource}))}function F(){r.removeEventListener("select",L),r.removeEventListener("selectstart",L),r.removeEventListener("selectend",L),r.removeEventListener("squeeze",L),r.removeEventListener("squeezestart",L),r.removeEventListener("squeezeend",L),r.removeEventListener("end",F),r.removeEventListener("inputsourceschange",k);for(let K=0;K<A.length;K++){const de=T[K];de!==null&&(T[K]=null,A[K].disconnect(de))}D=null,G=null,m.reset();for(const K in c)delete c[K];e.setRenderTarget(x),p=null,f=null,h=null,r=null,y=null,Ne.stop(),i.isPresenting=!1,e.setPixelRatio(S),e.setSize(C.width,C.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){s=K,i.isPresenting===!0&&Le("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){a=K,i.isPresenting===!0&&Le("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return u||o},this.setReferenceSpace=function(K){u=K},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return h===null&&v&&(h=new XRWebGLBinding(r,n)),h},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(K){if(r=K,r!==null){if(x=e.getRenderTarget(),r.addEventListener("select",L),r.addEventListener("selectstart",L),r.addEventListener("selectend",L),r.addEventListener("squeeze",L),r.addEventListener("squeezestart",L),r.addEventListener("squeezeend",L),r.addEventListener("end",F),r.addEventListener("inputsourceschange",k),g.xrCompatible!==!0&&await n.makeXRCompatible(),S=e.getPixelRatio(),e.getSize(C),v&&"createProjectionLayer"in XRWebGLBinding.prototype){let ae=null,be=null,Ie=null;g.depth&&(Ie=g.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,ae=g.stencil?Dr:Oi,be=g.stencil?qo:hi);const Pe={colorFormat:n.RGBA8,depthFormat:Ie,scaleFactor:s};h=this.getBinding(),f=h.createProjectionLayer(Pe),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),y=new fi(f.textureWidth,f.textureHeight,{format:$n,type:Dn,depthTexture:new Vs(f.textureWidth,f.textureHeight,be,void 0,void 0,void 0,void 0,void 0,void 0,ae),stencilBuffer:g.stencil,colorSpace:e.outputColorSpace,samples:g.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const ae={antialias:g.antialias,alpha:!0,depth:g.depth,stencil:g.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,n,ae),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),y=new fi(p.framebufferWidth,p.framebufferHeight,{format:$n,type:Dn,colorSpace:e.outputColorSpace,stencilBuffer:g.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(l),u=null,o=await r.requestReferenceSpace(a),Ne.setContext(r),Ne.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function k(K){for(let de=0;de<K.removed.length;de++){const ae=K.removed[de],be=T.indexOf(ae);be>=0&&(T[be]=null,A[be].disconnect(ae))}for(let de=0;de<K.added.length;de++){const ae=K.added[de];let be=T.indexOf(ae);if(be===-1){for(let Pe=0;Pe<A.length;Pe++)if(Pe>=T.length){T.push(ae),be=Pe;break}else if(T[Pe]===null){T[Pe]=ae,be=Pe;break}if(be===-1)break}const Ie=A[be];Ie&&Ie.connect(ae)}}const B=new W,j=new W;function Y(K,de,ae){B.setFromMatrixPosition(de.matrixWorld),j.setFromMatrixPosition(ae.matrixWorld);const be=B.distanceTo(j),Ie=de.projectionMatrix.elements,Pe=ae.projectionMatrix.elements,mt=Ie[14]/(Ie[10]-1),Xe=Ie[14]/(Ie[10]+1),tt=(Ie[9]+1)/Ie[5],ft=(Ie[9]-1)/Ie[5],He=(Ie[8]-1)/Ie[0],Lt=(Pe[8]+1)/Pe[0],gt=mt*He,_n=mt*Lt,U=be/(-He+Lt),Nt=U*-He;if(de.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(Nt),K.translateZ(U),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),Ie[10]===-1)K.projectionMatrix.copy(de.projectionMatrix),K.projectionMatrixInverse.copy(de.projectionMatrixInverse);else{const je=mt+U,lt=Xe+U,he=gt-Nt,St=_n+(be-Nt),R=tt*Xe/lt*je,M=ft*Xe/lt*je;K.projectionMatrix.makePerspective(he,St,R,M,je,lt),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function ne(K,de){de===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(de.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(r===null)return;let de=K.near,ae=K.far;m.texture!==null&&(m.depthNear>0&&(de=m.depthNear),m.depthFar>0&&(ae=m.depthFar)),N.near=P.near=b.near=de,N.far=P.far=b.far=ae,(D!==N.near||G!==N.far)&&(r.updateRenderState({depthNear:N.near,depthFar:N.far}),D=N.near,G=N.far),N.layers.mask=K.layers.mask|6,b.layers.mask=N.layers.mask&-5,P.layers.mask=N.layers.mask&-3;const be=K.parent,Ie=N.cameras;ne(N,be);for(let Pe=0;Pe<Ie.length;Pe++)ne(Ie[Pe],be);Ie.length===2?Y(N,b,P):N.projectionMatrix.copy(b.projectionMatrix),fe(K,N,be)};function fe(K,de,ae){ae===null?K.matrix.copy(de.matrixWorld):(K.matrix.copy(ae.matrixWorld),K.matrix.invert(),K.matrix.multiply(de.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(de.projectionMatrix),K.projectionMatrixInverse.copy(de.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=sd*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return N},this.getFoveation=function(){if(!(f===null&&p===null))return l},this.setFoveation=function(K){l=K,f!==null&&(f.fixedFoveation=K),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=K)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(N)},this.getCameraTexture=function(K){return c[K]};let Ve=null;function We(K,de){if(d=de.getViewerPose(u||o),_=de,d!==null){const ae=d.views;p!==null&&(e.setRenderTargetFramebuffer(y,p.framebuffer),e.setRenderTarget(y));let be=!1;ae.length!==N.cameras.length&&(N.cameras.length=0,be=!0);for(let Xe=0;Xe<ae.length;Xe++){const tt=ae[Xe];let ft=null;if(p!==null)ft=p.getViewport(tt);else{const Lt=h.getViewSubImage(f,tt);ft=Lt.viewport,Xe===0&&(e.setRenderTargetTextures(y,Lt.colorTexture,Lt.depthStencilTexture),e.setRenderTarget(y))}let He=w[Xe];He===void 0&&(He=new Xn,He.layers.enable(Xe),He.viewport=new Rt,w[Xe]=He),He.matrix.fromArray(tt.transform.matrix),He.matrix.decompose(He.position,He.quaternion,He.scale),He.projectionMatrix.fromArray(tt.projectionMatrix),He.projectionMatrixInverse.copy(He.projectionMatrix).invert(),He.viewport.set(ft.x,ft.y,ft.width,ft.height),Xe===0&&(N.matrix.copy(He.matrix),N.matrix.decompose(N.position,N.quaternion,N.scale)),be===!0&&N.cameras.push(He)}const Ie=r.enabledFeatures;if(Ie&&Ie.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&v){h=i.getBinding();const Xe=h.getDepthInformation(ae[0]);Xe&&Xe.isValid&&Xe.texture&&m.init(Xe,r.renderState)}if(Ie&&Ie.includes("camera-access")&&v){e.state.unbindTexture(),h=i.getBinding();for(let Xe=0;Xe<ae.length;Xe++){const tt=ae[Xe].camera;if(tt){let ft=c[tt];ft||(ft=new I_,c[tt]=ft);const He=h.getCameraImage(tt);ft.sourceTexture=He}}}}for(let ae=0;ae<A.length;ae++){const be=T[ae],Ie=A[ae];be!==null&&Ie!==void 0&&Ie.update(be,de,u||o)}Ve&&Ve(K,de),de.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:de}),_=null}const Ne=new O_;Ne.setAnimationLoop(We),this.setAnimationLoop=function(K){Ve=K},this.dispose=function(){}}}const cA=new Ft,W_=new Ue;W_.set(-1,0,0,0,1,0,0,0,1);function fA(t,e){function n(m,c){m.matrixAutoUpdate===!0&&m.updateMatrix(),c.value.copy(m.matrix)}function i(m,c){c.color.getRGB(m.fogColor.value,U_(t)),c.isFog?(m.fogNear.value=c.near,m.fogFar.value=c.far):c.isFogExp2&&(m.fogDensity.value=c.density)}function r(m,c,g,x,y){c.isNodeMaterial?c.uniformsNeedUpdate=!1:c.isMeshBasicMaterial?s(m,c):c.isMeshLambertMaterial?(s(m,c),c.envMap&&(m.envMapIntensity.value=c.envMapIntensity)):c.isMeshToonMaterial?(s(m,c),h(m,c)):c.isMeshPhongMaterial?(s(m,c),d(m,c),c.envMap&&(m.envMapIntensity.value=c.envMapIntensity)):c.isMeshStandardMaterial?(s(m,c),f(m,c),c.isMeshPhysicalMaterial&&p(m,c,y)):c.isMeshMatcapMaterial?(s(m,c),_(m,c)):c.isMeshDepthMaterial?s(m,c):c.isMeshDistanceMaterial?(s(m,c),v(m,c)):c.isMeshNormalMaterial?s(m,c):c.isLineBasicMaterial?(o(m,c),c.isLineDashedMaterial&&a(m,c)):c.isPointsMaterial?l(m,c,g,x):c.isSpriteMaterial?u(m,c):c.isShadowMaterial?(m.color.value.copy(c.color),m.opacity.value=c.opacity):c.isShaderMaterial&&(c.uniformsNeedUpdate=!1)}function s(m,c){m.opacity.value=c.opacity,c.color&&m.diffuse.value.copy(c.color),c.emissive&&m.emissive.value.copy(c.emissive).multiplyScalar(c.emissiveIntensity),c.map&&(m.map.value=c.map,n(c.map,m.mapTransform)),c.alphaMap&&(m.alphaMap.value=c.alphaMap,n(c.alphaMap,m.alphaMapTransform)),c.bumpMap&&(m.bumpMap.value=c.bumpMap,n(c.bumpMap,m.bumpMapTransform),m.bumpScale.value=c.bumpScale,c.side===gn&&(m.bumpScale.value*=-1)),c.normalMap&&(m.normalMap.value=c.normalMap,n(c.normalMap,m.normalMapTransform),m.normalScale.value.copy(c.normalScale),c.side===gn&&m.normalScale.value.negate()),c.displacementMap&&(m.displacementMap.value=c.displacementMap,n(c.displacementMap,m.displacementMapTransform),m.displacementScale.value=c.displacementScale,m.displacementBias.value=c.displacementBias),c.emissiveMap&&(m.emissiveMap.value=c.emissiveMap,n(c.emissiveMap,m.emissiveMapTransform)),c.specularMap&&(m.specularMap.value=c.specularMap,n(c.specularMap,m.specularMapTransform)),c.alphaTest>0&&(m.alphaTest.value=c.alphaTest);const g=e.get(c),x=g.envMap,y=g.envMapRotation;x&&(m.envMap.value=x,m.envMapRotation.value.setFromMatrix4(cA.makeRotationFromEuler(y)).transpose(),x.isCubeTexture&&x.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(W_),m.reflectivity.value=c.reflectivity,m.ior.value=c.ior,m.refractionRatio.value=c.refractionRatio),c.lightMap&&(m.lightMap.value=c.lightMap,m.lightMapIntensity.value=c.lightMapIntensity,n(c.lightMap,m.lightMapTransform)),c.aoMap&&(m.aoMap.value=c.aoMap,m.aoMapIntensity.value=c.aoMapIntensity,n(c.aoMap,m.aoMapTransform))}function o(m,c){m.diffuse.value.copy(c.color),m.opacity.value=c.opacity,c.map&&(m.map.value=c.map,n(c.map,m.mapTransform))}function a(m,c){m.dashSize.value=c.dashSize,m.totalSize.value=c.dashSize+c.gapSize,m.scale.value=c.scale}function l(m,c,g,x){m.diffuse.value.copy(c.color),m.opacity.value=c.opacity,m.size.value=c.size*g,m.scale.value=x*.5,c.map&&(m.map.value=c.map,n(c.map,m.uvTransform)),c.alphaMap&&(m.alphaMap.value=c.alphaMap,n(c.alphaMap,m.alphaMapTransform)),c.alphaTest>0&&(m.alphaTest.value=c.alphaTest)}function u(m,c){m.diffuse.value.copy(c.color),m.opacity.value=c.opacity,m.rotation.value=c.rotation,c.map&&(m.map.value=c.map,n(c.map,m.mapTransform)),c.alphaMap&&(m.alphaMap.value=c.alphaMap,n(c.alphaMap,m.alphaMapTransform)),c.alphaTest>0&&(m.alphaTest.value=c.alphaTest)}function d(m,c){m.specular.value.copy(c.specular),m.shininess.value=Math.max(c.shininess,1e-4)}function h(m,c){c.gradientMap&&(m.gradientMap.value=c.gradientMap)}function f(m,c){m.metalness.value=c.metalness,c.metalnessMap&&(m.metalnessMap.value=c.metalnessMap,n(c.metalnessMap,m.metalnessMapTransform)),m.roughness.value=c.roughness,c.roughnessMap&&(m.roughnessMap.value=c.roughnessMap,n(c.roughnessMap,m.roughnessMapTransform)),c.envMap&&(m.envMapIntensity.value=c.envMapIntensity)}function p(m,c,g){m.ior.value=c.ior,c.sheen>0&&(m.sheenColor.value.copy(c.sheenColor).multiplyScalar(c.sheen),m.sheenRoughness.value=c.sheenRoughness,c.sheenColorMap&&(m.sheenColorMap.value=c.sheenColorMap,n(c.sheenColorMap,m.sheenColorMapTransform)),c.sheenRoughnessMap&&(m.sheenRoughnessMap.value=c.sheenRoughnessMap,n(c.sheenRoughnessMap,m.sheenRoughnessMapTransform))),c.clearcoat>0&&(m.clearcoat.value=c.clearcoat,m.clearcoatRoughness.value=c.clearcoatRoughness,c.clearcoatMap&&(m.clearcoatMap.value=c.clearcoatMap,n(c.clearcoatMap,m.clearcoatMapTransform)),c.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=c.clearcoatRoughnessMap,n(c.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),c.clearcoatNormalMap&&(m.clearcoatNormalMap.value=c.clearcoatNormalMap,n(c.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(c.clearcoatNormalScale),c.side===gn&&m.clearcoatNormalScale.value.negate())),c.dispersion>0&&(m.dispersion.value=c.dispersion),c.iridescence>0&&(m.iridescence.value=c.iridescence,m.iridescenceIOR.value=c.iridescenceIOR,m.iridescenceThicknessMinimum.value=c.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=c.iridescenceThicknessRange[1],c.iridescenceMap&&(m.iridescenceMap.value=c.iridescenceMap,n(c.iridescenceMap,m.iridescenceMapTransform)),c.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=c.iridescenceThicknessMap,n(c.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),c.transmission>0&&(m.transmission.value=c.transmission,m.transmissionSamplerMap.value=g.texture,m.transmissionSamplerSize.value.set(g.width,g.height),c.transmissionMap&&(m.transmissionMap.value=c.transmissionMap,n(c.transmissionMap,m.transmissionMapTransform)),m.thickness.value=c.thickness,c.thicknessMap&&(m.thicknessMap.value=c.thicknessMap,n(c.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=c.attenuationDistance,m.attenuationColor.value.copy(c.attenuationColor)),c.anisotropy>0&&(m.anisotropyVector.value.set(c.anisotropy*Math.cos(c.anisotropyRotation),c.anisotropy*Math.sin(c.anisotropyRotation)),c.anisotropyMap&&(m.anisotropyMap.value=c.anisotropyMap,n(c.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=c.specularIntensity,m.specularColor.value.copy(c.specularColor),c.specularColorMap&&(m.specularColorMap.value=c.specularColorMap,n(c.specularColorMap,m.specularColorMapTransform)),c.specularIntensityMap&&(m.specularIntensityMap.value=c.specularIntensityMap,n(c.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,c){c.matcap&&(m.matcap.value=c.matcap)}function v(m,c){const g=e.get(c).light;m.referencePosition.value.setFromMatrixPosition(g.matrixWorld),m.nearDistance.value=g.shadow.camera.near,m.farDistance.value=g.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function dA(t,e,n,i){let r={},s={},o=[];const a=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function l(g,x){const y=x.program;i.uniformBlockBinding(g,y)}function u(g,x){let y=r[g.id];y===void 0&&(_(g),y=d(g),r[g.id]=y,g.addEventListener("dispose",m));const A=x.program;i.updateUBOMapping(g,A);const T=e.render.frame;s[g.id]!==T&&(f(g),s[g.id]=T)}function d(g){const x=h();g.__bindingPointIndex=x;const y=t.createBuffer(),A=g.__size,T=g.usage;return t.bindBuffer(t.UNIFORM_BUFFER,y),t.bufferData(t.UNIFORM_BUFFER,A,T),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,x,y),y}function h(){for(let g=0;g<a;g++)if(o.indexOf(g)===-1)return o.push(g),g;return Ke("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(g){const x=r[g.id],y=g.uniforms,A=g.__cache;t.bindBuffer(t.UNIFORM_BUFFER,x);for(let T=0,C=y.length;T<C;T++){const S=Array.isArray(y[T])?y[T]:[y[T]];for(let b=0,P=S.length;b<P;b++){const w=S[b];if(p(w,T,b,A)===!0){const N=w.__offset,D=Array.isArray(w.value)?w.value:[w.value];let G=0;for(let L=0;L<D.length;L++){const F=D[L],k=v(F);typeof F=="number"||typeof F=="boolean"?(w.__data[0]=F,t.bufferSubData(t.UNIFORM_BUFFER,N+G,w.__data)):F.isMatrix3?(w.__data[0]=F.elements[0],w.__data[1]=F.elements[1],w.__data[2]=F.elements[2],w.__data[3]=0,w.__data[4]=F.elements[3],w.__data[5]=F.elements[4],w.__data[6]=F.elements[5],w.__data[7]=0,w.__data[8]=F.elements[6],w.__data[9]=F.elements[7],w.__data[10]=F.elements[8],w.__data[11]=0):ArrayBuffer.isView(F)?w.__data.set(new F.constructor(F.buffer,F.byteOffset,w.__data.length)):(F.toArray(w.__data,G),G+=k.storage/Float32Array.BYTES_PER_ELEMENT)}t.bufferSubData(t.UNIFORM_BUFFER,N,w.__data)}}}t.bindBuffer(t.UNIFORM_BUFFER,null)}function p(g,x,y,A){const T=g.value,C=x+"_"+y;if(A[C]===void 0)return typeof T=="number"||typeof T=="boolean"?A[C]=T:ArrayBuffer.isView(T)?A[C]=T.slice():A[C]=T.clone(),!0;{const S=A[C];if(typeof T=="number"||typeof T=="boolean"){if(S!==T)return A[C]=T,!0}else{if(ArrayBuffer.isView(T))return!0;if(S.equals(T)===!1)return S.copy(T),!0}}return!1}function _(g){const x=g.uniforms;let y=0;const A=16;for(let C=0,S=x.length;C<S;C++){const b=Array.isArray(x[C])?x[C]:[x[C]];for(let P=0,w=b.length;P<w;P++){const N=b[P],D=Array.isArray(N.value)?N.value:[N.value];for(let G=0,L=D.length;G<L;G++){const F=D[G],k=v(F),B=y%A,j=B%k.boundary,Y=B+j;y+=j,Y!==0&&A-Y<k.storage&&(y+=A-Y),N.__data=new Float32Array(k.storage/Float32Array.BYTES_PER_ELEMENT),N.__offset=y,y+=k.storage}}}const T=y%A;return T>0&&(y+=A-T),g.__size=y,g.__cache={},this}function v(g){const x={boundary:0,storage:0};return typeof g=="number"||typeof g=="boolean"?(x.boundary=4,x.storage=4):g.isVector2?(x.boundary=8,x.storage=8):g.isVector3||g.isColor?(x.boundary=16,x.storage=12):g.isVector4?(x.boundary=16,x.storage=16):g.isMatrix3?(x.boundary=48,x.storage=48):g.isMatrix4?(x.boundary=64,x.storage=64):g.isTexture?Le("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(g)?(x.boundary=16,x.storage=g.byteLength):Le("WebGLRenderer: Unsupported uniform value type.",g),x}function m(g){const x=g.target;x.removeEventListener("dispose",m);const y=o.indexOf(x.__bindingPointIndex);o.splice(y,1),t.deleteBuffer(r[x.id]),delete r[x.id],delete s[x.id]}function c(){for(const g in r)t.deleteBuffer(r[g]);o=[],r={},s={}}return{bind:l,update:u,dispose:c}}const hA=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let ni=null;function pA(){return ni===null&&(ni=new eM(hA,16,16,Hr,Fi),ni.name="DFG_LUT",ni.minFilter=Vt,ni.magFilter=Vt,ni.wrapS=Ai,ni.wrapT=Ai,ni.generateMipmaps=!1,ni.needsUpdate=!0),ni}class mA{constructor(e={}){const{canvas:n=Py(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:u=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:h=!1,reversedDepthBuffer:f=!1,outputBufferType:p=Dn}=e;this.isWebGLRenderer=!0;let _;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=i.getContextAttributes().alpha}else _=o;const v=p,m=new Set([dh,fh,ch]),c=new Set([Dn,hi,Yo,qo,lh,uh]),g=new Uint32Array(4),x=new Int32Array(4),y=new W;let A=null,T=null;const C=[],S=[];let b=null;this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=ci,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const P=this;let w=!1,N=null;this._outputColorSpace=Mn;let D=0,G=0,L=null,F=-1,k=null;const B=new Rt,j=new Rt;let Y=null;const ne=new rt(0);let fe=0,Ve=n.width,We=n.height,Ne=1,K=null,de=null;const ae=new Rt(0,0,Ve,We),be=new Rt(0,0,Ve,We);let Ie=!1;const Pe=new N_;let mt=!1,Xe=!1;const tt=new Ft,ft=new W,He=new Rt,Lt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let gt=!1;function _n(){return L===null?Ne:1}let U=i;function Nt(E,O){return n.getContext(E,O)}try{const E={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:h};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${oh}`),n.addEventListener("webglcontextlost",ee,!1),n.addEventListener("webglcontextrestored",we,!1),n.addEventListener("webglcontextcreationerror",Fe,!1),U===null){const O="webgl2";if(U=Nt(O,E),U===null)throw Nt(O)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(E){throw Ke("WebGLRenderer: "+E.message),E}let je,lt,he,St,R,M,z,Z,te,re,ce,$,Q,_e,Se,le,se,De,ke,Qe,I,oe,q;function ve(){je=new p1(U),je.init(),I=new sA(U,je),lt=new o1(U,je,e,I),he=new iA(U,je),lt.reversedDepthBuffer&&f&&he.buffers.depth.setReversed(!0),St=new _1(U),R=new Gw,M=new rA(U,je,he,R,lt,I,St),z=new h1(P),Z=new yM(U),oe=new r1(U,Z),te=new m1(U,Z,St,oe),re=new x1(U,te,Z,oe,St),De=new v1(U,lt,M),Se=new a1(R),ce=new Hw(P,z,je,lt,oe,Se),$=new fA(P,R),Q=new Xw,_e=new Zw(je),se=new i1(P,z,he,re,_,l),le=new nA(P,re,lt),q=new dA(U,St,lt,he),ke=new s1(U,je,St),Qe=new g1(U,je,St),St.programs=ce.programs,P.capabilities=lt,P.extensions=je,P.properties=R,P.renderLists=Q,P.shadowMap=le,P.state=he,P.info=St}ve(),v!==Dn&&(b=new y1(v,n.width,n.height,r,s));const ue=new uA(P,U);this.xr=ue,this.getContext=function(){return U},this.getContextAttributes=function(){return U.getContextAttributes()},this.forceContextLoss=function(){const E=je.get("WEBGL_lose_context");E&&E.loseContext()},this.forceContextRestore=function(){const E=je.get("WEBGL_lose_context");E&&E.restoreContext()},this.getPixelRatio=function(){return Ne},this.setPixelRatio=function(E){E!==void 0&&(Ne=E,this.setSize(Ve,We,!1))},this.getSize=function(E){return E.set(Ve,We)},this.setSize=function(E,O,X=!0){if(ue.isPresenting){Le("WebGLRenderer: Can't change size while VR device is presenting.");return}Ve=E,We=O,n.width=Math.floor(E*Ne),n.height=Math.floor(O*Ne),X===!0&&(n.style.width=E+"px",n.style.height=O+"px"),b!==null&&b.setSize(n.width,n.height),this.setViewport(0,0,E,O)},this.getDrawingBufferSize=function(E){return E.set(Ve*Ne,We*Ne).floor()},this.setDrawingBufferSize=function(E,O,X){Ve=E,We=O,Ne=X,n.width=Math.floor(E*X),n.height=Math.floor(O*X),this.setViewport(0,0,E,O)},this.setEffects=function(E){if(v===Dn){Ke("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(E){for(let O=0;O<E.length;O++)if(E[O].isOutputPass===!0){Le("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}b.setEffects(E||[])},this.getCurrentViewport=function(E){return E.copy(B)},this.getViewport=function(E){return E.copy(ae)},this.setViewport=function(E,O,X,V){E.isVector4?ae.set(E.x,E.y,E.z,E.w):ae.set(E,O,X,V),he.viewport(B.copy(ae).multiplyScalar(Ne).round())},this.getScissor=function(E){return E.copy(be)},this.setScissor=function(E,O,X,V){E.isVector4?be.set(E.x,E.y,E.z,E.w):be.set(E,O,X,V),he.scissor(j.copy(be).multiplyScalar(Ne).round())},this.getScissorTest=function(){return Ie},this.setScissorTest=function(E){he.setScissorTest(Ie=E)},this.setOpaqueSort=function(E){K=E},this.setTransparentSort=function(E){de=E},this.getClearColor=function(E){return E.copy(se.getClearColor())},this.setClearColor=function(){se.setClearColor(...arguments)},this.getClearAlpha=function(){return se.getClearAlpha()},this.setClearAlpha=function(){se.setClearAlpha(...arguments)},this.clear=function(E=!0,O=!0,X=!0){let V=0;if(E){let H=!1;if(L!==null){const ge=L.texture.format;H=m.has(ge)}if(H){const ge=L.texture.type,ye=c.has(ge),me=se.getClearColor(),Te=se.getClearAlpha(),Ae=me.r,Oe=me.g,ze=me.b;ye?(g[0]=Ae,g[1]=Oe,g[2]=ze,g[3]=Te,U.clearBufferuiv(U.COLOR,0,g)):(x[0]=Ae,x[1]=Oe,x[2]=ze,x[3]=Te,U.clearBufferiv(U.COLOR,0,x))}else V|=U.COLOR_BUFFER_BIT}O&&(V|=U.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),X&&(V|=U.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),V!==0&&U.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(E){E.setRenderer(this),N=E},this.dispose=function(){n.removeEventListener("webglcontextlost",ee,!1),n.removeEventListener("webglcontextrestored",we,!1),n.removeEventListener("webglcontextcreationerror",Fe,!1),se.dispose(),Q.dispose(),_e.dispose(),R.dispose(),z.dispose(),re.dispose(),oe.dispose(),q.dispose(),ce.dispose(),ue.dispose(),ue.removeEventListener("sessionstart",Ah),ue.removeEventListener("sessionend",Rh),xr.stop()};function ee(E){E.preventDefault(),Jp("WebGLRenderer: Context Lost."),w=!0}function we(){Jp("WebGLRenderer: Context Restored."),w=!1;const E=St.autoReset,O=le.enabled,X=le.autoUpdate,V=le.needsUpdate,H=le.type;ve(),St.autoReset=E,le.enabled=O,le.autoUpdate=X,le.needsUpdate=V,le.type=H}function Fe(E){Ke("WebGLRenderer: A WebGL context could not be created. Reason: ",E.statusMessage)}function Et(E){const O=E.target;O.removeEventListener("dispose",Et),nt(O)}function nt(E){mi(E),R.remove(E)}function mi(E){const O=R.get(E).programs;O!==void 0&&(O.forEach(function(X){ce.releaseProgram(X)}),E.isShaderMaterial&&ce.releaseShaderCache(E))}this.renderBufferDirect=function(E,O,X,V,H,ge){O===null&&(O=Lt);const ye=H.isMesh&&H.matrixWorld.determinant()<0,me=ev(E,O,X,V,H);he.setMaterial(V,ye);let Te=X.index,Ae=1;if(V.wireframe===!0){if(Te=te.getWireframeAttribute(X),Te===void 0)return;Ae=2}const Oe=X.drawRange,ze=X.attributes.position;let Re=Oe.start*Ae,it=(Oe.start+Oe.count)*Ae;ge!==null&&(Re=Math.max(Re,ge.start*Ae),it=Math.min(it,(ge.start+ge.count)*Ae)),Te!==null?(Re=Math.max(Re,0),it=Math.min(it,Te.count)):ze!=null&&(Re=Math.max(Re,0),it=Math.min(it,ze.count));const Tt=it-Re;if(Tt<0||Tt===1/0)return;oe.setup(H,V,me,X,Te);let yt,ot=ke;if(Te!==null&&(yt=Z.get(Te),ot=Qe,ot.setIndex(yt)),H.isMesh)V.wireframe===!0?(he.setLineWidth(V.wireframeLinewidth*_n()),ot.setMode(U.LINES)):ot.setMode(U.TRIANGLES);else if(H.isLine){let Yt=V.linewidth;Yt===void 0&&(Yt=1),he.setLineWidth(Yt*_n()),H.isLineSegments?ot.setMode(U.LINES):H.isLineLoop?ot.setMode(U.LINE_LOOP):ot.setMode(U.LINE_STRIP)}else H.isPoints?ot.setMode(U.POINTS):H.isSprite&&ot.setMode(U.TRIANGLES);if(H.isBatchedMesh)if(je.get("WEBGL_multi_draw"))ot.renderMultiDraw(H._multiDrawStarts,H._multiDrawCounts,H._multiDrawCount);else{const Yt=H._multiDrawStarts,xe=H._multiDrawCounts,vn=H._multiDrawCount,qe=Te?Z.get(Te).bytesPerElement:1,bn=R.get(V).currentProgram.getUniforms();for(let Jn=0;Jn<vn;Jn++)bn.setValue(U,"_gl_DrawID",Jn),ot.render(Yt[Jn]/qe,xe[Jn])}else if(H.isInstancedMesh)ot.renderInstances(Re,Tt,H.count);else if(X.isInstancedBufferGeometry){const Yt=X._maxInstanceCount!==void 0?X._maxInstanceCount:1/0,xe=Math.min(X.instanceCount,Yt);ot.renderInstances(Re,Tt,xe)}else ot.render(Re,Tt)};function Qn(E,O,X){E.transparent===!0&&E.side===Ei&&E.forceSinglePass===!1?(E.side=gn,E.needsUpdate=!0,la(E,O,X),E.side=mr,E.needsUpdate=!0,la(E,O,X),E.side=Ei):la(E,O,X)}this.compile=function(E,O,X=null){X===null&&(X=E),T=_e.get(X),T.init(O),S.push(T),X.traverseVisible(function(H){H.isLight&&H.layers.test(O.layers)&&(T.pushLight(H),H.castShadow&&T.pushShadow(H))}),E!==X&&E.traverseVisible(function(H){H.isLight&&H.layers.test(O.layers)&&(T.pushLight(H),H.castShadow&&T.pushShadow(H))}),T.setupLights();const V=new Set;return E.traverse(function(H){if(!(H.isMesh||H.isPoints||H.isLine||H.isSprite))return;const ge=H.material;if(ge)if(Array.isArray(ge))for(let ye=0;ye<ge.length;ye++){const me=ge[ye];Qn(me,X,H),V.add(me)}else Qn(ge,X,H),V.add(ge)}),T=S.pop(),V},this.compileAsync=function(E,O,X=null){const V=this.compile(E,O,X);return new Promise(H=>{function ge(){if(V.forEach(function(ye){R.get(ye).currentProgram.isReady()&&V.delete(ye)}),V.size===0){H(E);return}setTimeout(ge,10)}je.get("KHR_parallel_shader_compile")!==null?ge():setTimeout(ge,10)})};let pu=null;function Q_(E){pu&&pu(E)}function Ah(){xr.stop()}function Rh(){xr.start()}const xr=new O_;xr.setAnimationLoop(Q_),typeof self<"u"&&xr.setContext(self),this.setAnimationLoop=function(E){pu=E,ue.setAnimationLoop(E),E===null?xr.stop():xr.start()},ue.addEventListener("sessionstart",Ah),ue.addEventListener("sessionend",Rh),this.render=function(E,O){if(O!==void 0&&O.isCamera!==!0){Ke("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(w===!0)return;N!==null&&N.renderStart(E,O);const X=ue.enabled===!0&&ue.isPresenting===!0,V=b!==null&&(L===null||X)&&b.begin(P,L);if(E.matrixWorldAutoUpdate===!0&&E.updateMatrixWorld(),O.parent===null&&O.matrixWorldAutoUpdate===!0&&O.updateMatrixWorld(),ue.enabled===!0&&ue.isPresenting===!0&&(b===null||b.isCompositing()===!1)&&(ue.cameraAutoUpdate===!0&&ue.updateCamera(O),O=ue.getCamera()),E.isScene===!0&&E.onBeforeRender(P,E,O,L),T=_e.get(E,S.length),T.init(O),T.state.textureUnits=M.getTextureUnits(),S.push(T),tt.multiplyMatrices(O.projectionMatrix,O.matrixWorldInverse),Pe.setFromProjectionMatrix(tt,ai,O.reversedDepth),Xe=this.localClippingEnabled,mt=Se.init(this.clippingPlanes,Xe),A=Q.get(E,C.length),A.init(),C.push(A),ue.enabled===!0&&ue.isPresenting===!0){const ye=P.xr.getDepthSensingMesh();ye!==null&&mu(ye,O,-1/0,P.sortObjects)}mu(E,O,0,P.sortObjects),A.finish(),P.sortObjects===!0&&A.sort(K,de),gt=ue.enabled===!1||ue.isPresenting===!1||ue.hasDepthSensing()===!1,gt&&se.addToRenderList(A,E),this.info.render.frame++,mt===!0&&Se.beginShadows();const H=T.state.shadowsArray;if(le.render(H,E,O),mt===!0&&Se.endShadows(),this.info.autoReset===!0&&this.info.reset(),(V&&b.hasRenderPass())===!1){const ye=A.opaque,me=A.transmissive;if(T.setupLights(),O.isArrayCamera){const Te=O.cameras;if(me.length>0)for(let Ae=0,Oe=Te.length;Ae<Oe;Ae++){const ze=Te[Ae];bh(ye,me,E,ze)}gt&&se.render(E);for(let Ae=0,Oe=Te.length;Ae<Oe;Ae++){const ze=Te[Ae];Ch(A,E,ze,ze.viewport)}}else me.length>0&&bh(ye,me,E,O),gt&&se.render(E),Ch(A,E,O)}L!==null&&G===0&&(M.updateMultisampleRenderTarget(L),M.updateRenderTargetMipmap(L)),V&&b.end(P),E.isScene===!0&&E.onAfterRender(P,E,O),oe.resetDefaultState(),F=-1,k=null,S.pop(),S.length>0?(T=S[S.length-1],M.setTextureUnits(T.state.textureUnits),mt===!0&&Se.setGlobalState(P.clippingPlanes,T.state.camera)):T=null,C.pop(),C.length>0?A=C[C.length-1]:A=null,N!==null&&N.renderEnd()};function mu(E,O,X,V){if(E.visible===!1)return;if(E.layers.test(O.layers)){if(E.isGroup)X=E.renderOrder;else if(E.isLOD)E.autoUpdate===!0&&E.update(O);else if(E.isLightProbeGrid)T.pushLightProbeGrid(E);else if(E.isLight)T.pushLight(E),E.castShadow&&T.pushShadow(E);else if(E.isSprite){if(!E.frustumCulled||Pe.intersectsSprite(E)){V&&He.setFromMatrixPosition(E.matrixWorld).applyMatrix4(tt);const ye=re.update(E),me=E.material;me.visible&&A.push(E,ye,me,X,He.z,null)}}else if((E.isMesh||E.isLine||E.isPoints)&&(!E.frustumCulled||Pe.intersectsObject(E))){const ye=re.update(E),me=E.material;if(V&&(E.boundingSphere!==void 0?(E.boundingSphere===null&&E.computeBoundingSphere(),He.copy(E.boundingSphere.center)):(ye.boundingSphere===null&&ye.computeBoundingSphere(),He.copy(ye.boundingSphere.center)),He.applyMatrix4(E.matrixWorld).applyMatrix4(tt)),Array.isArray(me)){const Te=ye.groups;for(let Ae=0,Oe=Te.length;Ae<Oe;Ae++){const ze=Te[Ae],Re=me[ze.materialIndex];Re&&Re.visible&&A.push(E,ye,Re,X,He.z,ze)}}else me.visible&&A.push(E,ye,me,X,He.z,null)}}const ge=E.children;for(let ye=0,me=ge.length;ye<me;ye++)mu(ge[ye],O,X,V)}function Ch(E,O,X,V){const{opaque:H,transmissive:ge,transparent:ye}=E;T.setupLightsView(X),mt===!0&&Se.setGlobalState(P.clippingPlanes,X),V&&he.viewport(B.copy(V)),H.length>0&&aa(H,O,X),ge.length>0&&aa(ge,O,X),ye.length>0&&aa(ye,O,X),he.buffers.depth.setTest(!0),he.buffers.depth.setMask(!0),he.buffers.color.setMask(!0),he.setPolygonOffset(!1)}function bh(E,O,X,V){if((X.isScene===!0?X.overrideMaterial:null)!==null)return;if(T.state.transmissionRenderTarget[V.id]===void 0){const Re=je.has("EXT_color_buffer_half_float")||je.has("EXT_color_buffer_float");T.state.transmissionRenderTarget[V.id]=new fi(1,1,{generateMipmaps:!0,type:Re?Fi:Dn,minFilter:Nr,samples:Math.max(4,lt.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:$e.workingColorSpace})}const ge=T.state.transmissionRenderTarget[V.id],ye=V.viewport||B;ge.setSize(ye.z*P.transmissionResolutionScale,ye.w*P.transmissionResolutionScale);const me=P.getRenderTarget(),Te=P.getActiveCubeFace(),Ae=P.getActiveMipmapLevel();P.setRenderTarget(ge),P.getClearColor(ne),fe=P.getClearAlpha(),fe<1&&P.setClearColor(16777215,.5),P.clear(),gt&&se.render(X);const Oe=P.toneMapping;P.toneMapping=ci;const ze=V.viewport;if(V.viewport!==void 0&&(V.viewport=void 0),T.setupLightsView(V),mt===!0&&Se.setGlobalState(P.clippingPlanes,V),aa(E,X,V),M.updateMultisampleRenderTarget(ge),M.updateRenderTargetMipmap(ge),je.has("WEBGL_multisampled_render_to_texture")===!1){let Re=!1;for(let it=0,Tt=O.length;it<Tt;it++){const yt=O[it],{object:ot,geometry:Yt,material:xe,group:vn}=yt;if(xe.side===Ei&&ot.layers.test(V.layers)){const qe=xe.side;xe.side=gn,xe.needsUpdate=!0,Ph(ot,X,V,Yt,xe,vn),xe.side=qe,xe.needsUpdate=!0,Re=!0}}Re===!0&&(M.updateMultisampleRenderTarget(ge),M.updateRenderTargetMipmap(ge))}P.setRenderTarget(me,Te,Ae),P.setClearColor(ne,fe),ze!==void 0&&(V.viewport=ze),P.toneMapping=Oe}function aa(E,O,X){const V=O.isScene===!0?O.overrideMaterial:null;for(let H=0,ge=E.length;H<ge;H++){const ye=E[H],{object:me,geometry:Te,group:Ae}=ye;let Oe=ye.material;Oe.allowOverride===!0&&V!==null&&(Oe=V),me.layers.test(X.layers)&&Ph(me,O,X,Te,Oe,Ae)}}function Ph(E,O,X,V,H,ge){E.onBeforeRender(P,O,X,V,H,ge),E.modelViewMatrix.multiplyMatrices(X.matrixWorldInverse,E.matrixWorld),E.normalMatrix.getNormalMatrix(E.modelViewMatrix),H.onBeforeRender(P,O,X,V,E,ge),H.transparent===!0&&H.side===Ei&&H.forceSinglePass===!1?(H.side=gn,H.needsUpdate=!0,P.renderBufferDirect(X,O,V,H,E,ge),H.side=mr,H.needsUpdate=!0,P.renderBufferDirect(X,O,V,H,E,ge),H.side=Ei):P.renderBufferDirect(X,O,V,H,E,ge),E.onAfterRender(P,O,X,V,H,ge)}function la(E,O,X){O.isScene!==!0&&(O=Lt);const V=R.get(E),H=T.state.lights,ge=T.state.shadowsArray,ye=H.state.version,me=ce.getParameters(E,H.state,ge,O,X,T.state.lightProbeGridArray),Te=ce.getProgramCacheKey(me);let Ae=V.programs;V.environment=E.isMeshStandardMaterial||E.isMeshLambertMaterial||E.isMeshPhongMaterial?O.environment:null,V.fog=O.fog;const Oe=E.isMeshStandardMaterial||E.isMeshLambertMaterial&&!E.envMap||E.isMeshPhongMaterial&&!E.envMap;V.envMap=z.get(E.envMap||V.environment,Oe),V.envMapRotation=V.environment!==null&&E.envMap===null?O.environmentRotation:E.envMapRotation,Ae===void 0&&(E.addEventListener("dispose",Et),Ae=new Map,V.programs=Ae);let ze=Ae.get(Te);if(ze!==void 0){if(V.currentProgram===ze&&V.lightsStateVersion===ye)return Nh(E,me),ze}else me.uniforms=ce.getUniforms(E),N!==null&&E.isNodeMaterial&&N.build(E,X,me),E.onBeforeCompile(me,P),ze=ce.acquireProgram(me,Te),Ae.set(Te,ze),V.uniforms=me.uniforms;const Re=V.uniforms;return(!E.isShaderMaterial&&!E.isRawShaderMaterial||E.clipping===!0)&&(Re.clippingPlanes=Se.uniform),Nh(E,me),V.needsLights=nv(E),V.lightsStateVersion=ye,V.needsLights&&(Re.ambientLightColor.value=H.state.ambient,Re.lightProbe.value=H.state.probe,Re.directionalLights.value=H.state.directional,Re.directionalLightShadows.value=H.state.directionalShadow,Re.spotLights.value=H.state.spot,Re.spotLightShadows.value=H.state.spotShadow,Re.rectAreaLights.value=H.state.rectArea,Re.ltc_1.value=H.state.rectAreaLTC1,Re.ltc_2.value=H.state.rectAreaLTC2,Re.pointLights.value=H.state.point,Re.pointLightShadows.value=H.state.pointShadow,Re.hemisphereLights.value=H.state.hemi,Re.directionalShadowMatrix.value=H.state.directionalShadowMatrix,Re.spotLightMatrix.value=H.state.spotLightMatrix,Re.spotLightMap.value=H.state.spotLightMap,Re.pointShadowMatrix.value=H.state.pointShadowMatrix),V.lightProbeGrid=T.state.lightProbeGridArray.length>0,V.currentProgram=ze,V.uniformsList=null,ze}function Lh(E){if(E.uniformsList===null){const O=E.currentProgram.getUniforms();E.uniformsList=hl.seqWithValue(O.seq,E.uniforms)}return E.uniformsList}function Nh(E,O){const X=R.get(E);X.outputColorSpace=O.outputColorSpace,X.batching=O.batching,X.batchingColor=O.batchingColor,X.instancing=O.instancing,X.instancingColor=O.instancingColor,X.instancingMorph=O.instancingMorph,X.skinning=O.skinning,X.morphTargets=O.morphTargets,X.morphNormals=O.morphNormals,X.morphColors=O.morphColors,X.morphTargetsCount=O.morphTargetsCount,X.numClippingPlanes=O.numClippingPlanes,X.numIntersection=O.numClipIntersection,X.vertexAlphas=O.vertexAlphas,X.vertexTangents=O.vertexTangents,X.toneMapping=O.toneMapping}function J_(E,O){if(E.length===0)return null;if(E.length===1)return E[0].texture!==null?E[0]:null;y.setFromMatrixPosition(O.matrixWorld);for(let X=0,V=E.length;X<V;X++){const H=E[X];if(H.texture!==null&&H.boundingBox.containsPoint(y))return H}return null}function ev(E,O,X,V,H){O.isScene!==!0&&(O=Lt),M.resetTextureUnits();const ge=O.fog,ye=V.isMeshStandardMaterial||V.isMeshLambertMaterial||V.isMeshPhongMaterial?O.environment:null,me=L===null?P.outputColorSpace:L.isXRRenderTarget===!0?L.texture.colorSpace:$e.workingColorSpace,Te=V.isMeshStandardMaterial||V.isMeshLambertMaterial&&!V.envMap||V.isMeshPhongMaterial&&!V.envMap,Ae=z.get(V.envMap||ye,Te),Oe=V.vertexColors===!0&&!!X.attributes.color&&X.attributes.color.itemSize===4,ze=!!X.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),Re=!!X.morphAttributes.position,it=!!X.morphAttributes.normal,Tt=!!X.morphAttributes.color;let yt=ci;V.toneMapped&&(L===null||L.isXRRenderTarget===!0)&&(yt=P.toneMapping);const ot=X.morphAttributes.position||X.morphAttributes.normal||X.morphAttributes.color,Yt=ot!==void 0?ot.length:0,xe=R.get(V),vn=T.state.lights;if(mt===!0&&(Xe===!0||E!==k)){const ut=E===k&&V.id===F;Se.setState(V,E,ut)}let qe=!1;V.version===xe.__version?(xe.needsLights&&xe.lightsStateVersion!==vn.state.version||xe.outputColorSpace!==me||H.isBatchedMesh&&xe.batching===!1||!H.isBatchedMesh&&xe.batching===!0||H.isBatchedMesh&&xe.batchingColor===!0&&H.colorTexture===null||H.isBatchedMesh&&xe.batchingColor===!1&&H.colorTexture!==null||H.isInstancedMesh&&xe.instancing===!1||!H.isInstancedMesh&&xe.instancing===!0||H.isSkinnedMesh&&xe.skinning===!1||!H.isSkinnedMesh&&xe.skinning===!0||H.isInstancedMesh&&xe.instancingColor===!0&&H.instanceColor===null||H.isInstancedMesh&&xe.instancingColor===!1&&H.instanceColor!==null||H.isInstancedMesh&&xe.instancingMorph===!0&&H.morphTexture===null||H.isInstancedMesh&&xe.instancingMorph===!1&&H.morphTexture!==null||xe.envMap!==Ae||V.fog===!0&&xe.fog!==ge||xe.numClippingPlanes!==void 0&&(xe.numClippingPlanes!==Se.numPlanes||xe.numIntersection!==Se.numIntersection)||xe.vertexAlphas!==Oe||xe.vertexTangents!==ze||xe.morphTargets!==Re||xe.morphNormals!==it||xe.morphColors!==Tt||xe.toneMapping!==yt||xe.morphTargetsCount!==Yt||!!xe.lightProbeGrid!=T.state.lightProbeGridArray.length>0)&&(qe=!0):(qe=!0,xe.__version=V.version);let bn=xe.currentProgram;qe===!0&&(bn=la(V,O,H),N&&V.isNodeMaterial&&N.onUpdateProgram(V,bn,xe));let Jn=!1,zi=!1,Yr=!1;const at=bn.getUniforms(),wt=xe.uniforms;if(he.useProgram(bn.program)&&(Jn=!0,zi=!0,Yr=!0),V.id!==F&&(F=V.id,zi=!0),xe.needsLights){const ut=J_(T.state.lightProbeGridArray,H);xe.lightProbeGrid!==ut&&(xe.lightProbeGrid=ut,zi=!0)}if(Jn||k!==E){he.buffers.depth.getReversed()&&E.reversedDepth!==!0&&(E._reversedDepth=!0,E.updateProjectionMatrix()),at.setValue(U,"projectionMatrix",E.projectionMatrix),at.setValue(U,"viewMatrix",E.matrixWorldInverse);const Hi=at.map.cameraPosition;Hi!==void 0&&Hi.setValue(U,ft.setFromMatrixPosition(E.matrixWorld)),lt.logarithmicDepthBuffer&&at.setValue(U,"logDepthBufFC",2/(Math.log(E.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&at.setValue(U,"isOrthographic",E.isOrthographicCamera===!0),k!==E&&(k=E,zi=!0,Yr=!0)}if(xe.needsLights&&(vn.state.directionalShadowMap.length>0&&at.setValue(U,"directionalShadowMap",vn.state.directionalShadowMap,M),vn.state.spotShadowMap.length>0&&at.setValue(U,"spotShadowMap",vn.state.spotShadowMap,M),vn.state.pointShadowMap.length>0&&at.setValue(U,"pointShadowMap",vn.state.pointShadowMap,M)),H.isSkinnedMesh){at.setOptional(U,H,"bindMatrix"),at.setOptional(U,H,"bindMatrixInverse");const ut=H.skeleton;ut&&(ut.boneTexture===null&&ut.computeBoneTexture(),at.setValue(U,"boneTexture",ut.boneTexture,M))}H.isBatchedMesh&&(at.setOptional(U,H,"batchingTexture"),at.setValue(U,"batchingTexture",H._matricesTexture,M),at.setOptional(U,H,"batchingIdTexture"),at.setValue(U,"batchingIdTexture",H._indirectTexture,M),at.setOptional(U,H,"batchingColorTexture"),H._colorsTexture!==null&&at.setValue(U,"batchingColorTexture",H._colorsTexture,M));const Vi=X.morphAttributes;if((Vi.position!==void 0||Vi.normal!==void 0||Vi.color!==void 0)&&De.update(H,X,bn),(zi||xe.receiveShadow!==H.receiveShadow)&&(xe.receiveShadow=H.receiveShadow,at.setValue(U,"receiveShadow",H.receiveShadow)),(V.isMeshStandardMaterial||V.isMeshLambertMaterial||V.isMeshPhongMaterial)&&V.envMap===null&&O.environment!==null&&(wt.envMapIntensity.value=O.environmentIntensity),wt.dfgLUT!==void 0&&(wt.dfgLUT.value=pA()),zi){if(at.setValue(U,"toneMappingExposure",P.toneMappingExposure),xe.needsLights&&tv(wt,Yr),ge&&V.fog===!0&&$.refreshFogUniforms(wt,ge),$.refreshMaterialUniforms(wt,V,Ne,We,T.state.transmissionRenderTarget[E.id]),xe.needsLights&&xe.lightProbeGrid){const ut=xe.lightProbeGrid;wt.probesSH.value=ut.texture,wt.probesMin.value.copy(ut.boundingBox.min),wt.probesMax.value.copy(ut.boundingBox.max),wt.probesResolution.value.copy(ut.resolution)}hl.upload(U,Lh(xe),wt,M)}if(V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&(hl.upload(U,Lh(xe),wt,M),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&at.setValue(U,"center",H.center),at.setValue(U,"modelViewMatrix",H.modelViewMatrix),at.setValue(U,"normalMatrix",H.normalMatrix),at.setValue(U,"modelMatrix",H.matrixWorld),V.uniformsGroups!==void 0){const ut=V.uniformsGroups;for(let Hi=0,qr=ut.length;Hi<qr;Hi++){const Dh=ut[Hi];q.update(Dh,bn),q.bind(Dh,bn)}}return bn}function tv(E,O){E.ambientLightColor.needsUpdate=O,E.lightProbe.needsUpdate=O,E.directionalLights.needsUpdate=O,E.directionalLightShadows.needsUpdate=O,E.pointLights.needsUpdate=O,E.pointLightShadows.needsUpdate=O,E.spotLights.needsUpdate=O,E.spotLightShadows.needsUpdate=O,E.rectAreaLights.needsUpdate=O,E.hemisphereLights.needsUpdate=O}function nv(E){return E.isMeshLambertMaterial||E.isMeshToonMaterial||E.isMeshPhongMaterial||E.isMeshStandardMaterial||E.isShadowMaterial||E.isShaderMaterial&&E.lights===!0}this.getActiveCubeFace=function(){return D},this.getActiveMipmapLevel=function(){return G},this.getRenderTarget=function(){return L},this.setRenderTargetTextures=function(E,O,X){const V=R.get(E);V.__autoAllocateDepthBuffer=E.resolveDepthBuffer===!1,V.__autoAllocateDepthBuffer===!1&&(V.__useRenderToTexture=!1),R.get(E.texture).__webglTexture=O,R.get(E.depthTexture).__webglTexture=V.__autoAllocateDepthBuffer?void 0:X,V.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(E,O){const X=R.get(E);X.__webglFramebuffer=O,X.__useDefaultFramebuffer=O===void 0};const iv=U.createFramebuffer();this.setRenderTarget=function(E,O=0,X=0){L=E,D=O,G=X;let V=null,H=!1,ge=!1;if(E){const me=R.get(E);if(me.__useDefaultFramebuffer!==void 0){he.bindFramebuffer(U.FRAMEBUFFER,me.__webglFramebuffer),B.copy(E.viewport),j.copy(E.scissor),Y=E.scissorTest,he.viewport(B),he.scissor(j),he.setScissorTest(Y),F=-1;return}else if(me.__webglFramebuffer===void 0)M.setupRenderTarget(E);else if(me.__hasExternalTextures)M.rebindTextures(E,R.get(E.texture).__webglTexture,R.get(E.depthTexture).__webglTexture);else if(E.depthBuffer){const Oe=E.depthTexture;if(me.__boundDepthTexture!==Oe){if(Oe!==null&&R.has(Oe)&&(E.width!==Oe.image.width||E.height!==Oe.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");M.setupDepthRenderbuffer(E)}}const Te=E.texture;(Te.isData3DTexture||Te.isDataArrayTexture||Te.isCompressedArrayTexture)&&(ge=!0);const Ae=R.get(E).__webglFramebuffer;E.isWebGLCubeRenderTarget?(Array.isArray(Ae[O])?V=Ae[O][X]:V=Ae[O],H=!0):E.samples>0&&M.useMultisampledRTT(E)===!1?V=R.get(E).__webglMultisampledFramebuffer:Array.isArray(Ae)?V=Ae[X]:V=Ae,B.copy(E.viewport),j.copy(E.scissor),Y=E.scissorTest}else B.copy(ae).multiplyScalar(Ne).floor(),j.copy(be).multiplyScalar(Ne).floor(),Y=Ie;if(X!==0&&(V=iv),he.bindFramebuffer(U.FRAMEBUFFER,V)&&he.drawBuffers(E,V),he.viewport(B),he.scissor(j),he.setScissorTest(Y),H){const me=R.get(E.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_CUBE_MAP_POSITIVE_X+O,me.__webglTexture,X)}else if(ge){const me=O;for(let Te=0;Te<E.textures.length;Te++){const Ae=R.get(E.textures[Te]);U.framebufferTextureLayer(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0+Te,Ae.__webglTexture,X,me)}}else if(E!==null&&X!==0){const me=R.get(E.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,me.__webglTexture,X)}F=-1},this.readRenderTargetPixels=function(E,O,X,V,H,ge,ye,me=0){if(!(E&&E.isWebGLRenderTarget)){Ke("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Te=R.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&ye!==void 0&&(Te=Te[ye]),Te){he.bindFramebuffer(U.FRAMEBUFFER,Te);try{const Ae=E.textures[me],Oe=Ae.format,ze=Ae.type;if(E.textures.length>1&&U.readBuffer(U.COLOR_ATTACHMENT0+me),!lt.textureFormatReadable(Oe)){Ke("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!lt.textureTypeReadable(ze)){Ke("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}O>=0&&O<=E.width-V&&X>=0&&X<=E.height-H&&U.readPixels(O,X,V,H,I.convert(Oe),I.convert(ze),ge)}finally{const Ae=L!==null?R.get(L).__webglFramebuffer:null;he.bindFramebuffer(U.FRAMEBUFFER,Ae)}}},this.readRenderTargetPixelsAsync=async function(E,O,X,V,H,ge,ye,me=0){if(!(E&&E.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Te=R.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&ye!==void 0&&(Te=Te[ye]),Te)if(O>=0&&O<=E.width-V&&X>=0&&X<=E.height-H){he.bindFramebuffer(U.FRAMEBUFFER,Te);const Ae=E.textures[me],Oe=Ae.format,ze=Ae.type;if(E.textures.length>1&&U.readBuffer(U.COLOR_ATTACHMENT0+me),!lt.textureFormatReadable(Oe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!lt.textureTypeReadable(ze))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Re=U.createBuffer();U.bindBuffer(U.PIXEL_PACK_BUFFER,Re),U.bufferData(U.PIXEL_PACK_BUFFER,ge.byteLength,U.STREAM_READ),U.readPixels(O,X,V,H,I.convert(Oe),I.convert(ze),0);const it=L!==null?R.get(L).__webglFramebuffer:null;he.bindFramebuffer(U.FRAMEBUFFER,it);const Tt=U.fenceSync(U.SYNC_GPU_COMMANDS_COMPLETE,0);return U.flush(),await Ly(U,Tt,4),U.bindBuffer(U.PIXEL_PACK_BUFFER,Re),U.getBufferSubData(U.PIXEL_PACK_BUFFER,0,ge),U.deleteBuffer(Re),U.deleteSync(Tt),ge}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(E,O=null,X=0){const V=Math.pow(2,-X),H=Math.floor(E.image.width*V),ge=Math.floor(E.image.height*V),ye=O!==null?O.x:0,me=O!==null?O.y:0;M.setTexture2D(E,0),U.copyTexSubImage2D(U.TEXTURE_2D,X,0,0,ye,me,H,ge),he.unbindTexture()};const rv=U.createFramebuffer(),sv=U.createFramebuffer();this.copyTextureToTexture=function(E,O,X=null,V=null,H=0,ge=0){let ye,me,Te,Ae,Oe,ze,Re,it,Tt;const yt=E.isCompressedTexture?E.mipmaps[ge]:E.image;if(X!==null)ye=X.max.x-X.min.x,me=X.max.y-X.min.y,Te=X.isBox3?X.max.z-X.min.z:1,Ae=X.min.x,Oe=X.min.y,ze=X.isBox3?X.min.z:0;else{const wt=Math.pow(2,-H);ye=Math.floor(yt.width*wt),me=Math.floor(yt.height*wt),E.isDataArrayTexture?Te=yt.depth:E.isData3DTexture?Te=Math.floor(yt.depth*wt):Te=1,Ae=0,Oe=0,ze=0}V!==null?(Re=V.x,it=V.y,Tt=V.z):(Re=0,it=0,Tt=0);const ot=I.convert(O.format),Yt=I.convert(O.type);let xe;O.isData3DTexture?(M.setTexture3D(O,0),xe=U.TEXTURE_3D):O.isDataArrayTexture||O.isCompressedArrayTexture?(M.setTexture2DArray(O,0),xe=U.TEXTURE_2D_ARRAY):(M.setTexture2D(O,0),xe=U.TEXTURE_2D),he.activeTexture(U.TEXTURE0),he.pixelStorei(U.UNPACK_FLIP_Y_WEBGL,O.flipY),he.pixelStorei(U.UNPACK_PREMULTIPLY_ALPHA_WEBGL,O.premultiplyAlpha),he.pixelStorei(U.UNPACK_ALIGNMENT,O.unpackAlignment);const vn=he.getParameter(U.UNPACK_ROW_LENGTH),qe=he.getParameter(U.UNPACK_IMAGE_HEIGHT),bn=he.getParameter(U.UNPACK_SKIP_PIXELS),Jn=he.getParameter(U.UNPACK_SKIP_ROWS),zi=he.getParameter(U.UNPACK_SKIP_IMAGES);he.pixelStorei(U.UNPACK_ROW_LENGTH,yt.width),he.pixelStorei(U.UNPACK_IMAGE_HEIGHT,yt.height),he.pixelStorei(U.UNPACK_SKIP_PIXELS,Ae),he.pixelStorei(U.UNPACK_SKIP_ROWS,Oe),he.pixelStorei(U.UNPACK_SKIP_IMAGES,ze);const Yr=E.isDataArrayTexture||E.isData3DTexture,at=O.isDataArrayTexture||O.isData3DTexture;if(E.isDepthTexture){const wt=R.get(E),Vi=R.get(O),ut=R.get(wt.__renderTarget),Hi=R.get(Vi.__renderTarget);he.bindFramebuffer(U.READ_FRAMEBUFFER,ut.__webglFramebuffer),he.bindFramebuffer(U.DRAW_FRAMEBUFFER,Hi.__webglFramebuffer);for(let qr=0;qr<Te;qr++)Yr&&(U.framebufferTextureLayer(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,R.get(E).__webglTexture,H,ze+qr),U.framebufferTextureLayer(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,R.get(O).__webglTexture,ge,Tt+qr)),U.blitFramebuffer(Ae,Oe,ye,me,Re,it,ye,me,U.DEPTH_BUFFER_BIT,U.NEAREST);he.bindFramebuffer(U.READ_FRAMEBUFFER,null),he.bindFramebuffer(U.DRAW_FRAMEBUFFER,null)}else if(H!==0||E.isRenderTargetTexture||R.has(E)){const wt=R.get(E),Vi=R.get(O);he.bindFramebuffer(U.READ_FRAMEBUFFER,rv),he.bindFramebuffer(U.DRAW_FRAMEBUFFER,sv);for(let ut=0;ut<Te;ut++)Yr?U.framebufferTextureLayer(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,wt.__webglTexture,H,ze+ut):U.framebufferTexture2D(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,wt.__webglTexture,H),at?U.framebufferTextureLayer(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,Vi.__webglTexture,ge,Tt+ut):U.framebufferTexture2D(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,Vi.__webglTexture,ge),H!==0?U.blitFramebuffer(Ae,Oe,ye,me,Re,it,ye,me,U.COLOR_BUFFER_BIT,U.NEAREST):at?U.copyTexSubImage3D(xe,ge,Re,it,Tt+ut,Ae,Oe,ye,me):U.copyTexSubImage2D(xe,ge,Re,it,Ae,Oe,ye,me);he.bindFramebuffer(U.READ_FRAMEBUFFER,null),he.bindFramebuffer(U.DRAW_FRAMEBUFFER,null)}else at?E.isDataTexture||E.isData3DTexture?U.texSubImage3D(xe,ge,Re,it,Tt,ye,me,Te,ot,Yt,yt.data):O.isCompressedArrayTexture?U.compressedTexSubImage3D(xe,ge,Re,it,Tt,ye,me,Te,ot,yt.data):U.texSubImage3D(xe,ge,Re,it,Tt,ye,me,Te,ot,Yt,yt):E.isDataTexture?U.texSubImage2D(U.TEXTURE_2D,ge,Re,it,ye,me,ot,Yt,yt.data):E.isCompressedTexture?U.compressedTexSubImage2D(U.TEXTURE_2D,ge,Re,it,yt.width,yt.height,ot,yt.data):U.texSubImage2D(U.TEXTURE_2D,ge,Re,it,ye,me,ot,Yt,yt);he.pixelStorei(U.UNPACK_ROW_LENGTH,vn),he.pixelStorei(U.UNPACK_IMAGE_HEIGHT,qe),he.pixelStorei(U.UNPACK_SKIP_PIXELS,bn),he.pixelStorei(U.UNPACK_SKIP_ROWS,Jn),he.pixelStorei(U.UNPACK_SKIP_IMAGES,zi),ge===0&&O.generateMipmaps&&U.generateMipmap(xe),he.unbindTexture()},this.initRenderTarget=function(E){R.get(E).__webglFramebuffer===void 0&&M.setupRenderTarget(E)},this.initTexture=function(E){E.isCubeTexture?M.setTextureCube(E,0):E.isData3DTexture?M.setTexture3D(E,0):E.isDataArrayTexture||E.isCompressedArrayTexture?M.setTexture2DArray(E,0):M.setTexture2D(E,0),he.unbindTexture()},this.resetState=function(){D=0,G=0,L=null,he.reset(),oe.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ai}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=$e._getDrawingBufferColorSpace(e),n.unpackColorSpace=$e._getUnpackColorSpace()}}const Gm={lens:0,wave:1,rgb:2},gA=`
  uniform float uVel;
  uniform int uEffect;
  varying vec2 vUv;
  void main() {
