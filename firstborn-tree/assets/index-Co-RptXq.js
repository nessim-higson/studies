 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(F,X){var $=F.length;F.push(X);e:for(;0<$;){var te=$-1>>>1,de=F[te];if(0<r(de,X))F[te]=X,F[$]=de,$=te;else break e}}function n(F){return F.length===0?null:F[0]}function i(F){if(F.length===0)return null;var X=F[0],$=F.pop();if($!==X){F[0]=$;e:for(var te=0,de=F.length,Ve=de>>>1;te<Ve;){var We=2*(te+1)-1,Le=F[We],K=We+1,fe=F[K];if(0>r(Le,$))K<de&&0>r(fe,Le)?(F[te]=fe,F[K]=$,te=K):(F[te]=Le,F[We]=$,te=We);else if(K<de&&0>r(fe,$))F[te]=fe,F[K]=$,te=K;else break e}}return X}function r(F,X){var $=F.sortIndex-X.sortIndex;return $!==0?$:F.id-X.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],d=1,h=null,c=3,m=!1,_=!1,x=!1,p=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(F){for(var X=n(u);X!==null;){if(X.callback===null)i(u);else if(X.startTime<=F)i(u),X.sortIndex=X.expirationTime,e(l,X);else break;X=n(u)}}function y(F){if(x=!1,v(F),!_)if(n(l)!==null)_=!0,O(R);else{var X=n(u);X!==null&&k(y,X.startTime-F)}}function R(F,X){_=!1,x&&(x=!1,f(S),S=-1),m=!0;var $=c;try{for(v(X),h=n(l);h!==null&&(!(h.expirationTime>X)||F&&!w());){var te=h.callback;if(typeof te=="function"){h.callback=null,c=h.priorityLevel;var de=te(h.expirationTime<=X);X=t.unstable_now(),typeof de=="function"?h.callback=de:h===n(l)&&i(l),v(X)}else i(l);h=n(l)}if(h!==null)var Ve=!0;else{var We=n(u);We!==null&&k(y,We.startTime-X),Ve=!1}return Ve}finally{h=null,c=$,m=!1}}var E=!1,C=null,S=-1,b=5,P=-1;function w(){return!(t.unstable_now()-P<b)}function L(){if(C!==null){var F=t.unstable_now();P=F;var X=!0;try{X=C(!0,F)}finally{X?z():(E=!1,C=null)}}else E=!1}var z;if(typeof g=="function")z=function(){g(L)};else if(typeof MessageChannel<"u"){var Y=new MessageChannel,D=Y.port2;Y.port1.onmessage=L,z=function(){D.postMessage(null)}}else z=function(){p(L,0)};function O(F){C=F,E||(E=!0,z())}function k(F,X){S=p(function(){F(t.unstable_now())},X)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(F){F.callback=null},t.unstable_continueExecution=function(){_||m||(_=!0,O(R))},t.unstable_forceFrameRate=function(F){0>F||125<F?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):b=0<F?Math.floor(1e3/F):5},t.unstable_getCurrentPriorityLevel=function(){return c},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(F){switch(c){case 1:case 2:case 3:var X=3;break;default:X=c}var $=c;c=X;try{return F()}finally{c=$}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(F,X){switch(F){case 1:case 2:case 3:case 4:case 5:break;default:F=3}var $=c;c=F;try{return X()}finally{c=$}},t.unstable_scheduleCallback=function(F,X,$){var te=t.unstable_now();switch(typeof $=="object"&&$!==null?($=$.delay,$=typeof $=="number"&&0<$?te+$:te):$=te,F){case 1:var de=-1;break;case 2:de=250;break;case 5:de=1073741823;break;case 4:de=1e4;break;default:de=5e3}return de=$+de,F={id:d++,callback:X,priorityLevel:F,startTime:$,expirationTime:de,sortIndex:-1},$>te?(F.sortIndex=$,e(u,F),n(l)===null&&F===n(u)&&(x?(f(S),S=-1):x=!0,k(y,$-te))):(F.sortIndex=de,e(l,F),_||m||(_=!0,O(R))),F},t.unstable_shouldYield=w,t.unstable_wrapCallback=function(F){var X=c;return function(){var $=c;c=X;try{return F.apply(this,arguments)}finally{c=$}}}})(ug);lg.exports=ug;var bv=lg.exports;/**
 * @license React
...
`)+`
`+f);const v=g+p+o,y=g+f+a,R=Nm(r,r.VERTEX_SHADER,v),E=Nm(r,r.FRAGMENT_SHADER,y);r.attachShader(x,R),r.attachShader(x,E),n.index0AttributeName!==void 0?r.bindAttribLocation(x,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function C(w){if(t.debug.checkShaderErrors){const L=r.getProgramInfoLog(x)||"",z=r.getShaderInfoLog(R)||"",Y=r.getShaderInfoLog(E)||"",D=L.trim(),O=z.trim(),k=Y.trim();let F=!0,X=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(F=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,x,R,E);else{const $=Im(r,R,"vertex"),te=Im(r,E,"fragment");Ke("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
...
`;function uA({media:t,startIndex:e=0,width:n,height:i,onIndex:r}){const s=ke.useRef(null),o=ke.useRef(e),a=ke.useRef(!1);ke.useEffect(()=>{var d;(d=s.current)!=null&&d.__goto&&s.current.__goto(e)},[e]);const[l,u]=ke.useState(!1);if(ke.useEffect(()=>{const d=s.current;if(!d||a.current)return;let h;try{h=new oA({antialias:!0,alpha:!0})}catch{a.current=!0,u(!0);return}h.setPixelRatio(Math.min(2,window.devicePixelRatio)),h.setSize(n,i),d.appendChild(h.domElement);const c=new ky,m=new xh(-n/2,n/2,i/2,-i/2,-1500,1500),_=i*.6,x=_*.78,p=x+110,f=new aM,g=[],v=t.map((O,k)=>{let F;if(O.type==="video"){const te=document.createElement("video");te.src=O.src,te.muted=!0,te.loop=!0,te.playsInline=!0,te.play().catch(()=>{}),g.push(te),F=new qy(te)}else F=f.load(O.src);F.colorSpace=Mn;const X=new Zn({vertexShader:aA,fragmentShader:lA,uniforms:{uMap:{value:F},uVel:{value:0},uTime:{value:0},uEffect:{value:Gm[Re.FX]??0}}}),$=new pi(new oa(x,_,48,48),X);return $.position.x=k*p,c.add($),$});let y=e*p,R=y,E=R,C=null;const S=(t.length-1)*p;d.__goto=O=>{y=Math.max(0,Math.min(S,O*p))};const b=O=>{var k;C={x:O.clientX,t:y},(k=d.setPointerCapture)==null||k.call(d,O.pointerId)},P=O=>{C&&(y=Math.max(-p*.4,Math.min(S+p*.4,C.t-(O.clientX-C.x)*1.6)))},w=()=>{C=null,y=Math.max(0,Math.min(S,y))},L=O=>{y=Math.max(0,Math.min(S,y+(O.deltaY+O.deltaX)*1.1))};d.addEventListener("pointerdown",b),d.addEventListener("pointermove",P),d.addEventListener("pointerup",w),d.addEventListener("pointercancel",w),d.addEventListener("wheel",L,{passive:!0});let z;const Y=new cM,D=()=>{R+=(y-R)*.085;const O=(R-E)/p;E=R;const k=Y.getElapsedTime(),F=Gm[Re.FX]??0;v.forEach(($,te)=>{$.position.x=te*p-R,$.material.uniforms.uVel.value=O*6,$.material.uniforms.uTime.value=k,$.material.uniforms.uEffect.value=F});const X=Math.round(Math.max(0,Math.min(S,R))/p);X!==o.current&&(o.current=X,r==null||r(X)),h.render(c,m),z=requestAnimationFrame(D)};return z=requestAnimationFrame(D),()=>{cancelAnimationFrame(z),d.removeEventListener("pointerdown",b),d.removeEventListener("pointermove",P),d.removeEventListener("pointerup",w),d.removeEventListener("pointercancel",w),d.removeEventListener("wheel",L),g.forEach(O=>O.pause()),v.forEach(O=>{O.geometry.dispose(),O.material.uniforms.uMap.value.dispose(),O.material.dispose()}),h.dispose(),d.removeChild(h.domElement)}},[t,n,i]),l){const d=t[Math.min(e,t.length-1)];return ue.jsx("div",{className:"fullBleed",children:d.type==="video"?ue.jsx("video",{src:d.src,autoPlay:!0,muted:!0,loop:!0,playsInline:!0}):ue.jsx("img",{src:d.src,alt:""})})}return ue.jsx("div",{className:"glStage",ref:s})}const cA=-200,Wm=220,Ec=265,fA=150;function dA(t,e,n,i){if(e||n==="arc"){const s=e?fA:Ec;return Array.from({length:t},(o,a)=>{const l=(cA+(t>1?a*Wm/(t-1):Wm/2))*Math.PI/180;return{ox:Math.cos(l)*s*1.25,oy:Math.sin(l)*s*.9,z:-150}})}if(n==="fan")return Array.from({length:t},(s,o)=>({ox:240+o*130,oy:-36-o*38,z:-110-o*175}));if(n==="tide")return Array.from({length:t},(o,a)=>({ox:(i*42+a*(1280/t))%1280-640,oy:(a%2?-1:1)*(105+a%3*38)+Math.sin(i*.7+a)*14,z:-120-a%3*150}));const r=i*9*Math.PI/180;return Array.from({length:t},(s,o)=>{const a=o/t*Math.PI*2-Math.PI/2+r;return{ox:Math.cos(a)*Ec*1.3,oy:Math.sin(a)*Ec*.85,z:-150}})}const hA=410,pA=110;function mA({sim:t,activeId:e,width:n,height:i,onNavigate:r}){const{visibleNodes:s,roles:o,byId:a}=t,l=ke.useRef(null),[u,d]=ke.useState(null),[h,c]=ke.useState(null);ke.useEffect(()=>c(null),[e]),ke.useEffect(()=>{const E=C=>C.key==="Escape"&&c(null);return window.addEventListener("keydown",E),()=>window.removeEventListener("keydown",E)},[]);const[,m]=ke.useState(0);ke.useEffect(()=>{let E;const C=()=>{(Re.EMIT==="orbit"||Re.EMIT==="tide")&&m(S=>S+1),E=requestAnimationFrame(C)};return E=requestAnimationFrame(C),()=>cancelAnimationFrame(E)},[]),ke.useEffect(()=>{const E=C=>{const S=C.clientX/window.innerWidth-.5,b=C.clientY/window.innerHeight-.5;l.current&&(l.current.style.perspectiveOrigin=`${50+S*16}% ${46+b*11}%`)};return window.addEventListener("mousemove",E),()=>window.removeEventListener("mousemove",E)},[]);const _=a.get(e),x=_.childIds.length===0,p=x&&_.media?_.media:null,f=!p&&(_!=null&&_.img)&&x?_:null,g=p?dA(p.length,h!=null,Re.EMIT,performance.now()/1e3):[],v=p&&h!=null?p[h]:null,y=E=>E==="active"?Ut("active",_.label,n):E==="parent"?38:E==="child"?Ut("child"):E==="sibling"?15:13,R=E=>{if(E.id===e&&v){c(null);return}r(E)};return ue.jsxs(ue.Fragment,{children:[v&&ue.jsx(uA,{media:p,startIndex:h,width:n,height:i??window.innerHeight,onIndex:E=>c(E)},`gl-${e}`),ue.jsxs("div",{className:"focusSpace",ref:l,children:[f&&ue.jsx("img",{className:"froomImg",src:f.img,alt:""},`room-${f.id}`),p&&_.x!=null&&ue.jsx("div",{className:"emitWrap",style:{transform:`translate3d(${_.x}px, ${_.y}px, 0)`},children:p.map((E,C)=>{const S=g[C],b=C%2===0,P=v?64:b?200:160,w=v?64:P*(b?1.24:.78);return ue.jsx("div",{className:`eFrame ${h===C?"current":""} ${Re.EMIT==="tide"&&h==null?"flow":""}`,style:{width:P,height:w,zIndex:20+C,transform:`translate(calc(-50% + ${S.ox}px), calc(-50% + ${S.oy}px)) translateZ(${S.z}px)`,animationDelay:`${.25+C*.14}s`},onClick:()=>c(C),children:E.type==="video"?ue.jsx("video",{src:E.src,autoPlay:!0,muted:!0,loop:!0,playsInline:!0}):ue.jsx("img",{src:E.src,alt:"",draggable:!1})},`${e}-em-${C}`)})}),s.map(E=>{if(E.x==null)return null;const C=o.get(E.id),S=Math.max(-3,Math.min(1,E.depth-_.depth)),b=S>=0?S*pA:S*hA,P=S<0?-S*1.7:0,w=S<0?Math.max(.3,1+S*.26):C==="active"?1:.92;return ue.jsx("div",{className:"fnode",style:{transform:`translate3d(${E.x}px, ${E.y}px, 0)`},children:ue.jsx("div",{className:"fnodeInner",style:{transform:`translateZ(${b}px)`,filter:P?`blur(${P}px)`:"none",opacity:w},children:ue.jsx("span",{"data-node":E.id,className:`flabel ${C==="active"?"activeL":""} ${u===E.id?"hot":""}`,style:{fontSize:y(C)},onMouseEnter:()=>d(E.id),onMouseLeave:()=>d(null),onClick:()=>R(E),children:E.label})})},E.id)}),(_==null?void 0:_.copy)&&_.x!=null&&!v&&ue.jsx("div",{className:"fcopy",style:{transform:`translate3d(${_.x}px, ${_.y+y("active")*.62+16}px, 0) translateX(-50%)`},children:_.copy},e)]})]})}const qa=165;function gA({sim:t,activeId:e,width:n,height:i,onNavigate:r}){const{visibleNodes:s,roles:o,byId:a}=t,[l,u]=ke.useState(null),d=n/2,h=i/2-20,c=a.get(e),m=c!=null&&c.img&&c.childIds.length===0?c:null,_=(p,f)=>{let g=p.x-d,v=p.y-h;const y=Math.hypot(g,v)||1;return{x:d+g/y*f,y:h+v/y*f*.82}},x=(p,f)=>p==="active"?Ut("active",c.label,n):p==="child"?Ut("child"):p==="parent"?Math.max(13,24-f*5):p==="sibling"?14:11.5;return ue.jsxs("div",{className:"ringsSpace",children:[m&&ue.jsx("img",{className:"ringsRoom",src:m.img,alt:""},`rroom-${m.id}`),ue.jsx("div",{className:"pulse",style:{left:d,top:h}},`pulse-${e}`),s.map(p=>{if(p.x==null)return null;const f=o.get(p.id),g=Math.max(0,c.depth-p.depth);let v=p.x,y=p.y,R=1;return f==="active"?(v=d,y=h):f==="child"?({x:v,y}=_(p,qa*1.32),R=.9):f==="sibling"?({x:v,y}=_(p,qa*2.15),R=.42):f==="parent"?({x:v,y}=_(p,qa*(1+g)*1.45),R=Math.max(.22,.55-g*.15)):({x:v,y}=_(p,qa*2.9),R=.2),ue.jsx("span",{"data-node":p.id,className:`rlabel ${f==="active"?"activeL":""} ${l===p.id?"hot":""}`,style:{transform:`translate3d(${v}px, ${y}px, 0) translate(-50%, -50%)`,fontSize:x(f,g),fontWeight:f==="active"?700:400,opacity:R},onMouseEnter:()=>u(p.id),onMouseLeave:()=>u(null),onClick:()=>r(p),children:p.label},p.id)}),(c==null?void 0:c.copy)&&ue.jsx("div",{className:"fcopy",style:{transform:`translate3d(${d}px, ${h+x("active",0)*.62+16}px, 0) translateX(-50%)`},children:c.copy},`rc-${e}`)]})}const _A={active:{w:700,op:1},child:{w:500,op:.95},parent:{w:200,op:.8},sibling:{w:200,op:.55},distant:{w:100,op:.4}};function vA({sim:t,activeId:e,width:n,onNavigate:i}){const{visibleNodes:r,roles:s,byId:o}=t,[a,l]=ke.useState(null),u=o.get(e),d=u!=null&&u.img&&u.childIds.length===0?u:null,h=(c,m)=>c==="active"?Ut("active",u.label,n)*1.15:c==="child"?Ut("child")*1.15:c==="parent"?Math.max(14,26-m*5):c==="sibling"?15:12;return ue.jsxs("div",{className:"weightSpace",children:[d&&ue.jsx("img",{className:"ringsRoom",src:d.img,alt:""},`wroom-${d.id}`),r.map(c=>{if(c.x==null)return null;const m=s.get(c.id),_=Math.max(0,u.depth-c.depth),x=_A[m],p=a===c.id;return ue.jsx("span",{"data-node":c.id,className:`wlabel ${m==="active"?"activeL":""}`,style:{transform:`translate3d(${c.x}px, ${c.y}px, 0) translate(-50%, -50%)`,fontSize:h(m,_),fontWeight:p&&m!=="active"?Math.min(700,x.w+200):x.w,opacity:p?Math.min(1,x.op+.3):x.op},onMouseEnter:()=>l(c.id),onMouseLeave:()=>l(null),onClick:()=>i(c),children:c.label},c.id)}),(u==null?void 0:u.copy)&&u.x!=null&&ue.jsx("div",{className:"fcopy",style:{transform:`translate3d(${u.x}px, ${u.y+h("active",0)*.62+16}px, 0) translateX(-50%)`},children:u.copy},`wc-${e}`)]})}const ud=[{obj:Re,key:"TYPE_SCALE",label:"Type scale",min:.7,max:2.4,step:.05},{obj:Re,key:"CHARGE",label:"Repulsion",min:-1200,max:-50,step:10},{obj:At,key:"STRENGTH",label:"Spring",min:.05,max:1.2,step:.05},{obj:Re,key:"DAMPING",label:"Damping",min:.1,max:.7,step:.02},{obj:Re,key:"ALPHA_KICK",label:"Energy",min:.2,max:1,step:.05},{obj:Re,key:"DRIFT",label:"Idle drift",min:0,max:.8,step:.02},{obj:At,key:"LOOSE",label:"Looseness",min:0,max:48,step:2},{obj:At,key:"GAP",label:"Rhythm",min:26,max:72,step:2},{obj:Re,key:"SPACING",label:"Spacing",min:0,max:48,step:2},{obj:Re,key:"CURSOR",label:"Cursor pull",min:-.8,max:.8,step:.05},{obj:Re,key:"SHOCK",label:"Shockwave",min:0,max:20,step:1}],xA=ud.map(t=>t.obj[t.key]);function SA({onTune:t}){const[e,n]=ke.useState(!0),[,i]=ke.useState(0),r=(o,a)=>{o.obj[o.key]=a,i(l=>l+1),t()},s=()=>{ud.forEach((o,a)=>o.obj[o.key]=xA[a]),i(o=>o+1),t()};return ue.jsxs("aside",{className:`tune ${e?"open":""}`,children:[ue.jsxs("button",{className:"tuneHead",onClick:()=>n(o=>!o),children:["Physics ",e?"▾":"▸"]}),e&&ue.jsxs("div",{className:"tuneBody",children:[ue.jsxs("div",{className:"tuneRow tuneVariants",children:[ue.jsx("span",{className:"tuneLabel",children:"Threads"}),[!0,!1].map(o=>ue.jsx("button",{className:Re.THREADS===o?"on":"",onClick:()=>{Re.THREADS=o,i(a=>a+1),t()},children:o?"on":"off"},String(o)))]}),ue.jsxs("div",{className:"tuneRow tuneVariants",children:[ue.jsx("span",{className:"tuneLabel",children:"Effect"}),["lens","wave","rgb"].map(o=>ue.jsx("button",{className:Re.FX===o?"on":"",onClick:()=>{Re.FX=o,i(a=>a+1),t()},children:o},o))]}),ue.jsxs("div",{className:"tuneRow tuneVariants",children:[ue.jsx("span",{className:"tuneLabel",children:"Emission"}),["arc","orbit","fan","tide"].map(o=>ue.jsx("button",{className:Re.EMIT===o?"on":"",onClick:()=>{Re.EMIT=o,i(a=>a+1),t()},children:o},o))]}),ud.map(o=>ue.jsxs("label",{className:"tuneRow",children:[ue.jsx("span",{className:"tuneLabel",children:o.label}),ue.jsx("input",{type:"range",min:o.min,max:o.max,step:o.step,value:o.obj[o.key],onChange:a=>r(o,+a.target.value)}),ue.jsx("span",{className:"tuneVal",children:Number(o.obj[o.key]).toFixed(o.step<1?2:0)})]},o.key)),ue.jsx("button",{className:"tuneReset",onClick:s,children:"Reset"})]})]})}function yA(t){const e=+this._x.call(null,t),n=+this._y.call(null,t);return X_(this.cover(e,n),e,n,t)}function X_(t,e,n,i){if(isNaN(e)||isNaN(n))return t;var r,s=t._root,o={data:i},a=t._x0,l=t._y0,u=t._x1,d=t._y1,h,c,m,_,x,p,f,g;if(!s)return t._root=o,t;for(;s.length;)if((x=e>=(h=(a+u)/2))?a=h:u=h,(p=n>=(c=(l+d)/2))?l=c:d=c,r=s,!(s=s[f=p<<1|x]))return r[f]=o,t;if(m=+t._x.call(null,s.data),_=+t._y.call(null,s.data),e===m&&n===_)return o.next=s,r?r[f]=o:t._root=o,t;do r=r?r[f]=new Array(4):t._root=new Array(4),(x=e>=(h=(a+u)/2))?a=h:u=h,(p=n>=(c=(l+d)/2))?l=c:d=c;while((f=p<<1|x)===(g=(_>=c)<<1|m>=h));return r[g]=s,r[f]=o,t}function MA(t){var e,n,i=t.length,r,s,o=new Array(i),a=new Array(i),l=1/0,u=1/0,d=-1/0,h=-1/0;for(n=0;n<i;++n)isNaN(r=+this._x.call(null,e=t[n]))||isNaN(s=+this._y.call(null,e))||(o[n]=r,a[n]=s,r<l&&(l=r),r>d&&(d=r),s<u&&(u=s),s>h&&(h=s));if(l>d||u>h)return this;for(this.cover(l,u).cover(d,h),n=0;n<i;++n)X_(this,o[n],a[n],t[n]);return this}function EA(t,e){if(isNaN(t=+t)||isNaN(e=+e))return this;var n=this._x0,i=this._y0,r=this._x1,s=this._y1;if(isNaN(n))r=(n=Math.floor(t))+1,s=(i=Math.floor(e))+1;else{for(var o=r-n||1,a=this._root,l,u;n>t||t>=r||i>e||e>=s;)switch(u=(e<i)<<1|t<n,l=new Array(4),l[u]=a,a=l,o*=2,u){case 0:r=n+o,s=i+o;break;case 1:n=r-o,s=i+o;break;case 2:r=n+o,i=s-o;break;case 3:n=r-o,i=s-o;break}this._root&&this._root.length&&(this._root=a)}return this._x0=n,this._y0=i,this._x1=r,this._y1=s,this}function TA(){var t=[];return this.visit(function(e){if(!e.length)do t.push(e.data);while(e=e.next)}),t}function wA(t){return arguments.length?this.cover(+t[0][0],+t[0][1]).cover(+t[1][0],+t[1][1]):isNaN(this._x0)?void 0:[[this._x0,this._y0],[this._x1,this._y1]]}function rn(t,e,n,i,r){this.node=t,this.x0=e,this.y0=n,this.x1=i,this.y1=r}function AA(t,e,n){var i,r=this._x0,s=this._y0,o,a,l,u,d=this._x1,h=this._y1,c=[],m=this._root,_,x;for(m&&c.push(new rn(m,r,s,d,h)),n==null?n=1/0:(r=t-n,s=e-n,d=t+n,h=e+n,n*=n);_=c.pop();)if(!(!(m=_.node)||(o=_.x0)>d||(a=_.y0)>h||(l=_.x1)<r||(u=_.y1)<s))if(m.length){var p=(o+l)/2,f=(a+u)/2;c.push(new rn(m[3],p,f,l,u),new rn(m[2],o,f,p,u),new rn(m[1],p,a,l,f),new rn(m[0],o,a,p,f)),(x=(e>=f)<<1|t>=p)&&(_=c[c.length-1],c[c.length-1]=c[c.length-1-x],c[c.length-1-x]=_)}else{var g=t-+this._x.call(null,m.data),v=e-+this._y.call(null,m.data),y=g*g+v*v;if(y<n){var R=Math.sqrt(n=y);r=t-R,s=e-R,d=t+R,h=e+R,i=m.data}}return i}function RA(t){if(isNaN(d=+this._x.call(null,t))||isNaN(h=+this._y.call(null,t)))return this;var e,n=this._root,i,r,s,o=this._x0,a=this._y0,l=this._x1,u=this._y1,d,h,c,m,_,x,p,f;if(!n)return this;if(n.length)for(;;){if((_=d>=(c=(o+l)/2))?o=c:l=c,(x=h>=(m=(a+u)/2))?a=m:u=m,e=n,!(n=n[p=x<<1|_]))return this;if(!n.length)break;(e[p+1&3]||e[p+2&3]||e[p+3&3])&&(i=e,f=p)}for(;n.data!==t;)if(r=n,!(n=n.next))return this;return(s=n.next)&&delete n.next,r?(s?r.next=s:delete r.next,this):e?(s?e[p]=s:delete e[p],(n=e[0]||e[1]||e[2]||e[3])&&n===(e[3]||e[2]||e[1]||e[0])&&!n.length&&(i?i[f]=n:this._root=n),this):(this._root=s,this)}function CA(t){for(var e=0,n=t.length;e<n;++e)this.remove(t[e]);return this}function bA(){return this._root}function PA(){var t=0;return this.visit(function(e){if(!e.length)do++t;while(e=e.next)}),t}function LA(t){var e=[],n,i=this._root,r,s,o,a,l;for(i&&e.push(new rn(i,this._x0,this._y0,this._x1,this._y1));n=e.pop();)if(!t(i=n.node,s=n.x0,o=n.y0,a=n.x1,l=n.y1)&&i.length){var u=(s+a)/2,d=(o+l)/2;(r=i[3])&&e.push(new rn(r,u,d,a,l)),(r=i[2])&&e.push(new rn(r,s,d,u,l)),(r=i[1])&&e.push(new rn(r,u,o,a,d)),(r=i[0])&&e.push(new rn(r,s,o,u,d))}return this}function NA(t){var e=[],n=[],i;for(this._root&&e.push(new rn(this._root,this._x0,this._y0,this._x1,this._y1));i=e.pop();){var r=i.node;if(r.length){var s,o=i.x0,a=i.y0,l=i.x1,u=i.y1,d=(o+l)/2,h=(a+u)/2;(s=r[0])&&e.push(new rn(s,o,a,d,h)),(s=r[1])&&e.push(new rn(s,d,a,l,h)),(s=r[2])&&e.push(new rn(s,o,h,d,u)),(s=r[3])&&e.push(new rn(s,d,h,l,u))}n.push(i)}for(;i=n.pop();)t(i.node,i.x0,i.y0,i.x1,i.y1);return this}function DA(t){return t[0]}function IA(t){return arguments.length?(this._x=t,this):this._x}function UA(t){return t[1]}function FA(t){return arguments.length?(this._y=t,this):this._y}function Sh(t,e,n){var i=new yh(e??DA,n??UA,NaN,NaN,NaN,NaN);return t==null?i:i.addAll(t)}function yh(t,e,n,i,r,s){this._x=t,this._y=e,this._x0=n,this._y0=i,this._x1=r,this._y1=s,this._root=void 0}function Xm(t){for(var e={data:t.data},n=e;t=t.next;)n=n.next={data:t.data};return e}var un=Sh.prototype=yh.prototype;un.copy=function(){var t=new yh(this._x,this._y,this._x0,this._y0,this._x1,this._y1),e=this._root,n,i;if(!e)return t;if(!e.length)return t._root=Xm(e),t;for(n=[{source:e,target:t._root=new Array(4)}];e=n.pop();)for(var r=0;r<4;++r)(i=e.source[r])&&(i.length?n.push({source:i,target:e.target[r]=new Array(4)}):e.target[r]=Xm(i));return t};un.add=yA;un.addAll=MA;un.cover=EA;un.data=TA;un.extent=wA;un.find=AA;un.remove=RA;un.removeAll=CA;un.root=bA;un.size=PA;un.visit=LA;un.visitAfter=NA;un.x=IA;un.y=FA;function sn(t){return function(){return t}}function ir(t){return(t()-.5)*1e-6}function OA(t){return t.x+t.vx}function kA(t){return t.y+t.vy}function BA(t){var e,n,i,r=1,s=1;typeof t!="function"&&(t=sn(t==null?1:+t));function o(){for(var u,d=e.length,h,c,m,_,x,p,f=0;f<s;++f)for(h=Sh(e,OA,kA).visitAfter(a),u=0;u<d;++u)c=e[u],x=n[c.index],p=x*x,m=c.x+c.vx,_=c.y+c.vy,h.visit(g);function g(v,y,R,E,C){var S=v.data,b=v.r,P=x+b;if(S){if(S.index>c.index){var w=m-S.x-S.vx,L=_-S.y-S.vy,z=w*w+L*L;z<P*P&&(w===0&&(w=ir(i),z+=w*w),L===0&&(L=ir(i),z+=L*L),z=(P-(z=Math.sqrt(z)))/z*r,c.vx+=(w*=z)*(P=(b*=b)/(p+b)),c.vy+=(L*=z)*P,S.vx-=w*(P=1-P),S.vy-=L*P)}return}return y>m+P||E<m-P||R>_+P||C<_-P}}function a(u){if(u.data)return u.r=n[u.data.index];for(var d=u.r=0;d<4;++d)u[d]&&u[d].r>u.r&&(u.r=u[d].r)}function l(){if(e){var u,d=e.length,h;for(n=new Array(d),u=0;u<d;++u)h=e[u],n[h.index]=+t(h,u,e)}}return o.initialize=function(u,d){e=u,i=d,l()},o.iterations=function(u){return arguments.length?(s=+u,o):s},o.strength=function(u){return arguments.length?(r=+u,o):r},o.radius=function(u){return arguments.length?(t=typeof u=="function"?u:sn(+u),l(),o):t},o}function zA(t){return t.index}function jm(t,e){var n=t.get(e);if(!n)throw new Error("node not found: "+e);return n}function VA(t){var e=zA,n=h,i,r=sn(30),s,o,a,l,u,d=1;t==null&&(t=[]);function h(p){return 1/Math.min(a[p.source.index],a[p.target.index])}function c(p){for(var f=0,g=t.length;f<d;++f)for(var v=0,y,R,E,C,S,b,P;v<g;++v)y=t[v],R=y.source,E=y.target,C=E.x+E.vx-R.x-R.vx||ir(u),S=E.y+E.vy-R.y-R.vy||ir(u),b=Math.sqrt(C*C+S*S),b=(b-s[v])/b*p*i[v],C*=b,S*=b,E.vx-=C*(P=l[v]),E.vy-=S*P,R.vx+=C*(P=1-P),R.vy+=S*P}function m(){if(o){var p,f=o.length,g=t.length,v=new Map(o.map((R,E)=>[e(R,E,o),R])),y;for(p=0,a=new Array(f);p<g;++p)y=t[p],y.index=p,typeof y.source!="object"&&(y.source=jm(v,y.source)),typeof y.target!="object"&&(y.target=jm(v,y.target)),a[y.source.index]=(a[y.source.index]||0)+1,a[y.target.index]=(a[y.target.index]||0)+1;for(p=0,l=new Array(g);p<g;++p)y=t[p],l[p]=a[y.source.index]/(a[y.source.index]+a[y.target.index]);i=new Array(g),_(),s=new Array(g),x()}}function _(){if(o)for(var p=0,f=t.length;p<f;++p)i[p]=+n(t[p],p,t)}function x(){if(o)for(var p=0,f=t.length;p<f;++p)s[p]=+r(t[p],p,t)}return c.initialize=function(p,f){o=p,u=f,m()},c.links=function(p){return arguments.length?(t=p,m(),c):t},c.id=function(p){return arguments.length?(e=p,c):e},c.iterations=function(p){return arguments.length?(d=+p,c):d},c.strength=function(p){return arguments.length?(n=typeof p=="function"?p:sn(+p),_(),c):n},c.distance=function(p){return arguments.length?(r=typeof p=="function"?p:sn(+p),x(),c):r},c}var HA={value:()=>{}};function j_(){for(var t=0,e=arguments.length,n={},i;t<e;++t){if(!(i=arguments[t]+"")||i in n||/[\s.]/.test(i))throw new Error("illegal type: "+i);n[i]=[]}return new ml(n)}function ml(t){this._=t}function GA(t,e){return t.trim().split(/^|\s+/).map(function(n){var i="",r=n.indexOf(".");if(r>=0&&(i=n.slice(r+1),n=n.slice(0,r)),n&&!e.hasOwnProperty(n))throw new Error("unknown type: "+n);return{type:n,name:i}})}ml.prototype=j_.prototype={constructor:ml,on:function(t,e){var n=this._,i=GA(t+"",n),r,s=-1,o=i.length;if(arguments.length<2){for(;++s<o;)if((r=(t=i[s]).type)&&(r=WA(n[r],t.name)))return r;return}if(e!=null&&typeof e!="function")throw new Error("invalid callback: "+e);for(;++s<o;)if(r=(t=i[s]).type)n[r]=Ym(n[r],t.name,e);else if(e==null)for(r in n)n[r]=Ym(n[r],t.name,null);return this},copy:function(){var t={},e=this._;for(var n in e)t[n]=e[n].slice();return new ml(t)},call:function(t,e){if((r=arguments.length-2)>0)for(var n=new Array(r),i=0,r,s;i<r;++i)n[i]=arguments[i+2];if(!this._.hasOwnProperty(t))throw new Error("unknown type: "+t);for(s=this._[t],i=0,r=s.length;i<r;++i)s[i].value.apply(e,n)},apply:function(t,e,n){if(!this._.hasOwnProperty(t))throw new Error("unknown type: "+t);for(var i=this._[t],r=0,s=i.length;r<s;++r)i[r].value.apply(e,n)}};function WA(t,e){for(var n=0,i=t.length,r;n<i;++n)if((r=t[n]).name===e)return r.value}function Ym(t,e,n){for(var i=0,r=t.length;i<r;++i)if(t[i].name===e){t[i]=HA,t=t.slice(0,i).concat(t.slice(i+1));break}return n!=null&&t.push({name:e,value:n}),t}var Gs=0,vo=0,co=0,Y_=1e3,Xl,xo,jl=0,Wr=0,pu=0,Zo=typeof performance=="object"&&performance.now?performance:Date,$_=typeof window=="object"&&window.requestAnimationFrame?window.requestAnimationFrame.bind(window):function(t){setTimeout(t,17)};function q_(){return Wr||($_(XA),Wr=Zo.now()+pu)}function XA(){Wr=0}function cd(){this._call=this._time=this._next=null}cd.prototype=K_.prototype={constructor:cd,restart:function(t,e,n){if(typeof t!="function")throw new TypeError("callback is not a function");n=(n==null?q_():+n)+(e==null?0:+e),!this._next&&xo!==this&&(xo?xo._next=this:Xl=this,xo=this),this._call=t,this._time=n,fd()},stop:function(){this._call&&(this._call=null,this._time=1/0,fd())}};function K_(t,e,n){var i=new cd;return i.restart(t,e,n),i}function jA(){q_(),++Gs;for(var t=Xl,e;t;)(e=Wr-t._time)>=0&&t._call.call(void 0,e),t=t._next;--Gs}function $m(){Wr=(jl=Zo.now())+pu,Gs=vo=0;try{jA()}finally{Gs=0,$A(),Wr=0}}function YA(){var t=Zo.now(),e=t-jl;e>Y_&&(pu-=e,jl=t)}function $A(){for(var t,e=Xl,n,i=1/0;e;)e._call?(i>e._time&&(i=e._time),t=e,e=e._next):(n=e._next,e._next=null,e=t?t._next=n:Xl=n);xo=t,fd(i)}function fd(t){if(!Gs){vo&&(vo=clearTimeout(vo));var e=t-Wr;e>24?(t<1/0&&(vo=setTimeout($m,t-Zo.now()-pu)),co&&(co=clearInterval(co))):(co||(jl=Zo.now(),co=setInterval(YA,Y_)),Gs=1,$_($m))}}const qA=1664525,KA=1013904223,qm=4294967296;function ZA(){let t=1;return()=>(t=(qA*t+KA)%qm)/qm}function QA(t){return t.x}function JA(t){return t.y}var eR=10,tR=Math.PI*(3-Math.sqrt(5));function nR(t){var e,n=1,i=.001,r=1-Math.pow(i,1/300),s=0,o=.6,a=new Map,l=K_(h),u=j_("tick","end"),d=ZA();t==null&&(t=[]);function h(){c(),u.call("tick",e),n<i&&(l.stop(),u.call("end",e))}function c(x){var p,f=t.length,g;x===void 0&&(x=1);for(var v=0;v<x;++v)for(n+=(s-n)*r,a.forEach(function(y){y(n)}),p=0;p<f;++p)g=t[p],g.fx==null?g.x+=g.vx*=o:(g.x=g.fx,g.vx=0),g.fy==null?g.y+=g.vy*=o:(g.y=g.fy,g.vy=0);return e}function m(){for(var x=0,p=t.length,f;x<p;++x){if(f=t[x],f.index=x,f.fx!=null&&(f.x=f.fx),f.fy!=null&&(f.y=f.fy),isNaN(f.x)||isNaN(f.y)){var g=eR*Math.sqrt(.5+x),v=x*tR;f.x=g*Math.cos(v),f.y=g*Math.sin(v)}(isNaN(f.vx)||isNaN(f.vy))&&(f.vx=f.vy=0)}}function _(x){return x.initialize&&x.initialize(t,d),x}return m(),e={tick:c,restart:function(){return l.restart(h),e},stop:function(){return l.stop(),e},nodes:function(x){return arguments.length?(t=x,m(),a.forEach(_),e):t},alpha:function(x){return arguments.length?(n=+x,e):n},alphaMin:function(x){return arguments.length?(i=+x,e):i},alphaDecay:function(x){return arguments.length?(r=+x,e):+r},alphaTarget:function(x){return arguments.length?(s=+x,e):s},velocityDecay:function(x){return arguments.length?(o=1-x,e):1-o},randomSource:function(x){return arguments.length?(d=x,a.forEach(_),e):d},force:function(x,p){return arguments.length>1?(p==null?a.delete(x):a.set(x,_(p)),e):a.get(x)},find:function(x,p,f){var g=0,v=t.length,y,R,E,C,S;for(f==null?f=1/0:f*=f,g=0;g<v;++g)C=t[g],y=x-C.x,R=p-C.y,E=y*y+R*R,E<f&&(S=C,f=E);return S},on:function(x,p){return arguments.length>1?(u.on(x,p),e):u.on(x)}}}function iR(){var t,e,n,i,r=sn(-30),s,o=1,a=1/0,l=.81;function u(m){var _,x=t.length,p=Sh(t,QA,JA).visitAfter(h);for(i=m,_=0;_<x;++_)e=t[_],p.visit(c)}function d(){if(t){var m,_=t.length,x;for(s=new Array(_),m=0;m<_;++m)x=t[m],s[x.index]=+r(x,m,t)}}function h(m){var _=0,x,p,f=0,g,v,y;if(m.length){for(g=v=y=0;y<4;++y)(x=m[y])&&(p=Math.abs(x.value))&&(_+=x.value,f+=p,g+=p*x.x,v+=p*x.y);m.x=g/f,m.y=v/f}else{x=m,x.x=x.data.x,x.y=x.data.y;do _+=s[x.data.index];while(x=x.next)}m.value=_}function c(m,_,x,p){if(!m.value)return!0;var f=m.x-e.x,g=m.y-e.y,v=p-_,y=f*f+g*g;if(v*v/l<y)return y<a&&(f===0&&(f=ir(n),y+=f*f),g===0&&(g=ir(n),y+=g*g),y<o&&(y=Math.sqrt(o*y)),e.vx+=f*m.value*i/y,e.vy+=g*m.value*i/y),!0;if(m.length||y>=a)return;(m.data!==e||m.next)&&(f===0&&(f=ir(n),y+=f*f),g===0&&(g=ir(n),y+=g*g),y<o&&(y=Math.sqrt(o*y)));do m.data!==e&&(v=s[m.data.index]*i/y,e.vx+=f*v,e.vy+=g*v);while(m=m.next)}return u.initialize=function(m,_){t=m,n=_,d()},u.strength=function(m){return arguments.length?(r=typeof m=="function"?m:sn(+m),d(),u):r},u.distanceMin=function(m){return arguments.length?(o=m*m,u):Math.sqrt(o)},u.distanceMax=function(m){return arguments.length?(a=m*m,u):Math.sqrt(a)},u.theta=function(m){return arguments.length?(l=m*m,u):Math.sqrt(l)},u}function rR(t){var e=sn(.1),n,i,r;typeof t!="function"&&(t=sn(t==null?0:+t));function s(a){for(var l=0,u=n.length,d;l<u;++l)d=n[l],d.vx+=(r[l]-d.x)*i[l]*a}function o(){if(n){var a,l=n.length;for(i=new Array(l),r=new Array(l),a=0;a<l;++a)i[a]=isNaN(r[a]=+t(n[a],a,n))?0:+e(n[a],a,n)}}return s.initialize=function(a){n=a,o()},s.strength=function(a){return arguments.length?(e=typeof a=="function"?a:sn(+a),o(),s):e},s.x=function(a){return arguments.length?(t=typeof a=="function"?a:sn(+a),o(),s):t},s}function sR(t){var e=sn(.1),n,i,r;typeof t!="function"&&(t=sn(t==null?0:+t));function s(a){for(var l=0,u=n.length,d;l<u;++l)d=n[l],d.vy+=(r[l]-d.y)*i[l]*a}function o(){if(n){var a,l=n.length;for(i=new Array(l),r=new Array(l),a=0;a<l;++a)i[a]=isNaN(r[a]=+t(n[a],a,n))?0:+e(n[a],a,n)}}return s.initialize=function(a){n=a,o()},s.strength=function(a){return arguments.length?(e=typeof a=="function"?a:sn(+a),o(),s):e},s.y=function(a){return arguments.length?(t=typeof a=="function"?a:sn(+a),o(),s):t},s}const Z_={id:"nevverland",label:"Nevverland",copy:"An experimental practice. Navigation as material, type as structure, imagery as weather. Built fast, kept forever — every study frozen the moment it works.",img:"img/03.jpg",children:[{id:"work",label:"Work",copy:"Studies in interfaces that behave like places — each one rebuilds a piece of the 2007 spatial web with today’s physics.",img:"img/07.jpg",children:[{id:"nike",label:"Nike",img:"img/00.jpg",copy:"Motion identity sprints. Twelve directions in ten days.",media:[{type:"video",src:"img/nike.mp4"},{type:"img",src:"img/00.jpg"},{type:"img",src:"img/03.jpg"},{type:"img",src:"img/05.jpg"}]},{id:"hbo",label:"HBO",img:"img/14.jpg",copy:"Title sequences as navigation. The menu is the trailer.",media:[{type:"img",src:"img/14.jpg"},{type:"video",src:"img/hbo.mp4"},{type:"img",src:"img/11.jpg"}]},{id:"sony",label:"Sony",img:"img/17.jpg",copy:"Product stories told through a bent lens.",media:[{type:"img",src:"img/17.jpg"},{type:"img",src:"img/09.jpg"},{type:"video",src:"img/sony.mp4"},{type:"img",src:"img/07.jpg"}]},{id:"pepsi",label:"Pepsi",img:"img/21.jpg",copy:"Liquid type systems for a liquid product.",media:[{type:"img",src:"img/21.jpg"},{type:"img",src:"img/34.jpg"},{type:"img",src:"img/38.jpg"}]},{id:"experimental",label:"Experimental",img:"img/28.jpg",copy:"The unbriefed work. Where the other four came from.",media:[{type:"video",src:"img/experimental.mp4"},{type:"img",src:"img/28.jpg"},{type:"img",src:"img/11.jpg"},{type:"img",src:"img/09.jpg"}]}]},{id:"about",label:"About",copy:"Nevverland is the studio of Nessim Higson — I AM ALWAYS HUNGRY. Twenty years of brand and interactive work, currently obsessed with making the web feel hand-made again. Small team, long leash, no templates.",img:"img/05.jpg",children:[{id:"studio",label:"Studio",img:"img/09.jpg",copy:"A room with good light, too many books, and a server that never sleeps."},{id:"people",label:"People",img:"img/11.jpg",copy:"One founder, many collaborators, several machines that think."},{id:"process",label:"Process",img:"img/34.jpg",copy:"Prototype first. Theory later, if ever. Ship the sketch."}]},{id:"info",label:"Info",copy:"Field notes and colophon. Set in Helvetica because the grid deserves respect; broken on purpose where it doesn’t. All imagery from the Uniqlock sessions.",img:"img/38.jpg",children:[{id:"notes",label:"Notes",img:"img/03.jpg",copy:"Working notes from each experiment, unedited."},{id:"colophon",label:"Colophon",img:"img/05.jpg",copy:"React + d3-force for the organic modes; just slots and springs for the structural ones."},{id:"archive",label:"Archive",img:"img/07.jpg",copy:"Frozen versions of everything, kept forever."}]},{id:"contact",label:"Contact",copy:"Always hungry. Say hello.",img:"img/09.jpg",children:[{id:"newyork",label:"New York",img:"img/11.jpg",copy:"EST, for now."},{id:"losangeles",label:"Los Angeles",img:"img/14.jpg",copy:"Golden hour, permanently."},{id:"email",label:"Email",img:"img/21.jpg",copy:"ness@iamalwayshungry.com"}]}]};function oR(t,e,n){const i=e.get(t.id);return n==="type"?Ut(i)*.8+2:oh[i].radius+Re.COLLIDE_PADDING}function aR(t,e,n=1){function i(r){const s=t();if(!s)return;const o=Re.CHILD_RING*n;for(const a of e()){let l=a.x-s.x,u=a.y-s.y,d=Math.sqrt(l*l+u*u);d<1&&(l=Math.cos(a.phase),u=Math.sin(a.phase),d=1);const h=(o-d)/d*Re.CHILD_RING_STRENGTH*r;a.vx+=l*h,a.vy+=u*h}}return i.initialize=()=>{},i}function lR(){let t=[],e=0;function n(){e+=.006;for(const i of t)i.vx+=Math.cos(e*i.driftSpeed+i.phase)*Re.DRIFT*.1,i.vy+=Math.sin(e*i.driftSpeed*1.37+i.phase)*Re.DRIFT*.1}return n.initialize=i=>t=i,n}function uR(t){let e=0;for(const n of t)e=(e*31+n.charCodeAt(0))%997;return e}function cR(t,e=At.STRENGTH){function n(i){for(const r of t){const s=r.anchor.x+r.dx,o=r.anchor.y+r.dy;r.node.vx+=(s-r.node.x)*e*i,r.node.vy+=(o-r.node.y)*e*i}}return n.initialize=()=>{},n}function fR(t,e,n,i,r=0){const s=i.get(t),o=zr(t,i),a=[],l=Math.max(At.COL_W,bo(s.label,Ut("active"))+70),u=Math.max(At.GAP,Ut("child")*1.9),d=Math.max(At.GAP_DISTANT,Ut("distant")*2.4);for(const h of e){const c=n.get(h.id);if(c==="child"){const m=s.childIds.indexOf(h.id);a.push({node:h,anchor:s,dx:l,dy:At.CHILD_DROP+r+m*u})}else if(c==="sibling"){const m=i.get(s.parentId).childIds,_=m.indexOf(h.id)-m.indexOf(t);a.push({node:h,anchor:s,dx:0,dy:_*u+(_>0?At.ACTIVE_CLEAR+r:0)})}else if(c==="parent"){const m=o.indexOf(h.id)+1;a.push({node:h,anchor:s,dx:-At.BREAD_STEP*m,dy:-At.ROW_LIFT*m})}else if(c==="distant"){const m=i.get(h.parentId).childIds,_=e.find(p=>p.parentId===h.parentId&&(n.get(p.id)==="parent"||p.id===t));if(!_)continue;const x=m.indexOf(h.id)-m.indexOf(_.id);a.push({node:h,anchor:_,dx:0,dy:x*d+(x>0?10:-6)})}}return a}function dR(t,e,n,i,r,s,o){const a=i.get(t),l=zr(t,i),u=[],d=Ut("active",a.label,s),h=Math.max(At.GAP,Ut("child")*2.15),c=Math.max(30,Ut("sibling")*2.6),m=f=>o?(uR(f)%100/50-1)*o:0;l.forEach((f,g)=>{u.push({node:i.get(f),anchor:a,dx:m(f)*.6,dy:-(d*.55+34+g*34)})});const _=a.childIds.filter(f=>n.has(f)),x=d*.55+26+r;_.forEach((f,g)=>{u.push({node:i.get(f),anchor:a,dx:m(f),dy:x+g*h})});let p=x+_.length*h+30;if(a.parentId)for(const f of i.get(a.parentId).childIds)f===t||!n.has(f)||(u.push({node:i.get(f),anchor:a,dx:m(f),dy:p}),p+=c);p+=18;for(const f of e)n.get(f.id)==="distant"&&(u.push({node:f,anchor:a,dx:m(f.id),dy:p}),p+=27);return u}function hR(t,e){let n=[];function i(r){const s=Re.CONTAIN_MARGIN;for(const o of n)o.x<s&&(o.vx+=(s-o.x)*Re.CONTAIN_STRENGTH*r),o.x>t-s&&(o.vx-=(o.x-(t-s))*Re.CONTAIN_STRENGTH*r),o.y<s&&(o.vy+=(s-o.y)*Re.CONTAIN_STRENGTH*r),o.y>e-s&&(o.vy-=(o.y-(e-s))*Re.CONTAIN_STRENGTH*r)}return i.initialize=r=>n=r,i}function pR(t){let e=[];function i(){if(!(!Re.CURSOR||t.x==null))for(const r of e){const s=t.x-r.x,o=t.y-r.y,a=Math.hypot(s,o);if(a>300||a<2)continue;const l=Re.CURSOR*(1-a/300)*.18;r.vx+=s/a*l,r.vy+=o/a*l}}return i.initialize=r=>e=r,i}function mR(t,e,n,i="type",r=0){const[,s]=ke.useState(0),o=ke.useRef(null);if(!o.current){const{nodes:d,byId:h}=IS(Z_);for(const c of d)c.phase=Math.random()*Math.PI*2,c.driftSpeed=.5+Math.random(),c.everShown=!1;o.current={sim:nR([]).stop(),nodes:d,byId:h,roles:new Map,seeded:!1,pointer:{x:null,y:null},prevFocus:null}}const{sim:a,nodes:l,byId:u}=o.current;return ke.useEffect(()=>{if(!e||!n)return;const d=i==="focus"||i==="rings"||i==="weight",h=i==="orbs"||d?"orbs":"type",c=e/2,m=n/2;if(!o.current.seeded){for(const w of l)w.x=e/2+(Math.random()-.5)*60,w.y=n/2+(Math.random()-.5)*60;o.current.seeded=!0}const _=US(t,u);o.current.roles=_;const x=w=>_.get(w.id),p=l.filter(w=>_.has(w.id));for(const w of p)if(!w.everShown){const L=w.parentId?u.get(w.parentId):null;L&&L.everShown&&(w.x=L.x+(Math.random()-.5)*40,w.y=L.y+(Math.random()-.5)*40),w.everShown=!0}const f=[];for(const w of p){if(!w.parentId||!_.has(w.parentId))continue;const L=x(w),z=L==="child"?"activeChild":L==="active"||L==="parent"?"breadcrumb":L==="sibling"?"sibling":"distant";f.push({source:w.parentId,target:w.id,kind:z})}o.current.links=f;for(const w of["charge","link","collide","x","y","ring","drift","contain","pointer"])a.force(w,null);a.nodes(p),a.velocityDecay(Re.DAMPING);const g=h==="type"?At.CHARGE_SCALE:1;a.force("charge",iR().strength(w=>Re.CHARGE*oh[x(w)].scale*g).distanceMax(Re.CHARGE_MAX_DISTANCE)),a.force("link",VA(f).id(w=>w.id).distance(w=>Re.LINK_DISTANCE[w.kind]).strength(h==="type"?At.LINK_STRENGTH:.6)),a.force("collide",BA(w=>d?bo(w.label,Ut(x(w)))*.42+6+Re.SPACING*.5:oR(w,_,h)+(h==="type"?Re.SPACING*.25:0)).strength(Re.COLLIDE_STRENGTH).iterations(2));const v=i==="structure"||i==="imagery",y=zr(t,u).length,R=u.get(t),E=R.childIds.filter(w=>_.has(w)),C=R.parentId?u.get(R.parentId).childIds.filter(w=>_.has(w)&&w!==t).length:0;let S,b;if(h==="type"){const w=Ut("active",R.label,e),L=Math.max(At.GAP,Ut("child")*1.9),z=(v||i==="depth")&&R.copy?Math.min(150,Math.ceil(R.copy.length/48)*21+26):0,Y=y*(v?34:At.ROW_LIFT*.7)+w*.5+30,D=w*.5+z+E.length*L+(C?30+C*(v?30:0):0);b=n*.46-(D-Y)/2;const O=Math.max(64,e*.07),k=v?0:Math.max(At.COL_W,bo(R.label,w)+70);let F=0;for(const te of E)F=Math.max(F,bo(u.get(te).label,Ut("child")));const X=v?O:O+y*At.BREAD_STEP,$=e-48-k-F;S=Math.max(X,Math.min(X,$))}else S=c,b=m;if(a.force("x",rR(S).strength(w=>x(w)==="active"?Re.CENTER_PULL_ACTIVE:Re.CENTER_PULL_OTHERS)),a.force("y",sR(w=>x(w)==="parent"&&h!=="type"?m-Re.BREADCRUMB_LIFT:b).strength(w=>{const L=x(w);return L==="active"?Re.CENTER_PULL_ACTIVE:L==="parent"?Re.BREADCRUMB_PULL:Re.CENTER_PULL_OTHERS})),h==="type"){const w=u.get(t),L=(v||i==="depth")&&w.copy?Math.min(150,Math.ceil(w.copy.length/48)*21+26):0,z=v?dR(t,p,_,u,L,e,i==="structure"?0:At.LOOSE):fR(t,p,_,u,L);a.force("ring",cR(z,v?Math.max(At.STRENGTH,.5):At.STRENGTH))}else a.force("ring",aR(()=>u.get(t),()=>p.filter(w=>x(w)==="child"),d?1.5:1));a.force("drift",lR()),a.force("contain",hR(e,n)),a.force("pointer",pR(o.current.pointer));const P=u.get(t);if(Re.SHOCK>0&&o.current.prevFocus&&o.current.prevFocus!==t&&P.x!=null)for(const w of p){if(w===P||w.x==null)continue;const L=w.x-P.x,z=w.y-P.y,Y=Math.hypot(L,z)||1,D=Re.SHOCK*Math.min(1,220/Y);w.vx+=L/Y*D,w.vy+=z/Y*D}return o.current.prevFocus=t,a.on("tick",()=>s(w=>w+1)),a.alpha(Re.ALPHA_KICK).alphaTarget(Re.DRIFT>.015?Re.IDLE_ALPHA:0).restart(),s(w=>w+1),()=>a.on("tick",null)},[t,e,n,i,r]),ke.useEffect(()=>()=>a.stop(),[]),{visibleNodes:l.filter(d=>o.current.roles.has(d.id)),links:o.current.links||[],roles:o.current.roles,byId:u,pointer:o.current.pointer}}const gR=Z_.id,_R=[{key:"type",label:"01 ORGANIC"},{key:"orbs",label:"02 ORBS"},{key:"structure",label:"03 STRUCTURE"},{key:"imagery",label:"04 IMAGERY"},{key:"depth",label:"05 DEPTH"},{key:"focus",label:"06 FOCAL"},{key:"rings",label:"07 RINGS"},{key:"weight",label:"08 WEIGHT"}];function vR(){const[t,e]=ke.useState(gR),[n,i]=ke.useState("focus"),[r,s]=ke.useState(0),[o,a]=ke.useState(!1),l=ke.useRef(null),[u,d]=ke.useState({width:0,height:0});ke.useEffect(()=>{const _=x=>{(x.key==="h"||x.key==="H")&&a(p=>!p)};return window.addEventListener("keydown",_),()=>window.removeEventListener("keydown",_)},[]),ke.useEffect(()=>{const _=l.current,x=_.getBoundingClientRect();d({width:x.width,height:x.height});const p=new ResizeObserver(([f])=>{const{width:g,height:v}=f.contentRect;d({width:g,height:v})});return p.observe(_),()=>p.disconnect()},[]);const h=mR(t,u.width,u.height,n,r);ke.useEffect(()=>{const _=x=>{x.key==="fb-nav"&&x.newValue&&h.byId.has(x.newValue)&&e(x.newValue)};return window.addEventListener("storage",_),()=>window.removeEventListener("storage",_)},[h.byId]);const c=_=>{const x=_.id===t?_.parentId:_.id;if(x){e(x);try{localStorage.setItem("fb-nav",x)}catch{}}},m=[t,...zr(t,h.byId)].reverse().map(_=>h.byId.get(_).label);return ue.jsxs("div",{className:`stage ${o?"bare":""}`,ref:l,onMouseMove:_=>{h.pointer.x=_.clientX,h.pointer.y=_.clientY},onMouseLeave:()=>{h.pointer.x=null,h.pointer.y=null},children:[u.width>0&&(n==="focus"?ue.jsx(mA,{sim:h,activeId:t,width:u.width,height:u.height,onNavigate:c}):n==="rings"?ue.jsx(gA,{sim:h,activeId:t,width:u.width,height:u.height,onNavigate:c}):n==="weight"?ue.jsx(vA,{sim:h,activeId:t,width:u.width,onNavigate:c}):ue.jsx(VS,{width:u.width,height:u.height,sim:h,activeId:t,mode:n,onNavigate:c})),ue.jsx(SA,{onTune:()=>s(_=>_+1)}),ue.jsxs("header",{className:"chrome top",children:[ue.jsx("span",{className:"wordmark",children:"NEVVERLAND"}),ue.jsx("span",{className:"trail",children:m.join("  /  ")})]}),ue.jsxs("footer",{className:"chrome bottom",children:[ue.jsx("span",{className:"hint",children:"CLICK A NODE TO NAVIGATE — CLICK THE FOCUS TO STEP BACK — H FOR CLEAN VIEW"}),ue.jsx("span",{className:"switch",children:_R.map(_=>ue.jsx("button",{className:n===_.key?"on":"",onClick:()=>i(_.key),children:_.label},_.key))})]})]})}Tc.createRoot(document.getElementById("root")).render(ue.jsx(Mv.StrictMode,{children:ue.jsx(vR,{})}));
