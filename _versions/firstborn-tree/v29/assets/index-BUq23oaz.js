 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(k,X){var Y=k.length;k.push(X);e:for(;0<Y;){var ne=Y-1>>>1,fe=k[ne];if(0<r(fe,X))k[ne]=X,k[Y]=fe,Y=ne;else break e}}function n(k){return k.length===0?null:k[0]}function i(k){if(k.length===0)return null;var X=k[0],Y=k.pop();if(Y!==X){k[0]=Y;e:for(var ne=0,fe=k.length,Ve=fe>>>1;ne<Ve;){var We=2*(ne+1)-1,Ne=k[We],K=We+1,de=k[K];if(0>r(Ne,Y))K<fe&&0>r(de,Ne)?(k[ne]=de,k[K]=Y,ne=K):(k[ne]=Ne,k[We]=Y,ne=We);else if(K<fe&&0>r(de,Y))k[ne]=de,k[K]=Y,ne=K;else break e}}return X}function r(k,X){var Y=k.sortIndex-X.sortIndex;return Y!==0?Y:k.id-X.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],d=1,h=null,f=3,p=!1,_=!1,v=!1,m=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function x(k){for(var X=n(u);X!==null;){if(X.callback===null)i(u);else if(X.startTime<=k)i(u),X.sortIndex=X.expirationTime,e(l,X);else break;X=n(u)}}function y(k){if(v=!1,x(k),!_)if(n(l)!==null)_=!0,O(A);else{var X=n(u);X!==null&&B(y,X.startTime-k)}}function A(k,X){_=!1,v&&(v=!1,c(S),S=-1),p=!0;var Y=f;try{for(x(X),h=n(l);h!==null&&(!(h.expirationTime>X)||k&&!E());){var ne=h.callback;if(typeof ne=="function"){h.callback=null,f=h.priorityLevel;var fe=ne(h.expirationTime<=X);X=t.unstable_now(),typeof fe=="function"?h.callback=fe:h===n(l)&&i(l),x(X)}else i(l);h=n(l)}if(h!==null)var Ve=!0;else{var We=n(u);We!==null&&B(y,We.startTime-X),Ve=!1}return Ve}finally{h=null,f=Y,p=!1}}var w=!1,C=null,S=-1,b=5,L=-1;function E(){return!(t.unstable_now()-L<b)}function P(){if(C!==null){var k=t.unstable_now();L=k;var X=!0;try{X=C(!0,k)}finally{X?F():(w=!1,C=null)}}else w=!1}var F;if(typeof g=="function")F=function(){g(P)};else if(typeof MessageChannel<"u"){var j=new MessageChannel,D=j.port2;j.port1.onmessage=P,F=function(){D.postMessage(null)}}else F=function(){m(P,0)};function O(k){C=k,w||(w=!0,F())}function B(k,X){S=m(function(){k(t.unstable_now())},X)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(k){k.callback=null},t.unstable_continueExecution=function(){_||p||(_=!0,O(A))},t.unstable_forceFrameRate=function(k){0>k||125<k?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):b=0<k?Math.floor(1e3/k):5},t.unstable_getCurrentPriorityLevel=function(){return f},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(k){switch(f){case 1:case 2:case 3:var X=3;break;default:X=f}var Y=f;f=X;try{return k()}finally{f=Y}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(k,X){switch(k){case 1:case 2:case 3:case 4:case 5:break;default:k=3}var Y=f;f=k;try{return X()}finally{f=Y}},t.unstable_scheduleCallback=function(k,X,Y){var ne=t.unstable_now();switch(typeof Y=="object"&&Y!==null?(Y=Y.delay,Y=typeof Y=="number"&&0<Y?ne+Y:ne):Y=ne,k){case 1:var fe=-1;break;case 2:fe=250;break;case 5:fe=1073741823;break;case 4:fe=1e4;break;default:fe=5e3}return fe=Y+fe,k={id:d++,callback:X,priorityLevel:k,startTime:Y,expirationTime:fe,sortIndex:-1},Y>ne?(k.sortIndex=Y,e(u,k),n(l)===null&&k===n(u)&&(v?(c(S),S=-1):v=!0,B(y,Y-ne))):(k.sortIndex=fe,e(l,k),_||p||(_=!0,O(A))),k},t.unstable_shouldYield=E,t.unstable_wrapCallback=function(k){var X=f;return function(){var Y=f;f=X;try{return k.apply(this,arguments)}finally{f=Y}}}})(ug);lg.exports=ug;var Pv=lg.exports;/**
 * @license React
...
`)+`
`+c);const x=g+m+o,y=g+c+a,A=Lm(r,r.VERTEX_SHADER,x),w=Lm(r,r.FRAGMENT_SHADER,y);r.attachShader(v,A),r.attachShader(v,w),n.index0AttributeName!==void 0?r.bindAttribLocation(v,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function C(E){if(t.debug.checkShaderErrors){const P=r.getProgramInfoLog(v)||"",F=r.getShaderInfoLog(A)||"",j=r.getShaderInfoLog(w)||"",D=P.trim(),O=F.trim(),B=j.trim();let k=!0,X=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(k=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,v,A,w);else{const Y=Dm(r,A,"vertex"),ne=Dm(r,w,"fragment");Ke("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
...
`;function X_({media:t,startIndex:e=0,width:n,height:i,onIndex:r}){const s=Le.useRef(null),o=Le.useRef(e),a=Le.useRef(!1);Le.useEffect(()=>{var d;(d=s.current)!=null&&d.__goto&&s.current.__goto(e)},[e]);const[l,u]=Le.useState(!1);if(Le.useEffect(()=>{const d=s.current;if(!d||a.current)return;let h;try{h=new aA({antialias:!0,alpha:!0})}catch{a.current=!0,u(!0);return}h.setPixelRatio(Math.min(2,window.devicePixelRatio)),h.setSize(n,i),d.appendChild(h.domElement);const f=new By,p=new vh(-n/2,n/2,i/2,-i/2,-1500,1500),_=i*.6,v=_*.78,m=v+110,c=new lM,g=[],x=t.map((O,B)=>{let k;if(O.type==="video"){const ne=document.createElement("video");ne.src=O.src,ne.muted=!0,ne.loop=!0,ne.playsInline=!0,ne.play().catch(()=>{}),g.push(ne),k=new Ky(ne)}else k=c.load(O.src);k.colorSpace=Mn;const X=new Zn({vertexShader:lA,fragmentShader:uA,uniforms:{uMap:{value:k},uVel:{value:0},uTime:{value:0},uEffect:{value:Hm[Ee.FX]??0}}}),Y=new pi(new oa(v,_,48,48),X);return Y.position.x=B*m,f.add(Y),Y});let y=e*m,A=y,w=A,C=null;const S=(t.length-1)*m;d.__goto=O=>{y=Math.max(0,Math.min(S,O*m))};const b=O=>{var B;C={x:O.clientX,t:y},(B=d.setPointerCapture)==null||B.call(d,O.pointerId)},L=O=>{C&&(y=Math.max(-m*.4,Math.min(S+m*.4,C.t-(O.clientX-C.x)*1.6)))},E=()=>{C=null,y=Math.max(0,Math.min(S,y))},P=O=>{y=Math.max(0,Math.min(S,y+(O.deltaY+O.deltaX)*1.1))};d.addEventListener("pointerdown",b),d.addEventListener("pointermove",L),d.addEventListener("pointerup",E),d.addEventListener("pointercancel",E),d.addEventListener("wheel",P,{passive:!0});let F;const j=new fM,D=()=>{A+=(y-A)*.085;const O=(A-w)/m;w=A;const B=j.getElapsedTime(),k=Hm[Ee.FX]??0;x.forEach((Y,ne)=>{Y.position.x=ne*m-A,Y.material.uniforms.uVel.value=O*6,Y.material.uniforms.uTime.value=B,Y.material.uniforms.uEffect.value=k});const X=Math.round(Math.max(0,Math.min(S,A))/m);X!==o.current&&(o.current=X,r==null||r(X)),h.render(f,p),F=requestAnimationFrame(D)};return F=requestAnimationFrame(D),()=>{cancelAnimationFrame(F),d.removeEventListener("pointerdown",b),d.removeEventListener("pointermove",L),d.removeEventListener("pointerup",E),d.removeEventListener("pointercancel",E),d.removeEventListener("wheel",P),g.forEach(O=>O.pause()),x.forEach(O=>{O.geometry.dispose(),O.material.uniforms.uMap.value.dispose(),O.material.dispose()}),h.dispose(),d.removeChild(h.domElement)}},[t,n,i]),l){const d=t[Math.min(e,t.length-1)];return J.jsx("div",{className:"fullBleed",children:d.type==="video"?J.jsx("video",{src:d.src,autoPlay:!0,muted:!0,loop:!0,playsInline:!0}):J.jsx("img",{src:d.src,alt:""})})}return J.jsx("div",{className:"glStage",ref:s})}const cA=-200,Gm=220,Mc=265;function fA(t,e,n,i,r=1){if(n==="arc"){const o=Mc*r;return Array.from({length:t},(a,l)=>{const u=(cA+(t>1?l*Gm/(t-1):Gm/2))*Math.PI/180;return{ox:Math.cos(u)*o*1.25,oy:Math.sin(u)*o*.9,z:-150}})}if(n==="fan")return Array.from({length:t},(o,a)=>({ox:(240+a*130)*r,oy:(-36-a*38)*r,z:-110-a*175}));if(n==="tide"){const o=1280*r;return Array.from({length:t},(a,l)=>({ox:(i*42+l*(o/t))%o-o/2,oy:((l%2?-1:1)*(105+l%3*38)+Math.sin(i*.7+l)*14)*r,z:-120-l%3*150}))}const s=i*9*Math.PI/180;return Array.from({length:t},(o,a)=>{const l=a/t*Math.PI*2-Math.PI/2+s;return{ox:Math.cos(l)*Mc*1.3*r,oy:Math.sin(l)*Mc*.85*r,z:-150}})}const dA=110;function hA({sim:t,activeId:e,width:n,height:i,onNavigate:r}){const{visibleNodes:s,roles:o,byId:a}=t,l=Le.useRef(null),[u,d]=Le.useState(null),[h,f]=Le.useState(null),[p,_]=Le.useState(null);Le.useEffect(()=>{_(null),f(null)},[e]),Le.useEffect(()=>{const E=P=>{if(P.key!=="Escape")return;if(p!=null){_(null);return}const F=a.get(e);F!=null&&F.parentId&&r(a.get(F.parentId))};return window.addEventListener("keydown",E),()=>window.removeEventListener("keydown",E)},[e,a,r,p]);const[,v]=Le.useState(0);Le.useEffect(()=>{let E;const P=()=>{(Ee.EMIT==="orbit"||Ee.EMIT==="tide")&&v(F=>F+1),E=requestAnimationFrame(P)};return E=requestAnimationFrame(P),()=>cancelAnimationFrame(E)},[]),Le.useEffect(()=>{const E=P=>{const F=P.clientX/window.innerWidth-.5,j=P.clientY/window.innerHeight-.5;l.current&&(l.current.style.perspectiveOrigin=`${50+F*16}% ${46+j*11}%`)};return window.addEventListener("mousemove",E),()=>window.removeEventListener("mousemove",E)},[]);const m=a.get(e),c=m.childIds.length===0,g=c&&m.media?m.media:null,x=!g&&(m!=null&&m.img)&&c?m:null,y=Ee.VIEWPORT_SCALE,A=g&&p!=null?g[p]:null,w=g?fA(g.length,!1,Ee.EMIT,performance.now()/1e3,y):[],C=E=>E==="active"?Ut("active",m.label,n):E==="parent"?38:E==="child"?Ut("child"):E==="sibling"?15:13,S=E=>{if(E.id===e&&A){_(null);return}r(E)},b=E=>{if(!E.target.closest(".flabel, .floatFrame, .froomImg, .leafCaption")){if(A){_(null);return}m.parentId&&r(a.get(m.parentId))}},L=!!g;return Ui(e,a).reverse().map(E=>a.get(E)),J.jsxs(J.Fragment,{children:[A&&J.jsx(X_,{media:g,startIndex:p,width:n,height:i??window.innerHeight,onIndex:E=>_(E)},`gl-${e}`),J.jsxs("div",{className:`focusSpace ${A?"viewing":""}`,ref:l,onClick:b,style:{pointerEvents:A?"none":"auto"},children:[g&&!A&&m.x!=null&&J.jsx("div",{className:"emitWrap",style:{transform:`translate3d(${m.x}px, ${m.y}px, 0)`},children:g.map((E,P)=>{const F=w[P],j=h===P,D=P%2===0,O=(j?330:D?230:188)*y,B=O*(j?1:D?1.2:.78);return J.jsx("div",{className:`eFrame ${j?"near":""}`,style:{width:O,height:B,zIndex:j?60:20+P,transform:`translate(calc(-50% + ${F.ox}px), calc(-50% + ${F.oy}px)) translateZ(${j?130:F.z}px) rotate(${j?0:P%2?2:-2}deg)`,filter:j?"grayscale(1)":"grayscale(1) brightness(0.82)",animationDelay:`${.25+P*.13}s`},onMouseEnter:()=>f(P),onMouseLeave:()=>f(null),onClick:k=>{k.stopPropagation(),_(P)},children:E.type==="video"?J.jsx("video",{src:E.src,autoPlay:!0,muted:!0,loop:!0,playsInline:!0}):J.jsx("img",{src:E.src,alt:"",draggable:!1})},`${e}-em-${P}`)})}),A&&J.jsx("span",{className:"imgExit",children:"esc ↩ back"}),!L&&x&&J.jsx("img",{className:"froomImg",src:x.img,alt:""},`room-${x.id}`),s.map(E=>{if(E.x==null)return null;const P=o.get(E.id);if(P==="sibling"||P==="distant")return null;const F=P==="parent"&&E.id===m.parentId;if(P==="parent"&&!F)return null;let j,D,O;return F?(j=-410*1.05,D=u===E.id?0:1.5,O=u===E.id?.85:.34):P==="active"?(j=0,D=0,O=1):(j=dA,D=0,O=u===E.id?1:.9),J.jsx("div",{className:"fnode",style:{transform:`translate3d(${E.x}px, ${E.y}px, 0)`},children:J.jsx("div",{className:"fnodeInner",style:{transform:`translateZ(${j}px)`,filter:D?`blur(${D}px)`:"none",opacity:O},children:J.jsxs("span",{"data-node":E.id,className:`flabel ${P==="active"?"activeL":""} ${F?"wayback":""} ${u===E.id?"hot":""}`,style:{fontSize:P==="active"&&g?C("active")*.5:C(P)},onMouseEnter:()=>d(E.id),onMouseLeave:()=>d(null),onClick:()=>S(E),children:[F&&J.jsx("span",{className:"backArrow",children:"↑ "}),E.label]})})},E.id)}),!A&&(m==null?void 0:m.copy)&&m.x!=null&&J.jsx("div",{className:"fcopy",style:{transform:`translate3d(${m.x}px, ${m.y+C("active")*.62+16}px, 0) translateX(-50%)`},children:m.copy},e)]})]})}const pA=165;function mA({sim:t,activeId:e,width:n,height:i,onNavigate:r}){const{visibleNodes:s,roles:o,byId:a}=t,[l,u]=Le.useState(null),d=pA*Ee.VIEWPORT_SCALE,h=n/2,f=i/2-20,p=a.get(e),_=p!=null&&p.img&&p.childIds.length===0?p:null,v=(c,g)=>{let x=c.x-h,y=c.y-f;const A=Math.hypot(x,y)||1;return{x:h+x/A*g,y:f+y/A*g*.82}},m=(c,g)=>c==="active"?Ut("active",p.label,n):c==="child"?Ut("child"):c==="parent"?Math.max(13,24-g*5):c==="sibling"?14:11.5;return J.jsxs("div",{className:"ringsSpace",children:[_&&J.jsx("img",{className:"ringsRoom",src:_.img,alt:""},`rroom-${_.id}`),J.jsx("div",{className:"pulse",style:{left:h,top:f}},`pulse-${e}`),s.map(c=>{if(c.x==null)return null;const g=o.get(c.id),x=Math.max(0,p.depth-c.depth);let y=c.x,A=c.y,w=1;return g==="active"?(y=h,A=f):g==="child"?({x:y,y:A}=v(c,d*1.32),w=.9):g==="sibling"?({x:y,y:A}=v(c,d*2.15),w=.42):g==="parent"?({x:y,y:A}=v(c,d*(1+x)*1.45),w=Math.max(.22,.55-x*.15)):({x:y,y:A}=v(c,d*2.9),w=.2),J.jsx("span",{"data-node":c.id,className:`rlabel ${g==="active"?"activeL":""} ${l===c.id?"hot":""}`,style:{transform:`translate3d(${y}px, ${A}px, 0) translate(-50%, -50%)`,fontSize:m(g,x),fontWeight:g==="active"?700:400,opacity:w},onMouseEnter:()=>u(c.id),onMouseLeave:()=>u(null),onClick:()=>r(c),children:c.label},c.id)}),(p==null?void 0:p.copy)&&J.jsx("div",{className:"fcopy",style:{transform:`translate3d(${h}px, ${f+m("active",0)*.62+16}px, 0) translateX(-50%)`},children:p.copy},`rc-${e}`)]})}const gA={active:{w:700,op:1},child:{w:500,op:.95},parent:{w:200,op:.8},sibling:{w:200,op:.55},distant:{w:100,op:.4}};function _A({sim:t,activeId:e,width:n,onNavigate:i}){const{visibleNodes:r,roles:s,byId:o}=t,[a,l]=Le.useState(null),u=o.get(e),d=u!=null&&u.img&&u.childIds.length===0?u:null,h=(f,p)=>f==="active"?Ut("active",u.label,n)*1.15:f==="child"?Ut("child")*1.15:f==="parent"?Math.max(14,26-p*5):f==="sibling"?15:12;return J.jsxs("div",{className:"weightSpace",children:[d&&J.jsx("img",{className:"ringsRoom",src:d.img,alt:""},`wroom-${d.id}`),r.map(f=>{if(f.x==null)return null;const p=s.get(f.id),_=Math.max(0,u.depth-f.depth),v=gA[p],m=a===f.id;return J.jsx("span",{"data-node":f.id,className:`wlabel ${p==="active"?"activeL":""}`,style:{transform:`translate3d(${f.x}px, ${f.y}px, 0) translate(-50%, -50%)`,fontSize:h(p,_),fontWeight:m&&p!=="active"?Math.min(700,v.w+200):v.w,opacity:m?Math.min(1,v.op+.3):v.op},onMouseEnter:()=>l(f.id),onMouseLeave:()=>l(null),onClick:()=>i(f),children:f.label},f.id)}),(u==null?void 0:u.copy)&&u.x!=null&&J.jsx("div",{className:"fcopy",style:{transform:`translate3d(${u.x}px, ${u.y+h("active",0)*.62+16}px, 0) translateX(-50%)`},children:u.copy},`wc-${e}`)]})}function vA({byId:t,activeId:e,width:n,height:i,onNavigate:r}){const[s,o]=Le.useState(null),[a,l]=Le.useState({phase:"in",chosen:null,dir:"down"});Le.useEffect(()=>{o(null),l({phase:"in",chosen:null,dir:"down"})},[e]),Le.useEffect(()=>{const c=g=>g.key==="Escape"&&(s!=null?o(null):m());return window.addEventListener("keydown",c),()=>window.removeEventListener("keydown",c)});const u=t.get(e),d=Ui(e,t).reverse().map(c=>t.get(c)),h=u.childIds.map(c=>t.get(c)),f=h.length===0,p=f&&u.media?u.media:null,_=u.parentId,v=(c,g,x=null)=>{c&&(l({phase:"out",chosen:x,dir:g}),setTimeout(()=>r(c),430))},m=()=>v(_&&t.get(_),"up");return J.jsxs("div",{className:"reveal",children:[p&&J.jsx(X_,{media:p,startIndex:s??0,width:n,height:i??window.innerHeight,onIndex:o},`gl-${e}`),J.jsxs("div",{className:`revealCol ${p?"overMedia":""} fold-${a.phase} fold-${a.dir}`,children:[J.jsx("nav",{className:"crumbs",children:d.map((c,g)=>J.jsxs("span",{className:"crumbItem",style:{animationDelay:`${g*50}ms`},children:[J.jsx("button",{onClick:()=>v(c,"up"),children:c.label}),J.jsx("i",{children:"/"})]},c.id))},`cr-${e}`),J.jsx("button",{className:"revealTitle",onClick:m,disabled:!_,style:{cursor:_?"pointer":"default"},children:u.label}),u.copy&&J.jsx("p",{className:"revealCopy",children:u.copy},`copy-${e}`),!f&&J.jsx("ul",{className:"revealList",children:h.map((c,g)=>J.jsx("li",{className:a.chosen===c.id?"chosen":"",style:{"--i":g},children:J.jsxs("button",{onClick:()=>v(c,"down",c.id),children:[J.jsx("span",{className:"idx",children:String(g+1).padStart(2,"0")}),J.jsx("span",{className:"lbl",children:c.label}),c.media&&J.jsx("span",{className:"tag",children:"work"}),J.jsx("span",{className:"arrow",children:"→"})]})},c.id))},`list-${e}`),f&&!p&&u.copy==null&&J.jsx("p",{className:"revealCopy",children:"—"})]})]})}const ld=[{obj:Ee,key:"TYPE_SCALE",label:"Type scale",min:.7,max:2.4,step:.05},{obj:Ee,key:"CHARGE",label:"Repulsion",min:-1200,max:-50,step:10},{obj:bt,key:"STRENGTH",label:"Spring",min:.05,max:1.2,step:.05},{obj:Ee,key:"DAMPING",label:"Damping",min:.1,max:.7,step:.02},{obj:Ee,key:"ALPHA_KICK",label:"Energy",min:.2,max:1,step:.05},{obj:Ee,key:"DRIFT",label:"Idle drift",min:0,max:.8,step:.02},{obj:bt,key:"LOOSE",label:"Looseness",min:0,max:48,step:2},{obj:bt,key:"GAP",label:"Rhythm",min:26,max:72,step:2},{obj:Ee,key:"SPACING",label:"Spacing",min:0,max:48,step:2},{obj:Ee,key:"CURSOR",label:"Cursor pull",min:-.8,max:.8,step:.05},{obj:Ee,key:"SHOCK",label:"Shockwave",min:0,max:20,step:1}],xA=ld.map(t=>t.obj[t.key]);function SA({onTune:t}){const[e,n]=Le.useState(typeof window>"u"?!0:window.innerWidth>680),[,i]=Le.useState(0),r=(o,a)=>{o.obj[o.key]=a,i(l=>l+1),t()},s=()=>{ld.forEach((o,a)=>o.obj[o.key]=xA[a]),i(o=>o+1),t()};return J.jsxs("aside",{className:`tune ${e?"open":""}`,children:[J.jsxs("button",{className:"tuneHead",onClick:()=>n(o=>!o),children:["Physics ",e?"▾":"▸"]}),e&&J.jsxs("div",{className:"tuneBody",children:[J.jsxs("div",{className:"tuneRow tuneVariants",children:[J.jsx("span",{className:"tuneLabel",children:"Threads"}),[!0,!1].map(o=>J.jsx("button",{className:Ee.THREADS===o?"on":"",onClick:()=>{Ee.THREADS=o,i(a=>a+1),t()},children:o?"on":"off"},String(o)))]}),J.jsxs("div",{className:"tuneRow tuneVariants",children:[J.jsx("span",{className:"tuneLabel",children:"Effect"}),["lens","wave","rgb"].map(o=>J.jsx("button",{className:Ee.FX===o?"on":"",onClick:()=>{Ee.FX=o,i(a=>a+1),t()},children:o},o))]}),J.jsxs("div",{className:"tuneRow tuneVariants",children:[J.jsx("span",{className:"tuneLabel",children:"Emission"}),["arc","orbit","fan","tide"].map(o=>J.jsx("button",{className:Ee.EMIT===o?"on":"",onClick:()=>{Ee.EMIT=o,i(a=>a+1),t()},children:o},o))]}),ld.map(o=>J.jsxs("label",{className:"tuneRow",children:[J.jsx("span",{className:"tuneLabel",children:o.label}),J.jsx("input",{type:"range",min:o.min,max:o.max,step:o.step,value:o.obj[o.key],onChange:a=>r(o,+a.target.value)}),J.jsx("span",{className:"tuneVal",children:Number(o.obj[o.key]).toFixed(o.step<1?2:0)})]},o.key)),J.jsx("button",{className:"tuneReset",onClick:s,children:"Reset"})]})]})}function yA(t){const e=+this._x.call(null,t),n=+this._y.call(null,t);return j_(this.cover(e,n),e,n,t)}function j_(t,e,n,i){if(isNaN(e)||isNaN(n))return t;var r,s=t._root,o={data:i},a=t._x0,l=t._y0,u=t._x1,d=t._y1,h,f,p,_,v,m,c,g;if(!s)return t._root=o,t;for(;s.length;)if((v=e>=(h=(a+u)/2))?a=h:u=h,(m=n>=(f=(l+d)/2))?l=f:d=f,r=s,!(s=s[c=m<<1|v]))return r[c]=o,t;if(p=+t._x.call(null,s.data),_=+t._y.call(null,s.data),e===p&&n===_)return o.next=s,r?r[c]=o:t._root=o,t;do r=r?r[c]=new Array(4):t._root=new Array(4),(v=e>=(h=(a+u)/2))?a=h:u=h,(m=n>=(f=(l+d)/2))?l=f:d=f;while((c=m<<1|v)===(g=(_>=f)<<1|p>=h));return r[g]=s,r[c]=o,t}function MA(t){var e,n,i=t.length,r,s,o=new Array(i),a=new Array(i),l=1/0,u=1/0,d=-1/0,h=-1/0;for(n=0;n<i;++n)isNaN(r=+this._x.call(null,e=t[n]))||isNaN(s=+this._y.call(null,e))||(o[n]=r,a[n]=s,r<l&&(l=r),r>d&&(d=r),s<u&&(u=s),s>h&&(h=s));if(l>d||u>h)return this;for(this.cover(l,u).cover(d,h),n=0;n<i;++n)j_(this,o[n],a[n],t[n]);return this}function EA(t,e){if(isNaN(t=+t)||isNaN(e=+e))return this;var n=this._x0,i=this._y0,r=this._x1,s=this._y1;if(isNaN(n))r=(n=Math.floor(t))+1,s=(i=Math.floor(e))+1;else{for(var o=r-n||1,a=this._root,l,u;n>t||t>=r||i>e||e>=s;)switch(u=(e<i)<<1|t<n,l=new Array(4),l[u]=a,a=l,o*=2,u){case 0:r=n+o,s=i+o;break;case 1:n=r-o,s=i+o;break;case 2:r=n+o,i=s-o;break;case 3:n=r-o,i=s-o;break}this._root&&this._root.length&&(this._root=a)}return this._x0=n,this._y0=i,this._x1=r,this._y1=s,this}function TA(){var t=[];return this.visit(function(e){if(!e.length)do t.push(e.data);while(e=e.next)}),t}function wA(t){return arguments.length?this.cover(+t[0][0],+t[0][1]).cover(+t[1][0],+t[1][1]):isNaN(this._x0)?void 0:[[this._x0,this._y0],[this._x1,this._y1]]}function rn(t,e,n,i,r){this.node=t,this.x0=e,this.y0=n,this.x1=i,this.y1=r}function AA(t,e,n){var i,r=this._x0,s=this._y0,o,a,l,u,d=this._x1,h=this._y1,f=[],p=this._root,_,v;for(p&&f.push(new rn(p,r,s,d,h)),n==null?n=1/0:(r=t-n,s=e-n,d=t+n,h=e+n,n*=n);_=f.pop();)if(!(!(p=_.node)||(o=_.x0)>d||(a=_.y0)>h||(l=_.x1)<r||(u=_.y1)<s))if(p.length){var m=(o+l)/2,c=(a+u)/2;f.push(new rn(p[3],m,c,l,u),new rn(p[2],o,c,m,u),new rn(p[1],m,a,l,c),new rn(p[0],o,a,m,c)),(v=(e>=c)<<1|t>=m)&&(_=f[f.length-1],f[f.length-1]=f[f.length-1-v],f[f.length-1-v]=_)}else{var g=t-+this._x.call(null,p.data),x=e-+this._y.call(null,p.data),y=g*g+x*x;if(y<n){var A=Math.sqrt(n=y);r=t-A,s=e-A,d=t+A,h=e+A,i=p.data}}return i}function RA(t){if(isNaN(d=+this._x.call(null,t))||isNaN(h=+this._y.call(null,t)))return this;var e,n=this._root,i,r,s,o=this._x0,a=this._y0,l=this._x1,u=this._y1,d,h,f,p,_,v,m,c;if(!n)return this;if(n.length)for(;;){if((_=d>=(f=(o+l)/2))?o=f:l=f,(v=h>=(p=(a+u)/2))?a=p:u=p,e=n,!(n=n[m=v<<1|_]))return this;if(!n.length)break;(e[m+1&3]||e[m+2&3]||e[m+3&3])&&(i=e,c=m)}for(;n.data!==t;)if(r=n,!(n=n.next))return this;return(s=n.next)&&delete n.next,r?(s?r.next=s:delete r.next,this):e?(s?e[m]=s:delete e[m],(n=e[0]||e[1]||e[2]||e[3])&&n===(e[3]||e[2]||e[1]||e[0])&&!n.length&&(i?i[c]=n:this._root=n),this):(this._root=s,this)}function CA(t){for(var e=0,n=t.length;e<n;++e)this.remove(t[e]);return this}function bA(){return this._root}function PA(){var t=0;return this.visit(function(e){if(!e.length)do++t;while(e=e.next)}),t}function LA(t){var e=[],n,i=this._root,r,s,o,a,l;for(i&&e.push(new rn(i,this._x0,this._y0,this._x1,this._y1));n=e.pop();)if(!t(i=n.node,s=n.x0,o=n.y0,a=n.x1,l=n.y1)&&i.length){var u=(s+a)/2,d=(o+l)/2;(r=i[3])&&e.push(new rn(r,u,d,a,l)),(r=i[2])&&e.push(new rn(r,s,d,u,l)),(r=i[1])&&e.push(new rn(r,u,o,a,d)),(r=i[0])&&e.push(new rn(r,s,o,u,d))}return this}function NA(t){var e=[],n=[],i;for(this._root&&e.push(new rn(this._root,this._x0,this._y0,this._x1,this._y1));i=e.pop();){var r=i.node;if(r.length){var s,o=i.x0,a=i.y0,l=i.x1,u=i.y1,d=(o+l)/2,h=(a+u)/2;(s=r[0])&&e.push(new rn(s,o,a,d,h)),(s=r[1])&&e.push(new rn(s,d,a,l,h)),(s=r[2])&&e.push(new rn(s,o,h,d,u)),(s=r[3])&&e.push(new rn(s,d,h,l,u))}n.push(i)}for(;i=n.pop();)t(i.node,i.x0,i.y0,i.x1,i.y1);return this}function DA(t){return t[0]}function IA(t){return arguments.length?(this._x=t,this):this._x}function UA(t){return t[1]}function FA(t){return arguments.length?(this._y=t,this):this._y}function xh(t,e,n){var i=new Sh(e??DA,n??UA,NaN,NaN,NaN,NaN);return t==null?i:i.addAll(t)}function Sh(t,e,n,i,r,s){this._x=t,this._y=e,this._x0=n,this._y0=i,this._x1=r,this._y1=s,this._root=void 0}function Wm(t){for(var e={data:t.data},n=e;t=t.next;)n=n.next={data:t.data};return e}var un=xh.prototype=Sh.prototype;un.copy=function(){var t=new Sh(this._x,this._y,this._x0,this._y0,this._x1,this._y1),e=this._root,n,i;if(!e)return t;if(!e.length)return t._root=Wm(e),t;for(n=[{source:e,target:t._root=new Array(4)}];e=n.pop();)for(var r=0;r<4;++r)(i=e.source[r])&&(i.length?n.push({source:i,target:e.target[r]=new Array(4)}):e.target[r]=Wm(i));return t};un.add=yA;un.addAll=MA;un.cover=EA;un.data=TA;un.extent=wA;un.find=AA;un.remove=RA;un.removeAll=CA;un.root=bA;un.size=PA;un.visit=LA;un.visitAfter=NA;un.x=IA;un.y=FA;function sn(t){return function(){return t}}function rr(t){return(t()-.5)*1e-6}function OA(t){return t.x+t.vx}function kA(t){return t.y+t.vy}function BA(t){var e,n,i,r=1,s=1;typeof t!="function"&&(t=sn(t==null?1:+t));function o(){for(var u,d=e.length,h,f,p,_,v,m,c=0;c<s;++c)for(h=xh(e,OA,kA).visitAfter(a),u=0;u<d;++u)f=e[u],v=n[f.index],m=v*v,p=f.x+f.vx,_=f.y+f.vy,h.visit(g);function g(x,y,A,w,C){var S=x.data,b=x.r,L=v+b;if(S){if(S.index>f.index){var E=p-S.x-S.vx,P=_-S.y-S.vy,F=E*E+P*P;F<L*L&&(E===0&&(E=rr(i),F+=E*E),P===0&&(P=rr(i),F+=P*P),F=(L-(F=Math.sqrt(F)))/F*r,f.vx+=(E*=F)*(L=(b*=b)/(m+b)),f.vy+=(P*=F)*L,S.vx-=E*(L=1-L),S.vy-=P*L)}return}return y>p+L||w<p-L||A>_+L||C<_-L}}function a(u){if(u.data)return u.r=n[u.data.index];for(var d=u.r=0;d<4;++d)u[d]&&u[d].r>u.r&&(u.r=u[d].r)}function l(){if(e){var u,d=e.length,h;for(n=new Array(d),u=0;u<d;++u)h=e[u],n[h.index]=+t(h,u,e)}}return o.initialize=function(u,d){e=u,i=d,l()},o.iterations=function(u){return arguments.length?(s=+u,o):s},o.strength=function(u){return arguments.length?(r=+u,o):r},o.radius=function(u){return arguments.length?(t=typeof u=="function"?u:sn(+u),l(),o):t},o}function zA(t){return t.index}function Xm(t,e){var n=t.get(e);if(!n)throw new Error("node not found: "+e);return n}function VA(t){var e=zA,n=h,i,r=sn(30),s,o,a,l,u,d=1;t==null&&(t=[]);function h(m){return 1/Math.min(a[m.source.index],a[m.target.index])}function f(m){for(var c=0,g=t.length;c<d;++c)for(var x=0,y,A,w,C,S,b,L;x<g;++x)y=t[x],A=y.source,w=y.target,C=w.x+w.vx-A.x-A.vx||rr(u),S=w.y+w.vy-A.y-A.vy||rr(u),b=Math.sqrt(C*C+S*S),b=(b-s[x])/b*m*i[x],C*=b,S*=b,w.vx-=C*(L=l[x]),w.vy-=S*L,A.vx+=C*(L=1-L),A.vy+=S*L}function p(){if(o){var m,c=o.length,g=t.length,x=new Map(o.map((A,w)=>[e(A,w,o),A])),y;for(m=0,a=new Array(c);m<g;++m)y=t[m],y.index=m,typeof y.source!="object"&&(y.source=Xm(x,y.source)),typeof y.target!="object"&&(y.target=Xm(x,y.target)),a[y.source.index]=(a[y.source.index]||0)+1,a[y.target.index]=(a[y.target.index]||0)+1;for(m=0,l=new Array(g);m<g;++m)y=t[m],l[m]=a[y.source.index]/(a[y.source.index]+a[y.target.index]);i=new Array(g),_(),s=new Array(g),v()}}function _(){if(o)for(var m=0,c=t.length;m<c;++m)i[m]=+n(t[m],m,t)}function v(){if(o)for(var m=0,c=t.length;m<c;++m)s[m]=+r(t[m],m,t)}return f.initialize=function(m,c){o=m,u=c,p()},f.links=function(m){return arguments.length?(t=m,p(),f):t},f.id=function(m){return arguments.length?(e=m,f):e},f.iterations=function(m){return arguments.length?(d=+m,f):d},f.strength=function(m){return arguments.length?(n=typeof m=="function"?m:sn(+m),_(),f):n},f.distance=function(m){return arguments.length?(r=typeof m=="function"?m:sn(+m),v(),f):r},f}var HA={value:()=>{}};function $_(){for(var t=0,e=arguments.length,n={},i;t<e;++t){if(!(i=arguments[t]+"")||i in n||/[\s.]/.test(i))throw new Error("illegal type: "+i);n[i]=[]}return new pl(n)}function pl(t){this._=t}function GA(t,e){return t.trim().split(/^|\s+/).map(function(n){var i="",r=n.indexOf(".");if(r>=0&&(i=n.slice(r+1),n=n.slice(0,r)),n&&!e.hasOwnProperty(n))throw new Error("unknown type: "+n);return{type:n,name:i}})}pl.prototype=$_.prototype={constructor:pl,on:function(t,e){var n=this._,i=GA(t+"",n),r,s=-1,o=i.length;if(arguments.length<2){for(;++s<o;)if((r=(t=i[s]).type)&&(r=WA(n[r],t.name)))return r;return}if(e!=null&&typeof e!="function")throw new Error("invalid callback: "+e);for(;++s<o;)if(r=(t=i[s]).type)n[r]=jm(n[r],t.name,e);else if(e==null)for(r in n)n[r]=jm(n[r],t.name,null);return this},copy:function(){var t={},e=this._;for(var n in e)t[n]=e[n].slice();return new pl(t)},call:function(t,e){if((r=arguments.length-2)>0)for(var n=new Array(r),i=0,r,s;i<r;++i)n[i]=arguments[i+2];if(!this._.hasOwnProperty(t))throw new Error("unknown type: "+t);for(s=this._[t],i=0,r=s.length;i<r;++i)s[i].value.apply(e,n)},apply:function(t,e,n){if(!this._.hasOwnProperty(t))throw new Error("unknown type: "+t);for(var i=this._[t],r=0,s=i.length;r<s;++r)i[r].value.apply(e,n)}};function WA(t,e){for(var n=0,i=t.length,r;n<i;++n)if((r=t[n]).name===e)return r.value}function jm(t,e,n){for(var i=0,r=t.length;i<r;++i)if(t[i].name===e){t[i]=HA,t=t.slice(0,i).concat(t.slice(i+1));break}return n!=null&&t.push({name:e,value:n}),t}var Gs=0,vo=0,co=0,Y_=1e3,Wl,xo,Xl=0,Wr=0,hu=0,Zo=typeof performance=="object"&&performance.now?performance:Date,q_=typeof window=="object"&&window.requestAnimationFrame?window.requestAnimationFrame.bind(window):function(t){setTimeout(t,17)};function K_(){return Wr||(q_(XA),Wr=Zo.now()+hu)}function XA(){Wr=0}function ud(){this._call=this._time=this._next=null}ud.prototype=Z_.prototype={constructor:ud,restart:function(t,e,n){if(typeof t!="function")throw new TypeError("callback is not a function");n=(n==null?K_():+n)+(e==null?0:+e),!this._next&&xo!==this&&(xo?xo._next=this:Wl=this,xo=this),this._call=t,this._time=n,cd()},stop:function(){this._call&&(this._call=null,this._time=1/0,cd())}};function Z_(t,e,n){var i=new ud;return i.restart(t,e,n),i}function jA(){K_(),++Gs;for(var t=Wl,e;t;)(e=Wr-t._time)>=0&&t._call.call(void 0,e),t=t._next;--Gs}function $m(){Wr=(Xl=Zo.now())+hu,Gs=vo=0;try{jA()}finally{Gs=0,YA(),Wr=0}}function $A(){var t=Zo.now(),e=t-Xl;e>Y_&&(hu-=e,Xl=t)}function YA(){for(var t,e=Wl,n,i=1/0;e;)e._call?(i>e._time&&(i=e._time),t=e,e=e._next):(n=e._next,e._next=null,e=t?t._next=n:Wl=n);xo=t,cd(i)}function cd(t){if(!Gs){vo&&(vo=clearTimeout(vo));var e=t-Wr;e>24?(t<1/0&&(vo=setTimeout($m,t-Zo.now()-hu)),co&&(co=clearInterval(co))):(co||(Xl=Zo.now(),co=setInterval($A,Y_)),Gs=1,q_($m))}}const qA=1664525,KA=1013904223,Ym=4294967296;function ZA(){let t=1;return()=>(t=(qA*t+KA)%Ym)/Ym}function QA(t){return t.x}function JA(t){return t.y}var eR=10,tR=Math.PI*(3-Math.sqrt(5));function nR(t){var e,n=1,i=.001,r=1-Math.pow(i,1/300),s=0,o=.6,a=new Map,l=Z_(h),u=$_("tick","end"),d=ZA();t==null&&(t=[]);function h(){f(),u.call("tick",e),n<i&&(l.stop(),u.call("end",e))}function f(v){var m,c=t.length,g;v===void 0&&(v=1);for(var x=0;x<v;++x)for(n+=(s-n)*r,a.forEach(function(y){y(n)}),m=0;m<c;++m)g=t[m],g.fx==null?g.x+=g.vx*=o:(g.x=g.fx,g.vx=0),g.fy==null?g.y+=g.vy*=o:(g.y=g.fy,g.vy=0);return e}function p(){for(var v=0,m=t.length,c;v<m;++v){if(c=t[v],c.index=v,c.fx!=null&&(c.x=c.fx),c.fy!=null&&(c.y=c.fy),isNaN(c.x)||isNaN(c.y)){var g=eR*Math.sqrt(.5+v),x=v*tR;c.x=g*Math.cos(x),c.y=g*Math.sin(x)}(isNaN(c.vx)||isNaN(c.vy))&&(c.vx=c.vy=0)}}function _(v){return v.initialize&&v.initialize(t,d),v}return p(),e={tick:f,restart:function(){return l.restart(h),e},stop:function(){return l.stop(),e},nodes:function(v){return arguments.length?(t=v,p(),a.forEach(_),e):t},alpha:function(v){return arguments.length?(n=+v,e):n},alphaMin:function(v){return arguments.length?(i=+v,e):i},alphaDecay:function(v){return arguments.length?(r=+v,e):+r},alphaTarget:function(v){return arguments.length?(s=+v,e):s},velocityDecay:function(v){return arguments.length?(o=1-v,e):1-o},randomSource:function(v){return arguments.length?(d=v,a.forEach(_),e):d},force:function(v,m){return arguments.length>1?(m==null?a.delete(v):a.set(v,_(m)),e):a.get(v)},find:function(v,m,c){var g=0,x=t.length,y,A,w,C,S;for(c==null?c=1/0:c*=c,g=0;g<x;++g)C=t[g],y=v-C.x,A=m-C.y,w=y*y+A*A,w<c&&(S=C,c=w);return S},on:function(v,m){return arguments.length>1?(u.on(v,m),e):u.on(v)}}}function iR(){var t,e,n,i,r=sn(-30),s,o=1,a=1/0,l=.81;function u(p){var _,v=t.length,m=xh(t,QA,JA).visitAfter(h);for(i=p,_=0;_<v;++_)e=t[_],m.visit(f)}function d(){if(t){var p,_=t.length,v;for(s=new Array(_),p=0;p<_;++p)v=t[p],s[v.index]=+r(v,p,t)}}function h(p){var _=0,v,m,c=0,g,x,y;if(p.length){for(g=x=y=0;y<4;++y)(v=p[y])&&(m=Math.abs(v.value))&&(_+=v.value,c+=m,g+=m*v.x,x+=m*v.y);p.x=g/c,p.y=x/c}else{v=p,v.x=v.data.x,v.y=v.data.y;do _+=s[v.data.index];while(v=v.next)}p.value=_}function f(p,_,v,m){if(!p.value)return!0;var c=p.x-e.x,g=p.y-e.y,x=m-_,y=c*c+g*g;if(x*x/l<y)return y<a&&(c===0&&(c=rr(n),y+=c*c),g===0&&(g=rr(n),y+=g*g),y<o&&(y=Math.sqrt(o*y)),e.vx+=c*p.value*i/y,e.vy+=g*p.value*i/y),!0;if(p.length||y>=a)return;(p.data!==e||p.next)&&(c===0&&(c=rr(n),y+=c*c),g===0&&(g=rr(n),y+=g*g),y<o&&(y=Math.sqrt(o*y)));do p.data!==e&&(x=s[p.data.index]*i/y,e.vx+=c*x,e.vy+=g*x);while(p=p.next)}return u.initialize=function(p,_){t=p,n=_,d()},u.strength=function(p){return arguments.length?(r=typeof p=="function"?p:sn(+p),d(),u):r},u.distanceMin=function(p){return arguments.length?(o=p*p,u):Math.sqrt(o)},u.distanceMax=function(p){return arguments.length?(a=p*p,u):Math.sqrt(a)},u.theta=function(p){return arguments.length?(l=p*p,u):Math.sqrt(l)},u}function rR(t){var e=sn(.1),n,i,r;typeof t!="function"&&(t=sn(t==null?0:+t));function s(a){for(var l=0,u=n.length,d;l<u;++l)d=n[l],d.vx+=(r[l]-d.x)*i[l]*a}function o(){if(n){var a,l=n.length;for(i=new Array(l),r=new Array(l),a=0;a<l;++a)i[a]=isNaN(r[a]=+t(n[a],a,n))?0:+e(n[a],a,n)}}return s.initialize=function(a){n=a,o()},s.strength=function(a){return arguments.length?(e=typeof a=="function"?a:sn(+a),o(),s):e},s.x=function(a){return arguments.length?(t=typeof a=="function"?a:sn(+a),o(),s):t},s}function sR(t){var e=sn(.1),n,i,r;typeof t!="function"&&(t=sn(t==null?0:+t));function s(a){for(var l=0,u=n.length,d;l<u;++l)d=n[l],d.vy+=(r[l]-d.y)*i[l]*a}function o(){if(n){var a,l=n.length;for(i=new Array(l),r=new Array(l),a=0;a<l;++a)i[a]=isNaN(r[a]=+t(n[a],a,n))?0:+e(n[a],a,n)}}return s.initialize=function(a){n=a,o()},s.strength=function(a){return arguments.length?(e=typeof a=="function"?a:sn(+a),o(),s):e},s.y=function(a){return arguments.length?(t=typeof a=="function"?a:sn(+a),o(),s):t},s}const Q_={id:"nevverland",label:"Nevverland",copy:"An experimental practice. Navigation as material, type as structure, imagery as weather. Built fast, kept forever — every study frozen the moment it works.",img:"img/03.jpg",children:[{id:"work",label:"Work",copy:"Studies in interfaces that behave like places — each one rebuilds a piece of the 2007 spatial web with today’s physics.",img:"img/07.jpg",children:[{id:"nike",label:"Nike",img:"img/00.jpg",copy:"Motion identity sprints. Twelve directions in ten days.",media:[{type:"video",src:"img/nike.mp4"},{type:"img",src:"img/00.jpg"},{type:"img",src:"img/03.jpg"},{type:"img",src:"img/05.jpg"}]},{id:"hbo",label:"HBO",img:"img/14.jpg",copy:"Title sequences as navigation. The menu is the trailer.",media:[{type:"img",src:"img/14.jpg"},{type:"video",src:"img/hbo.mp4"},{type:"img",src:"img/11.jpg"}]},{id:"sony",label:"Sony",img:"img/17.jpg",copy:"Product stories told through a bent lens.",media:[{type:"img",src:"img/17.jpg"},{type:"img",src:"img/09.jpg"},{type:"video",src:"img/sony.mp4"},{type:"img",src:"img/07.jpg"}]},{id:"pepsi",label:"Pepsi",img:"img/21.jpg",copy:"Liquid type systems for a liquid product.",media:[{type:"img",src:"img/21.jpg"},{type:"img",src:"img/34.jpg"},{type:"img",src:"img/38.jpg"}]},{id:"experimental",label:"Experimental",img:"img/28.jpg",copy:"The unbriefed work. Where the other four came from.",media:[{type:"video",src:"img/experimental.mp4"},{type:"img",src:"img/28.jpg"},{type:"img",src:"img/11.jpg"},{type:"img",src:"img/09.jpg"}]}]},{id:"about",label:"About",copy:"Nevverland is the studio of Nessim Higson — I AM ALWAYS HUNGRY. Twenty years of brand and interactive work, currently obsessed with making the web feel hand-made again. Small team, long leash, no templates.",img:"img/05.jpg",children:[{id:"studio",label:"Studio",img:"img/09.jpg",copy:"A room with good light, too many books, and a server that never sleeps."},{id:"people",label:"People",img:"img/11.jpg",copy:"One founder, many collaborators, several machines that think."},{id:"process",label:"Process",img:"img/34.jpg",copy:"Prototype first. Theory later, if ever. Ship the sketch."}]},{id:"info",label:"Info",copy:"Field notes and colophon. Set in Helvetica because the grid deserves respect; broken on purpose where it doesn’t. All imagery from the Uniqlock sessions.",img:"img/38.jpg",children:[{id:"notes",label:"Notes",img:"img/03.jpg",copy:"Working notes from each experiment, unedited."},{id:"colophon",label:"Colophon",img:"img/05.jpg",copy:"React + d3-force for the organic modes; just slots and springs for the structural ones."},{id:"archive",label:"Archive",img:"img/07.jpg",copy:"Frozen versions of everything, kept forever."}]},{id:"contact",label:"Contact",copy:"Always hungry. Say hello.",img:"img/09.jpg",children:[{id:"newyork",label:"New York",img:"img/11.jpg",copy:"EST, for now."},{id:"losangeles",label:"Los Angeles",img:"img/14.jpg",copy:"Golden hour, permanently."},{id:"email",label:"Email",img:"img/21.jpg",copy:"ness@iamalwayshungry.com"}]}]};function oR(t,e,n){const i=e.get(t.id);return n==="type"?Ut(i)*.8+2:sh[i].radius+Ee.COLLIDE_PADDING}function aR(t,e,n=1){function i(r){const s=t();if(!s)return;const o=Ee.CHILD_RING*n*Ee.VIEWPORT_SCALE;for(const a of e()){let l=a.x-s.x,u=a.y-s.y,d=Math.sqrt(l*l+u*u);d<1&&(l=Math.cos(a.phase),u=Math.sin(a.phase),d=1);const h=(o-d)/d*Ee.CHILD_RING_STRENGTH*r;a.vx+=l*h,a.vy+=u*h}}return i.initialize=()=>{},i}function lR(){let t=[],e=0;function n(){e+=.006;for(const i of t)i.vx+=Math.cos(e*i.driftSpeed+i.phase)*Ee.DRIFT*.1,i.vy+=Math.sin(e*i.driftSpeed*1.37+i.phase)*Ee.DRIFT*.1}return n.initialize=i=>t=i,n}function uR(t){let e=0;for(const n of t)e=(e*31+n.charCodeAt(0))%997;return e}function cR(t,e=bt.STRENGTH){function n(i){for(const r of t){const s=r.anchor.x+r.dx,o=r.anchor.y+r.dy;r.node.vx+=(s-r.node.x)*e*i,r.node.vy+=(o-r.node.y)*e*i}}return n.initialize=()=>{},n}function fR(t,e,n,i,r=0){const s=i.get(t),o=Ui(t,i),a=[],l=Ee.VIEWPORT_SCALE,u=Math.max(bt.COL_W*l*.78,bo(s.label,Ut("active"))+30*l),d=bt.BREAD_STEP*l,h=Math.max(bt.GAP*l,Ut("child")*1.7+6),f=Math.max(bt.GAP_DISTANT*l,Ut("distant")*2+8);for(const p of e){const _=n.get(p.id);if(_==="child"){const v=s.childIds.indexOf(p.id);a.push({node:p,anchor:s,dx:u,dy:bt.CHILD_DROP+r+v*h})}else if(_==="sibling"){const v=i.get(s.parentId).childIds,m=v.indexOf(p.id)-v.indexOf(t);a.push({node:p,anchor:s,dx:0,dy:m*h+(m>0?bt.ACTIVE_CLEAR+r:0)})}else if(_==="parent"){const v=o.indexOf(p.id)+1;a.push({node:p,anchor:s,dx:-d*v,dy:-bt.ROW_LIFT*l*v})}else if(_==="distant"){const v=i.get(p.parentId).childIds,m=e.find(g=>g.parentId===p.parentId&&(n.get(g.id)==="parent"||g.id===t));if(!m)continue;const c=v.indexOf(p.id)-v.indexOf(m.id);a.push({node:p,anchor:m,dx:0,dy:c*f+(c>0?10:-6)})}}return a}function dR(t,e,n,i,r,s,o){const a=i.get(t),l=Ui(t,i),u=[],d=Ut("active",a.label,s),h=Math.max(bt.GAP,Ut("child")*2.15),f=Math.max(30,Ut("sibling")*2.6),p=c=>o?(uR(c)%100/50-1)*o:0;l.forEach((c,g)=>{u.push({node:i.get(c),anchor:a,dx:p(c)*.6,dy:-(d*.55+34+g*34)})});const _=a.childIds.filter(c=>n.has(c)),v=d*.55+26+r;_.forEach((c,g)=>{u.push({node:i.get(c),anchor:a,dx:p(c),dy:v+g*h})});let m=v+_.length*h+30;if(a.parentId)for(const c of i.get(a.parentId).childIds)c===t||!n.has(c)||(u.push({node:i.get(c),anchor:a,dx:p(c),dy:m}),m+=f);m+=18;for(const c of e)n.get(c.id)==="distant"&&(u.push({node:c,anchor:a,dx:p(c.id),dy:m}),m+=27);return u}function hR(t,e){let n=[];function i(r){const s=Ee.CONTAIN_MARGIN*Ee.VIEWPORT_SCALE;for(const o of n)o.x<s&&(o.vx+=(s-o.x)*Ee.CONTAIN_STRENGTH*r),o.x>t-s&&(o.vx-=(o.x-(t-s))*Ee.CONTAIN_STRENGTH*r),o.y<s&&(o.vy+=(s-o.y)*Ee.CONTAIN_STRENGTH*r),o.y>e-s&&(o.vy-=(o.y-(e-s))*Ee.CONTAIN_STRENGTH*r)}return i.initialize=r=>n=r,i}function pR(t){let e=[];function i(){if(!(!Ee.CURSOR||t.x==null))for(const r of e){const s=t.x-r.x,o=t.y-r.y,a=Math.hypot(s,o);if(a>300||a<2)continue;const l=Ee.CURSOR*(1-a/300)*.18;r.vx+=s/a*l,r.vy+=o/a*l}}return i.initialize=r=>e=r,i}function mR(t,e,n,i="type",r=0){const[,s]=Le.useState(0),o=Le.useRef(null);if(!o.current){const{nodes:d,byId:h}=US(Q_);for(const f of d)f.phase=Math.random()*Math.PI*2,f.driftSpeed=.5+Math.random(),f.everShown=!1;o.current={sim:nR([]).stop(),nodes:d,byId:h,roles:new Map,seeded:!1,pointer:{x:null,y:null},prevFocus:null}}const{sim:a,nodes:l,byId:u}=o.current;return Le.useEffect(()=>{if(!e||!n)return;const d=i==="focus"||i==="rings"||i==="weight",h=i==="orbs"||d?"orbs":"type",f=e/2,p=n/2;if(!o.current.seeded){for(const E of l)E.x=e/2+(Math.random()-.5)*60,E.y=n/2+(Math.random()-.5)*60;o.current.seeded=!0}const _=FS(t,u);o.current.roles=_;const v=E=>_.get(E.id),m=l.filter(E=>_.has(E.id));for(const E of m)if(!E.everShown){const P=E.parentId?u.get(E.parentId):null;P&&P.everShown&&(E.x=P.x+(Math.random()-.5)*40,E.y=P.y+(Math.random()-.5)*40),E.everShown=!0}const c=[];for(const E of m){if(!E.parentId||!_.has(E.parentId))continue;const P=v(E),F=P==="child"?"activeChild":P==="active"||P==="parent"?"breadcrumb":P==="sibling"?"sibling":"distant";c.push({source:E.parentId,target:E.id,kind:F})}o.current.links=c;for(const E of["charge","link","collide","x","y","ring","drift","contain","pointer"])a.force(E,null);a.nodes(m),a.velocityDecay(Ee.DAMPING);const g=h==="type"?bt.CHARGE_SCALE:1;a.force("charge",iR().strength(E=>Ee.CHARGE*sh[v(E)].scale*g*Ee.VIEWPORT_SCALE).distanceMax(Ee.CHARGE_MAX_DISTANCE*Ee.VIEWPORT_SCALE)),a.force("link",VA(c).id(E=>E.id).distance(E=>Ee.LINK_DISTANCE[E.kind]*Ee.VIEWPORT_SCALE).strength(h==="type"?bt.LINK_STRENGTH:.6)),a.force("collide",BA(E=>d?bo(E.label,Ut(v(E)))*.42+6+Ee.SPACING*.5:oR(E,_,h)+(h==="type"?Ee.SPACING*.25:0)).strength(Ee.COLLIDE_STRENGTH).iterations(2));const x=i==="structure"||i==="imagery",y=Ui(t,u).length,A=u.get(t),w=A.childIds.filter(E=>_.has(E)),C=A.parentId?u.get(A.parentId).childIds.filter(E=>_.has(E)&&E!==t).length:0;let S,b;if(h==="type"){const E=Ee.VIEWPORT_SCALE,P=Ut("active",A.label,e),F=Math.max(bt.GAP*E,Ut("child")*1.7+6),j=(x||i==="depth")&&A.copy?Math.min(150,Math.ceil(A.copy.length/48)*21+26):0,D=y*(x?34:bt.ROW_LIFT*E*.7)+P*.5+30,O=P*.5+j+w.length*F+(C?30+C*(x?30:0):0);b=n*.46-(O-D)/2;const B=Math.max(28,e*.06),k=x?0:Math.max(bt.COL_W*E*.78,bo(A.label,P)+30*E);let X=0;for(const fe of w)X=Math.max(X,bo(u.get(fe).label,Ut("child")));const Y=x?B:B+y*bt.BREAD_STEP*E,ne=e-24-k-X;S=Math.max(B,Math.min(Y,Math.max(B,ne)))}else S=f,b=p;if(a.force("x",rR(S).strength(E=>v(E)==="active"?Ee.CENTER_PULL_ACTIVE:Ee.CENTER_PULL_OTHERS)),a.force("y",sR(E=>v(E)==="parent"&&h!=="type"?p-Ee.BREADCRUMB_LIFT:b).strength(E=>{const P=v(E);return P==="active"?Ee.CENTER_PULL_ACTIVE:P==="parent"?Ee.BREADCRUMB_PULL:Ee.CENTER_PULL_OTHERS})),h==="type"){const E=u.get(t),P=(x||i==="depth")&&E.copy?Math.min(150,Math.ceil(E.copy.length/48)*21+26):0,F=x?dR(t,m,_,u,P,e,i==="structure"?0:bt.LOOSE):fR(t,m,_,u,P);a.force("ring",cR(F,x?.9:bt.STRENGTH))}else a.force("ring",aR(()=>u.get(t),()=>m.filter(E=>v(E)==="child"),d?1.5:1));a.force("drift",lR()),a.force("contain",hR(e,n)),a.force("pointer",pR(o.current.pointer));const L=u.get(t);if(Ee.SHOCK>0&&o.current.prevFocus&&o.current.prevFocus!==t&&L.x!=null)for(const E of m){if(E===L||E.x==null)continue;const P=E.x-L.x,F=E.y-L.y,j=Math.hypot(P,F)||1,D=Ee.SHOCK*Math.min(1,220/j);E.vx+=P/j*D,E.vy+=F/j*D}return o.current.prevFocus=t,a.on("tick",()=>s(E=>E+1)),a.alpha(Ee.ALPHA_KICK).alphaTarget(Ee.DRIFT>.015?Ee.IDLE_ALPHA:0).restart(),s(E=>E+1),()=>a.on("tick",null)},[t,e,n,i,r]),Le.useEffect(()=>()=>a.stop(),[]),{visibleNodes:l.filter(d=>o.current.roles.has(d.id)),links:o.current.links||[],roles:o.current.roles,byId:u,pointer:o.current.pointer}}function qm(t){return Math.max(.5,Math.min(1,(t-80)/1e3))}const gR=Q_.id,_R=[{key:"focus",label:"01 FOCAL"},{key:"type",label:"02 ORGANIC"},{key:"orbs",label:"03 ORBS"},{key:"structure",label:"04 STRUCTURE"},{key:"imagery",label:"05 IMAGERY"},{key:"depth",label:"06 DEPTH"},{key:"rings",label:"07 RINGS"},{key:"weight",label:"08 WEIGHT"},{key:"reveal",label:"09 REVEAL"}];function vR(){const[t,e]=Le.useState(gR),[n,i]=Le.useState("focus"),[r,s]=Le.useState(0),[o,a]=Le.useState(!1),l=Le.useRef(null),[u,d]=Le.useState({width:0,height:0});Le.useEffect(()=>{const _=v=>{(v.key==="h"||v.key==="H")&&a(m=>!m)};return window.addEventListener("keydown",_),()=>window.removeEventListener("keydown",_)},[]),Le.useEffect(()=>{const _=l.current,v=_.getBoundingClientRect();Ee.VIEWPORT_SCALE=qm(v.width),d({width:v.width,height:v.height});const m=new ResizeObserver(([c])=>{const{width:g,height:x}=c.contentRect;Ee.VIEWPORT_SCALE=qm(g),d({width:g,height:x})});return m.observe(_),()=>m.disconnect()},[]);const h=mR(t,u.width,u.height,n,r);Le.useEffect(()=>{const _=v=>{v.key==="fb-nav"&&v.newValue&&h.byId.has(v.newValue)&&e(v.newValue)};return window.addEventListener("storage",_),()=>window.removeEventListener("storage",_)},[h.byId]);const f=_=>{const v=_.id===t?_.parentId:_.id;if(v){e(v);try{localStorage.setItem("fb-nav",v)}catch{}}},p=[t,...Ui(t,h.byId)].reverse().map(_=>h.byId.get(_).label);return J.jsxs("div",{className:`stage ${o?"bare":""}`,ref:l,onMouseMove:_=>{h.pointer.x=_.clientX,h.pointer.y=_.clientY},onMouseLeave:()=>{h.pointer.x=null,h.pointer.y=null},children:[u.width>0&&(n==="reveal"?J.jsx(vA,{byId:h.byId,activeId:t,width:u.width,height:u.height,onNavigate:f}):n==="focus"?J.jsx(hA,{sim:h,activeId:t,width:u.width,height:u.height,onNavigate:f}):n==="rings"?J.jsx(mA,{sim:h,activeId:t,width:u.width,height:u.height,onNavigate:f}):n==="weight"?J.jsx(_A,{sim:h,activeId:t,width:u.width,onNavigate:f}):J.jsx(HS,{width:u.width,height:u.height,sim:h,activeId:t,mode:n,onNavigate:f})),J.jsx(SA,{onTune:()=>s(_=>_+1)}),J.jsxs("header",{className:"chrome top",children:[J.jsx("span",{className:"wordmark",children:"NEVVERLAND"}),J.jsx("span",{className:"trail",children:p.join("  /  ")})]}),J.jsxs("footer",{className:"chrome bottom",children:[J.jsx("span",{className:"hint",children:"CLICK TO GO DEEPER — CLICK THE SPACE TO GO BACK — H FOR CLEAN VIEW"}),J.jsx("span",{className:"switch",children:_R.map(_=>J.jsx("button",{className:n===_.key?"on":"",onClick:()=>i(_.key),children:_.label},_.key))})]})]})}Ec.createRoot(document.getElementById("root")).render(J.jsx(Ev.StrictMode,{children:J.jsx(vR,{})}));
